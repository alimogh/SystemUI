...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    private V put(K k, final V v, final boolean z) {
        return (V) doTask(k, new ConcurrentReferenceHashMap<K, V>.Task(this, new TaskOption[]{TaskOption.RESTRUCTURE_BEFORE, TaskOption.RESIZE}) { // from class: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.1
    ...
    public V remove(Object obj) {
        return (V) doTask(obj, new ConcurrentReferenceHashMap<K, V>.Task(this, TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY) { // from class: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.2
            /* access modifiers changed from: protected */
            @Override // com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.Task
    ...
    public boolean remove(Object obj, final Object obj2) {
        return ((Boolean) doTask(obj, new ConcurrentReferenceHashMap<K, V>.Task(this, new TaskOption[]{TaskOption.RESTRUCTURE_AFTER, TaskOption.SKIP_IF_EMPTY}) { // from class: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.3
            /* access modifiers changed from: protected */
            @Override // com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.Task
    ...
    public boolean replace(K k, final V v, final V v2) {
        return ((Boolean) doTask(k, new ConcurrentReferenceHashMap<K, V>.Task(this, new TaskOption[]{TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY}) { // from class: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.4
    ...
    public V replace(K k, final V v) {
        return (V) doTask(k, new ConcurrentReferenceHashMap<K, V>.Task(this, new TaskOption[]{TaskOption.RESTRUCTURE_BEFORE, TaskOption.SKIP_IF_EMPTY}) { // from class: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.5
            /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap$Entry<K, V> */
            /* JADX WARN: Multi-variable type inference failed */
            /* access modifiers changed from: protected */
            @Override // com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.Task
    ...
    public final class Segment extends ReentrantLock {
        ...
        public <T> T doTask(final int i, final Object obj, ConcurrentReferenceHashMap<K, V>.Task task) {
            ...
            try {
                ...
                return task.execute(findInChain, entry, new ConcurrentReferenceHashMap<K, V>.Entries() { // from class: com.oneplus.utils.reflection.utils.ConcurrentReferenceHashMap.Segment.1
