...
public class OpNavigationHandle extends View {
            ...
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (!this.mStartAnimPlayed && (abs >= 40 || abs2 >= 40)) {
                        ...
                        Log.d("OpNavigationHandle", "Animation played " + this.mStartAnimPlayed + ", xDiff " + abs + ", yDiff " + abs2);
                        return;
                    } else {
                        return;
                    }
    ...
    private void doStartAnim() {
        /*
            r6 = this;
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r0 = r6.mAnimDirection
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r1 = com.oneplus.systemui.statusbar.phone.OpNavigationHandle.AnimDirection.DOWN
            r2 = 2
        ...
        L_0x0033:
            ...
            return
        L_0x0037:
            int[] r0 = com.oneplus.systemui.statusbar.phone.OpNavigationHandle.AnonymousClass3.$SwitchMap$com$oneplus$systemui$statusbar$phone$OpNavigationHandle$AnimDirection
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r1 = r6.mAnimDirection
            int r1 = r1.ordinal()
            r0 = r0[r1]
            r1 = 0
            r3 = 1
        ...
        L_0x004e:
            ...
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r4 = r6.mAnimDirection
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r5 = com.oneplus.systemui.statusbar.phone.OpNavigationHandle.AnimDirection.UP
        ...
        L_0x0072:
            ...
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r4 = r6.mAnimDirection
            com.oneplus.systemui.statusbar.phone.OpNavigationHandle$AnimDirection r5 = com.oneplus.systemui.statusbar.phone.OpNavigationHandle.AnimDirection.LEFT
        ...
        L_0x00ac:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.systemui.statusbar.phone.OpNavigationHandle.doStartAnim():void");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: com.oneplus.systemui.statusbar.phone.OpNavigationHandle$3  reason: invalid class name */
    public static /* synthetic */ class AnonymousClass3 {
        static final /* synthetic */ int[] $SwitchMap$com$oneplus$systemui$statusbar$phone$OpNavigationHandle$AnimDirection;

        static {
            int[] iArr = new int[AnimDirection.values().length];
            $SwitchMap$com$oneplus$systemui$statusbar$phone$OpNavigationHandle$AnimDirection = iArr;
            try {
                iArr[AnimDirection.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                $SwitchMap$com$oneplus$systemui$statusbar$phone$OpNavigationHandle$AnimDirection[AnimDirection.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                $SwitchMap$com$oneplus$systemui$statusbar$phone$OpNavigationHandle$AnimDirection[AnimDirection.DOWN.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                $SwitchMap$com$oneplus$systemui$statusbar$phone$OpNavigationHandle$AnimDirection[AnimDirection.UP.ordinal()] = 4;
    ...
    private void doEndAnim() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.systemui.statusbar.phone.OpNavigationHandle.doEndAnim():void");
    }
