...
public class DisplayImeController implements DisplayController.OnDisplaysChangedListener {
    ...
    public class PerDisplay extends IDisplayWindowInsetsController.Stub {
        ...
        public void insetsChanged(InsetsState insetsState) {
            ((KeyguardUpdateMonitor) Dependency.get(KeyguardUpdateMonitor.class)).notifyInsetsChanged();
            DisplayImeController.this.mHandler.post(new Runnable(insetsState) { // from class: com.android.systemui.wm.-$$Lambda$DisplayImeController$PerDisplay$RsnC99lStI9aBLStiHw26Ct1bkM
            ...
            if (insetsSourceControlArr != null) {
                for (InsetsSourceControl insetsSourceControl : insetsSourceControlArr) {
                    if (insetsSourceControl != null && insetsSourceControl.getType() == 13) {
                        DisplayImeController.this.mHandler.post(new Runnable(insetsSourceControl) { // from class: com.android.systemui.wm.-$$Lambda$DisplayImeController$PerDisplay$VKegz7htjpQCkeKeoZ-Wkho3eGY
        ...
        private void startAnimation(boolean z, boolean z2) {
            ...
            if (source != null && this.mImeSourceControl != null) {
                ...
                if (this.mAnimationDirection != 2 || z) {
                    ...
                    this.mAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(f3, z4, height, f2) { // from class: com.android.systemui.wm.-$$Lambda$DisplayImeController$PerDisplay$J4UVZpw7ZmqU_1hqrDGd2-bjaNE
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                            DisplayImeController.PerDisplay.this.lambda$startAnimation$4$DisplayImeController$PerDisplay(this.f$1, this.f$2, this.f$3, this.f$4, valueAnimator2);
                        }
                    });
                    ...
                    this.mAnimation.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.wm.DisplayImeController.PerDisplay.1
                        ...
                        public void onAnimationStart(Animator animator) {
                            ...
                            acquire.setAlpha(PerDisplay.this.mImeSourceControl.getLeash(), f6);
                        ...
                        public void onAnimationEnd(Animator animator) {
                            ...
                            if (perDisplay2.mAnimationDirection == 2 && !this.mCancelled) {
                                ...
                                IInputMethodManager imms = DisplayImeController.this.getImms();
                                if (imms != null) {
                                    try {
