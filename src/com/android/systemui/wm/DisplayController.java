...
public class DisplayController {
    ...
    private final IDisplayWindowListener mDisplayContainerListener = new IDisplayWindowListener.Stub() { // from class: com.android.systemui.wm.DisplayController.1
        public void onDisplayAdded(int i) {
            DisplayController.this.mHandler.post(new Runnable(i) { // from class: com.android.systemui.wm.-$$Lambda$DisplayController$1$zJ2mVywyLG45RsLGtw9ST7xxypY
        ...
        public void onDisplayConfigurationChanged(int i, Configuration configuration) {
            DisplayController.this.mHandler.post(new Runnable(i, configuration) { // from class: com.android.systemui.wm.-$$Lambda$DisplayController$1$mO2SyO-pDmJKrsjv09X-0fk_FOg
                public final /* synthetic */ int f$1;
        ...
        public void onDisplayRemoved(int i) {
            DisplayController.this.mHandler.post(new Runnable(i) { // from class: com.android.systemui.wm.-$$Lambda$DisplayController$1$sHTeIz3WbujoajhpVNRgzuLoi74
                public final /* synthetic */ int f$1;
        ...
        public void onFixedRotationStarted(int i, int i2) {
            DisplayController.this.mHandler.post(new Runnable(i, i2) { // from class: com.android.systemui.wm.-$$Lambda$DisplayController$1$l7FiEOWmAq5RJbL_Wn1mlPPItcA
                public final /* synthetic */ int f$1;
        ...
        public void onFixedRotationFinished(int i) {
            DisplayController.this.mHandler.post(new Runnable(i) { // from class: com.android.systemui.wm.-$$Lambda$DisplayController$1$ZPKsrnP-JwHyuDSJzU-6c-SEJs0
                public final /* synthetic */ int f$1;
