...
public class DisplayChangeController {
    ...
    public DisplayChangeController(Handler handler, IWindowManager iWindowManager) {
        AnonymousClass1 r0 = new IDisplayWindowRotationController.Stub() { // from class: com.android.systemui.wm.DisplayChangeController.1
            public void onRotateDisplay(int i, int i2, int i3, IDisplayWindowRotationCallback iDisplayWindowRotationCallback) {
                DisplayChangeController.this.mHandler.post(new Runnable(i, i2, i3, iDisplayWindowRotationCallback) { // from class: com.android.systemui.wm.-$$Lambda$DisplayChangeController$1$cr2NyoFjnt2r0DMHwy9cOe5oGO4
