...
public class SystemWindows {
    ...
    public SystemWindows(Context context, DisplayController displayController, IWindowManager iWindowManager) {
        AnonymousClass1 r0 = new DisplayController.OnDisplaysChangedListener() { // from class: com.android.systemui.wm.SystemWindows.1
        ...
        try {
            iWindowManager.openSession(new IWindowSessionCallback.Stub(this) { // from class: com.android.systemui.wm.SystemWindows.2
    ...
    public void removeView(View view) {
        SurfaceControlViewHost remove = this.mViewRoots.remove(view);
        if (remove != null) {
            remove.release();
        }
    }
    ...
    public class ContainerWindow extends IWindow.Stub {
        ...
        public void enterScreenCompatMode(boolean z, int i) {
        }
