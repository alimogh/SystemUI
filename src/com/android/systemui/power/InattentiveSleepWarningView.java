...
public class InattentiveSleepWarningView extends FrameLayout {
    ...
    InattentiveSleepWarningView(Context context) {
        super(context);
        LayoutInflater.from(((FrameLayout) this).mContext).inflate(C0011R$layout.inattentive_sleep_warning, (ViewGroup) this, true);
        setFocusable(true);
    ...
    public void dismiss(boolean z) {
        if (getParent() != null) {
            ...
            if (z) {
                ...
                postOnAnimation(new Runnable(animator) { // from class: com.android.systemui.power.-$$Lambda$VKaan4AksvR9EA2Slt2S3X5pVOI
