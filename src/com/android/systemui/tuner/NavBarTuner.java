...
public class NavBarTuner extends TunerPreferenceFragment {
    private static final int[][] ICONS = {new int[]{C0006R$drawable.ic_qs_circle, C0015R$string.tuner_circle}, new int[]{C0006R$drawable.ic_add, C0015R$string.tuner_plus}, new int[]{C0006R$drawable.ic_remove, C0015R$string.tuner_minus}, new int[]{C0006R$drawable.ic_left, C0015R$string.tuner_left}, new int[]{C0006R$drawable.ic_right, C0015R$string.tuner_right}, new int[]{C0006R$drawable.ic_menu, C0015R$string.tuner_menu}};
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        addPreferencesFromResource(C0017R$xml.nav_bar_tuner);
    ...
    private void bindLayout(ListPreference listPreference) {
        addTunable(new TunerService.Tunable(listPreference) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$nx5Q7aHowvZ9Bevy96_zeYYIxAY
    ...
    public /* synthetic */ void lambda$bindLayout$2$NavBarTuner(ListPreference listPreference, String str, String str2) {
        this.mHandler.post(new Runnable(str2, listPreference) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$RQUqCpCXtFwKbIxFJ1AuU4K69W4
    ...
    private void bindButton(String str, String str2, String str3) {
        ...
        addTunable(new TunerService.Tunable(str2, listPreference, listPreference2, findPreference) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$AtqwC3eDMLXM8PvQu0SrBbBcxZQ
            ...
            public final void onTuningChanged(String str4, String str5) {
                NavBarTuner.this.lambda$bindButton$5$NavBarTuner(this.f$1, this.f$2, this.f$3, this.f$4, str4, str5);
            }
        }, str);
        $$Lambda$NavBarTuner$5vkJoJwaFUhdGZ7Fp4qtkLVqooo r11 = new Preference.OnPreferenceChangeListener(str, listPreference, findPreference, listPreference2) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$5vkJoJwaFUhdGZ7Fp4qtkLVqooo
            public final /* synthetic */ String f$1;
            public final /* synthetic */ ListPreference f$2;
        ...
        findPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener(findPreference, str, listPreference, listPreference2) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$VEefG8gxDDp8OSjE4w47bWNl4eQ
    ...
    public /* synthetic */ void lambda$bindButton$5$NavBarTuner(String str, ListPreference listPreference, ListPreference listPreference2, Preference preference, String str2, String str3) {
        this.mHandler.post(new Runnable(str3, str, listPreference, listPreference2, preference) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$sQQgaEvmFdhni6jwm3oIAJf94Eo
            public final /* synthetic */ String f$1;
            public final /* synthetic */ String f$2;
            public final /* synthetic */ ListPreference f$3;
            public final /* synthetic */ ListPreference f$4;
    ...
    public /* synthetic */ boolean lambda$bindButton$7$NavBarTuner(String str, ListPreference listPreference, Preference preference, ListPreference listPreference2, Preference preference2, Object obj) {
        this.mHandler.post(new Runnable(str, listPreference, preference, listPreference2) { // from class: com.android.systemui.tuner.-$$Lambda$NavBarTuner$Q4QuzL1NB7uGZ3GCFspFwSEMA8g
            public final /* synthetic */ String f$1;
            public final /* synthetic */ ListPreference f$2;
            public final /* synthetic */ Preference f$3;
            public final /* synthetic */ ListPreference f$4;
