...
public class PluginFragment extends PreferenceFragment {
    ...
    private void loadPrefs() {
        ...
        packageManager.getPackagesHoldingPermissions(new String[]{"com.android.systemui.permission.PLUGIN"}, 516).forEach(new Consumer(arrayMap, pluginManager, context, createPreferenceScreen) { // from class: com.android.systemui.tuner.-$$Lambda$PluginFragment$iW8kXrJfaof7fDZHqMxR_RNftYk
    ...
    public static class PluginPreference extends SwitchPreference {
        ...
        public PluginPreference(Context context, PackageInfo packageInfo, PluginEnabler pluginEnabler) {
            ...
            setWidgetLayoutResource(C0011R$layout.tuner_widget_settings_switch);
        }
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            int i = 0;
            preferenceViewHolder.findViewById(C0008R$id.settings).setVisibility(this.mHasSettings ? 0 : 8);
            View findViewById = preferenceViewHolder.findViewById(C0008R$id.divider);
            if (!this.mHasSettings) {
                i = 8;
            }
            findViewById.setVisibility(i);
            preferenceViewHolder.findViewById(C0008R$id.settings).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.tuner.-$$Lambda$PluginFragment$PluginPreference$Xt_y65tw1Tc7XykRWrNNbIDklTs
