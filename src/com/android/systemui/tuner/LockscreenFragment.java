...
public class LockscreenFragment extends PreferenceFragment {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        new Handler();
        addPreferencesFromResource(C0017R$xml.lockscreen_settings);
    ...
    private void setupGroup(String str, String str2) {
        addTunable(new TunerService.Tunable((SwitchPreference) findPreference(str2), findPreference(str)) { // from class: com.android.systemui.tuner.-$$Lambda$LockscreenFragment$Obd464MAoJT5uRv3BJuc47igR_Y
            ...
            public final void onTuningChanged(String str3, String str4) {
                LockscreenFragment.this.lambda$setupGroup$1$LockscreenFragment(this.f$1, this.f$2, str3, str4);
            }
        }, str);
    }
    ...
    private void setSummary(Preference preference, String str) {
        if (str == null) {
            preference.setSummary(C0015R$string.lockscreen_none);
            return;
        }
    ...
    public static class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(View view) {
            ...
            this.expand = (ExpandableIndicator) view.findViewById(C0008R$id.expand);
        }
    }
    ...
    public static class App extends Item {
        ...
        public void toggleExpando(Adapter adapter) {
            ...
            this.mExpanded = z;
            if (z) {
                this.mChildren.forEach(new Consumer(adapter) { // from class: com.android.systemui.tuner.-$$Lambda$LockscreenFragment$App$ETExpSuIeTllbJ9AB_3DTGOAJgk
    ...
    public static class Adapter extends RecyclerView.Adapter<Holder> {
        ...
        public Holder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new Holder(LayoutInflater.from(viewGroup.getContext()).inflate(C0011R$layout.tuner_shortcut_item, viewGroup, false));
        }
        ...
        public void onBindViewHolder(Holder holder, int i) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener(holder) { // from class: com.android.systemui.tuner.-$$Lambda$LockscreenFragment$Adapter$VuIE2eL9-LHOyBflZw_Px7xwF04
            ...
            if (expando != null) {
                ...
                holder.expand.setOnClickListener(new View.OnClickListener(holder) { // from class: com.android.systemui.tuner.-$$Lambda$LockscreenFragment$Adapter$fS6IuUEavDgpMOkDZLNh46UcUNQ
                    public final /* synthetic */ LockscreenFragment.Holder f$1;
