...
public class RadioListPreference extends CustomListPreference {
    ...
    public Dialog onDialogCreated(DialogFragment dialogFragment, Dialog dialog) {
        ...
        Toolbar toolbar = (Toolbar) dialog2.findViewById(16908709);
        View view = new View(getContext());
        view.setId(C0008R$id.content);
        dialog2.setContentView(view);
        toolbar.setTitle(getTitle());
        toolbar.setNavigationIcon(Utils.getDrawable(dialog2.getContext(), 16843531));
        toolbar.setNavigationOnClickListener(new View.OnClickListener(dialog2) { // from class: com.android.systemui.tuner.-$$Lambda$RadioListPreference$4DEUOALD3KxT1NUXowELf-5ZJ2M
            ...
            public final void onClick(View view2) {
                RadioListPreference.lambda$onDialogCreated$0(this.f$0, view2);
            }
        });
    ...
    public void onDialogStateRestored(DialogFragment dialogFragment, Dialog dialog, Bundle bundle) {
        ...
        RadioFragment radioFragment = (RadioFragment) FragmentHostManager.get(dialog.findViewById(C0008R$id.content)).getFragmentManager().findFragmentById(C0008R$id.content);
