...
public class TunerServiceImpl extends TunerService {
    ...
    public TunerServiceImpl(Context context, Handler handler, LeakDetector leakDetector, BroadcastDispatcher broadcastDispatcher) {
        ...
        AnonymousClass1 r4 = new CurrentUserTracker(broadcastDispatcher) { // from class: com.android.systemui.tuner.TunerServiceImpl.1
    ...
    private void upgradeTuner(int i, int i2, Handler handler) {
        ...
        if (i < 4) {
            handler.postDelayed(new Runnable(this.mCurrentUser) { // from class: com.android.systemui.tuner.-$$Lambda$TunerServiceImpl$SZ83wU1GcnmYXjZCH1hfw7pCVvY
    ...
    private void addTunable(TunerService.Tunable tunable, String str) {
        ...
        tunable.onTuningChanged(str, (String) DejankUtils.whitelistIpcs(new Supplier(str) { // from class: com.android.systemui.tuner.-$$Lambda$TunerServiceImpl$rxKdnA_ESs9ir91j7kkfizLlu6E
