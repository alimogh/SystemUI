...
public class ShortcutPicker extends PreferenceFragment implements TunerService.Tunable {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        preferenceCategory.setTitle(C0015R$string.tuner_other_apps);
        ...
        this.mNonePreference.setTitle(C0015R$string.lockscreen_none);
        this.mNonePreference.setIcon(C0006R$drawable.ic_remove_circle);
        ...
        activityList.forEach(new Consumer(context, createPreferenceScreen, preferenceCategory) { // from class: com.android.systemui.tuner.-$$Lambda$ShortcutPicker$S1ImsFAQfzG0QWSEvA0DqvnEIeY
    ...
    public /* synthetic */ void lambda$onCreatePreferences$1$ShortcutPicker(Context context, PreferenceScreen preferenceScreen, PreferenceCategory preferenceCategory, LauncherActivityInfo launcherActivityInfo) {
        try {
            ...
            if (shortcuts.size() != 0) {
                ...
                shortcuts.forEach(new Consumer(context, launcherActivityInfo, preferenceScreen) { // from class: com.android.systemui.tuner.-$$Lambda$ShortcutPicker$UYdUITYIUaxXrzDZbzfvlRGD9eA
                    public final /* synthetic */ Context f$1;
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        if ("sysui_keyguard_left".equals(this.mKey)) {
            getActivity().setTitle(C0015R$string.lockscreen_shortcut_left);
        } else {
            getActivity().setTitle(C0015R$string.lockscreen_shortcut_right);
        }
    }
    ...
    public void onTuningChanged(String str, String str2) {
        ...
        this.mSelectablePreferences.forEach(new Consumer(str2) { // from class: com.android.systemui.tuner.-$$Lambda$ShortcutPicker$i1fIZ726bN-ySXwulncRN12T1Qg
    ...
    public static class AppPreference extends SelectablePreference {
        ...
        public AppPreference(Context context, LauncherActivityInfo launcherActivityInfo) {
            ...
            setTitle(context.getString(C0015R$string.tuner_launch_app, launcherActivityInfo.getLabel()));
            setSummary(context.getString(C0015R$string.tuner_app, launcherActivityInfo.getLabel()));
        }
        ...
        @Override // com.android.systemui.tuner.SelectablePreference, androidx.preference.Preference, java.lang.Object
    ...
    public static class ShortcutPreference extends SelectablePreference {
        ...
        public ShortcutPreference(Context context, ShortcutParser.Shortcut shortcut, CharSequence charSequence) {
            ...
            setSummary(context.getString(C0015R$string.tuner_app, charSequence));
        }
