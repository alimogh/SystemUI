...
public class CornerHandleView extends View {
    ...
    private float getOuterRadiusPx() {
        int dimensionPixelSize = getResources().getDimensionPixelSize(C0005R$dimen.rounded_corner_radius_bottom) / 2;
        if (dimensionPixelSize == 0 && mDisableRoundedCorner == 0) {
            dimensionPixelSize = getResources().getDimensionPixelSize(C0005R$dimen.config_rounded_mask_size);
        }
        if (dimensionPixelSize == 0) {
            dimensionPixelSize = getResources().getDimensionPixelSize(C0005R$dimen.rounded_corner_radius_top) / 2;
        }
        if (dimensionPixelSize == 0) {
