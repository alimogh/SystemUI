...
public class SystemActions extends SystemUI {
    ...
    private void registerActions() {
        RemoteAction createRemoteAction = createRemoteAction(17039577, "SYSTEM_ACTION_BACK");
        RemoteAction createRemoteAction2 = createRemoteAction(17039579, "SYSTEM_ACTION_HOME");
        RemoteAction createRemoteAction3 = createRemoteAction(17039586, "SYSTEM_ACTION_RECENTS");
        RemoteAction createRemoteAction4 = createRemoteAction(17039581, "SYSTEM_ACTION_NOTIFICATIONS");
        RemoteAction createRemoteAction5 = createRemoteAction(17039585, "SYSTEM_ACTION_QUICK_SETTINGS");
        RemoteAction createRemoteAction6 = createRemoteAction(17039584, "SYSTEM_ACTION_POWER_DIALOG");
        RemoteAction createRemoteAction7 = createRemoteAction(17039580, "SYSTEM_ACTION_LOCK_SCREEN");
        RemoteAction createRemoteAction8 = createRemoteAction(17039587, "SYSTEM_ACTION_TAKE_SCREENSHOT");
        RemoteAction createRemoteAction9 = createRemoteAction(17039578, "SYSTEM_ACTION_ACCESSIBILITY_SHORTCUT");
    ...
    private void handleTakeScreenshot() {
        ...
        bundle.putBoolean("voiceLongshot", false);
        bundle.putBoolean("longshot", false);
        bundle.putString("focusWindow", "");
        screenshotHelper.getScreenshotHelperInjector().takeScreenshot(1, true, true, new Handler(Looper.getMainLooper()), false, bundle);
    }
