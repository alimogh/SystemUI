...
public interface QSTile {
    ...
    public static class State {
        ...
        public CharSequence lottiePrefix = "";
        public int lottieSupport = 0;
        ...
        public boolean copyTo(State state) {
            if (state == null) {
                ...
                state.lottiePrefix = this.lottiePrefix;
                state.lottieSupport = this.lottieSupport;
                return z;
            } else {
                throw new IllegalArgumentException();
            }
        ...
        public StringBuilder toStringBuilder() {
            ...
            sb.append("\"");
            sb.append(",lottiePrefix=");
            sb.append(this.lottiePrefix);
            sb.append(",lottieSupport=");
            sb.append(Integer.toHexString(this.lottieSupport));
            sb.append(']');
            return sb;
        }
