...
public class ThemeOverlayManager {
    ...
    public void applyCurrentUserOverlays(Map<String, String> map, Set<UserHandle> set) {
        ...
        ((Set) hashSet.stream().map(new Function() { // from class: com.android.systemui.theme.-$$Lambda$ThemeOverlayManager$XHd3K8Vp7fhFb4ucZudIi42URZk
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return ThemeOverlayManager.this.lambda$applyCurrentUserOverlays$0$ThemeOverlayManager((String) obj);
            }
        }).collect(Collectors.toSet())).forEach(new Consumer(arrayList) { // from class: com.android.systemui.theme.-$$Lambda$ThemeOverlayManager$Ce247HGCsGLtUA2wdEQCGlPUIx4
        ...
        Map map2 = (Map) arrayList.stream().filter(new Predicate() { // from class: com.android.systemui.theme.-$$Lambda$ThemeOverlayManager$FzQkanwY8TEeM97QNlP4yjS7F4s
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ThemeOverlayManager.this.lambda$applyCurrentUserOverlays$2$ThemeOverlayManager((OverlayInfo) obj);
            }
        }).filter(new Predicate(hashSet) { // from class: com.android.systemui.theme.-$$Lambda$ThemeOverlayManager$rD72NeWKvvYjih6pAWlvN555mFM
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return ThemeOverlayManager.lambda$applyCurrentUserOverlays$3(this.f$0, (OverlayInfo) obj);
            }
    ...
    static /* synthetic */ boolean lambda$applyCurrentUserOverlays$3(Set set, OverlayInfo overlayInfo) {
    ...
    private void setEnabledAsync(String str, UserHandle userHandle, boolean z) {
        this.mExecutor.execute(new Runnable(str, userHandle, z) { // from class: com.android.systemui.theme.-$$Lambda$ThemeOverlayManager$Za-49vHyQK-Yiveq0XqQrGRFGHg
    ...
    public /* synthetic */ void lambda$setEnabledAsync$7$ThemeOverlayManager(String str, UserHandle userHandle, boolean z) {
        if (DEBUG) {
            Log.d("ThemeOverlayManager", String.format("setEnabled: %s %s %b", str, userHandle, Boolean.valueOf(z)));
        }
        try {
            OverlayInfo overlayInfo = this.mOverlayManager.getOverlayInfo(str, userHandle);
            if (z && overlayInfo == null) {
                Log.e("ThemeOverlayManager", "setEnabled failed: null info");
            } else if (z) {
