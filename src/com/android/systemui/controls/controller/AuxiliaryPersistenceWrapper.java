...
public final class AuxiliaryPersistenceWrapper {
    ...
    public static final class DeletionJobService extends JobService {
        ...
        public static final class Companion {
            ...
            public final int getDELETE_FILE_JOB_ID$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            ...
            public final JobInfo getJobForContext(@NotNull Context context) {
                ...
                JobInfo build = new JobInfo.Builder(getDELETE_FILE_JOB_ID$packages__apps__OPSystemUI__android_common__OPSystemUI_core() + context.getUserId(), new ComponentName(context, DeletionJobService.class)).setMinimumLatency(DeletionJobService.WEEK_IN_MILLIS).setPersisted(true).build();
