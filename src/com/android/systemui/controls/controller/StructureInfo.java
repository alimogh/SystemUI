...
public final class StructureInfo {
    ...
    @NotNull
    public final StructureInfo copy(@NotNull ComponentName componentName, @NotNull CharSequence charSequence, @NotNull List<ControlInfo> list) {
    ...
    public StructureInfo(@NotNull ComponentName componentName, @NotNull CharSequence charSequence, @NotNull List<ControlInfo> list) {
        Intrinsics.checkParameterIsNotNull(componentName, "componentName");
        Intrinsics.checkParameterIsNotNull(charSequence, "structure");
        Intrinsics.checkParameterIsNotNull(list, "controls");
