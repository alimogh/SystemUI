...
public final class ControlsEditingActivity extends LifecycleActivity {
    private static final int EMPTY_TEXT_ID = C0015R$string.controls_favorite_removed;
    private static final int SUBTITLE_ID = C0015R$string.controls_favorite_rearrange;
    ...
    public ControlsEditingActivity(@NotNull ControlsControllerImpl controlsControllerImpl, @NotNull BroadcastDispatcher broadcastDispatcher, @NotNull GlobalActionsComponent globalActionsComponent) {
    ...
    private final void bindViews() {
        ...
        viewStub.setLayoutResource(C0011R$layout.controls_management_editing);
        viewStub.inflate();
        View requireViewById2 = requireViewById(C0008R$id.title);
        ...
        if (charSequence != null) {
            ...
            if (charSequence2 != null) {
                ...
                View requireViewById3 = requireViewById(C0008R$id.subtitle);
    ...
    private final void bindButtons() {
        ViewGroup viewGroup = (ViewGroup) requireViewById(C0008R$id.controls_management_root);
        View requireViewById = requireViewById(C0008R$id.done);
        Button button = (Button) requireViewById;
        button.setEnabled(false);
        button.setText(C0015R$string.save);
        button.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.systemui.controls.management.ControlsEditingActivity$bindButtons$$inlined$apply$lambda$1
            final /* synthetic */ ControlsEditingActivity this$0;
        ...
        if (componentName != null) {
            ...
            if (charSequence != null) {
                ...
                if (componentName2 != null) {
                    ...
                    float f = getResources().getFloat(C0005R$dimen.control_card_elevation);
                    RecyclerView recyclerView = (RecyclerView) requireViewById(C0008R$id.list);
                    Intrinsics.checkExpressionValueIsNotNull(recyclerView, "recyclerView");
                    recyclerView.setAlpha(0.0f);
                    ControlAdapter controlAdapter = new ControlAdapter(f);
                    controlAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver(recyclerView) { // from class: com.android.systemui.controls.management.ControlsEditingActivity$setUpList$$inlined$apply$lambda$1
                        final /* synthetic */ RecyclerView $recyclerView$inlined;
                        private boolean hasAnimated;

                        {
                            this.$recyclerView$inlined = r1;
                        }
                        ...
                        public void onChanged() {
                            if (!this.hasAnimated) {
                                ...
                                ControlsAnimations controlsAnimations = ControlsAnimations.INSTANCE;
                                RecyclerView recyclerView2 = this.$recyclerView$inlined;
                                Intrinsics.checkExpressionValueIsNotNull(recyclerView2, "recyclerView");
                                controlsAnimations.enterAnimation(recyclerView2).start();
                            }
                        }
                    });
                    int dimensionPixelSize = getResources().getDimensionPixelSize(C0005R$dimen.controls_card_margin);
                    ...
                    ControlsEditingActivity$setUpList$$inlined$apply$lambda$2 controlsEditingActivity$setUpList$$inlined$apply$lambda$2 = new GridLayoutManager(recyclerView.getContext(), 2, controlAdapter, recyclerView, marginItemDecorator) { // from class: com.android.systemui.controls.management.ControlsEditingActivity$setUpList$$inlined$apply$lambda$2
