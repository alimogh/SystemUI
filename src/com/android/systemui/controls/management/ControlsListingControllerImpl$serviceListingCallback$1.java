...
final class ControlsListingControllerImpl$serviceListingCallback$1 implements ServiceListing.Callback {
    ...
    public final void onServicesReloaded(List<ServiceInfo> list) {
        ...
        this.this$0.backgroundExecutor.execute(new Runnable(this) { // from class: com.android.systemui.controls.management.ControlsListingControllerImpl$serviceListingCallback$1.1
