...
public final class Dependency_MembersInjector {
    ...
    public static void injectMOpZenModeController(Dependency dependency, Lazy<OpZenModeController> lazy) {
        dependency.mOpZenModeController = lazy;
    }

    public static void injectMOpBiometricDialogImpl(Dependency dependency, Lazy<OpBiometricDialogImpl> lazy) {
        dependency.mOpBiometricDialogImpl = lazy;
    }

    public static void injectMOpSceneModeObserver(Dependency dependency, Lazy<OpSceneModeObserver> lazy) {
        dependency.mOpSceneModeObserver = lazy;
    }

    public static void injectMOpChargingAnimationController(Dependency dependency, Lazy<OpChargingAnimationController> lazy) {
        dependency.mOpChargingAnimationController = lazy;
    }

    public static void injectMOpNetworkSpeedController(Dependency dependency, Lazy<NetworkSpeedController> lazy) {
        dependency.mOpNetworkSpeedController = lazy;
    }

    public static void injectMOPWLBHelper(Dependency dependency, Lazy<OPWLBHelper> lazy) {
        dependency.mOPWLBHelper = lazy;
    }

    public static void injectMOpNotificationController(Dependency dependency, Lazy<OpNotificationController> lazy) {
        dependency.mOpNotificationController = lazy;
    }

    public static void injectMOpHighlightHintController(Dependency dependency, Lazy<OpHighlightHintController> lazy) {
        dependency.mOpHighlightHintController = lazy;
    }

    public static void injectMOpThreekeyVolumeGuideController(Dependency dependency, Lazy<OpThreekeyVolumeGuideController> lazy) {
        dependency.mOpThreekeyVolumeGuideController = lazy;
    }

    public static void injectMOpBitmojiManager(Dependency dependency, Lazy<OpBitmojiManager> lazy) {
        dependency.mOpBitmojiManager = lazy;
    }
}
