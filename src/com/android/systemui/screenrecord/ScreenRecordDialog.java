...
public class ScreenRecordDialog extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTitle(C0015R$string.screenrecord_name);
        setContentView(C0011R$layout.screen_record_dialog);
        ((Button) findViewById(C0008R$id.button_cancel)).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.screenrecord.-$$Lambda$ScreenRecordDialog$UwuybAZfzEbq-KArO9WeoPnEStk
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ScreenRecordDialog.this.lambda$onCreate$0$ScreenRecordDialog(view);
            }
        });
        ((Button) findViewById(C0008R$id.button_start)).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.screenrecord.-$$Lambda$ScreenRecordDialog$PtlgQ6bdLH8Q6JnpPzk4xxbDTtg
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.mAudioSwitch = (Switch) findViewById(C0008R$id.screenrecord_audio_switch);
        this.mTapsSwitch = (Switch) findViewById(C0008R$id.screenrecord_taps_switch);
        this.mOptions = (Spinner) findViewById(C0008R$id.screen_recording_options);
        ...
        this.mOptions.setOnItemClickListenerInt(new AdapterView.OnItemClickListener() { // from class: com.android.systemui.screenrecord.-$$Lambda$ScreenRecordDialog$cUVjQAzT3j1yIYL-9zw8455dx4I
