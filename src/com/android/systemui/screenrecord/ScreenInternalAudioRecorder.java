...
public class ScreenInternalAudioRecorder {
    ...
    private void setupSimple() throws IOException {
        ...
        this.mThread = new Thread(new Runnable(minBufferSize) { // from class: com.android.systemui.screenrecord.-$$Lambda$ScreenInternalAudioRecorder$FTFstmjlXd36MWRTIZuGd5VznkI
