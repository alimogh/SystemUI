...
public class MediaProjectionPermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnCancelListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (Utils.isHeadlessRemoteDisplayProvider(packageManager, this.mPackageName)) {
            str = getString(C0015R$string.media_projection_dialog_service_text);
            str2 = getString(C0015R$string.media_projection_dialog_service_title);
        } else {
            ...
            String string = getString(C0015R$string.media_projection_dialog_text, new Object[]{unicodeWrap});
            ...
            str2 = getString(C0015R$string.media_projection_dialog_title, new Object[]{unicodeWrap});
            str = spannableString;
        }
        View inflate = View.inflate(this, C0011R$layout.media_projection_dialog_title, null);
        ((TextView) inflate.findViewById(C0008R$id.dialog_title)).setText(str2);
        AlertDialog create = new AlertDialog.Builder(this).setCustomTitle(inflate).setMessage(str).setPositiveButton(C0015R$string.media_projection_action_text, this).setNegativeButton(17039360, this).setOnCancelListener(this).create();
        this.mDialog = create;
        create.create();
