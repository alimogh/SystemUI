...
public class ResumeMediaBrowser {
    ...
    public void restart() {
        ...
        Bundle bundle = new Bundle();
        bundle.putBoolean("android.service.media.extra.RECENT", true);
        MediaBrowser mediaBrowser = new MediaBrowser(this.mContext, this.mComponentName, new MediaBrowser.ConnectionCallback() { // from class: com.android.systemui.media.ResumeMediaBrowser.3
            @Override // android.media.browse.MediaBrowser.ConnectionCallback
            public void onConnected() {
    ...
    public void testConnection() {
        disconnect();
        AnonymousClass4 r0 = new MediaBrowser.ConnectionCallback() { // from class: com.android.systemui.media.ResumeMediaBrowser.4
            @Override // android.media.browse.MediaBrowser.ConnectionCallback
            public void onConnected() {
                ...
                try {
                    if (TextUtils.isEmpty(ResumeMediaBrowser.this.mMediaBrowser.getRoot())) {
                        ResumeMediaBrowser.this.mCallback.onError();
                    } else {
                        ResumeMediaBrowser.this.mCallback.onConnected();
                    }
                } catch (IllegalStateException e) {
                    Log.e("ResumeMediaBrowser", "onConnected: " + e.getMessage());
                    ResumeMediaBrowser.this.mCallback.onError();
                }
            }
