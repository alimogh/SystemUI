...
public class MediaControlPanel {
    static final int[] ACTION_IDS = {C0008R$id.action0, C0008R$id.action1, C0008R$id.action2, C0008R$id.action3, C0008R$id.action4};
    ...
    private final ViewOutlineProvider mViewOutlineProvider = new ViewOutlineProvider() { // from class: com.android.systemui.media.MediaControlPanel.1
    ...
    private void loadDimens() {
        ...
        this.mAlbumArtSize = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.qs_media_album_size);
    }
    ...
    public void bind(MediaData mediaData) {
        ...
        if (this.mViewHolder != null) {
            ...
            if (clickIntent != null) {
                this.mViewHolder.getPlayer().setOnClickListener(new View.OnClickListener(clickIntent) { // from class: com.android.systemui.media.-$$Lambda$MediaControlPanel$r2fXPXw2z1qXnX31VuekOYH3JxQ
            ...
            setVisibleAndAlpha(collapsedLayout, C0008R$id.album_art, z);
            setVisibleAndAlpha(expandedLayout, C0008R$id.album_art, z);
            ImageView appIcon = this.mViewHolder.getAppIcon();
            if (mediaData.getAppIcon() != null) {
                appIcon.setImageDrawable(mediaData.getAppIcon());
            } else {
                appIcon.setImageDrawable(this.mContext.getDrawable(C0006R$drawable.ic_music_note));
            }
            ...
            this.mViewHolder.getSeamless().setBackgroundResource(ThemeColorUtils.getCurrentTheme() == 0 ? C0006R$drawable.op_qs_widget_bg_light : C0006R$drawable.op_qs_widget_bg_dark);
            setVisibleAndAlpha(collapsedLayout, C0008R$id.media_seamless, true);
            setVisibleAndAlpha(expandedLayout, C0008R$id.media_seamless, true);
            this.mViewHolder.getSeamless().setOnClickListener(new View.OnClickListener(mediaData) { // from class: com.android.systemui.media.-$$Lambda$MediaControlPanel$-TE2FbF426T83JfnZb2pju5PDfs
            ...
            while (i3 < actions.size() && i3 < iArr.length) {
                ...
                if (action2 == null) {
                    ...
                    action.setOnClickListener(new View.OnClickListener(action2) { // from class: com.android.systemui.media.-$$Lambda$MediaControlPanel$_SKXzyUYhhL8GMTnpSLM2qnRFFw
            ...
            this.mBackgroundExecutor.execute(new Runnable(getController()) { // from class: com.android.systemui.media.-$$Lambda$MediaControlPanel$hrbddZ1-8Mr3EF0WaK5GAsQc9Ds
