...
public final class MediaDataCombineLatest {
    ...
    public MediaDataCombineLatest(@NotNull MediaDataManager mediaDataManager, @NotNull MediaDeviceManager mediaDeviceManager) {
        ...
        this.dataSource.addListener(new MediaDataManager.Listener(this) { // from class: com.android.systemui.media.MediaDataCombineLatest.1
        ...
        this.deviceSource.addListener(new MediaDeviceManager.Listener(this) { // from class: com.android.systemui.media.MediaDataCombineLatest.2
            final /* synthetic */ MediaDataCombineLatest this$0;
