...
public final class MediaViewController {
    ...
    public MediaViewController(@NotNull Context context, @NotNull ConfigurationController configurationController, @NotNull MediaHostStatesManager mediaHostStatesManager) {
        ...
        this.collapsedLayout.load(context, C0017R$xml.media_collapsed);
        this.expandedLayout.load(context, C0017R$xml.media_expanded);
        this.mediaHostStatesManager.addController(this);
        this.layoutController.setSizeChangedListener(new Function2<Integer, Integer, Unit>(this) { // from class: com.android.systemui.media.MediaViewController.1
            final /* synthetic */ MediaViewController this$0;
