...
public class AuthPanelController extends ViewOutlineProvider {
    ...
    public void getOutline(View view, Outline outline) {
        ...
        outline.setRoundRect(i3, i, i4, this.mContainerHeight, this.mCornerRadius);
    }
    ...
    public void updateForContentDimensions(int i, int i2, int i3) {
        ...
        if (this.mUseFullScreen) {
            ...
            i4 = (int) this.mContext.getResources().getDimension(C0005R$dimen.biometric_dialog_border_padding);
        }
        if (this.mUseFullScreen) {
            f = 0.0f;
        } else {
            f = this.mContext.getResources().getDimension(C0005R$dimen.oneplus_contorl_radius_r16);
        }
        if (i3 > 0) {
    ...
    AuthPanelController(Context context, View view) {
        ...
        this.mCornerRadius = context.getResources().getDimension(C0005R$dimen.oneplus_contorl_radius_r16);
        this.mMargin = (int) context.getResources().getDimension(C0005R$dimen.biometric_dialog_border_padding);
