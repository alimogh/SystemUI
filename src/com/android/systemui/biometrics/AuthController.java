...
public class AuthController extends SystemUI implements CommandQueue.Callbacks, AuthDialogCallback {
    ...
    AuthController(Context context, CommandQueue commandQueue, Injector injector) {
        ...
        this.mBroadcastReceiver = new BroadcastReceiver() { // from class: com.android.systemui.biometrics.AuthController.1
        ...
        this.mTaskStackChangedRunnable = new Runnable() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthController$9xrKq1STVRQV2C5tA3mmrn4d1Bk
    ...
    public void onBiometricAuthenticated() {
        ...
        if (authDialog != null) {
            ...
            Log.w("BiometricPrompt/AuthController", "onBiometricAuthenticated, mCurrentDialog is null");
        }
    }
    ...
    public void onBiometricHelp(String str) {
        ...
        AuthDialog authDialog = this.mCurrentDialog;
        if (authDialog != null) {
            authDialog.onHelp(str);
        } else {
            Log.w("BiometricPrompt/AuthController", "onBiometricHelp, mCurrentDialog is null");
        }
    }
    ...
    public void onBiometricError(int i, int i2, int i3) {
        ...
        if (this.mCurrentDialog.isAllowDeviceCredentials() && z2) {
            ...
            if (i2 == 100) {
                str = this.mContext.getString(17039762);
            } else {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        Log.d("BiometricPrompt/AuthController", "onConfigurationChanged");
        if (this.mCurrentDialog != null) {
    ...
    public AuthDialog buildDialog(Bundle bundle, boolean z, int i, int i2, String str, boolean z2, long j, int i3) {
        ...
        int i4;
        if (!OpUtils.isCustomFingerprint() || !Utils.isBiometricAllowed(bundle) || i2 != 2) {
            Context context = this.mContext;
            if (ThemeColorUtils.getCurrentTheme() == 1) {
                i4 = C0016R$style.Oneplus_Theme_BiometricDialog_Dark;
            } else {
                i4 = C0016R$style.Oneplus_Theme_BiometricDialog_Light;
            }
            contextThemeWrapper = new ContextThemeWrapper(context, i4);
        } else {
            contextThemeWrapper = new ContextThemeWrapper(this.mContext, C0016R$style.Oneplus_Theme_BiometricDialog_Dark);
        }
        AuthContainerView.Builder builder = new AuthContainerView.Builder(contextThemeWrapper);
