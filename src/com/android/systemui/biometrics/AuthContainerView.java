...
public class AuthContainerView extends LinearLayout implements AuthDialog, WakefulnessLifecycle.Observer {
    ...
    public static class Injector {
        ...
        public ScrollView getBiometricScrollView(FrameLayout frameLayout) {
            return (ScrollView) frameLayout.findViewById(C0008R$id.biometric_scrollview);
        }

        public FrameLayout inflateContainerView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            return (FrameLayout) layoutInflater.inflate(C0011R$layout.auth_container_view, viewGroup, false);
        }
        ...
        public ImageView getBackgroundView(FrameLayout frameLayout) {
            return (ImageView) frameLayout.findViewById(C0008R$id.background);
        }

        public View getPanelView(FrameLayout frameLayout) {
            return frameLayout.findViewById(C0008R$id.panel);
        }
    ...
    public final class BiometricCallback implements AuthBiometricView.Callback {
        ...
        public void onAction(int i) {
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    AuthContainerView.this.mHandler.postDelayed(new Runnable() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthContainerView$BiometricCallback$_PVe7wil4E5Jd70vq9AnXnFCWJk
        ...
        private /* synthetic */ void lambda$onAction$0$AuthContainerView$BiometricCallback() {
    ...
    AuthContainerView(Config config, Injector injector) {
        ...
        this.mTranslationY = getResources().getDimension(C0005R$dimen.biometric_dialog_animation_translation_offset);
        ...
        if (Utils.isBiometricAllowed(this.mConfig.mBiometricPromptBundle)) {
            ...
            if (i == 2) {
                this.mBiometricView = (AuthBiometricFingerprintView) from.inflate(C0011R$layout.auth_biometric_fingerprint_view, (ViewGroup) null, false);
            } else if (i == 8) {
                this.mBiometricView = (AuthBiometricFaceView) from.inflate(C0011R$layout.auth_biometric_face_view, (ViewGroup) null, false);
            } else {
        ...
        setOnKeyListener(new View.OnKeyListener() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthContainerView$DgtzYoQDVOv5iHGCr90WcpJUnck
            @Override // android.view.View.OnKeyListener
            public final boolean onKey(View view, int i2, KeyEvent keyEvent) {
                return AuthContainerView.this.lambda$new$0$AuthContainerView(view, i2, keyEvent);
            }
        });
    ...
    private /* synthetic */ boolean lambda$new$0$AuthContainerView(View view, int i, KeyEvent keyEvent) {
        if (i != 4) {
            return false;
        }
        if (keyEvent.getAction() == 1) {
            ...
            if (authBiometricView != null) {
                authBiometricView.onBackKeyClicked();
            }
            animateAway(1);
        }
        return true;
    ...
    private void addCredentialView(boolean z, boolean z2) {
        ...
        if (credentialType != 1) {
            if (credentialType == 2) {
                this.mCredentialView = (AuthCredentialView) from.inflate(C0011R$layout.auth_credential_pattern_view, (ViewGroup) null, false);
        ...
        this.mCredentialView = (AuthCredentialView) from.inflate(C0011R$layout.auth_credential_password_view, (ViewGroup) null, false);
        this.mBackgroundView.setOnClickListener(null);
        this.mBackgroundView.setImportantForAccessibility(2);
        this.mCredentialView.setContainerView(this);
        this.mCredentialView.setUserId(this.mConfig.mUserId);
    ...
    public void onAttachedToWindowInternal() {
        ...
        int i = ((LinearLayout) this).mContext.getResources().getConfiguration().orientation;
        if (OpUtils.isCustomFingerprint() && (this.mBiometricView instanceof AuthBiometricFingerprintView) && i == 2) {
            Log.d("BiometricPrompt/AuthContainerView", "current orientation is landscape, wait to recreate...");
            setAlpha(0.0f);
        } else if (this.mConfig.mSkipIntro) {
            this.mContainerState = 3;
            AuthBiometricView authBiometricView = this.mBiometricView;
            if (authBiometricView != null) {
                authBiometricView.onBiometricPromptReady();
            }
        } else {
            ...
            setAlpha(0.0f);
            postOnAnimation(new Runnable() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthContainerView$9SlioxBspj7c8LZaxiUDurCbgao
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private /* synthetic */ void lambda$onAttachedToWindowInternal$1$AuthContainerView() {
        this.mPanelView.animate().translationY(0.0f).setDuration(250).setInterpolator(this.mLinearOutSlowIn).withLayer().withEndAction(new Runnable() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthContainerView$1mKgWyZEd46UtqNrM99ex3KJvfw
            @Override // java.lang.Runnable
            public final void run() {
                AuthContainerView.lambda$1mKgWyZEd46UtqNrM99ex3KJvfw(AuthContainerView.this);
            }
        }).start();
    ...
    private void animateAway(boolean z, int i) {
        ...
        if (i2 == 1) {
            ...
            postOnAnimation(new Runnable(new Runnable() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthContainerView$vtbE2-wtRO04iHv7UirSn4_zgk0
                @Override // java.lang.Runnable
                public final void run() {
                    AuthContainerView.this.lambda$animateAway$2$AuthContainerView();
                }
            }) { // from class: com.android.systemui.biometrics.-$$Lambda$AuthContainerView$hmGjJ8kJosRRIFfZpgTQM0R9XiM
    ...
    private /* synthetic */ void lambda$animateAway$2$AuthContainerView() {
        setVisibility(4);
        removeWindowIfAttached(true);
    }
    ...
    private /* synthetic */ void lambda$animateAway$3$AuthContainerView(Runnable runnable) {
    ...
    public WindowManager.LayoutParams getLayoutParams(IBinder iBinder) {
        WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(-1, -1, 2017, 16785664, -3);
        layoutParams.privateFlags |= 16;
        layoutParams.setFitInsetsTypes(layoutParams.getFitInsetsTypes() & (~(WindowInsets.Type.statusBars() | WindowInsets.Type.navigationBars() | WindowInsets.Type.ime())));
        layoutParams.setTitle("BiometricPrompt");
        layoutParams.token = iBinder;
        if (OpUtils.isCustomFingerprint() && (this.mBiometricView instanceof AuthBiometricFingerprintView)) {
