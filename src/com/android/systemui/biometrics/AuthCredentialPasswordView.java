...
public class AuthCredentialPasswordView extends AuthCredentialView implements TextView.OnEditorActionListener {
    ...
    public void onFinishInflate() {
        ...
        ImeAwareEditText findViewById = findViewById(C0008R$id.lockPassword);
        this.mPasswordField = findViewById;
        findViewById.setOnEditorActionListener(this);
        this.mPasswordField.setOnKeyListener(new View.OnKeyListener() { // from class: com.android.systemui.biometrics.-$$Lambda$AuthCredentialPasswordView$uBlA6RM9f63nDB7lqx6FDe1sZjk
    ...
    private void checkPasswordAndUnlock() {
        ...
        try {
            if (!lockscreenCredential.isNone()) {
                this.mPendingLockCheck = LockPatternChecker.verifyCredential(this.mLockPatternUtils, lockscreenCredential, this.mOperationId, this.mEffectiveUserId, new LockPatternChecker.OnVerifyCallback() { // from class: com.android.systemui.biometrics.-$$Lambda$bUxMWJPKQYxZ29Sl7YhLi_sbYZU
