...
public final class ReceiverData {
    ...
    public ReceiverData(@NotNull BroadcastReceiver broadcastReceiver, @NotNull IntentFilter intentFilter, @NotNull Executor executor, @NotNull UserHandle userHandle) {
