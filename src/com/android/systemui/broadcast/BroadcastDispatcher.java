...
public class BroadcastDispatcher extends BroadcastReceiver implements Dumpable {
    ...
    public BroadcastDispatcher(@NotNull Context context, @NotNull Looper looper, @NotNull Executor executor, @NotNull DumpManager dumpManager, @NotNull BroadcastDispatcherLogger broadcastDispatcherLogger) {
    ...
    public void registerReceiverWithHandler(@NotNull BroadcastReceiver broadcastReceiver, @NotNull IntentFilter intentFilter, @NotNull Handler handler, @NotNull UserHandle userHandle) {
