...
public class BadgedImageView extends ImageView {
    ...
    public BadgedImageView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mBubbleBitmapSize = getResources().getDimensionPixelSize(C0005R$dimen.bubble_bitmap_size);
        this.mDrawParams = new DotRenderer.DrawParams();
        this.mDotRenderer = new DotRenderer(this.mBubbleBitmapSize, PathParser.createPathFromPathData(getResources().getString(17039916)), 100);
        setFocusable(true);
        setClickable(true);
    }
    ...
    public void setDotPositionOnLeft(boolean z, boolean z2) {
        if (!z2 || z == getDotOnLeft() || !shouldDrawDot()) {
            ...
            animateDotScale(0.0f, new Runnable(z) { // from class: com.android.systemui.bubbles.-$$Lambda$BadgedImageView$Z7e3tGxE0eQYPk5Be9lp1Zt58bs
    ...
    private void animateDotScale(float f, Runnable runnable) {
        ...
        clearAnimation();
        animate().setDuration(200).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(z) { // from class: com.android.systemui.bubbles.-$$Lambda$BadgedImageView$5JtatqU5fJ_DVxOW3Qg2hefSWas
            public final /* synthetic */ boolean f$1;
        ...
        }).withEndAction(new Runnable(z, runnable) { // from class: com.android.systemui.bubbles.-$$Lambda$BadgedImageView$v47cozs89EavNMNnxmtPzE3ZmYs
            public final /* synthetic */ boolean f$1;
