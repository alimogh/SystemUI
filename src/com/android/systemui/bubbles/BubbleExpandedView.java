...
public class BubbleExpandedView extends LinearLayout {
    ...
    public BubbleExpandedView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mStateCallback = new ActivityView.StateCallback() { // from class: com.android.systemui.bubbles.BubbleExpandedView.1
            public void onActivityViewReady(ActivityView activityView) {
                int i3 = AnonymousClass4.$SwitchMap$com$android$systemui$bubbles$BubbleExpandedView$ActivityViewStatus[BubbleExpandedView.this.mActivityViewStatus.ordinal()];
                if (i3 == 1 || i3 == 2) {
                    ...
                    BubbleExpandedView.this.post(new Runnable(makeCustomAnimation) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleExpandedView$1$g0YjNvBWtSGWit8uywvLlkarcag
                    ...
                    BubbleExpandedView.this.post(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleExpandedView$1$3ncDnIQQCskyrWWDiIMVoTXxvGg
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            public void onTaskRemovalStarted(int i3) {
                if (BubbleExpandedView.this.mBubble != null) {
                    BubbleExpandedView.this.post(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleExpandedView$1$8DxRCXjWXD-jbCBbQO_LWChzL0s
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public void updateDimensions() {
        ...
        this.mMinHeight = resources.getDimensionPixelSize(C0005R$dimen.bubble_expanded_default_height);
        this.mOverflowHeight = resources.getDimensionPixelSize(C0005R$dimen.bubble_overflow_height);
        this.mPointerMargin = resources.getDimensionPixelSize(C0005R$dimen.bubble_pointer_margin);
    }
    ...
    public void onFinishInflate() {
        ...
        Resources resources = getResources();
        this.mPointerView = findViewById(C0008R$id.pointer_view);
        ...
        this.mSettingsIconHeight = getContext().getResources().getDimensionPixelSize(C0005R$dimen.bubble_manage_button_height);
        this.mSettingsIcon = (AlphaOptimizedButton) findViewById(C0008R$id.settings_button);
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0005R$dimen.bubble_expanded_view_padding);
        this.mExpandedViewPadding = dimensionPixelSize;
        setPadding(dimensionPixelSize, dimensionPixelSize, dimensionPixelSize, dimensionPixelSize);
        setOnTouchListener(new View.OnTouchListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleExpandedView$iXgIC2YqSeoFlnxX0VwZo_0Hqrs
    ...
    public void setManageClickListener(View.OnClickListener onClickListener) {
        findViewById(C0008R$id.settings_button).setOnClickListener(onClickListener);
    }
    ...
    public void applyThemeAttrs() {
        ...
        if (i == 16) {
            this.mPointerDrawable.setTint(getResources().getColor(C0004R$color.bubbles_light));
        } else if (i == 32) {
            this.mPointerDrawable.setTint(getResources().getColor(C0004R$color.bubbles_dark));
        }
    ...
    public void update(Bubble bubble) {
        ...
        if (z || (bubble != null && bubble.getKey().equals(this.mBubble.getKey()))) {
            this.mBubble = bubble;
            this.mSettingsIcon.setContentDescription(getResources().getString(C0015R$string.bubbles_settings_button_description, bubble.getAppName()));
    ...
    private int getMaxExpandedHeight() {
        ...
        boolean z = false;
        int stableInsetBottom = getRootWindowInsets() != null ? getRootWindowInsets().getStableInsetBottom() : 0;
        if (getResources().getConfiguration().orientation == 2) {
            z = true;
        }
        if (z) {
            paddingTop = (((this.mDisplaySize.y - this.mExpandedViewContainerLocation[1]) - getPaddingTop()) - getPaddingBottom()) - this.mPointerHeight;
            i = this.mPointerMargin;
        } else {
            paddingTop = ((((this.mDisplaySize.y - this.mExpandedViewContainerLocation[1]) - getPaddingTop()) - getPaddingBottom()) - this.mSettingsIconHeight) - this.mPointerHeight;
            i = this.mPointerMargin;
        }
        return (paddingTop - i) - stableInsetBottom;
    }
    ...
    public void updateView(int[] iArr) {
        ...
        if (usingActivityView() && this.mActivityView.getVisibility() == 0 && this.mActivityView.isAttachedToWindow()) {
            ...
            AlphaOptimizedButton alphaOptimizedButton = this.mSettingsIcon;
            if (z) {
                i = 8;
            }
            alphaOptimizedButton.setVisibility(i);
        }
    }
