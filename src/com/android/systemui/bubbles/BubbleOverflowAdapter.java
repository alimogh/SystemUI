...
public class BubbleOverflowAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(viewGroup.getContext()).inflate(C0011R$layout.bubble_overflow_view, viewGroup, false);
        ...
        ((TextView) linearLayout.findViewById(C0008R$id.bubble_view_name)).setTextColor(ensureTextContrast);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.iconView.setOnClickListener(new View.OnClickListener(bubble) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleOverflowAdapter$MgnimWNCDitXqbPJN2vzJpXXigU
        ...
        if (title == null) {
            title = this.mContext.getResources().getString(C0015R$string.notification_bubble_title);
        }
        viewHolder.iconView.setContentDescription(this.mContext.getResources().getString(C0015R$string.bubble_content_description_single, title, bubble.getAppName()));
        viewHolder.iconView.setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: com.android.systemui.bubbles.BubbleOverflowAdapter.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, BubbleOverflowAdapter.this.mContext.getResources().getString(C0015R$string.bubble_accessibility_action_add_back)));
            }
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LinearLayout linearLayout) {
            super(linearLayout);
            this.iconView = (BadgedImageView) linearLayout.findViewById(C0008R$id.bubble_view);
            this.textView = (TextView) linearLayout.findViewById(C0008R$id.bubble_view_name);
        }
    }
}
