...
public class BubbleFlyoutView extends FrameLayout {
    ...
    public BubbleFlyoutView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(C0011R$layout.bubble_flyout, (ViewGroup) this, true);
        this.mFlyoutTextContainer = (ViewGroup) findViewById(C0008R$id.bubble_flyout_text_container);
        this.mSenderText = (TextView) findViewById(C0008R$id.bubble_flyout_name);
        this.mSenderAvatar = (ImageView) findViewById(C0008R$id.bubble_flyout_avatar);
        this.mMessageText = (TextView) this.mFlyoutTextContainer.findViewById(C0008R$id.bubble_flyout_text);
        Resources resources = getResources();
        this.mFlyoutPadding = resources.getDimensionPixelSize(C0005R$dimen.bubble_flyout_padding_x);
        this.mFlyoutSpaceFromBubble = resources.getDimensionPixelSize(C0005R$dimen.bubble_flyout_space_from_bubble);
        this.mPointerSize = resources.getDimensionPixelSize(C0005R$dimen.bubble_flyout_pointer_size);
        this.mBubbleSize = resources.getDimensionPixelSize(C0005R$dimen.individual_bubble_size);
        int dimensionPixelSize = resources.getDimensionPixelSize(C0005R$dimen.bubble_bitmap_size);
        ...
        this.mFlyoutElevation = resources.getDimensionPixelSize(C0005R$dimen.bubble_flyout_elevation);
    ...
    public void setupFlyoutStartingAsDot(Bubble.FlyoutMessage flyoutMessage, PointF pointF, float f, boolean z, int i, Runnable runnable, Runnable runnable2, float[] fArr, boolean z2) {
        ...
        post(new Runnable(pointF, z2, runnable) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleFlyoutView$MmTh2kLTzOgAqdKgn0YGS6zixjU
