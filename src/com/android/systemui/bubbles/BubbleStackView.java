...
public class BubbleStackView extends FrameLayout implements ViewTreeObserver.OnComputeInternalInsetsListener {
    private static final SurfaceSynchronizer DEFAULT_SURFACE_SYNCHRONIZER = new SurfaceSynchronizer() { // from class: com.android.systemui.bubbles.BubbleStackView.1
        ...
        public void syncSurfaceAndRun(final Runnable runnable) {
            Choreographer.getInstance().postFrameCallback(new Choreographer.FrameCallback(this) { // from class: com.android.systemui.bubbles.BubbleStackView.1.1
    ...
    private final DynamicAnimation.OnAnimationEndListener mAfterFlyoutTransitionSpring = new DynamicAnimation.OnAnimationEndListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$qNTN7f0ovKQkRVyENDOFd8Z5ydA
    ...
    private final Runnable mAnimateTemporarilyInvisibleImmediate = new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$m1Oanm_NNH1J1i2WLfzcc3QC7Uw
    ...
    private View.OnClickListener mBubbleClickListener = new View.OnClickListener() { // from class: com.android.systemui.bubbles.BubbleStackView.6
    ...
    private RelativeTouchListener mBubbleTouchListener = new RelativeTouchListener() { // from class: com.android.systemui.bubbles.BubbleStackView.7
    ...
    private View.OnClickListener mFlyoutClickListener = new View.OnClickListener() { // from class: com.android.systemui.bubbles.BubbleStackView.8
        @Override // android.view.View.OnClickListener
        public void onClick(View view) {
            if (BubbleStackView.this.maybeShowStackUserEducation()) {
    ...
    private final FloatPropertyCompat mFlyoutCollapseProperty = new FloatPropertyCompat("FlyoutCollapseSpring") { // from class: com.android.systemui.bubbles.BubbleStackView.3
    ...
    private RelativeTouchListener mFlyoutTouchListener = new RelativeTouchListener() { // from class: com.android.systemui.bubbles.BubbleStackView.9
        @Override // com.android.systemui.util.RelativeTouchListener
        public boolean onDown(View view, MotionEvent motionEvent) {
            BubbleStackView.this.mFlyout.removeCallbacks(BubbleStackView.this.mHideFlyout);
            return true;
    ...
    private Runnable mHideFlyout = new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$jXS10HgKCVgyvjX1UcSgdO2D_ug
        @Override // java.lang.Runnable
        public final void run() {
    ...
    private final MagnetizedObject.MagnetListener mIndividualBubbleMagnetListener = new MagnetizedObject.MagnetListener() { // from class: com.android.systemui.bubbles.BubbleStackView.4
        ...
        public void onReleasedInTarget(MagnetizedObject.MagneticTarget magneticTarget) {
            if (BubbleStackView.this.mExpandedAnimationController.getDraggedOutBubble() != null) {
                BubbleStackView.this.mExpandedAnimationController.dismissDraggedOutBubble(BubbleStackView.this.mExpandedAnimationController.getDraggedOutBubble(), (float) BubbleStackView.this.mDismissTargetContainer.getHeight(), new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$4$aSvR9-6CLWJ5wWFJfNBEMIcwA5g
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    private final MagnetizedObject.MagnetListener mStackMagnetListener = new MagnetizedObject.MagnetListener() { // from class: com.android.systemui.bubbles.BubbleStackView.5
        @Override // com.android.systemui.util.magnetictarget.MagnetizedObject.MagnetListener
        public void onStuckToTarget(MagnetizedObject.MagneticTarget magneticTarget) {
            BubbleStackView bubbleStackView = BubbleStackView.this;
        ...
        @Override // com.android.systemui.util.magnetictarget.MagnetizedObject.MagnetListener
        public void onReleasedInTarget(MagnetizedObject.MagneticTarget magneticTarget) {
            BubbleStackView.this.mStackAnimationController.animateStackDismissal((float) BubbleStackView.this.mDismissTargetContainer.getHeight(), new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$5$Lr-rLsLBxyFUc80K5g0SFXrW0Yg
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private ViewTreeObserver.OnDrawListener mSystemGestureExcludeUpdater = new ViewTreeObserver.OnDrawListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$c-OiserdP7VIvU56hCAARnBncEE
    ...
    private ViewTreeObserver.OnPreDrawListener mViewUpdater = new ViewTreeObserver.OnPreDrawListener() { // from class: com.android.systemui.bubbles.BubbleStackView.2
    ...
    public BubbleStackView(Context context, BubbleData bubbleData, SurfaceSynchronizer surfaceSynchronizer, FloatingContentCoordinator floatingContentCoordinator, SysUiState sysUiState, Runnable runnable, Consumer<Boolean> consumer, Runnable runnable2) {
        ...
        this.mMaxBubbles = resources.getInteger(C0009R$integer.bubbles_max_rendered);
        this.mBubbleSize = resources.getDimensionPixelSize(C0005R$dimen.individual_bubble_size);
        this.mBubbleElevation = resources.getDimensionPixelSize(C0005R$dimen.bubble_elevation);
        this.mBubblePaddingTop = resources.getDimensionPixelSize(C0005R$dimen.bubble_padding_top);
        this.mBubbleTouchPadding = resources.getDimensionPixelSize(C0005R$dimen.bubble_touch_padding);
        this.mStatusBarHeight = resources.getDimensionPixelSize(17105481);
        this.mImeOffset = resources.getDimensionPixelSize(C0005R$dimen.pip_ime_offset);
        this.mDisplaySize = new Point();
        ((WindowManager) context.getSystemService("window")).getDefaultDisplay().getRealSize(this.mDisplaySize);
        this.mExpandedViewPadding = resources.getDimensionPixelSize(C0005R$dimen.bubble_expanded_view_padding);
        int dimensionPixelSize = resources.getDimensionPixelSize(C0005R$dimen.bubble_elevation);
        ...
        $$Lambda$BubbleStackView$Hjz7hXc94PYdpndVbPsPbyIpyWU r9 = new Runnable(runnable) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$Hjz7hXc94PYdpndVbPsPbyIpyWU
        ...
        this.mStackAnimationController = new StackAnimationController(floatingContentCoordinator, new IntSupplier() { // from class: com.android.systemui.bubbles.-$$Lambda$3l4urKvsZCQadEpiHWxUBGPGyvY
        ...
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0005R$dimen.dismiss_circle_size);
        ...
        frameLayout4.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C0005R$dimen.floating_dismiss_gradient_height), 80));
        this.mDismissTargetContainer.setPadding(0, 0, 0, getResources().getDimensionPixelSize(C0005R$dimen.floating_dismiss_bottom_margin));
        ...
        this.mDismissTargetContainer.setBackgroundResource(C0006R$drawable.floating_dismiss_gradient_transition);
        addView(this.mDismissTargetContainer);
        this.mDismissTargetCircle.setTranslationY((float) getResources().getDimensionPixelSize(C0005R$dimen.floating_dismiss_gradient_height));
        ...
        setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener(consumer) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$WdFVrYRSAwHYzZq062ZrQQcAUk8
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(colorMatrix, colorMatrix2) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$nTtH9EoKZ3I47Rp-Pl0BGULUUeI
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$DgIHzfVnE2ZObZ8qcZwxCeDQAK0
    ...
    public /* synthetic */ WindowInsets lambda$new$4$BubbleStackView(Consumer consumer, View view, WindowInsets windowInsets) {
        ...
        this.mExpandedAnimationController.updateYPosition(new Runnable(windowInsets) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$SGgilPVMr7ds9JBrPWP0ZRoSeUQ
    ...
    private void setUpManageMenu() {
        ...
        ViewGroup viewGroup2 = (ViewGroup) LayoutInflater.from(getContext()).inflate(C0011R$layout.bubble_manage_menu, (ViewGroup) this, false);
        ...
        this.mManageMenu.findViewById(C0008R$id.bubble_manage_menu_dismiss_container).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$r9lwHRxNgYPwFIdyspAWzwNWX0c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BubbleStackView.this.lambda$setUpManageMenu$10$BubbleStackView(view);
            }
        });
        this.mManageMenu.findViewById(C0008R$id.bubble_manage_menu_dont_bubble_container).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$GRQaewUOo0NVAl_1r4p82XhLmc4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BubbleStackView.this.lambda$setUpManageMenu$11$BubbleStackView(view);
            }
        });
        this.mManageMenu.findViewById(C0008R$id.bubble_manage_menu_settings_container).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$OgUqEHRcTH_CSY2Hykwvk0S0vx4
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BubbleStackView.this.lambda$setUpManageMenu$13$BubbleStackView(view);
            }
        });
        this.mManageSettingsIcon = (ImageView) this.mManageMenu.findViewById(C0008R$id.bubble_manage_menu_settings_icon);
        this.mManageSettingsText = (TextView) this.mManageMenu.findViewById(C0008R$id.bubble_manage_menu_settings_name);
    ...
    public /* synthetic */ void lambda$setUpManageMenu$13$BubbleStackView(View view) {
        ...
        if (selectedBubble != null && this.mBubbleData.hasBubbleInStackWithKey(selectedBubble.getKey())) {
            collapseStack(new Runnable(selectedBubble.getSettingsIntent(((FrameLayout) this).mContext), selectedBubble) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$2Rn_iGaMRg7HpIeuK7fa52Zy4nY
    ...
    private void setUpUserEducation() {
        ...
        if (shouldShowBubblesEducation) {
            View inflate = this.mInflater.inflate(C0011R$layout.bubble_stack_user_education, (ViewGroup) this, false);
            ...
            ((TextView) this.mUserEducationView.findViewById(C0008R$id.user_education_title)).setTextColor(ensureTextContrast);
            ((TextView) this.mUserEducationView.findViewById(C0008R$id.user_education_description)).setTextColor(ensureTextContrast);
        ...
        if (shouldShowManageEducation) {
            BubbleManageEducationView bubbleManageEducationView2 = (BubbleManageEducationView) this.mInflater.inflate(C0011R$layout.bubbles_manage_button_education, (ViewGroup) this, false);
    ...
    private void setUpOverflow() {
        ...
        this.mBubbleOverflow.getIconView().setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$gUr7zrwt06iDPovK5kFZqUDsxYs
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void onDisplaySizeChanged() {
        ...
        this.mStatusBarHeight = resources.getDimensionPixelSize(17105481);
        this.mBubblePaddingTop = resources.getDimensionPixelSize(C0005R$dimen.bubble_padding_top);
        this.mBubbleSize = getResources().getDimensionPixelSize(C0005R$dimen.individual_bubble_size);
        ...
        this.mExpandedAnimationController.updateResources(this.mOrientation, this.mDisplaySize);
        this.mStackAnimationController.updateResources(this.mOrientation);
        int dimensionPixelSize = resources.getDimensionPixelSize(C0005R$dimen.dismiss_circle_size);
    ...
    public void updateExpandedViewDirection(int i) {
        List<Bubble> bubbles = this.mBubbleData.getBubbles();
        if (!bubbles.isEmpty()) {
            bubbles.forEach(new Consumer(i) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$C-KKUSLKaEFdqjL8UshFp6r2378
    ...
    public void setupLocalMenu(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_top_left, resources.getString(C0015R$string.bubble_accessibility_action_move_top_left)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_top_right, resources.getString(C0015R$string.bubble_accessibility_action_move_top_right)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_bottom_left, resources.getString(C0015R$string.bubble_accessibility_action_move_bottom_left)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_bottom_right, resources.getString(C0015R$string.bubble_accessibility_action_move_bottom_right)));
    ...
    public boolean performAccessibilityActionInternal(int i, Bundle bundle) {
        ...
        if (i == 1048576) {
            ...
            announceForAccessibility(getResources().getString(C0015R$string.accessibility_bubble_dismissed));
            return true;
        } else if (i == 524288) {
            this.mBubbleData.setExpanded(false);
            return true;
            ...
            return true;
        } else if (i != C0008R$id.action_move_bottom_right) {
            return false;
        } else {
    ...
    public void updateContentDescription() {
        if (!this.mBubbleData.getBubbles().isEmpty()) {
            for (int i = 0; i < this.mBubbleData.getBubbles().size(); i++) {
                ...
                if (title == null) {
                    title = getResources().getString(C0015R$string.notification_bubble_title);
                }
                if (bubble.getIconView() != null) {
                    if (this.mIsExpanded || i > 0) {
                        bubble.getIconView().setContentDescription(getResources().getString(C0015R$string.bubble_content_description_single, title, appName));
                    } else {
                        bubble.getIconView().setContentDescription(getResources().getString(C0015R$string.bubble_content_description_stack, title, appName, Integer.valueOf(this.mBubbleContainer.getChildCount() - 1)));
                    }
                }
            }
        }
    ...
    public void setSelectedBubble(BubbleViewProvider bubbleViewProvider) {
        ...
        if (this.mExpandedBubble != bubbleViewProvider) {
            ...
            try {
                screenshotAnimatingOutBubbleIntoSurface(new Consumer(bubbleViewProvider) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$v9Fpisep_4rDb1vjFiHap285MHs
    ...
    private void showNewlySelectedBubble(BubbleViewProvider bubbleViewProvider) {
        ...
        if (this.mIsExpanded) {
            ...
            this.mSurfaceSynchronizer.syncSurfaceAndRun(new Runnable(bubbleViewProvider2, bubbleViewProvider) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$8QlfeYkGdUNh1TqL6uaiSF62PB0
                public final /* synthetic */ BubbleViewProvider f$1;
    ...
    private boolean maybeShowStackUserEducation() {
        ...
        updateUserEducationForLayoutDirection();
        this.mUserEducationView.post(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$-qEPeIiYThpJeOpmzYMlHotgNlc
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void updateUserEducationForLayoutDirection() {
        View view = this.mUserEducationView;
        if (view != null) {
            LinearLayout linearLayout = (LinearLayout) view.findViewById(C0008R$id.user_education_view);
            TextView textView = (TextView) this.mUserEducationView.findViewById(C0008R$id.user_education_title);
            TextView textView2 = (TextView) this.mUserEducationView.findViewById(C0008R$id.user_education_description);
            if (getResources().getConfiguration().getLayoutDirection() == 0) {
                this.mUserEducationView.setLayoutDirection(0);
                linearLayout.setBackgroundResource(C0006R$drawable.bubble_stack_user_education_bg);
                textView.setGravity(3);
                textView2.setGravity(3);
                return;
            }
            this.mUserEducationView.setLayoutDirection(1);
            linearLayout.setBackgroundResource(C0006R$drawable.bubble_stack_user_education_bg_rtl);
    ...
    public void hideStackUserEducation(boolean z) {
        if (this.mShouldShowUserEducation && this.mUserEducationView.getVisibility() == 0 && !this.mAnimatingEducationAway) {
            ...
            this.mUserEducationView.animate().alpha(0.0f).setDuration(z ? 40 : 200).withEndAction(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$m0XC_pa-gmXZSQ75lsfSAXgWwAg
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void maybeShowManageEducation(boolean z) {
        ...
        if (bubbleManageEducationView != null) {
            if (z && this.mShouldShowManageEducation && bubbleManageEducationView.getVisibility() != 0 && this.mIsExpanded && this.mExpandedBubble.getExpandedView() != null) {
                ...
                this.mManageEducationView.post(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$HbG4ghYlsoeaS4sVsaHntwSx5g4
                    @Override // java.lang.Runnable
                    public final void run() {
                ...
                this.mManageEducationView.animate().alpha(0.0f).setDuration(this.mIsExpansionAnimating ? 40 : 200).withEndAction(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$y4EqEexeus3MZ5glmUeVBmnnXPA
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$maybeShowManageEducation$24$BubbleStackView() {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C0005R$dimen.bubbles_manage_education_top_inset);
        ...
        this.mManageEducationView.findViewById(C0008R$id.manage).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$9Nx-qZetHgM6c4X0j2S1B9RZkd0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BubbleStackView.this.lambda$maybeShowManageEducation$21$BubbleStackView(view);
            }
        });
        this.mManageEducationView.findViewById(C0008R$id.got_it).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$GYZbVitDInH2RKYw7i19AAO6zHM
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BubbleStackView.this.lambda$maybeShowManageEducation$22$BubbleStackView(view);
            }
        });
        this.mManageEducationView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$N-z5_OzRSP1AvTx6QRv1WoAsDRI
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$maybeShowManageEducation$21$BubbleStackView(View view) {
        this.mExpandedBubble.getExpandedView().findViewById(C0008R$id.settings_button).performClick();
    ...
    private void animateExpansion() {
        ...
        updateOverflowVisibility();
        updatePointerPosition();
        this.mExpandedAnimationController.expandFromStack(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$3CiEYd1ciKAdZrEnaQ-sH0oiFPo
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.mDelayedAnimationHandler.postDelayed(new Runnable(bubbleLeft) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$UNuCs4sUpvhXoc1ew2TBDXBo2Fg
    ...
    public /* synthetic */ void lambda$animateExpansion$29$BubbleStackView(float f) {
        ...
        instance.addUpdateListener(new PhysicsAnimator.UpdateListener(f) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$b_UaRBEuWlY-020n8jg6KaRxhDs
            public final /* synthetic */ float f$1;
        ...
        instance.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$pisfEoH-pfRWWDMgdm3_RYzne28
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void animateCollapse() {
        ...
        this.mDelayedAnimationHandler.postDelayed(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$NMpNWXmTuSktREQh1njzbI8GffU
            @Override // java.lang.Runnable
            public final void run() {
        ...
        instance.addUpdateListener(new PhysicsAnimator.UpdateListener(iconView, bubbleLeft) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$H-5vYdJ9CVvPdyUTg_Cbel0Xecw
        ...
        instance.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$h3oedcF547c9oDcRUG7H-xXzZeI
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$animateCollapse$31$BubbleStackView() {
        this.mExpandedAnimationController.collapseBackToStack(this.mStackAnimationController.getStackPositionAlongNearestHorizontalEdge(), new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$RLGYh0bXzbo7gLPSUpwtl0rh8zQ
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void animateSwitchBubbles() {
        ...
        if (this.mIsExpanded) {
            ...
            instance.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$pEtxhN7hJ3YH-4z9e-fDKF3VeMo
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.mExpandedViewContainer.setAnimationMatrix(this.mExpandedViewContainerMatrix);
            this.mDelayedAnimationHandler.postDelayed(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$E5IVko96vDa38BXRKa-W2m_RUJM
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$animateSwitchBubbles$36$BubbleStackView() {
        ...
        instance.spring(AnimatableScaleMatrix.SCALE_X, AnimatableScaleMatrix.getAnimatableValueForScaleFactor(1.0f), this.mScaleInSpringConfig);
        instance.spring(AnimatableScaleMatrix.SCALE_Y, AnimatableScaleMatrix.getAnimatableValueForScaleFactor(1.0f), this.mScaleInSpringConfig);
        instance.addUpdateListener(new PhysicsAnimator.UpdateListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$ddRwJKDnyQ0sMOzts_rJUhoOp9U
            @Override // com.android.systemui.util.animation.PhysicsAnimator.UpdateListener
            public final void onAnimationUpdateForProperty(Object obj, ArrayMap arrayMap) {
                BubbleStackView.this.lambda$animateSwitchBubbles$34$BubbleStackView((AnimatableScaleMatrix) obj, arrayMap);
            }
        });
        instance.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$6gxlC8TSjhqAqfcarGbWjlPEvjk
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void hideDismissTarget() {
        if (this.mShowingDismiss) {
            ...
            physicsAnimator.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$xFYhUm7TnCCBRG3JRHNKpHUKPlE
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void animateInFlyoutForBubble(Bubble bubble) {
        ...
        if (flyoutMessage != null && flyoutMessage.message != null && bubble.showFlyout() && (((view = this.mUserEducationView) == null || view.getVisibility() != 0) && !isExpanded() && !this.mIsExpansionAnimating && !this.mIsGestureInProgress && this.mBubbleToExpandAfterFlyoutCollapse == null && iconView != null)) {
            ...
            clearFlyoutOnHide();
            this.mAfterFlyoutHidden = new Runnable(iconView) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$CYJd20zKzWrHFqeWE_8Gsgx5kPs
            ...
            post(new Runnable(bubble, flyoutMessage) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$KX0Tp-qCGg3cAYGLQEThgtWbFX0
    ...
    public /* synthetic */ void lambda$animateInFlyoutForBubble$41$BubbleStackView(Bubble bubble, Bubble.FlyoutMessage flyoutMessage) {
        if (!isExpanded()) {
            $$Lambda$BubbleStackView$FdgpI1yIWBqhVrPpLrADoKYyrnw r7 = new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$FdgpI1yIWBqhVrPpLrADoKYyrnw
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$animateInFlyoutForBubble$40$BubbleStackView() {
        $$Lambda$BubbleStackView$1wZEYs1bqQVpEdcpI6IEUDdY0OU r0 = new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$1wZEYs1bqQVpEdcpI6IEUDdY0OU
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void showManageMenu(boolean z) {
        ...
        if (z && this.mBubbleData.hasBubbleInStackWithKey(this.mExpandedBubble.getKey())) {
            ...
            this.mManageSettingsText.setText(getResources().getString(C0015R$string.bubbles_app_settings, bubbleInStackWithKey.getAppName()));
        }
        this.mExpandedBubble.getExpandedView().getManageButtonBoundsOnScreen(this.mTempRect);
        ...
        if (z) {
            ...
            instance.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$66q0xFex2JGOS-PpLClbbWQL_UE
                @Override // java.lang.Runnable
                public final void run() {
            ...
            instance2.withEndActions(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$sNHlTJ3HvrRehpCED1n9iqYBH3A
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void updateExpandedBubble() {
        ...
        if (this.mIsExpanded && (bubbleViewProvider = this.mExpandedBubble) != null && bubbleViewProvider.getExpandedView() != null) {
            ...
            expandedView.setManageClickListener(new View.OnClickListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$R5D2WvsrOupUqEboJoXeDAozj24
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            if (!this.mIsExpansionAnimating) {
                this.mSurfaceSynchronizer.syncSurfaceAndRun(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$ULCkxljaWNb1HjCQS8HNQGEim50
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ void lambda$updateExpandedBubble$45$BubbleStackView() {
        post(new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$tSRUcpVJ_facfkGXYDqDR9OJwMQ
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void screenshotAnimatingOutBubbleIntoSurface(Consumer<Boolean> consumer) {
        ...
        post(new Runnable(consumer) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$MCpRhr7435uVYw2HGhQ51yVBRac
            public final /* synthetic */ Consumer f$1;
    ...
    public /* synthetic */ void lambda$screenshotAnimatingOutBubbleIntoSurface$48$BubbleStackView(Consumer consumer) {
        ...
        if (this.mAnimatingOutBubbleBuffer.getGraphicBuffer().isDestroyed()) {
            ...
            this.mSurfaceSynchronizer.syncSurfaceAndRun(new Runnable(consumer) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$0p9zU4O79lP7pId00KTtOu3oOm4
                public final /* synthetic */ Consumer f$1;
    ...
    public /* synthetic */ void lambda$screenshotAnimatingOutBubbleIntoSurface$47$BubbleStackView(Consumer consumer) {
        post(new Runnable(consumer) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleStackView$FdX0ZJ9EYnkK2lpUxRIrtE_sXRw
