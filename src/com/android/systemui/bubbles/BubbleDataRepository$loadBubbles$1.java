...
public final class BubbleDataRepository$loadBubbles$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            for (ShortcutKey shortcutKey : set) {
                ...
                boolean unused = CollectionsKt__MutableCollectionsKt.addAll(arrayList2, shortcuts);
            }
            ...
            while (true) {
                ...
                if (it.hasNext()) {
                    ...
                    BuildersKt.launch$default(this.this$0.uiScope, null, null, new AnonymousClass1(this, null), 3, null);
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        @NotNull
        public final Continuation<Unit> create(@Nullable Object obj5, @NotNull Continuation<?> continuation) {
            Intrinsics.checkParameterIsNotNull(continuation, "completion");
            AnonymousClass1 r0 = new AnonymousClass1(this.this$0, arrayList3, continuation);
            r0.p$ = (CoroutineScope) obj5;
            return r0;
        }
