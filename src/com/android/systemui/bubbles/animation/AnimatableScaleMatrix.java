...
public class AnimatableScaleMatrix extends Matrix {
    public static final FloatPropertyCompat<AnimatableScaleMatrix> SCALE_X = new FloatPropertyCompat<AnimatableScaleMatrix>("matrixScaleX") { // from class: com.android.systemui.bubbles.animation.AnimatableScaleMatrix.1
    ...
    public static final FloatPropertyCompat<AnimatableScaleMatrix> SCALE_Y = new FloatPropertyCompat<AnimatableScaleMatrix>("matrixScaleY") { // from class: com.android.systemui.bubbles.animation.AnimatableScaleMatrix.2
        public float getValue(AnimatableScaleMatrix animatableScaleMatrix) {
