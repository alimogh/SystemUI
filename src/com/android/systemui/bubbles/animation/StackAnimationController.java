...
public class StackAnimationController extends PhysicsAnimationLayout.PhysicsAnimationController {
    ...
    public void flingThenSpringFirstBubbleWithStackFollowing(DynamicAnimation.ViewProperty viewProperty, float f, float f2, SpringForce springForce, Float f3) {
        ...
        if (isActiveController()) {
            ...
            flingAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener(viewProperty, springForce, f3, f4, f5) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$StackAnimationController$bZgezj9fblRl_isenTD4ApewvoU
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z, float f6, float f7) {
                    StackAnimationController.this.lambda$flingThenSpringFirstBubbleWithStackFollowing$0$StackAnimationController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dynamicAnimation, z, f6, f7);
                }
            });
    ...
    public void animateStackDismissal(float f, Runnable runnable) {
        animationsForChildrenFromIndex(0, new PhysicsAnimationLayout.PhysicsAnimationController.ChildAnimationConfigurator(f) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$StackAnimationController$D-5Qpma319hSMbP8sqDKnJq90JU
    ...
    public void springFirstBubbleWithStackFollowing(DynamicAnimation.ViewProperty viewProperty, SpringForce springForce, float f, float f2, Runnable... runnableArr) {
        if (this.mLayout.getChildCount() != 0 && isActiveController()) {
            ...
            springAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener(z, runnableArr) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$StackAnimationController$TVDnndU2JkVcHNzVQ-aINweVCLk
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z2, float f3, float f4) {
                    StackAnimationController.this.lambda$springFirstBubbleWithStackFollowing$2$StackAnimationController(this.f$1, this.f$2, dynamicAnimation, z2, f3, f4);
                }
            });
    ...
    public void onActiveControllerForLayout(PhysicsAnimationLayout physicsAnimationLayout) {
        ...
        this.mStackOffset = (float) resources.getDimensionPixelSize(C0005R$dimen.bubble_stack_offset);
        this.mBubbleSize = resources.getDimensionPixelSize(C0005R$dimen.individual_bubble_size);
        this.mBubbleBitmapSize = resources.getDimensionPixelSize(C0005R$dimen.bubble_bitmap_size);
        this.mBubblePaddingTop = resources.getDimensionPixelSize(C0005R$dimen.bubble_padding_top);
        this.mBubbleOffscreen = resources.getDimensionPixelSize(C0005R$dimen.bubble_stack_offscreen);
        this.mStackStartingVerticalOffset = resources.getDimensionPixelSize(C0005R$dimen.bubble_stack_starting_offset_y);
    ...
    public MagnetizedObject<StackAnimationController> getMagnetizedStack(MagnetizedObject.MagneticTarget magneticTarget) {
        if (this.mMagnetizedStack == null) {
            AnonymousClass2 r0 = new MagnetizedObject<StackAnimationController>(this.mLayout.getContext(), this, new StackPositionProperty(DynamicAnimation.TRANSLATION_X), new StackPositionProperty(DynamicAnimation.TRANSLATION_Y)) { // from class: com.android.systemui.bubbles.animation.StackAnimationController.2
