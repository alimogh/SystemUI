...
public class ExpandedAnimationController extends PhysicsAnimationLayout.PhysicsAnimationController {
    ...
    public void updateResources(int i, Point point) {
        ...
        if (physicsAnimationLayout != null) {
            ...
            this.mBubblePaddingTop = (float) resources.getDimensionPixelSize(C0005R$dimen.bubble_padding_top);
            this.mStatusBarHeight = (float) resources.getDimensionPixelSize(17105481);
            this.mStackOffsetPx = (float) resources.getDimensionPixelSize(C0005R$dimen.bubble_stack_offset);
            this.mBubblePaddingTop = (float) resources.getDimensionPixelSize(C0005R$dimen.bubble_padding_top);
            this.mBubbleSizePx = (float) resources.getDimensionPixelSize(C0005R$dimen.individual_bubble_size);
            this.mBubblesMaxRendered = resources.getInteger(C0009R$integer.bubbles_max_rendered);
    ...
    private void startOrUpdatePathAnimation(boolean z) {
        Runnable runnable;
        if (z) {
            runnable = new Runnable() { // from class: com.android.systemui.bubbles.animation.-$$Lambda$ExpandedAnimationController$gE2Cl95ubR0Pg2NTtDLGoNhSLoM
            ...
            runnable = new Runnable() { // from class: com.android.systemui.bubbles.animation.-$$Lambda$ExpandedAnimationController$WjMaDVcvCcyW4ns9Ixw4Q7pkHT4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        animationsForChildrenFromIndex(0, new PhysicsAnimationLayout.PhysicsAnimationController.ChildAnimationConfigurator(z) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$ExpandedAnimationController$BqKaoXwLUpmgmPFnP5DT1MILnec
    ...
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$0$ExpandedAnimationController() {
        this.mAnimatingExpand = false;
    ...
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$1$ExpandedAnimationController() {
        this.mAnimatingCollapse = false;
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x009e: APUT  (r5v1 java.lang.Runnable[]), (0 ??[int, short, byte, char]), (r7v3 java.lang.Runnable) */
    /* access modifiers changed from: public */
    /* renamed from: lambda$startOrUpdatePathAnimation$3 */
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$3$ExpandedAnimationController(boolean z, int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
        int i2;
    ...
    private /* synthetic */ void lambda$startOrUpdatePathAnimation$2$ExpandedAnimationController() {
    ...
    public void prepareForBubbleDrag(final View view, MagnetizedObject.MagneticTarget magneticTarget, MagnetizedObject.MagnetListener magnetListener) {
        ...
        AnonymousClass1 r0 = new MagnetizedObject<View>(this.mLayout.getContext(), DynamicAnimation.TRANSLATION_X, DynamicAnimation.TRANSLATION_Y, view) { // from class: com.android.systemui.bubbles.animation.ExpandedAnimationController.1
    ...
    public void snapBubbleBack(View view, float f, float f2) {
        ...
        animationForChildAtIndex.start(new Runnable(view) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$ExpandedAnimationController$N9wvaPtVhtSOeiJ2KFEP39-mzf4
    ...
    private /* synthetic */ void lambda$updateYPosition$5$ExpandedAnimationController(int i, PhysicsAnimationLayout.PhysicsPropertyAnimator physicsPropertyAnimator) {
