...
public class PhysicsAnimationLayout extends FrameLayout {
    ...
    public static abstract class PhysicsAnimationController {
        ...
        public PhysicsPropertyAnimator animationForChild(View view) {
            PhysicsPropertyAnimator physicsPropertyAnimator = (PhysicsPropertyAnimator) view.getTag(C0008R$id.physics_animator_tag);
            if (physicsPropertyAnimator == null) {
                ...
                view.setTag(C0008R$id.physics_animator_tag, physicsPropertyAnimator);
            }
        ...
        public MultiAnimationStarter animationsForChildrenFromIndex(int i, ChildAnimationConfigurator childAnimationConfigurator) {
            ...
            return new MultiAnimationStarter(hashSet, arrayList) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsAnimationController$QukG2X_vIQ5QkpRissMu_oS31l0
        ...
        private /* synthetic */ void lambda$animationsForChildrenFromIndex$1$PhysicsAnimationLayout$PhysicsAnimationController(Set set, List list, Runnable[] runnableArr) {
            $$Lambda$PhysicsAnimationLayout$PhysicsAnimationController$Q2IEgFtVQbcjE9VQhU6hzQCTEA r0 = new Runnable(runnableArr) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsAnimationController$Q2IEgFt-VQbcjE9VQhU6hzQCTEA
        ...
        public void setEndActionForMultipleProperties(Runnable runnable, DynamicAnimation.ViewProperty... viewPropertyArr) {
            $$Lambda$PhysicsAnimationLayout$PhysicsAnimationController$k470cCDrnNZB7vKHsf7OzOwkMRY r0 = new Runnable(viewPropertyArr, runnable) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsAnimationController$k470cCDrnNZB7vKHsf7OzOwkMRY
        ...
        private /* synthetic */ void lambda$setEndActionForMultipleProperties$2$PhysicsAnimationLayout$PhysicsAnimationController(DynamicAnimation.ViewProperty[] viewPropertyArr, Runnable runnable) {
    ...
    public void removeView(View view) {
        if (this.mController != null) {
            ...
            this.mController.onChildRemoved(view, indexOfChild, new Runnable(view) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$VGQ81KsCYiJ-C0alb-wfA2McXCU
    ...
    private /* synthetic */ void lambda$removeView$0$PhysicsAnimationLayout(View view) {
    ...
    private ObjectAnimator getTargetAnimatorFromView(View view) {
        return (ObjectAnimator) view.getTag(C0008R$id.target_animator_tag);
    }
    ...
    private void setUpAnimationForChild(DynamicAnimation.ViewProperty viewProperty, View view, int i) {
        ...
        springAnimation.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener(view, viewProperty) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$zwbjiGEsnfRdNGFmqcdzTxp4TUg
            public final /* synthetic */ View f$1;
    ...
    private /* synthetic */ void lambda$setUpAnimationForChild$1$PhysicsAnimationLayout(View view, DynamicAnimation.ViewProperty viewProperty, DynamicAnimation dynamicAnimation, float f, float f2) {
    ...
    private int getTagIdForProperty(DynamicAnimation.ViewProperty viewProperty) {
        if (viewProperty.equals(DynamicAnimation.TRANSLATION_X)) {
            return C0008R$id.translation_x_dynamicanimation_tag;
        }
        if (viewProperty.equals(DynamicAnimation.TRANSLATION_Y)) {
            return C0008R$id.translation_y_dynamicanimation_tag;
        }
        if (viewProperty.equals(DynamicAnimation.SCALE_X)) {
            return C0008R$id.scale_x_dynamicanimation_tag;
        }
        if (viewProperty.equals(DynamicAnimation.SCALE_Y)) {
            return C0008R$id.scale_y_dynamicanimation_tag;
        }
        if (viewProperty.equals(DynamicAnimation.ALPHA)) {
            return C0008R$id.alpha_dynamicanimation_tag;
        }
        return -1;
    }
    ...
    public class PhysicsPropertyAnimator {
        ...
        public PhysicsPropertyAnimator followAnimatedTargetAlongPath(Path path, int i, TimeInterpolator timeInterpolator, final Runnable... runnableArr) {
            ...
            if (runnableArr != null) {
                ofFloat.addListener(new AnimatorListenerAdapter(this) { // from class: com.android.systemui.bubbles.animation.PhysicsAnimationLayout.PhysicsPropertyAnimator.3
        ...
        public void start(Runnable... runnableArr) {
            ...
            if (runnableArr != null && runnableArr.length > 0) {
                this.mAssociatedController.setEndActionForMultipleProperties(new Runnable(runnableArr) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$iuqdgR2C6CC4Qpac87e6S6WedyM
                    public final /* synthetic */ Runnable[] f$0;
            ...
            if (this.mPositionEndActions != null) {
                $$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$3DhSPSmkLIWL6PRkLpBmJ3MVps r3 = new Runnable(PhysicsAnimationLayout.this.getAnimationFromView(DynamicAnimation.TRANSLATION_X, this.mView), PhysicsAnimationLayout.this.getAnimationFromView(DynamicAnimation.TRANSLATION_Y, this.mView)) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$3DhSPSm-kLIWL6PRkLpBmJ3MVps
        ...
        private /* synthetic */ void lambda$start$1$PhysicsAnimationLayout$PhysicsPropertyAnimator(SpringAnimation springAnimation, SpringAnimation springAnimation2) {
        ...
        public void animateValueForChild(DynamicAnimation.ViewProperty viewProperty, View view, float f, float f2, long j, float f3, float f4, final Runnable... runnableArr) {
            ...
            if (view != null && (springAnimation = (SpringAnimation) view.getTag(PhysicsAnimationLayout.this.getTagIdForProperty(viewProperty))) != null) {
                if (runnableArr != null) {
                    springAnimation.addEndListener(new OneTimeEndListener(this) { // from class: com.android.systemui.bubbles.animation.PhysicsAnimationLayout.PhysicsPropertyAnimator.4
                ...
                if (spring != null) {
                    $$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$YrUNYDpshnd98P1tIxCkdc37pTc r1 = new Runnable(f3, f4, f2, springAnimation, f) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$YrUNYDpshnd98P1tIxCkdc37pTc
        ...
        public void startPathAnimation() {
            ...
            final $$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$VvmQYTYF92KoaeTMVxzFjdA4FFA r2 = new Runnable() { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$VvmQYTYF92KoaeTMVxzFjdA4FFA
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.mPathAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(r2) { // from class: com.android.systemui.bubbles.animation.-$$Lambda$PhysicsAnimationLayout$PhysicsPropertyAnimator$1Xv4slF4ncwrmkshsfcHipCSgjk
                public final /* synthetic */ Runnable f$0;
            ...
            this.mView.setTag(C0008R$id.target_animator_tag, this.mPathAnimator);
            this.mPathAnimator.start();
        }

        /* access modifiers changed from: public */
        /* renamed from: lambda$startPathAnimation$3 */
        private /* synthetic */ void lambda$startPathAnimation$3$PhysicsAnimationLayout$PhysicsPropertyAnimator() {
