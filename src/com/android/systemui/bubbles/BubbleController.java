...
public class BubbleController implements ConfigurationController.ConfigurationListener, Dumpable, OpSceneModeObserver.Callback {
    private boolean mAddedToWindowManager = false;
    private IStatusBarService mBarService;
    private BubbleData mBubbleData;
    private final BubbleData.Listener mBubbleDataListener = new BubbleData.Listener() { // from class: com.android.systemui.bubbles.BubbleController.10
    ...
    private final List<NotificationEntry> mCacheEntries = new ArrayList();
    ...
    public BubbleController(Context context, NotificationShadeWindowController notificationShadeWindowController, StatusBarStateController statusBarStateController, ShadeController shadeController, BubbleData bubbleData, BubbleStackView.SurfaceSynchronizer surfaceSynchronizer, ConfigurationController configurationController, NotificationInterruptStateProvider notificationInterruptStateProvider, ZenModeController zenModeController, NotificationLockscreenUserManager notificationLockscreenUserManager, NotificationGroupManager notificationGroupManager, NotificationEntryManager notificationEntryManager, NotifPipeline notifPipeline, FeatureFlags featureFlags, DumpManager dumpManager, FloatingContentCoordinator floatingContentCoordinator, BubbleDataRepository bubbleDataRepository, SysUiState sysUiState, INotificationManager iNotificationManager, IStatusBarService iStatusBarService, WindowManager windowManager, LauncherApps launcherApps) {
        ...
        this.mBubbleData.setPendingIntentCancelledListener(new PendingIntentCanceledListener() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$nWhc82cKJiqwvfEf64TRF3Q5U6g
        ...
        ((OpSceneModeObserver) Dependency.get(OpSceneModeObserver.class)).addCallback(this);
    }
    ...
    public /* synthetic */ void lambda$new$1$BubbleController(Bubble bubble) {
        if (bubble.getBubbleIntent() != null) {
            if (bubble.isIntentActive()) {
                ...
                this.mHandler.post(new Runnable(bubble) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$itibjTNfFjFc1_LsSQYkBCjv-NQ
    ...
    private void ensureStackViewCreated() {
        if (this.mStackView == null) {
            BubbleStackView bubbleStackView = new BubbleStackView(this.mContext, this.mBubbleData, this.mSurfaceSynchronizer, this.mFloatingContentCoordinator, this.mSysUiState, new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$9ZgvorygajtGrm7C34N9mjHiRg4
                @Override // java.lang.Runnable
                public final void run() {
                    BubbleController.this.onAllBubblesAnimatedOut();
                }
            }, new Consumer() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$n5Txkm3_6gK60tp4RYvQGkCgICc
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    BubbleController.this.onImeVisibilityChanged(((Boolean) obj).booleanValue());
                }
            }, new Runnable() { // from class: com.android.systemui.bubbles.-$$Lambda$jFCV6yHjrilnLmu1dvU8ruP2Llk
                @Override // java.lang.Runnable
                public final void run() {
            ...
            this.mStackView.setUnbubbleConversationCallback(new Consumer() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$QJVf62b5wCS3J_DHWUbuCKTKs3M
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    public void setExpandListener(BubbleExpandListener bubbleExpandListener) {
        $$Lambda$BubbleController$0VC4vw4gvzIdDv19h0ZrywF_riU r0 = new BubbleExpandListener(bubbleExpandListener) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$0VC4vw4gvzIdDv19h0ZrywF_riU
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: updateBubble */
    public void lambda$onBrickModeChanged$8(NotificationEntry notificationEntry) {
        if (this.mIsInBrickMode) {
            Log.d("Bubbles", "updateBubble cache");
            this.mCacheEntries.add(notificationEntry);
            return;
        }
    ...
    public void loadOverflowBubblesFromDisk() {
        if (this.mBubbleData.getOverflowBubbles().isEmpty() && !this.mOverflowDataLoaded) {
            ...
            this.mDataRepository.loadBubbles(new Function1() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$DOCWkNShFlaO6cGprPyPx98P4oE
    ...
    public /* synthetic */ Unit lambda$loadOverflowBubblesFromDisk$6$BubbleController(List list) {
        list.forEach(new Consumer() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$_mg4UF9QSoehsZuSwJtOultVl1U
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public /* synthetic */ void lambda$loadOverflowBubblesFromDisk$5$BubbleController(Bubble bubble) {
        if (!this.mBubbleData.hasAnyBubbleWithKey(bubble.getKey())) {
            bubble.inflate(new BubbleViewInfoTask.Callback(bubble) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$2Y1b47AMtxr-ttMHzCCBd8aAXiw
                public final /* synthetic */ Bubble f$1;
                ...
                public final void onBubbleViewsReady(Bubble bubble2) {
                    BubbleController.this.lambda$loadOverflowBubblesFromDisk$4$BubbleController(this.f$1, bubble2);
                }
    ...
    public void inflateAndAdd(Bubble bubble, boolean z, boolean z2) {
        ...
        bubble.setInflateSynchronously(this.mInflateSynchronously);
        bubble.inflate(new BubbleViewInfoTask.Callback(z, z2) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$kBf4keAqVIQRxl9SNI0prTDdem4
            ...
            @Override // com.android.systemui.bubbles.BubbleViewInfoTask.Callback
            public final void onBubbleViewsReady(Bubble bubble2) {
                BubbleController.this.lambda$inflateAndAdd$7$BubbleController(this.f$1, this.f$2, bubble2);
            }
    ...
    private void onEntryAdded(NotificationEntry notificationEntry) {
        if (this.mNotificationInterruptStateProvider.shouldBubbleUp(notificationEntry) && notificationEntry.isBubble() && canLaunchInActivityView(this.mContext, notificationEntry)) {
            lambda$onBrickModeChanged$8(notificationEntry);
        }
    }
    ...
    public class BubblesImeListener extends PinnedStackListenerForwarder.PinnedStackListener {
        ...
        public void onImeVisibilityChanged(boolean z, int i) {
            if (BubbleController.this.mStackView != null) {
                BubbleController.this.mStackView.post(new Runnable(z, i) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$BubblesImeListener$k3Ccv-01hiK8jFFaKEuMmcHqId4
                    public final /* synthetic */ boolean f$1;
    ...
    public void onBrickModeChanged() {
        boolean isInBrickMode = ((OpSceneModeObserver) Dependency.get(OpSceneModeObserver.class)).isInBrickMode();
        if (this.mIsInBrickMode != isInBrickMode) {
            this.mIsInBrickMode = isInBrickMode;
            Log.d("Bubbles", "onBrickModeChanged " + this.mIsInBrickMode);
            if (!this.mIsInBrickMode && this.mCacheEntries.size() != 0) {
                this.mCacheEntries.forEach(new Consumer() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleController$l3FpaLM-dXpIARU0UhlMpBxDEL4
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        BubbleController.this.lambda$onBrickModeChanged$8$BubbleController((NotificationEntry) obj);
                    }
                });
