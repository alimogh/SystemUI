...
public class BubbleData {
    ...
    public BubbleData(Context context) {
        ...
        this.mMaxBubbles = this.mContext.getResources().getInteger(C0009R$integer.bubbles_max_rendered);
        this.mMaxOverflowBubbles = this.mContext.getResources().getInteger(C0009R$integer.bubbles_max_overflow);
    }
    ...
    public void removeBubblesWithInvalidShortcuts(String str, List<ShortcutInfo> list, int i) {
        ...
        $$Lambda$BubbleData$OJROTAbwBF0fCA1oF1e2LMcjfg r4 = new Predicate(str, hashSet) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleData$OJROTAbwBF0fCA-1oF1e2LMcjfg
        ...
        $$Lambda$BubbleData$3x9c7VXMa5ZgtScfM_PLfdJBhCY r3 = new Consumer(i) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleData$3x9c7VXMa5ZgtScfM_PLfdJBhCY
    ...
    private /* synthetic */ void lambda$removeBubblesWithInvalidShortcuts$1$BubbleData(int i, Bubble bubble) {
        dismissBubbleWithKey(bubble.getKey(), i);
    }

    public void removeBubblesWithPackageName(String str, int i) {
        $$Lambda$BubbleData$yNv2b3CKuwvR21gLk1U8HP86Gac r0 = new Predicate(str) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleData$yNv2b3CKuwvR21gLk1U8HP86Gac
            public final /* synthetic */ String f$0;
        ...
        $$Lambda$BubbleData$xKiHMLOJXi3HkPeIm_knLGFnA8A r2 = new Consumer(i) { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleData$xKiHMLOJXi3HkPeIm_knLGFnA8A
            public final /* synthetic */ int f$1;
    ...
    private /* synthetic */ void lambda$removeBubblesWithPackageName$3$BubbleData(int i, Bubble bubble) {
        dismissBubbleWithKey(bubble.getKey(), i);
    }
    ...
    private void trim() {
        if (this.mBubbles.size() > this.mMaxBubbles) {
            this.mBubbles.stream().sorted(Comparator.comparingLong($$Lambda$x9O8XLDgnXklCbpbq_xgakOvcgY.INSTANCE)).filter(new Predicate() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleData$fdQdGUozu7-xCn6j8BuMSn_4JPo
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return BubbleData.this.lambda$trim$4$BubbleData((Bubble) obj);
                }
            }).findFirst().ifPresent(new Consumer() { // from class: com.android.systemui.bubbles.-$$Lambda$BubbleData$8l9nPNZ1SFL5Nh0WWQItDAiTp7Y
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
    ...
    private /* synthetic */ boolean lambda$trim$4$BubbleData(Bubble bubble) {
        return !bubble.equals(this.mSelectedBubble);
    }

    /* access modifiers changed from: public */
    /* renamed from: lambda$trim$5 */
    private /* synthetic */ void lambda$trim$5$BubbleData(Bubble bubble) {
    ...
    private boolean repackAll() {
        ...
        this.mBubbles.stream().sorted(BUBBLES_BY_SORT_KEY_DESCENDING).forEachOrdered(new Consumer(arrayList) { // from class: com.android.systemui.bubbles.-$$Lambda$0tU2wih_2wwdAnw6hE7FT9YuCis
