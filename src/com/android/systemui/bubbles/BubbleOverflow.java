...
public class BubbleOverflow implements BubbleViewProvider {
    ...
    public void setUpOverflow(ViewGroup viewGroup, BubbleStackView bubbleStackView) {
        updateDimensions();
        BubbleExpandedView bubbleExpandedView = (BubbleExpandedView) this.mInflater.inflate(C0011R$layout.bubble_expanded_view, viewGroup, false);
    ...
    public void updateDimensions() {
        this.mBitmapSize = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.bubble_bitmap_size);
        this.mIconBitmapSize = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.bubble_overflow_icon_bitmap_size);
    ...
    public void updateIcon(Context context, ViewGroup viewGroup) {
        ...
        this.mInflater = from;
        BadgedImageView badgedImageView = (BadgedImageView) from.inflate(C0011R$layout.bubble_overflow_button, viewGroup, false);
        this.mOverflowBtn = badgedImageView;
        badgedImageView.setContentDescription(this.mContext.getResources().getString(C0015R$string.bubble_overflow_button_content_description));
        ...
        ColorDrawable colorDrawable = new ColorDrawable(resources.getColor(C0004R$color.bubbles_light));
        if ((resources.getConfiguration().uiMode & 48) == 32) {
            colorDrawable = new ColorDrawable(resources.getColor(C0004R$color.bubbles_dark));
        }
        ...
        this.mPath = PathParser.createPathFromPathData(this.mContext.getResources().getString(17039916));
