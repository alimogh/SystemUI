...
public final class DaggerSystemUIRootComponent implements SystemUIRootComponent {
    ...
    private void initialize(Builder builder) {
        ...
        Provider<AudioManager> provider12 = DoubleCheck.provider(SystemServicesModule_ProvideAudioManagerFactory.create(this.provideContextProvider));
        ...
        Provider<DeviceProvisionedControllerImpl> provider13 = DoubleCheck.provider(DeviceProvisionedControllerImpl_Factory.create(this.provideContextProvider, this.provideMainHandlerProvider, this.providesBroadcastDispatcherProvider));
        this.deviceProvisionedControllerImplProvider = provider13;
        this.navigationModeControllerProvider = DoubleCheck.provider(NavigationModeController_Factory.create(this.provideContextProvider, provider13, this.provideConfigurationControllerProvider, this.provideUiBackgroundExecutorProvider));
        ...
        Provider<NotificationManager> provider14 = DoubleCheck.provider(SystemServicesModule_ProvideNotificationManagerFactory.create(this.provideContextProvider));
        this.provideNotificationManagerProvider = provider14;
        this.provideNotificationListenerProvider = DoubleCheck.provider(StatusBarDependenciesModule_ProvideNotificationListenerFactory.create(this.provideContextProvider, provider14, this.provideMainHandlerProvider));
        ...
        Provider<KeyguardManager> provider20 = DoubleCheck.provider(SystemServicesModule_ProvideKeyguardManagerFactory.create(this.provideContextProvider));
        this.provideKeyguardManagerProvider = provider20;
        Provider<NotificationLockscreenUserManagerImpl> provider21 = DoubleCheck.provider(NotificationLockscreenUserManagerImpl_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider, this.provideDevicePolicyManagerProvider, this.provideUserManagerProvider, this.notificationClickNotifierProvider, provider20, this.statusBarStateControllerImplProvider, this.provideMainHandlerProvider, this.deviceProvisionedControllerImplProvider, this.keyguardStateControllerImplProvider));
        this.notificationLockscreenUserManagerImplProvider = provider21;
        Provider<KeyguardBypassController> provider22 = DoubleCheck.provider(KeyguardBypassController_Factory.create(this.provideContextProvider, this.tunerServiceImplProvider, this.statusBarStateControllerImplProvider, provider21, this.keyguardStateControllerImplProvider, this.dumpManagerProvider));
        this.keyguardBypassControllerProvider = provider22;
        this.provideHeadsUpManagerPhoneProvider = DoubleCheck.provider(SystemUIDefaultModule_ProvideHeadsUpManagerPhoneFactory.create(this.provideContextProvider, this.statusBarStateControllerImplProvider, provider22, this.notificationGroupManagerProvider, this.provideConfigurationControllerProvider));
        ...
        Provider<LogBufferEulogizer> provider26 = DoubleCheck.provider(LogBufferEulogizer_Factory.create(this.provideContextProvider, this.dumpManagerProvider, this.bindSystemClockProvider, provider25));
        ...
        Provider<ConversationNotificationManager> provider30 = DoubleCheck.provider(ConversationNotificationManager_Factory.create(this.provideNotificationEntryManagerProvider, this.notificationGroupManagerProvider, this.provideContextProvider, this.provideMainHandlerProvider));
    ...
    private void initialize2(Builder builder) {
        ...
        Provider<BatteryController> provider = DoubleCheck.provider(SystemUIDefaultModule_ProvideBatteryControllerFactory.create(this.provideContextProvider, this.enhancedEstimatesImplProvider, this.providePowerManagerProvider, this.providesBroadcastDispatcherProvider, this.provideMainHandlerProvider, create));
        ...
        IconBuilder_Factory create2 = IconBuilder_Factory.create(this.provideContextProvider);
        ...
        Provider<ProtoTracer> provider11 = DoubleCheck.provider(ProtoTracer_Factory.create(this.provideContextProvider, this.dumpManagerProvider));
        this.protoTracerProvider = provider11;
        Provider<CommandQueue> provider12 = DoubleCheck.provider(StatusBarDependenciesModule_ProvideCommandQueueFactory.create(this.provideContextProvider, provider11));
        this.provideCommandQueueProvider = provider12;
        Provider<DarkIconDispatcherImpl> provider13 = DoubleCheck.provider(DarkIconDispatcherImpl_Factory.create(this.provideContextProvider, provider12));
        this.darkIconDispatcherImplProvider = provider13;
        this.lightBarControllerProvider = DoubleCheck.provider(LightBarController_Factory.create(this.provideContextProvider, provider13, this.provideBatteryControllerProvider, this.navigationModeControllerProvider));
        ...
        Provider<ChannelEditorDialogController> provider15 = DoubleCheck.provider(ChannelEditorDialogController_Factory.create(this.provideContextProvider, this.provideINotificationManagerProvider, ChannelEditorDialog_Builder_Factory.create()));
        ...
        this.userSwitcherControllerProvider = DoubleCheck.provider(UserSwitcherController_Factory.create(this.provideContextProvider, this.keyguardStateControllerImplProvider, this.provideMainHandlerProvider, provider17, this.providesBroadcastDispatcherProvider, this.provideUiEventLoggerProvider));
        ...
        Provider<NetworkScoreManager> provider18 = DoubleCheck.provider(SystemServicesModule_ProvideNetworkScoreManagerFactory.create(this.provideContextProvider));
        ...
        this.pipBoundsHandlerProvider = DoubleCheck.provider(PipBoundsHandler_Factory.create(this.provideContextProvider, create10, this.displayControllerProvider));
    ...
    private void initialize3(Builder builder) {
        ...
        RecentsModule_ProvideRecentsImplFactory create = RecentsModule_ProvideRecentsImplFactory.create(this.provideContextProvider, delegateFactory);
        this.provideRecentsImplProvider = create;
        Provider<Recents> provider = DoubleCheck.provider(SystemUIDefaultModule_ProvideRecentsFactory.create(this.provideContextProvider, create, this.provideCommandQueueProvider));
        ...
        PipAnimationController_Factory create2 = PipAnimationController_Factory.create(this.provideContextProvider, this.pipSurfaceTransactionHelperProvider);
        this.pipAnimationControllerProvider = create2;
        this.pipTaskOrganizerProvider = DoubleCheck.provider(PipTaskOrganizer_Factory.create(this.provideContextProvider, this.pipBoundsHandlerProvider, this.pipSurfaceTransactionHelperProvider, this.provideDividerProvider, this.displayControllerProvider, create2));
        Provider<PipManager> provider4 = DoubleCheck.provider(PipManager_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider, this.displayControllerProvider, this.floatingContentCoordinatorProvider, DeviceConfigProxy_Factory.create(), this.pipBoundsHandlerProvider, this.pipSnapAlgorithmProvider, this.pipTaskOrganizerProvider, this.provideSysUiStateProvider));
        this.pipManagerProvider = provider4;
        this.pipUIProvider = DoubleCheck.provider(PipUI_Factory.create(this.provideContextProvider, this.provideCommandQueueProvider, provider4));
        ...
        Provider<PackageManagerWrapper> provider5 = DoubleCheck.provider(SystemServicesModule_ProvidePackageManagerWrapperFactory.create());
        this.providePackageManagerWrapperProvider = provider5;
        Provider provider6 = DoubleCheck.provider(AssistHandleReminderExpBehavior_Factory.create(this.provideSystemClockProvider, this.provideBackgroundHandlerProvider, this.deviceConfigHelperProvider, this.statusBarStateControllerImplProvider, this.provideActivityManagerWrapperProvider, this.overviewProxyServiceProvider, this.provideSysUiStateProvider, this.wakefulnessLifecycleProvider, provider5, this.providesBroadcastDispatcherProvider, this.bootCompleteCacheImplProvider));
        this.assistHandleReminderExpBehaviorProvider = provider6;
        Provider provider7 = DoubleCheck.provider(AssistModule_ProvideAssistHandleBehaviorControllerMapFactory.create(this.assistHandleOffBehaviorProvider, this.assistHandleLikeHomeBehaviorProvider, provider6));
        this.provideAssistHandleBehaviorControllerMapProvider = provider7;
        this.assistHandleBehaviorControllerProvider = DoubleCheck.provider(AssistHandleBehaviorController_Factory.create(this.provideContextProvider, this.provideAssistUtilsProvider, this.provideBackgroundHandlerProvider, this.provideAssistHandleViewControllerProvider, this.deviceConfigHelperProvider, provider7, this.navigationModeControllerProvider, this.provideAccessibilityManagerProvider, this.dumpManagerProvider));
        Provider<PhoneStateMonitor> provider8 = DoubleCheck.provider(PhoneStateMonitor_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider, this.optionalOfLazyOfStatusBarProvider, this.bootCompleteCacheImplProvider));
        this.phoneStateMonitorProvider = provider8;
        Provider<AssistLogger> provider9 = DoubleCheck.provider(AssistLogger_Factory.create(this.provideContextProvider, this.provideUiEventLoggerProvider, this.provideAssistUtilsProvider, provider8, this.assistHandleBehaviorControllerProvider));
        this.assistLoggerProvider = provider9;
        Provider<DefaultUiController> provider10 = DoubleCheck.provider(DefaultUiController_Factory.create(this.provideContextProvider, provider9));
        this.defaultUiControllerProvider = provider10;
        this.assistManagerProvider = DoubleCheck.provider(AssistManager_Factory.create(this.deviceProvisionedControllerImplProvider, this.provideContextProvider, this.provideAssistUtilsProvider, this.assistHandleBehaviorControllerProvider, this.provideCommandQueueProvider, this.phoneStateMonitorProvider, this.overviewProxyServiceProvider, this.provideConfigurationControllerProvider, this.provideSysUiStateProvider, provider10, this.assistLoggerProvider));
        ...
        Provider<IBatteryStats> provider11 = DoubleCheck.provider(SystemServicesModule_ProvideIBatteryStatsFactory.create());
        this.provideIBatteryStatsProvider = provider11;
        Provider<KeyguardIndicationController> provider12 = DoubleCheck.provider(KeyguardIndicationController_Factory.create(this.provideContextProvider, this.builderProvider2, this.keyguardStateControllerImplProvider, this.statusBarStateControllerImplProvider, this.keyguardUpdateMonitorProvider, this.dockManagerImplProvider, this.providesBroadcastDispatcherProvider, this.provideDevicePolicyManagerProvider, provider11, this.provideUserManagerProvider));
        this.keyguardIndicationControllerProvider = provider12;
        this.lockscreenLockIconControllerProvider = DoubleCheck.provider(LockscreenLockIconController_Factory.create(this.lockscreenGestureLoggerProvider, this.keyguardUpdateMonitorProvider, this.provideLockPatternUtilsProvider, this.shadeControllerImplProvider, this.accessibilityControllerProvider, provider12, this.statusBarStateControllerImplProvider, this.provideConfigurationControllerProvider, this.notificationWakeUpCoordinatorProvider, this.keyguardBypassControllerProvider, this.dockManagerImplProvider, this.keyguardStateControllerImplProvider, this.provideResourcesProvider, this.provideHeadsUpManagerPhoneProvider));
        ...
        Provider<LogBuffer> provider13 = DoubleCheck.provider(LogModule_ProvideDozeLogBufferFactory.create(this.provideLogcatEchoTrackerProvider, this.dumpManagerProvider));
        this.provideDozeLogBufferProvider = provider13;
        DozeLogger_Factory create4 = DozeLogger_Factory.create(provider13);
        this.dozeLoggerProvider = create4;
        Provider<DozeLog> provider14 = DoubleCheck.provider(DozeLog_Factory.create(this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, create4));
        this.dozeLogProvider = provider14;
        Provider<DozeScrimController> provider15 = DoubleCheck.provider(DozeScrimController_Factory.create(this.dozeParametersProvider, provider14));
        this.dozeScrimControllerProvider = provider15;
        Provider<BiometricUnlockController> provider16 = DoubleCheck.provider(BiometricUnlockController_Factory.create(this.provideContextProvider, provider15, this.newKeyguardViewMediatorProvider, this.scrimControllerProvider, this.provideStatusBarProvider, this.shadeControllerImplProvider, this.notificationShadeWindowControllerProvider, this.keyguardStateControllerImplProvider, ConcurrencyModule_ProvideHandlerFactory.create(), this.keyguardUpdateMonitorProvider, this.provideResourcesProvider, this.keyguardBypassControllerProvider, this.dozeParametersProvider, this.provideMetricsLoggerProvider, this.dumpManagerProvider));
        this.biometricUnlockControllerProvider = provider16;
        this.dozeServiceHostProvider = DoubleCheck.provider(DozeServiceHost_Factory.create(this.dozeLogProvider, this.providePowerManagerProvider, this.wakefulnessLifecycleProvider, this.statusBarStateControllerImplProvider, this.deviceProvisionedControllerImplProvider, this.provideHeadsUpManagerPhoneProvider, this.provideBatteryControllerProvider, this.scrimControllerProvider, provider16, this.newKeyguardViewMediatorProvider, this.assistManagerProvider, this.dozeScrimControllerProvider, this.keyguardUpdateMonitorProvider, this.provideVisualStabilityManagerProvider, this.pulseExpansionHandlerProvider, this.notificationShadeWindowControllerProvider, this.notificationWakeUpCoordinatorProvider, this.lockscreenLockIconControllerProvider));
        ...
        Provider<VolumeDialogControllerImpl> provider17 = DoubleCheck.provider(VolumeDialogControllerImpl_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider, this.optionalOfLazyOfStatusBarProvider, this.ringerModeTrackerImplProvider));
        this.volumeDialogControllerImplProvider = provider17;
        this.volumeDialogComponentProvider = DoubleCheck.provider(VolumeDialogComponent_Factory.create(this.provideContextProvider, this.newKeyguardViewMediatorProvider, provider17));
        ...
        AnonymousClass3 r1 = new Provider<NotificationRowComponent.Builder>() { // from class: com.android.systemui.dagger.DaggerSystemUIRootComponent.3
            @Override // javax.inject.Provider
        ...
        Provider<Choreographer> provider18 = DoubleCheck.provider(DependencyProvider_ProvidesChoreographerFactory.create(builder.dependencyProvider));
        this.providesChoreographerProvider = provider18;
        this.notificationShadeDepthControllerProvider = DoubleCheck.provider(NotificationShadeDepthController_Factory.create(this.statusBarStateControllerImplProvider, this.blurUtilsProvider, this.biometricUnlockControllerProvider, this.keyguardStateControllerImplProvider, provider18, this.provideWallpaperManagerProvider, this.notificationShadeWindowControllerProvider, this.dozeParametersProvider, this.dumpManagerProvider));
        ...
        Provider<MediaResumeListener> provider21 = DoubleCheck.provider(MediaResumeListener_Factory.create(this.provideContextProvider, this.providesBroadcastDispatcherProvider, this.provideBackgroundExecutorProvider, this.tunerServiceImplProvider));
        this.mediaResumeListenerProvider = provider21;
        this.mediaDataManagerProvider = DoubleCheck.provider(MediaDataManager_Factory.create(this.provideContextProvider, this.provideBackgroundExecutorProvider, this.provideMainExecutorProvider, this.mediaControllerFactoryProvider, this.dumpManagerProvider, this.providesBroadcastDispatcherProvider, this.mediaTimeoutListenerProvider, provider21));
        Provider<NotificationMediaManager> provider22 = DoubleCheck.provider(StatusBarDependenciesModule_ProvideNotificationMediaManagerFactory.create(this.provideContextProvider, this.provideStatusBarProvider, this.notificationShadeWindowControllerProvider, this.provideNotificationEntryManagerProvider, this.mediaArtworkProcessorProvider, this.keyguardBypassControllerProvider, this.provideMainDelayableExecutorProvider, DeviceConfigProxy_Factory.create(), this.mediaDataManagerProvider));
        this.provideNotificationMediaManagerProvider = provider22;
        ((DelegateFactory) this.provideNotificationMediaManagerProvider).setDelegatedProvider(provider22);
        Provider<StatusBarKeyguardViewManager> provider23 = DoubleCheck.provider(StatusBarKeyguardViewManager_Factory.create(this.provideContextProvider, this.providesViewMediatorCallbackProvider, this.provideLockPatternUtilsProvider, this.statusBarStateControllerImplProvider, this.provideConfigurationControllerProvider, this.keyguardUpdateMonitorProvider, this.navigationModeControllerProvider, this.dockManagerImplProvider, this.notificationShadeWindowControllerProvider, this.keyguardStateControllerImplProvider, this.provideNotificationMediaManagerProvider));
        this.statusBarKeyguardViewManagerProvider = provider23;
        ((DelegateFactory) this.statusBarKeyguardViewManagerProvider).setDelegatedProvider(provider23);
        Provider<TrustManager> provider24 = DoubleCheck.provider(SystemServicesModule_ProvideTrustManagerFactory.create(this.provideContextProvider));
        this.provideTrustManagerProvider = provider24;
        Provider<KeyguardViewMediator> provider25 = DoubleCheck.provider(KeyguardModule_NewKeyguardViewMediatorFactory.create(this.provideContextProvider, this.falsingManagerProxyProvider, this.provideLockPatternUtilsProvider, this.providesBroadcastDispatcherProvider, this.statusBarKeyguardViewManagerProvider, this.dismissCallbackRegistryProvider, this.keyguardUpdateMonitorProvider, this.dumpManagerProvider, this.providePowerManagerProvider, provider24, this.provideUiBackgroundExecutorProvider, DeviceConfigProxy_Factory.create(), this.navigationModeControllerProvider));
        this.newKeyguardViewMediatorProvider = provider25;
        ((DelegateFactory) this.newKeyguardViewMediatorProvider).setDelegatedProvider(provider25);
        Provider<NotificationShadeWindowController> provider26 = DoubleCheck.provider(NotificationShadeWindowController_Factory.create(this.provideContextProvider, this.provideWindowManagerProvider, this.provideIActivityManagerProvider, this.dozeParametersProvider, this.statusBarStateControllerImplProvider, this.provideConfigurationControllerProvider, this.newKeyguardViewMediatorProvider, this.keyguardBypassControllerProvider, this.sysuiColorExtractorProvider, this.dumpManagerProvider));
        this.notificationShadeWindowControllerProvider = provider26;
        ((DelegateFactory) this.notificationShadeWindowControllerProvider).setDelegatedProvider(provider26);
        ...
        Provider<BubblePersistentRepository> provider27 = DoubleCheck.provider(BubblePersistentRepository_Factory.create(this.provideContextProvider));
        this.bubblePersistentRepositoryProvider = provider27;
        Provider<BubbleDataRepository> provider28 = DoubleCheck.provider(BubbleDataRepository_Factory.create(this.bubbleVolatileRepositoryProvider, provider27, this.provideLauncherAppsProvider));
        this.bubbleDataRepositoryProvider = provider28;
        DelegateFactory delegateFactory4 = (DelegateFactory) this.newBubbleControllerProvider;
        Provider<BubbleController> provider29 = DoubleCheck.provider(BubbleModule_NewBubbleControllerFactory.create(this.provideContextProvider, this.notificationShadeWindowControllerProvider, this.statusBarStateControllerImplProvider, this.shadeControllerImplProvider, this.bubbleDataProvider, this.provideConfigurationControllerProvider, this.notificationInterruptStateProviderImplProvider, this.zenModeControllerImplProvider, this.notificationLockscreenUserManagerImplProvider, this.notificationGroupManagerProvider, this.provideNotificationEntryManagerProvider, this.notifPipelineProvider, this.featureFlagsProvider, this.dumpManagerProvider, this.floatingContentCoordinatorProvider, provider28, this.provideSysUiStateProvider, this.provideINotificationManagerProvider, this.provideIStatusBarServiceProvider, this.provideWindowManagerProvider, this.provideLauncherAppsProvider));
        this.newBubbleControllerProvider = provider29;
        delegateFactory4.setDelegatedProvider(provider29);
    ...
    private void initialize4(Builder builder) {
        ...
        this.controlsListingControllerImplProvider = DoubleCheck.provider(ControlsListingControllerImpl_Factory.create(this.provideContextProvider, provider));
        ...
        Provider<PackageManager> provider2 = DoubleCheck.provider(SystemServicesModule_ProvidePackageManagerFactory.create(this.provideContextProvider));
        ...
        Provider<GlobalActionsComponent> provider4 = DoubleCheck.provider(GlobalActionsComponent_Factory.create(this.provideContextProvider, this.provideCommandQueueProvider, this.extensionControllerImplProvider, create2, this.statusBarKeyguardViewManagerProvider));
        ...
        Provider<ControlActionCoordinatorImpl> provider5 = DoubleCheck.provider(ControlActionCoordinatorImpl_Factory.create(this.provideContextProvider, this.provideDelayableExecutorProvider, this.provideMainDelayableExecutorProvider, this.activityStarterDelegateProvider, this.keyguardStateControllerImplProvider, this.globalActionsComponentProvider));
        this.controlActionCoordinatorImplProvider = provider5;
        Provider<ControlsUiControllerImpl> provider6 = DoubleCheck.provider(ControlsUiControllerImpl_Factory.create(this.controlsControllerImplProvider, this.provideContextProvider, this.provideMainDelayableExecutorProvider, this.provideBackgroundDelayableExecutorProvider, this.controlsListingControllerImplProvider, this.provideSharePreferencesProvider, provider5, this.activityStarterDelegateProvider, this.shadeControllerImplProvider));
        ...
        Provider<GlobalScreenshot> provider9 = DoubleCheck.provider(GlobalScreenshot_Factory.create(this.provideContextProvider, this.provideResourcesProvider, create5, this.provideUiEventLoggerProvider));
        ...
        this.opBiometricDialogImplProvider = DoubleCheck.provider(OpBiometricDialogImpl_Factory.create(this.provideContextProvider, this.provideCommandQueueProvider));
        this.opBitmojiManagerProvider = DoubleCheck.provider(OpBitmojiManager_Factory.create(this.provideContextProvider));
        ...
        this.foregroundServiceNotificationListenerProvider = DoubleCheck.provider(ForegroundServiceNotificationListener_Factory.create(this.provideContextProvider, this.foregroundServiceControllerProvider, this.provideNotificationEntryManagerProvider, this.notifPipelineProvider, create6, this.bindSystemClockProvider));
        ...
        this.oPWLBHelperProvider = DoubleCheck.provider(OPWLBHelper_Factory.create(this.provideContextProvider));
        ...
        this.opThreekeyVolumeGuideControllerImplProvider = DoubleCheck.provider(OpThreekeyVolumeGuideControllerImpl_Factory.create(this.provideContextProvider));
        DelegateFactory delegateFactory2 = new DelegateFactory();
    ...
    private void initialize5(Builder builder) {
        ...
        AutoAddTracker_Builder_Factory create2 = AutoAddTracker_Builder_Factory.create(this.provideContextProvider);
        ...
        Provider<QSTileHost> provider2 = DoubleCheck.provider(QSTileHost_Factory.create(this.provideContextProvider, this.statusBarIconControllerImplProvider, this.qSFactoryImplProvider, this.provideMainHandlerProvider, this.provideBgLooperProvider, this.providePluginManagerProvider, this.tunerServiceImplProvider, this.autoTileManagerProvider, this.dumpManagerProvider, this.providesBroadcastDispatcherProvider, this.optionalOfStatusBarProvider, create3, this.provideUiEventLoggerProvider));
        ...
        this.mediaControlPanelProvider = MediaControlPanel_Factory.create(this.provideContextProvider, this.provideBackgroundExecutorProvider, this.activityStarterDelegateProvider, this.mediaViewControllerProvider, create4);
        ...
        SystemServicesModule_ProvideMediaRouter2ManagerFactory create5 = SystemServicesModule_ProvideMediaRouter2ManagerFactory.create(this.provideContextProvider);
        this.provideMediaRouter2ManagerProvider = create5;
        Provider<MediaDeviceManager> provider5 = DoubleCheck.provider(MediaDeviceManager_Factory.create(this.provideContextProvider, this.localMediaManagerFactoryProvider, create5, this.provideMainExecutorProvider, this.mediaDataManagerProvider, this.dumpManagerProvider));
        ...
        Provider<MediaCarouselController> provider8 = DoubleCheck.provider(MediaCarouselController_Factory.create(this.provideContextProvider, this.mediaControlPanelProvider, this.provideVisualStabilityManagerProvider, this.mediaHostStatesManagerProvider, this.activityStarterDelegateProvider, this.provideMainDelayableExecutorProvider, provider7, this.provideConfigurationControllerProvider, this.falsingManagerProxyProvider));
        this.mediaCarouselControllerProvider = provider8;
        this.mediaHierarchyManagerProvider = DoubleCheck.provider(MediaHierarchyManager_Factory.create(this.provideContextProvider, this.statusBarStateControllerImplProvider, this.keyguardStateControllerImplProvider, this.keyguardBypassControllerProvider, provider8, this.notificationLockscreenUserManagerImplProvider, this.wakefulnessLifecycleProvider));
    ...
    private final class DependencyInjectorImpl implements Dependency.DependencyInjector {
        ...
        private Dependency injectDependency(Dependency dependency) {
            ...
            Dependency_MembersInjector.injectMOpZenModeController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opZenModeControllerImplProvider));
            Dependency_MembersInjector.injectMOpBiometricDialogImpl(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opBiometricDialogImplProvider));
            Dependency_MembersInjector.injectMOpSceneModeObserver(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opSceneModeObserverProvider));
            Dependency_MembersInjector.injectMOpChargingAnimationController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opChargingAnimationControllerImplProvider));
            Dependency_MembersInjector.injectMOpNetworkSpeedController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.networkSpeedControllerImplProvider));
            Dependency_MembersInjector.injectMOPWLBHelper(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.oPWLBHelperProvider));
            Dependency_MembersInjector.injectMOpNotificationController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opNotificationControllerProvider));
            Dependency_MembersInjector.injectMOpHighlightHintController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opHighlightHintControllerImplProvider));
            Dependency_MembersInjector.injectMOpThreekeyVolumeGuideController(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opThreekeyVolumeGuideControllerImplProvider));
            Dependency_MembersInjector.injectMOpBitmojiManager(dependency, DoubleCheck.lazy(DaggerSystemUIRootComponent.this.opBitmojiManagerProvider));
            return dependency;
        }
    }
