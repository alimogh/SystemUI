...
public final class LogMessageImpl implements LogMessage {
    ...
    public int hashCode() {
        ...
        String tag = getTag();
        int hashCode2 = (((hashCode + (tag != null ? tag.hashCode() : 0)) * 31) + Long.hashCode(getTimestamp())) * 31;
        Function1<LogMessage, String> printer = getPrinter();
        int hashCode3 = (hashCode2 + (printer != null ? printer.hashCode() : 0)) * 31;
        String str1 = getStr1();
        int hashCode4 = (hashCode3 + (str1 != null ? str1.hashCode() : 0)) * 31;
        String str2 = getStr2();
    ...
    public LogMessageImpl(@NotNull LogLevel logLevel, @NotNull String str, long j, @NotNull Function1<? super LogMessage, String> function1, @Nullable String str2, @Nullable String str3, @Nullable String str4, int i, int i2, long j2, long j3, double d, boolean z, boolean z2, boolean z3, boolean z4) {
