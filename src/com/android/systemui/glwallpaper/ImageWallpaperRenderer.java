...
public class ImageWallpaperRenderer implements GLWallpaperRenderer {
    ...
    public void onSurfaceCreated() {
        ...
        this.mProgram.useGLProgram(C0014R$raw.image_wallpaper_vertex_shader, C0014R$raw.image_wallpaper_fragment_shader);
        this.mTexture.use(new Consumer() { // from class: com.android.systemui.glwallpaper.-$$Lambda$ImageWallpaperRenderer$tbObMkzj33QDR6llFkRAHA0TWow
