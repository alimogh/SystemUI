...
import com.oneplus.systemui.statusbar.OpNotificationShelf;
import com.oneplus.util.OpUtils;
public class NotificationShelf extends OpNotificationShelf implements View.OnLayoutChangeListener, StatusBarStateController.StateListener {
    ...
    private static final int TAG_CONTINUOUS_CLIPPING = C0008R$id.continuous_clipping_tag;
    ...
    public void onFinishInflate() {
        ...
        NotificationIconContainer notificationIconContainer = (NotificationIconContainer) findViewById(C0008R$id.content);
    ...
    private void initDimens() {
        ...
        resources.getDimensionPixelOffset(C0005R$dimen.status_bar_padding_start);
        ...
        if (OpUtils.isSupportResolutionSwitch(getContext())) {
            OpUtils.getDimensionPixelSize(getResources(), C0005R$dimen.status_bar_padding_start, 1080);
        }
        ...
        this.mHiddenShelfIconSize = (float) resources.getDimensionPixelOffset(C0005R$dimen.hidden_shelf_icon_size);
    ...
    /* access modifiers changed from: protected */
    @Override // com.oneplus.systemui.statusbar.OpNotificationShelf, com.android.systemui.statusbar.notification.row.ActivatableNotificationView
    ...
    /* JADX WARNING: Removed duplicated region for block: B:76:0x0171 A[ADDED_TO_REGION] */
    ...
    private void updateContinuousClipping(final ExpandableNotificationRow expandableNotificationRow) {
        ...
        if (z2 && !z) {
            ...
            shelfIcon.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener(this) { // from class: com.android.systemui.statusbar.NotificationShelf.2
    ...
    private void updateIconPositioning(ExpandableView expandableView, float f, float f2, float f3, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (iconState != null) {
            ...
            if (f == f5) {
                ...
                iconState.translateContent = (((float) (this.mMaxLayoutHeight - this.mPaddingBottom)) - getTranslationY()) - ((float) getIntrinsicHeight()) > 0.0f;
            }
        ...
        if (expandableView instanceof ExpandableNotificationRow) {
            ...
            if (iconState != null) {
                ...
                if (z4 || contrastedStaticDrawableColor == 0) {
                    i4 = contrastedStaticDrawableColor;
                } else {
                    int originalIconColor = expandableNotificationRow.getOriginalIconColor();
                    i4 = (OpUtils.isGlobalROM(getContext()) || originalIconColor != 0) ? NotificationUtils.interpolateColors(originalIconColor, contrastedStaticDrawableColor, iconState.iconAppearAmount) : i3;
                }
                iconState.iconColor = i4;
            }
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (this.mInteractive) {
            ...
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, getContext().getString(C0015R$string.accessibility_overflow_action)));
        }
    }
