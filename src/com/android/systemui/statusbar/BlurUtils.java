...
public class BlurUtils implements Dumpable {
    ...
    private final int maxBlurRadius = this.resources.getDimensionPixelSize(C0005R$dimen.max_window_blur_radius);
    ...
    public BlurUtils(@NotNull Resources resources, @NotNull DumpManager dumpManager) {
        ...
        this.minBlurRadius = resources.getDimensionPixelSize(C0005R$dimen.min_window_blur_radius);
    ...
    public final void applyBlur(@org.jetbrains.annotations.Nullable android.view.ViewRootImpl r3, int r4) {
        ...
        L_0x0019:
            ...
            r0 = 0
            android.view.SurfaceControl r3 = r3.getSurfaceControl()     // Catch:{ all -> 0x002e }
            r2.setBackgroundBlurRadius(r3, r4)     // Catch:{ all -> 0x002e }
            r2.apply()     // Catch:{ all -> 0x002e }
