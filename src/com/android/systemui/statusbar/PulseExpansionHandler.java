...
public final class PulseExpansionHandler implements Gefingerpoken {
    ...
    public PulseExpansionHandler(@NotNull Context context, @NotNull NotificationWakeUpCoordinator notificationWakeUpCoordinator, @NotNull KeyguardBypassController keyguardBypassController, @NotNull HeadsUpManagerPhone headsUpManagerPhone, @NotNull NotificationRoundnessManager notificationRoundnessManager, @NotNull StatusBarStateController statusBarStateController, @NotNull FalsingManager falsingManager) {
        ...
        context.getResources().getDimensionPixelSize(C0005R$dimen.keyguard_drag_down_min_distance);
    ...
    private final boolean canHandleMotionEvent() {
        if (this.mPulsing && this.wakeUpCoordinator.getCanShowPulsingHuns() && !this.qsExpanded && !this.bouncerShowing) {
            return true;
        }
        return false;
    }
                ...
                if (velocityTracker2 != null) {
                    ...
                    if (y > ((float) 0)) {
                        ...
                        if (velocityTracker3 == null) {
                            Intrinsics.throwNpe();
                            throw null;
                        } else if (velocityTracker3.getYVelocity() > ((float) -1000) && this.statusBarStateController.getState() != 0) {
                            z = true;
                        }
                    }
    ...
    private final void resetClock() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: com.android.systemui.statusbar.PulseExpansionHandler$resetClock$1
            final /* synthetic */ PulseExpansionHandler this$0;
    ...
    public final void setUp(@NotNull NotificationStackScrollLayout notificationStackScrollLayout, @NotNull ExpansionCallback expansionCallback, @NotNull ShadeController shadeController) {
