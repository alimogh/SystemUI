...
public class StatusBarIconView extends AnimatedImageView implements StatusIconDisplayable {
    ...
    private void reloadDimens() {
        ...
        this.mStatusBarIconDrawingSizeIncreased = resources.getDimensionPixelSize(C0005R$dimen.status_bar_icon_drawing_size_dark);
        ...
        this.mSystemIconDesiredHeight = resources.getDimension(17105486);
        float dimension = resources.getDimension(17105485);
    ...
    public boolean set(StatusBarIcon statusBarIcon) {
        ...
        if (!z) {
            ...
            setTag(C0008R$id.icon_is_grayscale, null);
            maybeUpdateIconScaleDimens();
        }
        if (!z2) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDotAppearAmount != 0.0f) {
            float alpha = ((float) Color.alpha(this.mCurrentSetColor)) / 255.0f;
    ...
    private void initializeDecorColor() {
        if (this.mNotification != null) {
            setDecorColor(getContext().getColor(this.mNightMode ? 17170886 : 17170887));
        }
    }
    ...
    private void updateIconColor() {
        if (this.mShowsConversation) {
            ...
            int interpolateColors = NotificationUtils.interpolateColors(this.mCurrentSetColor, -1, this.mDozeAmount);
            ...
            updateTintMatrix(this.mMatrix, interpolateColors, this.mDozeAmount * 0.67f);
    ...
    private void applyIconAndColors() {
        ...
        if (rect != null) {
            ...
            if (slot != null && slot.equals("bluetooth")) {
                ...
                if (resId == C0006R$drawable.stat_sys_bt_battery_1 || resId == C0006R$drawable.stat_sys_bt_battery_1_dark) {
                    if (z) {
                        setImageResource(C0006R$drawable.stat_sys_bt_battery_1_dark);
                    } else {
                        setImageResource(C0006R$drawable.stat_sys_bt_battery_1);
                    }
                    setImageTintList(null);
                    return;
                } else if (resId == C0006R$drawable.stat_sys_bt_battery_2 || resId == C0006R$drawable.stat_sys_bt_battery_2_dark) {
                    if (z) {
                        setImageResource(C0006R$drawable.stat_sys_bt_battery_2_dark);
                    } else {
                        setImageResource(C0006R$drawable.stat_sys_bt_battery_2);
                    }
                    setImageTintList(null);
                    return;
                }
