...
public final class NotifViewManager {
    ...
    public NotifViewManager(@NotNull NotifViewBarn notifViewBarn, @NotNull VisualStabilityManager visualStabilityManager, @NotNull FeatureFlags featureFlags) {
    ...
    public final void attach(@NotNull ShadeListBuilder shadeListBuilder) {
        ...
        if (this.featureFlags.isNewNotifPipelineRenderingEnabled()) {
            shadeListBuilder.setOnRenderListListener(new ShadeListBuilder.OnRenderListListener(this) { // from class: com.android.systemui.statusbar.notification.collection.NotifViewManager$attach$1
    ...
    /* JADX WARNING: Removed duplicated region for block: B:58:0x0081 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:62:0x0053 A[SYNTHETIC] */
    ...
    private final Sequence<NotificationListItem> getListItems(SimpleNotificationListContainer simpleNotificationListContainer) {
        ...
        }), NotifViewManager$getListItems$$inlined$filterIsInstance$1.INSTANCE);
        if (sequence != null) {
            return sequence;
        }
            ...
            if (it.hasNext()) {
                ...
                if (representativeEntry != null) {
                    ...
                    if (listEntry instanceof GroupEntry) {
                        ...
                        z = z || requireView.applyChildOrder(getChildListFromParent(listEntry), this.stabilityManager, null);
