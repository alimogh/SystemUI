...
public class KeyguardCoordinator implements Coordinator {
    ...
    private void setupInvalidateNotifListCallbacks() {
        ...
        AnonymousClass2 r0 = new ContentObserver(this.mMainHandler) { // from class: com.android.systemui.statusbar.notification.collection.coordinator.KeyguardCoordinator.2
