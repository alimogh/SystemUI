...
public class PreparationCoordinator implements Coordinator {
    ...
    PreparationCoordinator(PreparationCoordinatorLogger preparationCoordinatorLogger, NotifInflaterImpl notifInflaterImpl, NotifInflationErrorManager notifInflationErrorManager, NotifViewBarn notifViewBarn, IStatusBarService iStatusBarService, int i) {
        ...
        AnonymousClass4 r0 = new NotifInflationErrorManager.NotifInflationErrorListener() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.PreparationCoordinator.4
    ...
    private void inflateEntry(NotificationEntry notificationEntry, String str) {
        ...
        this.mNotifInflater.inflateViews(notificationEntry, new NotifInflater.InflationCallback() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.-$$Lambda$PreparationCoordinator$tbJy9n4VTgoZq_0jM3QiWTlwU2k
            @Override // com.android.systemui.statusbar.notification.collection.inflation.NotifInflater.InflationCallback
            public final void onInflationFinished(NotificationEntry notificationEntry2) {
                PreparationCoordinator.this.onInflationFinished(notificationEntry2);
            }
        });
    }
    ...
    private void rebind(NotificationEntry notificationEntry, String str) {
        this.mInflatingNotifs.add(notificationEntry);
        this.mNotifInflater.rebindViews(notificationEntry, new NotifInflater.InflationCallback() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.-$$Lambda$PreparationCoordinator$tbJy9n4VTgoZq_0jM3QiWTlwU2k
            @Override // com.android.systemui.statusbar.notification.collection.inflation.NotifInflater.InflationCallback
            public final void onInflationFinished(NotificationEntry notificationEntry2) {
                PreparationCoordinator.this.onInflationFinished(notificationEntry2);
            }
