...
public class NotificationRowBinderImpl implements NotificationRowBinder {
    ...
    public void inflateViews(NotificationEntry notificationEntry, Runnable runnable, NotificationRowContentBinder.InflationCallback inflationCallback) throws InflationException {
        ...
        if (notificationEntry.rowExists()) {
            ...
            notificationEntry.getRowController().setLongPressListenerIfNeeded();
            return;
        }
        this.mIconManager.createIcons(notificationEntry);
        this.mRowInflaterTaskProvider.get().inflate(this.mContext, viewParentForNotification, notificationEntry, new RowInflaterTask.RowInflationFinishedListener(notificationEntry, runnable, inflationCallback) { // from class: com.android.systemui.statusbar.notification.collection.inflation.-$$Lambda$NotificationRowBinderImpl$SFe64hfrb5m8XyXzSK440usXoQw
    ...
    private void inflateContentViews(NotificationEntry notificationEntry, ExpandableNotificationRow expandableNotificationRow, NotificationRowContentBinder.InflationCallback inflationCallback) {
        ...
        if (stageParams != null) {
            ...
            boolean z = true;
            boolean z2 = ((NotificationLockscreenUserManager) Dependency.get(NotificationLockscreenUserManager.class)).isSecure() && ((NotificationEntryManager) Dependency.get(NotificationEntryManager.class)).isLocked(notificationEntry.getKey());
            if (!(((NotificationLockscreenUserManager) Dependency.get(NotificationLockscreenUserManager.class)).needsRedaction(notificationEntry) || z2) && !z2) {
                z = false;
            }
            expandableNotificationRow.setNeedsRedaction(z);
            expandableNotificationRow.setContentHidden(z2);
            stageParams.rebindAllContentViews();
            this.mRowContentBindStage.requestRebind(notificationEntry, new NotifBindPipeline.BindCallback(isImportantMessaging, shouldUseLowPriorityView, inflationCallback) { // from class: com.android.systemui.statusbar.notification.collection.inflation.-$$Lambda$NotificationRowBinderImpl$M_8U_SW8MSCq5I74bBphTK6ZY-4
                ...
                public final void onBindFinished(NotificationEntry notificationEntry2) {
                    NotificationRowBinderImpl.lambda$inflateContentViews$1(ExpandableNotificationRow.this, this.f$1, this.f$2, this.f$3, notificationEntry2);
                }
            });
        }
    }
