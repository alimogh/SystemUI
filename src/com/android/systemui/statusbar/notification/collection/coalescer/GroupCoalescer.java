...
public class GroupCoalescer implements Dumpable {
    ...
    private void resetShortTimeout(EventBatch eventBatch) {
        ...
        eventBatch.mCancelShortTimeout = this.mMainExecutor.executeDelayed(new Runnable(eventBatch) { // from class: com.android.systemui.statusbar.notification.collection.coalescer.-$$Lambda$GroupCoalescer$CkC530E2KSp8Q8dstQvPigtYz5M
