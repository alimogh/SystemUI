...
public final class CoalescedEvent {
    ...
    public CoalescedEvent(@NotNull String str, int i, @NotNull StatusBarNotification statusBarNotification, @NotNull NotificationListenerService.Ranking ranking, @Nullable EventBatch eventBatch) {
