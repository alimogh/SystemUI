...
public class ShadeListBuilder implements Dumpable {
    ...
    private static final NotifSection sDefaultSection = new NotifSection("DefaultSection") { // from class: com.android.systemui.statusbar.notification.collection.ShadeListBuilder.2
    ...
    private final Comparator<ListEntry> mTopLevelComparator = new Comparator() { // from class: com.android.systemui.statusbar.notification.collection.-$$Lambda$ShadeListBuilder$j4Y9-Xdxb2bsigQJC_JntCQwmx4
    ...
    public void addPreGroupFilter(NotifFilter notifFilter) {
        ...
        notifFilter.setInvalidationListener(new Pluggable.PluggableListener() { // from class: com.android.systemui.statusbar.notification.collection.-$$Lambda$ShadeListBuilder$nY0ibCyaS-Pniz4LEX1W2bWrRcs
    ...
    public void addFinalizeFilter(NotifFilter notifFilter) {
        ...
        notifFilter.setInvalidationListener(new Pluggable.PluggableListener() { // from class: com.android.systemui.statusbar.notification.collection.-$$Lambda$ShadeListBuilder$xeAx9GATmY7ZgJZ0F6oEQlc0G_0
            @Override // com.android.systemui.statusbar.notification.collection.listbuilder.pluggable.Pluggable.PluggableListener
            public final void onPluggableInvalidated(Object obj) {
    ...
    public void addPromoter(NotifPromoter notifPromoter) {
        ...
        notifPromoter.setInvalidationListener(new Pluggable.PluggableListener() { // from class: com.android.systemui.statusbar.notification.collection.-$$Lambda$ShadeListBuilder$WhP4dzR4yYnVTR1LdzWTnz4ov9k
            @Override // com.android.systemui.statusbar.notification.collection.listbuilder.pluggable.Pluggable.PluggableListener
            public final void onPluggableInvalidated(Object obj) {
    ...
    public void setSections(List<NotifSection> list) {
        ...
        for (NotifSection notifSection : list) {
            ...
            notifSection.setInvalidationListener(new Pluggable.PluggableListener() { // from class: com.android.systemui.statusbar.notification.collection.-$$Lambda$ShadeListBuilder$bhojRXQ6I-zMsuyeOmu4rRbLGws
                @Override // com.android.systemui.statusbar.notification.collection.listbuilder.pluggable.Pluggable.PluggableListener
                public final void onPluggableInvalidated(Object obj) {
    ...
    private void promoteNotifs(List<ListEntry> list) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if (listEntry instanceof GroupEntry) {
                ((GroupEntry) listEntry).getRawChildren().removeIf(new Predicate(list) { // from class: com.android.systemui.statusbar.notification.collection.-$$Lambda$ShadeListBuilder$ePmhZ1cn_R-Hisgrq179QhMPgfM
