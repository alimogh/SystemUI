...
public class NotificationGutsManager implements Dumpable, NotificationLifetimeExtender {
    ...
    private void startAppNotificationSettingsActivity(String str, int i, NotificationChannel notificationChannel, ExpandableNotificationRow expandableNotificationRow) {
        ...
        if (notificationChannel != null) {
            ...
            if (expandableNotificationRow != null) {
                Bundle bundle2 = expandableNotificationRow.getEntry().getSbn().getNotification().extras;
    ...
    public boolean bindGuts(ExpandableNotificationRow expandableNotificationRow, NotificationMenuRowPlugin.MenuItem menuItem) {
        ...
        expandableNotificationRow.getGuts().setClosedListener(new NotificationGuts.OnGutsClosedListener(expandableNotificationRow, sbn) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$lbHSFb83h5SRmJTPUlzactX7_1Q
    ...
    private void initializeSnoozeView(ExpandableNotificationRow expandableNotificationRow, NotificationSnooze notificationSnooze) {
        ...
        guts.setHeightChangedListener(new NotificationGuts.OnHeightChangedListener(expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$xtHxMW6jrIgJGugFgxSSg6aT080
            public final /* synthetic */ ExpandableNotificationRow f$1;
    ...
    private void initializeAppOpsInfo(ExpandableNotificationRow expandableNotificationRow, AppOpsInfo appOpsInfo) {
        ...
        $$Lambda$NotificationGutsManager$wyMAwZ08iUSa7KG3DScd2mF0ZVk r4 = new AppOpsInfo.OnSettingsClickListener(sbn, guts, expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$wyMAwZ08iUSa7KG3DScd2mF0ZVk
    ...
    public void initializeNotificationInfo(ExpandableNotificationRow expandableNotificationRow, NotificationInfo notificationInfo) throws Exception {
        ...
        $$Lambda$NotificationGutsManager$5sbilrrQIt_lf8k9ZdwNLnjs r14 = new NotificationInfo.OnAppSettingsClickListener(guts, sbn, expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$5sbilrrQIt_lf--8k9ZdwNLn-js
        ...
        if (!user.equals(UserHandle.ALL) || this.mLockscreenUserManager.getCurrentUserId() == 0) {
            r13 = new NotificationInfo.OnSettingsClickListener(guts, sbn, packageName, expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$Q50_8sHdIRaYdx4NmoW9bex_4-o
                public final /* synthetic */ NotificationGuts f$1;
                public final /* synthetic */ StatusBarNotification f$2;
    ...
    public void initializePartialConversationNotificationInfo(ExpandableNotificationRow expandableNotificationRow, PartialConversationInfo partialConversationInfo) throws Exception {
        ...
        PackageManager packageManagerForUser = StatusBar.getPackageManagerForUser(this.mContext, user.getIdentifier());
        if (!user.equals(UserHandle.ALL) || this.mLockscreenUserManager.getCurrentUserId() == 0) {
            r12 = new NotificationInfo.OnSettingsClickListener(guts, sbn, packageName, expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$_QQQs9zfP_ZSHrXlaEFU7rOxG50
                public final /* synthetic */ NotificationGuts f$1;
                public final /* synthetic */ StatusBarNotification f$2;
                public final /* synthetic */ String f$3;
                public final /* synthetic */ ExpandableNotificationRow f$4;
    ...
    public void initializeConversationNotificationInfo(ExpandableNotificationRow expandableNotificationRow, NotificationConversationInfo notificationConversationInfo) throws Exception {
        ...
        UserHandle user = sbn.getUser();
        PackageManager packageManagerForUser = StatusBar.getPackageManagerForUser(this.mContext, user.getIdentifier());
        $$Lambda$NotificationGutsManager$SxOqoV1fAYXT8YXSboDhbPUKcNY r7 = new NotificationConversationInfo.OnSnoozeClickListener(sbn) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$SxOqoV1fAYXT8YXSboDhbPUKcNY
            public final /* synthetic */ StatusBarNotification f$1;
        ...
        $$Lambda$NotificationGutsManager$sCU8ga9RgRp89PSTE4vP2xOWPYM r15 = new NotificationConversationInfo.OnConversationSettingsClickListener(sbn, expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$sCU8ga9RgRp89PSTE4vP2xOWPYM
            public final /* synthetic */ StatusBarNotification f$1;
        ...
        if (!user.equals(UserHandle.ALL) || this.mLockscreenUserManager.getCurrentUserId() == 0) {
            r16 = new NotificationConversationInfo.OnSettingsClickListener(guts, sbn, packageName, expandableNotificationRow) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$l1uQ6jkAF-_qnuYpLc8JtAuLHmo
                public final /* synthetic */ NotificationGuts f$1;
                public final /* synthetic */ StatusBarNotification f$2;
                public final /* synthetic */ String f$3;
                public final /* synthetic */ ExpandableNotificationRow f$4;
    ...
    public boolean openGuts(View view, int i, int i2, NotificationMenuRowPlugin.MenuItem menuItem) {
        ...
        this.mStatusBarLazy.get().executeRunnableDismissingKeyguard(new Runnable(view, i, i2, menuItem) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$FMcYcqx6JxHHSZHrMeuI2W1DjZY
    ...
    public /* synthetic */ void lambda$openGuts$11$NotificationGutsManager(View view, int i, int i2, NotificationMenuRowPlugin.MenuItem menuItem) {
        this.mMainHandler.post(new Runnable(view, i, i2, menuItem) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotificationGutsManager$PjWrLLW0p5M-pvIfRIh3E86B4Vc
            public final /* synthetic */ View f$1;
            public final /* synthetic */ int f$2;
            public final /* synthetic */ int f$3;
            public final /* synthetic */ NotificationMenuRowPlugin.MenuItem f$4;
