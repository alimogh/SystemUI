...
public class HybridConversationNotificationView extends HybridNotificationView {
    ...
    public void onFinishInflate() {
        ...
        this.mConversationIconView = (ImageView) requireViewById(16908888);
        this.mConversationFacePile = requireViewById(16908883);
        this.mConversationSenderName = (TextView) requireViewById(C0008R$id.conversation_notification_sender);
        this.mFacePileSize = getResources().getDimensionPixelSize(C0005R$dimen.conversation_single_line_face_pile_size);
        this.mConversationIconSize = getResources().getDimensionPixelSize(C0005R$dimen.conversation_single_line_avatar_size);
        this.mFacePileProtectionWidth = getResources().getDimensionPixelSize(C0005R$dimen.conversation_single_line_face_pile_protection_width);
    ...
    public void bind(CharSequence charSequence, CharSequence charSequence2, View view) {
        ...
        if (conversationIcon != null) {
            ...
            View requireViewById = requireViewById(16908883);
            this.mConversationFacePile = requireViewById;
            ImageView imageView = (ImageView) requireViewById.requireViewById(16908885);
            ImageView imageView2 = (ImageView) this.mConversationFacePile.requireViewById(16908884);
            ImageView imageView3 = (ImageView) this.mConversationFacePile.requireViewById(16908886);
