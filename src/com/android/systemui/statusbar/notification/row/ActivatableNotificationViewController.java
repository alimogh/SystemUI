...
public class ActivatableNotificationViewController {
    ...
    public void init() {
        ...
        $$Lambda$ActivatableNotificationViewController$r3sTjOy8fdG9h_zptjU2waOJUhM r3 = new DoubleTapHelper.ActivationListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ActivatableNotificationViewController$r3sTjOy8fdG9h_zptjU2waOJUhM
        ...
        $$Lambda$YDw8IXhiUvHyYCObyXXnYJSdUnc r4 = new DoubleTapHelper.DoubleTapListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$YDw8IXhiUvHyYCObyXXnYJSdUnc
        ...
        $$Lambda$ELEe9GisA3PeCbD7mpobFwmaM r5 = new DoubleTapHelper.SlideBackListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ELE-e-9GisA3PeCbD7mpobFwmaM
        ...
        this.mDoubleTapHelper = new DoubleTapHelper(activatableNotificationView, r3, r4, r5, new DoubleTapHelper.DoubleTapLogListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$PkPBcaaRR8KHImTlnKW995Xmvx8
