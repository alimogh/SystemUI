...
public class NotificationMenuRow implements NotificationMenuRowPlugin, View.OnClickListener, ExpandableNotificationRow.LayoutListener {
    ...
    public NotificationMenuRow(Context context, PeopleNotificationIdentifier peopleNotificationIdentifier) {
        ...
        this.mShouldShowMenu = context.getResources().getBoolean(C0003R$bool.config_showNotificationGear);
    ...
    private void createMenuViews(boolean z, boolean z2) {
        ...
        this.mHorizSpaceForIcon = resources.getDimensionPixelSize(C0005R$dimen.notification_menu_icon_size);
        this.mVertSpaceForIcons = resources.getDimensionPixelSize(C0005R$dimen.notification_min_height);
    ...
    private void setAppName(String str, ArrayList<NotificationMenuRowPlugin.MenuItem> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String format = String.format(resources.getString(C0015R$string.notification_menu_accessibility), str, menuItem.getContentDescription());
    ...
    static NotificationMenuRowPlugin.MenuItem createSnoozeItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0015R$string.notification_menu_snooze_description), (NotificationSnooze) LayoutInflater.from(context).inflate(C0011R$layout.notification_snooze, (ViewGroup) null, false), C0006R$drawable.ic_snooze);
    }

    static NotificationMenuItem createConversationItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0015R$string.notification_menu_gear_description), (NotificationConversationInfo) LayoutInflater.from(context).inflate(C0011R$layout.notification_conversation_info, (ViewGroup) null, false), C0006R$drawable.op_ic_settings);
    }

    static NotificationMenuItem createPartialConversationItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0015R$string.notification_menu_gear_description), (PartialConversationInfo) LayoutInflater.from(context).inflate(C0011R$layout.partial_conversation_info, (ViewGroup) null, false), C0006R$drawable.op_ic_settings);
    }

    static NotificationMenuItem createInfoItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0015R$string.notification_menu_gear_description), (NotificationInfo) LayoutInflater.from(context).inflate(C0011R$layout.notification_info, (ViewGroup) null, false), C0006R$drawable.op_ic_settings);
    }

    static NotificationMenuRowPlugin.MenuItem createAppOpsItem(Context context) {
        return new NotificationMenuItem(context, null, (AppOpsInfo) LayoutInflater.from(context).inflate(C0011R$layout.app_ops_info, (ViewGroup) null, false), -1);
    }
    ...
    public static class NotificationMenuItem implements NotificationMenuRowPlugin.MenuItem {
        ...
        public NotificationMenuItem(Context context, String str, NotificationGuts.GutsContent gutsContent, int i) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0005R$dimen.notification_menu_icon_padding);
            int color = resources.getColor(C0004R$color.notification_gear_color);
            if (i >= 0) {
