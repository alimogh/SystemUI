...
public class HybridGroupManager {
    ...
    public void initDimens() {
        ...
        this.mOverflowNumberSize = (float) resources.getDimensionPixelSize(C0005R$dimen.group_overflow_number_size);
        this.mOverflowNumberPadding = resources.getDimensionPixelSize(C0005R$dimen.group_overflow_number_padding);
    }
    ...
    private HybridNotificationView inflateHybridViewWithStyle(int i, View view, ViewGroup viewGroup) {
        ...
        if (view instanceof ConversationLayout) {
            i2 = C0011R$layout.hybrid_conversation_notification;
        } else {
            i2 = C0011R$layout.hybrid_notification;
        }
    ...
    private TextView inflateOverflowNumber(ViewGroup viewGroup) {
        TextView textView = (TextView) ((LayoutInflater) this.mContext.getSystemService(LayoutInflater.class)).inflate(C0011R$layout.hybrid_overflow_number, viewGroup, false);
    ...
    public HybridNotificationView bindFromNotification(HybridNotificationView hybridNotificationView, View view, StatusBarNotification statusBarNotification, ViewGroup viewGroup) {
        return bindFromNotificationWithStyle(hybridNotificationView, view, statusBarNotification, C0016R$style.HybridNotification, viewGroup);
    }
    ...
    public TextView bindOverflowNumber(TextView textView, int i, ViewGroup viewGroup) {
        ...
        String string = this.mContext.getResources().getString(C0015R$string.notification_group_overflow_indicator, Integer.valueOf(i));
        if (!string.equals(textView.getText())) {
            textView.setText(string);
        }
        textView.setContentDescription(String.format(this.mContext.getResources().getQuantityString(C0013R$plurals.notification_group_overflow_description, i), Integer.valueOf(i)));
