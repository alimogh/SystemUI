...
public class NotificationContentView extends FrameLayout {
    ...
    public void initView() {
        ...
        this.mNotificationContentMarginEnd = getResources().getDimensionPixelSize(17105346);
        this.mQuickReplyHeight = ((FrameLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.quick_reply_notification_height);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            measureChildWithMargins(view2, i, 0, View.MeasureSpec.makeMeasureSpec(this.mQuickReplyHeight, 1073741824), 0);
            i3 = Math.max(i3, this.mQuickReplyChild.getMeasuredHeight());
        }
        View view3 = this.mQuickReplyHeadsUpChild;
        if (view3 != null) {
            measureChildWithMargins(view3, i, 0, View.MeasureSpec.makeMeasureSpec(this.mQuickReplyHeight, 1073741824), 0);
    ...
    private int getExtraRemoteInputHeight(RemoteInputView remoteInputView) {
        ...
        if (remoteInputView.isActive() || remoteInputView.isSending()) {
            return getResources().getDimensionPixelSize(17105345);
        }
        return 0;
    }
    ...
    public void onViewAdded(View view) {
        ...
        view.setTag(C0008R$id.row_tag_for_content_view, this.mContainingNotification);
    }
    ...
    private int getMinContentHeightHint() {
        ...
        if (this.mIsChildInGroup && isVisibleOrTransitioning(3)) {
            return ((FrameLayout) this).mContext.getResources().getDimensionPixelSize(17105336);
        }
        ...
        if (this.mQuickReplyHeadsUpChild != null && isVisibleOrTransitioning(7)) {
            i = getViewHeight(7);
            ...
            i = getViewHeight(0) + ((FrameLayout) this).mContext.getResources().getDimensionPixelSize(17105336);
        } else {
            i = getMinHeight();
        }
    ...
    private int getViewHeight(int i, boolean z) {
        ...
        boolean z2 = SystemProperties.getBoolean("persist.sys.HeadsUpAppearanceController.debug", false);
        if (wrapperForView != null) {
            if (z2 && i == 2 && getResources().getConfiguration().orientation == 2) {
                Log.d("NotificationContentView", "viewWrapper header translation: " + wrapperForView.getHeaderTranslation(z));
            }
            height += wrapperForView.getHeaderTranslation(z);
        }
        if (Build.DEBUG_ONEPLUS && i == 2) {
            Log.d("NotificationContentView", "notification height: " + height + ", forceNoHeader: " + z);
        }
        return height;
    }
        ...
        if (this.mContractedChild != null) {
            ...
            if (z3 || z2) {
                ...
                if (viewForVisibleType != null) {
                    ...
                    if (this.mFirstSeen && ((calculateVisibleType == 7 || calculateVisibleType == 6) && (((view = this.mQuickReplyHeadsUpChild) != null && view.getVisibility() == 0) || ((view2 = this.mQuickReplyChild) != null && view2.getVisibility() == 0)))) {
                        Log.d("NotificationContentView", "Notification is displayed as Quick Reply style");
                        this.mFirstSeen = false;
                    }
                }
                if (!z || ((calculateVisibleType != 1 || this.mExpandedChild == null) && ((calculateVisibleType != 2 || this.mHeadsUpChild == null) && ((calculateVisibleType != 3 || this.mSingleLineView == null) && ((calculateVisibleType != 6 || this.mQuickReplyChild == null) && ((calculateVisibleType != 7 || this.mQuickReplyHeadsUpChild == null) && calculateVisibleType != 0)))))) {
                    updateViewVisibilities(calculateVisibleType);
                } else {
    ...
    /* JADX DEBUG: Can't convert new array creation: APUT found in different block: 0x0056: APUT  
      ...
      (wrap: java.lang.Integer : 0x0052: INVOKE  (r4v3 java.lang.Integer) = (r4v2 int) type: STATIC call: java.lang.Integer.valueOf(int):java.lang.Integer)
     */
    ...
    private RemoteInputView applyRemoteInput(View view, NotificationEntry notificationEntry, boolean z, PendingIntent pendingIntent, RemoteInputView remoteInputView, NotificationViewWrapper notificationViewWrapper) {
        View findViewById = view.findViewById(16908722);
        ...
        if (z) {
            ...
            remoteInputView.setOnVisibilityChangedListener(new Consumer() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$GC_EXjlJWjwU2u0y95DlTq2QVf0
    ...
    private void applyBubbleAction(View view, NotificationEntry notificationEntry) {
        ...
        if (view != null && this.mContainingNotification != null && this.mPeopleIdentifier != null) {
            ImageView imageView = (ImageView) view.findViewById(16908800);
            View findViewById = view.findViewById(16908722);
            LinearLayout linearLayout = (LinearLayout) view.findViewById(16908723);
            if (imageView != null && findViewById != null && linearLayout != null) {
                ...
                if (z) {
                    ...
                    if (notificationEntry.isBubble()) {
                        i = C0006R$drawable.ic_stop_bubble;
                    } else {
                        i = C0006R$drawable.ic_create_bubble;
                    }
                    ...
                    if (notificationEntry.isBubble()) {
                        i2 = C0015R$string.notification_conversation_unbubble;
                    } else {
                        i2 = C0015R$string.notification_conversation_bubble;
                    }
                    ...
                    linearLayout.setPaddingRelative(0, 0, getResources().getDimensionPixelSize(17104957), 0);
                    return;
                }
                imageView.setVisibility(8);
                linearLayout.setPaddingRelative(0, 0, getResources().getDimensionPixelSize(17104956), 0);
            }
        }
    }
    ...
    private SmartReplyView applySmartReplyView(View view, InflatedSmartReplies.SmartRepliesAndActions smartRepliesAndActions, NotificationEntry notificationEntry, InflatedSmartReplies inflatedSmartReplies) {
        View findViewById = view.findViewById(16909447);
    ...
    public void updateExpandButtons(boolean z) {
        ...
        if (!this.mContainingNotification.isContentHidden() && (this.mVisibleType != 2 || OpLsState.getInstance().getPhoneStatusBar() == null || OpLsState.getInstance().getPhoneStatusBar().getPanelController() == null || !OpLsState.getInstance().getPhoneStatusBar().getPanelController().isQsExpanded())) {
            z2 = z;
        }
        if (this.mExpandedChild != null) {
    ...
    public int getHeadsUpHeight(boolean z) {
        ...
        if (SystemProperties.getBoolean("persist.sys.HeadsUp.debug", false) && i == 2 && getResources().getConfiguration().orientation == 2) {
            Log.d("NotificationContentView", "mHeadsUpRemoteInput height: " + getExtraRemoteInputHeight(this.mHeadsUpRemoteInput) + ", mExpandedRemoteInput: " + getExtraRemoteInputHeight(this.mExpandedRemoteInput));
        }
