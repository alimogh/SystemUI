...
public class PartialConversationInfo extends LinearLayout implements NotificationGuts.GutsContent {
    ...
    private View.OnClickListener mOnDone = new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$PartialConversationInfo$nflnLN0fffGCKkiUNaYNxW2-Ovc
    ...
    private void bindActions() {
        ...
        findViewById(C0008R$id.settings_link).setOnClickListener(settingsOnClickListener);
        ((TextView) findViewById(C0008R$id.non_configurable_text)).setText(getResources().getString(C0015R$string.no_shortcut, this.mAppName));
    }
    ...
    private View.OnClickListener getSettingsOnClickListener() {
        ...
        return new View.OnClickListener(i) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$PartialConversationInfo$OYcvrnC5h5eirxa5ANc3qGWEO2w
    ...
    private View.OnClickListener getTurnOffNotificationsClickListener() {
        return new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$PartialConversationInfo$12HGV21n_Ekv-i_xKHwNYt5E1xk
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$getTurnOffNotificationsClickListener$3$PartialConversationInfo(View view) {
        ...
        if (!this.mPresentingChannelEditorDialog && (channelEditorDialogController = this.mChannelEditorDialogController) != null) {
            ...
            this.mChannelEditorDialogController.setOnFinishListener(new OnChannelEditorDialogFinishedListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$PartialConversationInfo$ybMQkDgz9yD0IGZqfIgwLQnlkXw
    ...
    private void bindPackage() {
        ...
        ((TextView) findViewById(C0008R$id.name)).setText(this.mAppName);
        ((ImageView) findViewById(C0008R$id.icon)).setImageDrawable(this.mPkgIcon);
    }
