...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    private void updateColors() {
        this.mNormalColor = ((FrameLayout) this).mContext.getColor(C0004R$color.notification_material_background_color);
        this.mTintedRippleColor = ((FrameLayout) this).mContext.getColor(C0004R$color.notification_ripple_tinted_color);
        this.mNormalRippleColor = ((FrameLayout) this).mContext.getColor(C0004R$color.notification_ripple_untinted_color);
        this.mDimmedAlpha = Color.alpha(((FrameLayout) this).mContext.getColor(C0004R$color.notification_material_background_dimmed_color));
    }

    private void initDimens() {
        this.mHeadsUpAddStartLocation = getResources().getDimensionPixelSize(17105347);
    }
    ...
    public void onFinishInflate() {
        ...
        this.mBackgroundNormal = (NotificationBackgroundView) findViewById(C0008R$id.backgroundNormal);
        FakeShadowView fakeShadowView = (FakeShadowView) findViewById(C0008R$id.fake_shadow);
        this.mFakeShadow = fakeShadowView;
        this.mShadowHidden = fakeShadowView.getVisibility() != 0;
        this.mBackgroundDimmed = (NotificationBackgroundView) findViewById(C0008R$id.backgroundDimmed);
        initBackground();
        updateBackground();
        updateBackgroundTint();
        updateOutlineAlpha();
    ...
    public void initBackground() {
        this.mBackgroundNormal.setCustomBackground(C0006R$drawable.notification_material_bg);
        this.mBackgroundDimmed.setCustomBackground(C0006R$drawable.notification_material_bg_dim);
    }

    public void setREDBackground() {
        this.mBackgroundNormal.setCustomBackground(C0006R$drawable.op_qs_red_all);
        this.mBackgroundDimmed.setCustomBackground(C0006R$drawable.op_qs_red_all);
    }
    ...
    private void startActivateAnimation(boolean z) {
        ...
        if (isAttachedToWindow() && isDimmable()) {
            ...
            if (z) {
                ...
                animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.notification.row.ActivatableNotificationView.2
            ...
            animate.alpha(f).setInterpolator(interpolator).setUpdateListener(new ValueAnimator.AnimatorUpdateListener(z) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ActivatableNotificationView$OICE3JOCIwmVbbHi746Bfw-wQKU
    ...
    private void updateBackgroundTint(boolean z) {
        ...
        if (calculateBgColor != i) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ActivatableNotificationView$RyrpIvGKNair8LtB-lYHJy-dGQs
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ActivatableNotificationView.this.lambda$updateBackgroundTint$1$ActivatableNotificationView(valueAnimator2);
                }
            });
    ...
    private void startAppearAnimation(final boolean z, float f, long j, long j2, final Runnable runnable, AnimatorListenerAdapter animatorListenerAdapter) {
        ...
        this.mAppearAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ActivatableNotificationView$zXl7sYwVdaC-_0arcFQWEk_iqbo
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
