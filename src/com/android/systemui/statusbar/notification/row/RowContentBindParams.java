...
public final class RowContentBindParams {
    private static int DEFAULT_INFLATION_FLAGS = 3;
    ...
    public RowContentBindParams() {
        int i = DEFAULT_INFLATION_FLAGS;
        this.mContentViews = i;
        this.mDirtyContentViews = i;
        if (!OpUtils.QUICK_REPLY_BUBBLE) {
            DEFAULT_INFLATION_FLAGS = DEFAULT_INFLATION_FLAGS | 32 | 64;
        }
    }
