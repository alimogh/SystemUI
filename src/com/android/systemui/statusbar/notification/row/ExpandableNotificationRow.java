...
public class ExpandableNotificationRow extends ActivatableNotificationView implements PluginListener<NotificationMenuRowPlugin>, SwipeableView, NotificationListItem {
    ...
    private View.OnClickListener mExpandClickListener = new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.row.ExpandableNotificationRow.1
        ...
        public void onClick(View view) {
            ...
            } else if (!ExpandableNotificationRow.this.shouldShowPublic() && ((!ExpandableNotificationRow.this.mIsLowPriority || ExpandableNotificationRow.this.isExpanded()) && ExpandableNotificationRow.this.mGroupManager.isSummaryOfGroup(ExpandableNotificationRow.this.mEntry.getSbn()))) {
    ...
    private final Runnable mExpireRecentlyAlertedFlag = new Runnable() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ExpandableNotificationRow$XUb-nXphAmdEb1BUkM4zkhhpdtg
    ...
    private boolean mIsScrollerExpanded;
    ...
    private void setIconAnimationRunningForChild(boolean z, View view) {
        if (view != null) {
            ...
            setIconRunning((ImageView) view.findViewById(16909368), z);
        }
    }
    ...
    public void updateShelfIconColor() {
        ...
        int i = 0;
        if (!Boolean.TRUE.equals(shelfIcon.getTag(C0008R$id.icon_is_pre_L)) || NotificationUtils.isGrayscale(shelfIcon, ContrastColorUtil.getInstance(((FrameLayout) this).mContext))) {
    ...
    public int getOriginalIconColor() {
        int originalIconColor = (!this.mIsSummaryWithChildren || shouldShowPublic()) ? getShowingLayout().getOriginalIconColor() : this.mChildrenContainer.getVisibleHeader().getOriginalIconColor();
        boolean z = true;
        if (originalIconColor != 1) {
            return originalIconColor;
        }
        StatusBarIconView shelfIcon = getShelfIcon();
        boolean isGrayscale = shelfIcon != null ? NotificationUtils.isGrayscale(shelfIcon, ContrastColorUtil.getInstance(((FrameLayout) this).mContext)) : false;
        if (!OpUtils.isGlobalROM(getContext()) && !isGrayscale) {
            return 0;
        }
        NotificationEntry notificationEntry = this.mEntry;
    ...
    private void updateLimitsForView(NotificationContentView notificationContentView) {
        ...
        int i2;
        boolean z = true;
        boolean z2 = (notificationContentView.getContractedChild() == null || notificationContentView.getContractedChild().getId() == 16909480) ? false : true;
        boolean z3 = this.mEntry.targetSdk < 24;
        boolean z4 = this.mEntry.targetSdk < 28;
        View expandedChild = notificationContentView.getExpandedChild();
        boolean z5 = (expandedChild == null || expandedChild.findViewById(16909153) == null) ? false : true;
        ...
        if (notificationContentView.getHeadsUpChild() == null || notificationContentView.getHeadsUpChild().getId() == 16909480) {
            z = false;
        }
        if (!z || !z4) {
    ...
    public void setHeadsUp(boolean z) {
        ...
        if (OpUtils.isREDVersion()) {
            if (this.mIsHeadsUp && !this.mIsScrollerExpanded) {
                setREDBackground();
            } else if (!this.mIsHeadsUp) {
                restoreBackground();
            }
            setIsHeadsUp(z);
        }
    ...
    private void setChronometerRunningForChild(boolean z, View view) {
        if (view != null) {
            View findViewById = view.findViewById(16908842);
    ...
    public NotificationHeaderView getNotificationHeader() {
        if (this.mIsSummaryWithChildren) {
            if (OpUtils.DEBUG_ONEPLUS) {
                Log.d("ExpandableNotifRow", "getNotificationHeader getHeaderView " + this.mChildrenContainer.getHeaderView());
            }
            return this.mChildrenContainer.getHeaderView();
        }
        if (OpUtils.DEBUG_ONEPLUS) {
            Log.d("ExpandableNotifRow", "getNotificationHeader getNotificationHeader " + this.mPrivateLayout.getNotificationHeader());
        }
    ...
    private void reInflateViews() {
        ...
        if (notificationGuts != null) {
            ...
            NotificationGuts notificationGuts2 = (NotificationGuts) LayoutInflater.from(((FrameLayout) this).mContext).inflate(C0011R$layout.notification_guts, (ViewGroup) this, false);
    ...
    public void setIsScrollerExpanded(boolean z) {
        this.mIsScrollerExpanded = z;
        if (isHeadsUp() && z) {
            restoreBackground();
        }
    }
    ...
    public void setAppOpsOnClickListener(OnAppOpsClickListener onAppOpsClickListener) {
        this.mOnAppOpsClickListener = new View.OnClickListener(onAppOpsClickListener) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$ExpandableNotificationRow$7jXuB4sFjLsVw6Zajpc39FzigT4
    ...
    public /* synthetic */ void lambda$setAppOpsOnClickListener$1$ExpandableNotificationRow(OnAppOpsClickListener onAppOpsClickListener, View view) {
        ...
        if (provider != null) {
            NotificationMenuRowPlugin.MenuItem appOpsMenuItem = provider.getAppOpsMenuItem(((FrameLayout) this).mContext);
            if (this.mIsContentHidden) {
                performClick();
            } else if (appOpsMenuItem != null) {
    ...
    public void onFinishInflate() {
        ...
        this.mPublicLayout = (NotificationContentView) findViewById(C0008R$id.expandedPublic);
        NotificationContentView notificationContentView = (NotificationContentView) findViewById(C0008R$id.expanded);
        ...
        ViewStub viewStub = (ViewStub) findViewById(C0008R$id.notification_guts_stub);
        ...
        ViewStub viewStub2 = (ViewStub) findViewById(C0008R$id.child_container_stub);
    ...
    public Animator getTranslateViewAnimator(final float f, ValueAnimator.AnimatorUpdateListener animatorUpdateListener) {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.notification.row.ExpandableNotificationRow.6
    ...
    public boolean canShowHeadsUp() {
        if (OpLsState.getInstance().getPhoneStatusBar() != null && OpLsState.getInstance().getPhoneStatusBar().getPanelController() != null && OpLsState.getInstance().getPhoneStatusBar().getPanelController().isQsExpanded() && (this.mEntry.getSbn().getNotification() == null || !"call".equals(this.mEntry.getSbn().getNotification().category))) {
            return false;
        }
    ...
    public void setHideSensitive(boolean z, boolean z2, long j, long j2) {
        if (getVisibility() != 8) {
            ...
            int i = 0;
            boolean z4 = this.mSensitive && (z || this.mIsContentHidden);
    ...
    private void animateShowingPublic(long j, long j2, boolean z) {
        ...
        for (final View view : viewArr3) {
            ...
            view.animate().cancel();
            view.animate().alpha(0.0f).setStartDelay(j).setDuration(j2).withEndAction(new Runnable(this) { // from class: com.android.systemui.statusbar.notification.row.ExpandableNotificationRow.7
                @Override // java.lang.Runnable
                public void run() {
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (provider != null && provider.getSnoozeMenuItem(getContext()) != null) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_snooze, getContext().getResources().getString(C0015R$string.notification_menu_snooze_action)));
        }
    }
    ...
    public boolean performAccessibilityActionInternal(int i, Bundle bundle) {
        ...
        if (i == 32) {
            ...
            return true;
        } else if (i != C0008R$id.action_snooze || (provider = getProvider()) == null) {
            return false;
        } else {
    ...
    public boolean isMediaRow() {
        return (getExpandedContentView() == null || getExpandedContentView().findViewById(16909153) == null) ? false : true;
    }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        printWriter.print(", sensitive: " + this.mSensitive);
        printWriter.print(", contentHidden: " + this.mIsContentHidden);
        printWriter.println();
    ...
    public void reinflateQuickReply(boolean z) {
        ...
        if (this.mPrivateLayout.getQuickReplyContractedChild() == null || this.mPrivateLayout.getQuickReplyHeadsUpChild() == null) {
            RowContentBindParams stageParams = this.mRowContentBindStage.getStageParams(this.mEntry);
            stageParams.requireContentViews(96);
            stageParams.setNeedsReinflation(true);
            this.mRowContentBindStage.requestRebind(this.mEntry, null);
        }
    }
