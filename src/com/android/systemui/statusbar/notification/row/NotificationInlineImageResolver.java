...
public class NotificationInlineImageResolver implements ImageResolver {
    ...
    public int getMaxImageWidth() {
        return this.mContext.getResources().getDimensionPixelSize(isLowRam() ? 17105353 : 17105352);
    }

    /* access modifiers changed from: protected */
    @VisibleForTesting
    public int getMaxImageHeight() {
        return this.mContext.getResources().getDimensionPixelSize(isLowRam() ? 17105351 : 17105350);
    }
    ...
    public /* synthetic */ void lambda$preloadImages$0$NotificationInlineImageResolver(Uri uri) {
        if (uri != null && !this.mImageCache.hasEntry(uri)) {
            this.mImageCache.preload(uri);
        }
    }
