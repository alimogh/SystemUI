...
public abstract class StackScrollerDecorView extends ExpandableView {
    ...
    private final Runnable mContentVisibilityEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$StackScrollerDecorView$GE_2dwloJkJho6ozN7VXOOo7f2I
    ...
    private final Runnable mSecondaryVisibilityEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$StackScrollerDecorView$2MZ2DZW5S75DgdV6pIZbLhsQuUs
        @Override // java.lang.Runnable
        public final void run() {
