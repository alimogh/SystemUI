...
public final class NotifBindPipeline {
    ...
    NotifBindPipeline(CommonNotifCollection commonNotifCollection, NotifBindPipelineLogger notifBindPipelineLogger, Looper looper) {
        AnonymousClass1 r0 = new NotifCollectionListener() { // from class: com.android.systemui.statusbar.notification.row.NotifBindPipeline.1
    ...
    public void setStage(BindStage bindStage) {
        ...
        bindStage.setBindRequestListener(new BindRequester.BindRequestListener() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotifBindPipeline$Ub0DE4cDhgUUqolBUMUBBCvUjYs
    ...
    public void onBindRequested(NotificationEntry notificationEntry, CancellationSignal cancellationSignal, BindCallback bindCallback) {
        ...
        if (bindEntry != null) {
            ...
            if (bindCallback != null) {
                ...
                cancellationSignal.setOnCancelListener(new CancellationSignal.OnCancelListener(set, bindCallback) { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotifBindPipeline$AMh7TPDBgF4c0_yw5t-ceqMMco8
    ...
    private void startPipeline(NotificationEntry notificationEntry) {
        ...
        if (this.mStage != null) {
            this.mStage.executeStage(notificationEntry, this.mBindEntries.get(notificationEntry).row, new BindStage.StageCallback() { // from class: com.android.systemui.statusbar.notification.row.-$$Lambda$NotifBindPipeline$3PgyvwQAf2ulPzCouWU3DaPqlCo
                ...
                public final void onStageFinished(NotificationEntry notificationEntry2) {
                    NotifBindPipeline.this.lambda$startPipeline$1$NotifBindPipeline(notificationEntry2);
                }
            });
            return;
        }
