...
public class NotificationTemplateViewWrapper extends NotificationHeaderViewWrapper {
    ...
    protected NotificationTemplateViewWrapper(Context context, View view, ExpandableNotificationRow expandableNotificationRow) {
        ...
        this.mFullHeaderTranslation = context.getResources().getDimensionPixelSize(17105345) - context.getResources().getDimensionPixelSize(17105348);
    }

    private void resolveTemplateViews(StatusBarNotification statusBarNotification) {
        ImageView imageView = (ImageView) this.mView.findViewById(16909368);
        ...
        this.mText = (TextView) this.mView.findViewById(16909504);
        ...
        this.mActionsContainer = this.mView.findViewById(16908722);
        this.mActions = this.mView.findViewById(16908721);
        this.mReplyAction = (ImageView) this.mView.findViewById(16909348);
        this.mRemoteInputHistory = this.mView.findViewById(16909227);
    ...
    private void updatePendingIntentCancellations() {
        ...
        if (notificationActionListLayout != null) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                performOnPendingIntentCancellation(button, new Runnable(button) { // from class: com.android.systemui.statusbar.notification.row.wrapper.-$$Lambda$NotificationTemplateViewWrapper$JRq0wlJLDK40PaCOgvvnny6lB0w
    ...
    public /* synthetic */ void lambda$updatePendingIntentCancellations$0$NotificationTemplateViewWrapper(Button button) {
        if (button.isEnabled()) {
            ...
            float f = this.mView.getResources().getFloat(17105334);
    ...
    private void performOnPendingIntentCancellation(View view, Runnable runnable) {
        final PendingIntent pendingIntent = (PendingIntent) view.getTag(16909281);
        if (pendingIntent != null) {
            if (this.mCancelledPendingIntents.contains(pendingIntent)) {
                runnable.run();
                return;
            }
            final $$Lambda$NotificationTemplateViewWrapper$JW7SqyfmhP6HCTJ8F1p53b90n6s r1 = new PendingIntent.CancelListener(pendingIntent, runnable) { // from class: com.android.systemui.statusbar.notification.row.wrapper.-$$Lambda$NotificationTemplateViewWrapper$JW7SqyfmhP6HCTJ8F1p53b90n6s
                ...
                public final void onCancelled(PendingIntent pendingIntent2) {
                    NotificationTemplateViewWrapper.this.lambda$performOnPendingIntentCancellation$3$NotificationTemplateViewWrapper(this.f$1, this.f$2, pendingIntent2);
                }
            };
            ...
            if (view.isAttachedToWindow()) {
                this.mUiOffloadThread.execute(new Runnable(pendingIntent, r1) { // from class: com.android.systemui.statusbar.notification.row.wrapper.-$$Lambda$NotificationTemplateViewWrapper$qLtzjAQEVXJmd7CTS0Q7hmNVWkU
            ...
            view.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationTemplateViewWrapper.2
                ...
                public void onViewAttachedToWindow(View view2) {
                    NotificationTemplateViewWrapper.this.mUiOffloadThread.execute(new Runnable(pendingIntent, r1) { // from class: com.android.systemui.statusbar.notification.row.wrapper.-$$Lambda$NotificationTemplateViewWrapper$2$GihuSx3OPFqk-7UFX7W5ZofmkRI
                        public final /* synthetic */ PendingIntent f$0;
                        public final /* synthetic */ PendingIntent.CancelListener f$1;
                ...
                public void onViewDetachedFromWindow(View view2) {
                    NotificationTemplateViewWrapper.this.mUiOffloadThread.execute(new Runnable(pendingIntent, r1) { // from class: com.android.systemui.statusbar.notification.row.wrapper.-$$Lambda$NotificationTemplateViewWrapper$2$YHJcr04bTyX63VZ5BMhNHsutz1Y
                        public final /* synthetic */ PendingIntent f$0;
                        public final /* synthetic */ PendingIntent.CancelListener f$1;
    ...
    public /* synthetic */ void lambda$performOnPendingIntentCancellation$3$NotificationTemplateViewWrapper(PendingIntent pendingIntent, Runnable runnable, PendingIntent pendingIntent2) {
        this.mView.post(new Runnable(pendingIntent, runnable) { // from class: com.android.systemui.statusbar.notification.row.wrapper.-$$Lambda$NotificationTemplateViewWrapper$W5E5gGqEebINqbELkmQR7ZZYP8Q
            public final /* synthetic */ PendingIntent f$1;
            public final /* synthetic */ Runnable f$2;
