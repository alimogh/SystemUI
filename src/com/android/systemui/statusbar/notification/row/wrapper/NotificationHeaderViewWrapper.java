...
public class NotificationHeaderViewWrapper extends NotificationViewWrapper {
    ...
    public void resolveHeaderViews() {
        this.mIconContainer = (FrameLayout) this.mView.findViewById(16909032);
        this.mIcon = this.mView.findViewById(16908294);
        this.mHeaderText = (TextView) this.mView.findViewById(16909033);
        this.mAppNameText = (TextView) this.mView.findViewById(16908761);
        this.mExpandButton = this.mView.findViewById(16908949);
        Configuration configuration = this.mContext.getResources().getConfiguration();
        if (configuration != null) {
            if ((configuration.uiMode & 48) == 32) {
                this.mExpandButton.setColorFilter(this.mContext.getResources().getColor(C0004R$color.op_control_icon_color_active_dark));
            } else {
                this.mExpandButton.setColorFilter(this.mContext.getResources().getColor(C0004R$color.op_control_icon_color_active_light));
            }
        }
        this.mWorkProfileImage = (ImageView) this.mView.findViewById(16909319);
        this.mNotificationHeader = this.mView.findViewById(16909225);
        this.mCameraIcon = this.mView.findViewById(16908823);
        this.mMicIcon = this.mView.findViewById(16909172);
        this.mOverlayIcon = this.mView.findViewById(16909269);
        this.mAppOps = this.mView.findViewById(16908762);
        this.mAudiblyAlertedIcon = this.mView.findViewById(16908740);
    ...
    public void applyConversationSkin() {
        ...
        if (frameLayout != null) {
            ...
            marginLayoutParams.width = this.mIconContainer.getContext().getResources().getDimensionPixelSize(17105107);
            marginLayoutParams.setMarginStart(this.mIconContainer.getContext().getResources().getDimensionPixelSize(17105347) * -1);
        }
    ...
    public void clearConversationSkin() {
        TextView textView = this.mAppNameText;
        if (textView != null) {
            this.mAppNameText.setTextAppearance(Utils.getThemeAttr(textView.getContext(), 17957005, 16974722));
            ((ViewGroup.MarginLayoutParams) this.mAppNameText.getLayoutParams()).setMarginStart(this.mAppNameText.getContext().getResources().getDimensionPixelSize(17105355));
        }
        FrameLayout frameLayout = this.mIconContainer;
        if (frameLayout != null) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) frameLayout.getLayoutParams();
        ...
        CachingIconView cachingIconView = this.mIcon;
        if (cachingIconView != null) {
            ((ViewGroup.MarginLayoutParams) cachingIconView.getLayoutParams()).setMarginEnd(this.mIcon.getContext().getResources().getDimensionPixelSize(17105359));
        }
    }
