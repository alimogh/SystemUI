...
public class NotificationMediaTemplateViewWrapper extends NotificationTemplateViewWrapper {
    ...
    private View.OnAttachStateChangeListener mAttachStateListener = new View.OnAttachStateChangeListener() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationMediaTemplateViewWrapper.3
    ...
    private MediaController.Callback mMediaCallback = new MediaController.Callback() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationMediaTemplateViewWrapper.4
    ...
    protected final Runnable mOnUpdateTimerTick = new Runnable() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationMediaTemplateViewWrapper.6
    ...
    private ViewTreeObserver.OnPreDrawListener mPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationMediaTemplateViewWrapper.5
    ...
    @VisibleForTesting
    protected SeekBar.OnSeekBarChangeListener mSeekListener = new SeekBar.OnSeekBarChangeListener() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationMediaTemplateViewWrapper.1
    ...
    private MediaNotificationView.VisibilityChangeListener mVisibilityListener = new MediaNotificationView.VisibilityChangeListener() { // from class: com.android.systemui.statusbar.notification.row.wrapper.NotificationMediaTemplateViewWrapper.2
    ...
    private void resolveViews() {
        boolean z;
        this.mActions = this.mView.findViewById(16909153);
        ...
        ViewStub viewStub = (ViewStub) this.mView.findViewById(16909238);
        if (viewStub instanceof ViewStub) {
            ...
            this.mMetricsLogger.write(newLog(1));
            SeekBar seekBar = (SeekBar) this.mSeekBarView.findViewById(16909236);
            this.mSeekBar = seekBar;
            seekBar.setOnSeekBarChangeListener(this.mSeekListener);
            this.mSeekBarElapsedTime = (TextView) this.mSeekBarView.findViewById(16909234);
            this.mSeekBarTotalTime = (TextView) this.mSeekBarView.findViewById(16909239);
            z = true;
        }
        if (z) {
