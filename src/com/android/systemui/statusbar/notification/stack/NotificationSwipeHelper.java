...
public class NotificationSwipeHelper extends SwipeHelper implements NotificationSwipeActionHelper {
    ...
    private final Runnable mFalsingCheck = new Runnable() { // from class: com.android.systemui.statusbar.notification.stack.-$$Lambda$NotificationSwipeHelper$C9LXWH0up2brEDre5OaSo4akO38
