...
public class StackScrollAlgorithm {
    ...
    private boolean mIsQsFullyExpanded;
    ...
    public float updateChild(int i, StackScrollAlgorithmState stackScrollAlgorithmState, AmbientState ambientState, float f, boolean z) {
        ...
        if (z2) {
            viewState.alpha = (!this.mIsExpanded || this.mIsQsFullyExpanded) ? 0.0f : 1.0f;
            viewState.hidden = !this.mIsExpanded || this.mIsQsFullyExpanded;
            if (f3 > ((float) ambientState.getInnerHeight())) {
                f3 = (float) ambientState.getInnerHeight();
            }
            viewState.yTranslation = f3;
        } else if (z3) {
    ...
    private void clampPositionToShelf(ExpandableView expandableView, ExpandableViewState expandableViewState, AmbientState ambientState) {
        if (ambientState.getShelf() != null) {
            ...
            float min = this.mIsQsFullyExpanded ? (float) innerHeight : Math.min(expandableViewState.yTranslation, (float) innerHeight);
            expandableViewState.yTranslation = min;
            if (min >= ((float) innerHeight)) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x007e, code lost:
        if (r0.isAboveShelf() != false) goto L_0x008a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0084, code lost:
        if (r0.showingPulsing() == false) goto L_0x0087;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public float updateChildZValue(int r9, float r10, com.android.systemui.statusbar.notification.stack.StackScrollAlgorithm.StackScrollAlgorithmState r11, com.android.systemui.statusbar.notification.stack.AmbientState r12) {
        /*
        // Method dump skipped, instructions count: 215
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.statusbar.notification.stack.StackScrollAlgorithm.updateChildZValue(int, float, com.android.systemui.statusbar.notification.stack.StackScrollAlgorithm$StackScrollAlgorithmState, com.android.systemui.statusbar.notification.stack.AmbientState):float");
    }
