...
public class NotificationChildrenContainer extends ViewGroup {
    ...
    static {
        AnonymousClass1 r0 = new AnimationProperties() { // from class: com.android.systemui.statusbar.notification.stack.NotificationChildrenContainer.1
    ...
    private void initDimens() {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0005R$dimen.notification_children_container_top_padding);
        this.mNotificatonTopPadding = dimensionPixelSize;
        this.mHeaderHeight = this.mNotificationHeaderMargin + dimensionPixelSize;
        this.mCollapsedBottompadding = (float) resources.getDimensionPixelSize(17105345);
        ...
        this.mTranslationForHeader = resources.getDimensionPixelSize(17105345) - this.mNotificationHeaderMargin;
    ...
    public void addNotification(ExpandableNotificationRow expandableNotificationRow, int i) {
        ...
        if (expandableNotificationRow.isAttachedToWindow()) {
    ...
    public void recreateNotificationHeader(View.OnClickListener onClickListener, boolean z) {
        ...
        if (this.mNotificationHeader == null) {
            ...
            apply.findViewById(16908949).setVisibility(0);
    ...
    private View inflateDivider() {
        return LayoutInflater.from(((ViewGroup) this).mContext).inflate(C0011R$layout.notification_children_divider, (ViewGroup) this, false);
    }
        ...
        if (viewGroup != calculateDesiredHeader) {
            if (z) {
                if (calculateDesiredHeader == null || viewGroup == null) {
                    ...
                    wrapperForView2.transformTo(wrapperForView, new Runnable() { // from class: com.android.systemui.statusbar.notification.stack.-$$Lambda$NotificationChildrenContainer$yaCA55rJjaS5fwWl4gZlw69MJ2w
                        @Override // java.lang.Runnable
