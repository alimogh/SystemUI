...
public class ExpandableViewState extends ViewState {
    private static final int TAG_ANIMATOR_HEIGHT = C0008R$id.height_animator_tag;
    private static final int TAG_ANIMATOR_TOP_INSET = C0008R$id.top_inset_animator_tag;
    private static final int TAG_END_HEIGHT = C0008R$id.height_animator_end_value_tag;
    private static final int TAG_END_TOP_INSET = C0008R$id.top_inset_animator_end_value_tag;
    private static final int TAG_START_HEIGHT = C0008R$id.height_animator_start_value_tag;
    private static final int TAG_START_TOP_INSET = C0008R$id.top_inset_animator_start_value_tag;
    ...
    private void startInsetAnimation(final ExpandableView expandableView, AnimationProperties animationProperties) {
        ...
        if (num2 == null || num2.intValue() != i4) {
            ...
            if (animationProperties.getAnimationFilter().animateTopInset) {
                ...
                ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: com.android.systemui.statusbar.notification.stack.ExpandableViewState.3
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                    public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                ofInt.addListener(new AnimatorListenerAdapter(this) { // from class: com.android.systemui.statusbar.notification.stack.ExpandableViewState.4
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
