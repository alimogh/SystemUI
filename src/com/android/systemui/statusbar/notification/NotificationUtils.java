...
import com.oneplus.systemui.statusbar.notification.OpNotificationUtils;
public class NotificationUtils extends OpNotificationUtils {
    ...
    public static boolean isGrayscale(ImageView imageView, ContrastColorUtil contrastColorUtil) {
        return OpNotificationUtils.isGrayscaleInternal(imageView, contrastColorUtil);
    }
