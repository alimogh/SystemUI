...
public final class NotificationWakeUpCoordinator implements OnHeadsUpChangedListener, StatusBarStateController.StateListener, PanelExpansionListener {
    ...
    public NotificationWakeUpCoordinator(@NotNull HeadsUpManager headsUpManager, @NotNull StatusBarStateController statusBarStateController, @NotNull KeyguardBypassController keyguardBypassController, @NotNull DozeParameters dozeParameters) {
    ...
    public final void setStackScroller(@NotNull NotificationStackScrollLayout notificationStackScrollLayout) {
        ...
        notificationStackScrollLayout.setOnPulseHeightChangedListener(new Runnable(this) { // from class: com.android.systemui.statusbar.notification.NotificationWakeUpCoordinator$setStackScroller$1
            final /* synthetic */ NotificationWakeUpCoordinator this$0;
