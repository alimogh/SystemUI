...
public class HeadsUpViewBinder {
    ...
    public void bindHeadsUpView(NotificationEntry notificationEntry, NotifBindPipeline.BindCallback bindCallback) {
        ...
        CancellationSignal requestRebind = this.mStage.requestRebind(notificationEntry, new NotifBindPipeline.BindCallback(bindCallback) { // from class: com.android.systemui.statusbar.notification.interruption.-$$Lambda$HeadsUpViewBinder$6G6TWnHGbt5lFbnq41xlKU8ib20
