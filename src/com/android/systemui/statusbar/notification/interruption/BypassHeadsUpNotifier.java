...
public final class BypassHeadsUpNotifier implements StatusBarStateController.StateListener, NotificationMediaManager.MediaListener {
    ...
    public BypassHeadsUpNotifier(@NotNull Context context, @NotNull KeyguardBypassController keyguardBypassController, @NotNull StatusBarStateController statusBarStateController, @NotNull HeadsUpManagerPhone headsUpManagerPhone, @NotNull NotificationLockscreenUserManager notificationLockscreenUserManager, @NotNull NotificationMediaManager notificationMediaManager, @NotNull NotificationEntryManager notificationEntryManager, @NotNull TunerService tunerService) {
        ...
        tunerService.addTunable(new TunerService.Tunable(this) { // from class: com.android.systemui.statusbar.notification.interruption.BypassHeadsUpNotifier.1
