...
public class NotificationEntryManager implements CommonNotifCollection, Dumpable, OPWLBHelper.IWLBModeChangeListener, OpHighlightHintController.OnHighlightHintStateChangeListener, VisualStabilityManager.Callback {
    ...
    protected final HashMap<String, NotificationEntry> mCachedNotifications;
    ...
    public NotificationEntryManager(NotificationEntryManagerLogger notificationEntryManagerLogger, NotificationGroupManager notificationGroupManager, NotificationRankingManager notificationRankingManager, KeyguardEnvironment keyguardEnvironment, FeatureFlags featureFlags, Lazy<NotificationRowBinder> lazy, Lazy<NotificationRemoteInputManager> lazy2, LeakDetector leakDetector, ForegroundServiceDismissalFeatureController foregroundServiceDismissalFeatureController) {
        ...
        this.mCachedNotifications = new HashMap<>();
        this.mInflationCallback = new NotificationRowContentBinder.InflationCallback() { // from class: com.android.systemui.statusbar.notification.NotificationEntryManager.1
            ...
            public void onAsyncInflationFinished(NotificationEntry notificationEntry) {
                if (NotificationEntryManager.this.mCachedNotifications.containsKey(notificationEntry.getKey())) {
                    if (NotificationEntryManager.this.mCachedNotifications.get(notificationEntry.getKey()).hasJustLaunchedFullScreenIntent()) {
                        notificationEntry.notifyFullScreenIntentLaunched();
                        if (NotificationEntryManager.OP_DEBUG) {
                            Log.d("NotificationEntryMgr", "onAsyncInflationFinished, update lastFullScreenIntentLaunchTime from cached entry, key: " + notificationEntry.getKey());
                        }
                    }
                    NotificationEntryManager.this.mCachedNotifications.remove(notificationEntry.getKey());
                }
        ...
        this.mNotifListener = new NotificationListener.NotificationHandler() { // from class: com.android.systemui.statusbar.notification.NotificationEntryManager.2
        ...
        oPWLBHelper.registerChanges(this);
        addNotificationEntryListener(this.mOpwlbHelper.getNotificationEntryListener());
    ...
    public void addNotificationLifetimeExtender(NotificationLifetimeExtender notificationLifetimeExtender) {
        ...
        notificationLifetimeExtender.setCallback(new NotificationLifetimeExtender.NotificationSafeToRemoveCallback() { // from class: com.android.systemui.statusbar.notification.-$$Lambda$NotificationEntryManager$B9Rprc7VWCrqKYHxmFbKGPst6oI
    ...
    private void addNotificationInternal(StatusBarNotification statusBarNotification, NotificationListenerService.RankingMap rankingMap) throws InflationException {
        ...
        if (!this.mFeatureFlags.isNewNotifPipelineRenderingEnabled()) {
            this.mNotificationRowBinderLazy.get().inflateViews(notificationEntry, new Runnable(statusBarNotification) { // from class: com.android.systemui.statusbar.notification.-$$Lambda$NotificationEntryManager$lOGPG9l6kx5UZEzr26g7h2LQR6w
    ...
    private void updateNotificationInternal(StatusBarNotification statusBarNotification, NotificationListenerService.RankingMap rankingMap) throws InflationException {
        ...
        if (activeNotificationUnfiltered != null) {
            ...
            if (!this.mFeatureFlags.isNewNotifPipelineRenderingEnabled()) {
                this.mNotificationRowBinderLazy.get().inflateViews(activeNotificationUnfiltered, new Runnable(statusBarNotification) { // from class: com.android.systemui.statusbar.notification.-$$Lambda$NotificationEntryManager$RJEcTAo4cuGvAgvl2zrMgzSF4kM
                    public final /* synthetic */ StatusBarNotification f$1;
    ...
    @Override // com.oneplus.worklife.OPWLBHelper.IWLBModeChangeListener
    public void onModeChanged() {
        updateNotifications("updateNotificationInternal");
    }

    public ArrayList<NotificationEntry> getSortedAndFiltered() {
    ...
    public boolean isLocked(String str) {
        NotificationListenerService.Ranking ranking = new NotificationListenerService.Ranking();
        if (this.mRankingManager.getRankingMap() == null) {
            return false;
        }
        this.mRankingManager.getRankingMap().getRanking(str, ranking);
        return ranking.isLocked();
    }

    private void updateHighlightHint() {
        ...
        synchronized (this.mActiveNotifications) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                StatusBarNotification sbn = this.mActiveNotifications.valueAt(i2).getSbn();
        ...
        ((OpHighlightHintController) Dependency.get(OpHighlightHintController.class)).onNotificationUpdate(z, statusBarNotification, z2, statusBarNotification2);
    }
