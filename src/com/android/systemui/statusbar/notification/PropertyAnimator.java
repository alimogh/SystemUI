    ...
    public static <T extends View> void startAnimation(final T t, AnimatableProperty animatableProperty, float f, AnimationProperties animationProperties) {
        ...
        if (f3 == null || f3.floatValue() != f) {
            ...
            if (animationFilter != null && animationFilter.shouldAnimateProperty(property)) {
                ...
                ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(property, t) { // from class: com.android.systemui.statusbar.notification.-$$Lambda$PropertyAnimator$VEXcQp-kY9kIrKbFhOrW7gy9zN4
                    ...
                    public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                        PropertyAnimator.lambda$startAnimation$0(this.f$0, this.f$1, valueAnimator2);
                    }
                });
