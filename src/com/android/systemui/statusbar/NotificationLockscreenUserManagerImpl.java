...
public class NotificationLockscreenUserManagerImpl extends OpNotificationLockscreenUserManagerImpl implements Dumpable, NotificationLockscreenUserManager, StatusBarStateController.StateListener {
    ...
    public boolean shouldShowOnKeyguard(NotificationEntry notificationEntry) {
        ...
        } else if (notificationEntry.getBucket() != 6) {
            z = true;
        }
        return shouldShowOnKeyguardInternal(this.mEntryManager, notificationEntry.getSbn(), this.mShowLockscreenNotifications, z);
    }

    private boolean hideSilentNotificationsOnLockscreen() {
        return ((Boolean) DejankUtils.whitelistIpcs(new Supplier() { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationLockscreenUserManagerImpl$ghZezzviwGt8pgH-T3DEzpSavw8
    ...
    private void updateCurrentProfilesCache() {
        ...
        this.mMainHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationLockscreenUserManagerImpl$PLQsiLSkjaG6xwZdvFK_TGqwDWU
    ...
    public void updatePublicMode() {
        ...
        for (int size = currentProfiles.size() - 1; size >= 0; size--) {
            ...
            boolean booleanValue = ((Boolean) DejankUtils.whitelistIpcs(new Supplier(i) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationLockscreenUserManagerImpl$R0Mmt5x5H5RiJ7r74XavfJAbwsU
    ...
    @Override // com.oneplus.systemui.statusbar.OpNotificationLockscreenUserManagerImpl, com.android.systemui.Dumpable
