...
public class NotificationRemoteInputManager implements Dumpable {
    ...
    private final RemoteViews.OnClickHandler mOnClickHandler = new RemoteViews.OnClickHandler() { // from class: com.android.systemui.statusbar.NotificationRemoteInputManager.1
        public boolean onClickHandler(View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
            ...
            return NotificationRemoteInputManager.this.mCallback.handleRemoteViewClick(view, pendingIntent, new ClickHandler(remoteResponse, view, notificationForParent, pendingIntent) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationRemoteInputManager$1$ZtHhq33lnHmB3dDn_Na8muulDlc
        ...
        private void logActionClick(View view, NotificationEntry notificationEntry, PendingIntent pendingIntent) {
            Integer num = (Integer) view.getTag(16909221);
            if (num != null) {
                ...
                int indexOfChild = (view.getId() != 16908696 || parent == null || !(parent instanceof ViewGroup)) ? -1 : ((ViewGroup) parent).indexOfChild(view);
                int activeNotificationsCount = NotificationRemoteInputManager.this.mEntryManager.getActiveNotificationsCount();
                if (NotificationRemoteInputManager.this.mEntryManager.getActiveNotificationUnfiltered(key) == null) {
                    Log.w("NotifRemoteInputManager", "getActiveNotificationUnfiltered is null");
                    return;
                }
        ...
        private boolean handleRemoteInput(View view, PendingIntent pendingIntent) {
            ...
            Object tag = view.getTag(16909342);
        ...
        remoteInputController.addCallback(new RemoteInputController.Callback() { // from class: com.android.systemui.statusbar.NotificationRemoteInputManager.3
            ...
            public void onRemoteInputSent(NotificationEntry notificationEntry) {
                if (NotificationRemoteInputManager.FORCE_REMOTE_INPUT_HISTORY && NotificationRemoteInputManager.this.isNotificationKeptForRemoteInputHistory(notificationEntry.getKey())) {
                    ...
                    NotificationRemoteInputManager.this.mMainHandler.postDelayed(new Runnable(notificationEntry) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationRemoteInputManager$3$4_sgjm8NgJs8c5OYAKLP29ZAlfg
        ...
        while (true) {
            ...
            if (parent instanceof View) {
                ...
                if (view2.isRootNamespace()) {
                    ...
                    expandableNotificationRow = (ExpandableNotificationRow) view2.getTag(C0008R$id.row_tag_for_content_view);
                    break;
                }
            }
