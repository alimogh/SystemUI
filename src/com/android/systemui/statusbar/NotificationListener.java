...
public class NotificationListener extends NotificationListenerWithPlugins {
    ...
    public void onListenerConnected() {
        ...
        this.mMainHandler.post(new Runnable(activeNotifications, getCurrentRanking()) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationListener$IqvG8K3BFQSXJ_G1S_U_QONW3G4
    ...
    public void onNotificationPosted(StatusBarNotification statusBarNotification, NotificationListenerService.RankingMap rankingMap) {
        ...
        if (statusBarNotification != null && !onPluginNotificationPosted(statusBarNotification, rankingMap)) {
            this.mMainHandler.post(new Runnable(statusBarNotification, rankingMap) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationListener$NvFmU0XrVPuc5pizHcri9I0apkw
                public final /* synthetic */ StatusBarNotification f$1;
                public final /* synthetic */ NotificationListenerService.RankingMap f$2;
    ...
    public void onNotificationRemoved(StatusBarNotification statusBarNotification, NotificationListenerService.RankingMap rankingMap, int i) {
        ...
        if (statusBarNotification != null && !onPluginNotificationRemoved(statusBarNotification, rankingMap)) {
            this.mMainHandler.post(new Runnable(statusBarNotification, rankingMap, i) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationListener$WRx7hwu-hf4Oq9iR81FcmuDk9R0
                public final /* synthetic */ StatusBarNotification f$1;
                public final /* synthetic */ NotificationListenerService.RankingMap f$2;
    ...
    public void onNotificationRankingUpdate(NotificationListenerService.RankingMap rankingMap) {
        ...
        if (rankingMap != null) {
            this.mMainHandler.post(new Runnable(onPluginRankingUpdate(rankingMap)) { // from class: com.android.systemui.statusbar.-$$Lambda$NotificationListener$MPB4hTnfgfJz099PViVIkkbEBIE
    ...
    private static NotificationListenerService.Ranking getRankingOrTemporaryStandIn(NotificationListenerService.RankingMap rankingMap, String str) {
        ...
        ranking.populate(str, 0, false, 0, 0, 0, null, null, null, new ArrayList(), new ArrayList(), false, 0, false, 0, false, new ArrayList(), new ArrayList(), false, false, false, null, false, false);
        return ranking;
    }
}
