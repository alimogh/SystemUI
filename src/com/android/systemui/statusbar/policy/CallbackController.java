...
public interface CallbackController<T> {
    ...
    default T observe(Lifecycle lifecycle, T t) {
        lifecycle.addObserver(new LifecycleEventObserver(t) { // from class: com.android.systemui.statusbar.policy.-$$Lambda$CallbackController$TlIH8GpCbmJQdNzMgf9ko_xLlUk
