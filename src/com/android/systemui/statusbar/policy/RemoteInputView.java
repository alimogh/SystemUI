...
public class RemoteInputView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public void onFinishInflate() {
        ...
        this.mProgressBar = (ProgressBar) findViewById(C0008R$id.remote_input_progress);
        ImageButton imageButton = (ImageButton) findViewById(C0008R$id.remote_input_send);
        ...
        remoteEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: com.android.systemui.statusbar.policy.RemoteInputView.1
    ...
    public Intent prepareRemoteInputFromData(String str, Uri uri) {
        ...
        this.mEntry.remoteInputText = ((LinearLayout) this).mContext.getString(C0015R$string.remote_input_image_insertion_text);
        NotificationEntry notificationEntry = this.mEntry;
    ...
    public static RemoteInputView inflate(Context context, ViewGroup viewGroup, NotificationEntry notificationEntry, RemoteInputController remoteInputController) {
        RemoteInputView remoteInputView = (RemoteInputView) LayoutInflater.from(context).inflate(C0011R$layout.remote_input, viewGroup, false);
    ...
    public static class RemoteEditText extends EditText {
        ...
        public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
            ...
            InputConnection createWrapper = onCreateInputConnection == null ? null : InputConnectionCompat.createWrapper(onCreateInputConnection, editorInfo, new InputConnectionCompat.OnCommitContentListener() { // from class: com.android.systemui.statusbar.policy.RemoteInputView.RemoteEditText.1
