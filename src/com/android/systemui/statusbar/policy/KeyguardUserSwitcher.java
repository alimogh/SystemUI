...
public class KeyguardUserSwitcher {
    ...
    public KeyguardUserSwitcher(Context context, ViewStub viewStub, KeyguardStatusBarView keyguardStatusBarView, NotificationPanelViewController notificationPanelViewController) {
        boolean z = context.getResources().getBoolean(17891480);
    ...
    private void reinflateViews() {
        ...
        LayoutInflater.from(this.mUserSwitcherContainer.getContext()).inflate(C0011R$layout.keyguard_user_switcher_inner, this.mUserSwitcherContainer);
        ViewGroup viewGroup2 = (ViewGroup) this.mUserSwitcherContainer.findViewById(C0008R$id.keyguard_user_switcher_inner);
    ...
    private void startAppearAnimation() {
        ...
        this.mAppearAnimationUtils.startAnimation(viewArr, new Runnable() { // from class: com.android.systemui.statusbar.policy.KeyguardUserSwitcher.1
    ...
    private void startDisappearAnimation() {
        this.mAnimating = true;
        this.mUserSwitcher.animate().alpha(0.0f).setDuration(300).setInterpolator(Interpolators.ALPHA_OUT).withEndAction(new Runnable() { // from class: com.android.systemui.statusbar.policy.KeyguardUserSwitcher.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    public static class Adapter extends UserSwitcherController.BaseUserAdapter implements View.OnClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (!(view instanceof UserDetailItemView) || !(view.getTag() instanceof UserSwitcherController.UserRecord)) {
                view = LayoutInflater.from(this.mContext).inflate(C0011R$layout.keyguard_user_switcher_item, viewGroup, false);
            ...
            if (item.picture == null) {
                ...
                CircleFramedDrawable circleFramedDrawable = new CircleFramedDrawable(item.picture, (int) userDetailItemView.getResources().getDimension(C0005R$dimen.kg_framed_avatar_size));
        ...
        private static Drawable getDrawable(Context context, UserSwitcherController.UserRecord userRecord) {
            ...
            if (userRecord.isCurrent) {
                i = C0004R$color.kg_user_switcher_selected_avatar_icon_color;
            } else if (!userRecord.isSwitchToEnabled) {
                i = C0004R$color.GM2_grey_600;
            } else {
                i = C0004R$color.kg_user_switcher_avatar_icon_color;
            }
            iconDrawable.setTint(context.getResources().getColor(i, context.getTheme()));
            return userRecord.isCurrent ? new LayerDrawable(new Drawable[]{context.getDrawable(C0006R$drawable.bg_avatar_selected), iconDrawable}) : iconDrawable;
        }
