            ...
            if (handler != null) {
                ...
                if ("android.intent.action.TIME_TICK".equals(action) || "android.intent.action.TIME_SET".equals(action) || "android.intent.action.TIMEZONE_CHANGED".equals(action) || "android.intent.action.LOCALE_CHANGED".equals(action)) {
                    if ("android.intent.action.LOCALE_CHANGED".equals(action) || "android.intent.action.TIMEZONE_CHANGED".equals(action)) {
                        handler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.-$$Lambda$DateView$1$I-3qZI4QmwEIAfQqo2b2oUNiPII
                    ...
                    handler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.-$$Lambda$DateView$1$v1y3JoGtv68dyea2Bk7AdwrkpMI
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public DateView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            if (this.mDatePattern == null) {
                this.mDatePattern = getContext().getString(C0015R$string.system_ui_date_pattern);
            }
