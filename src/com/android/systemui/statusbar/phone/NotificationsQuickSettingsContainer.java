...
public class NotificationsQuickSettingsContainer extends FrameLayout implements ViewStub.OnInflateListener, FragmentHostManager.FragmentListener, AboveShelfObserver.HasViewAboveShelfChangedListener {
    ...
    private final Comparator<View> mIndexComparator = Comparator.comparingInt(new ToIntFunction() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$rYOLYKY9UUHboooVhy4ZToEslhI
    ...
    public void onFinishInflate() {
        ...
        this.mQsFrame = (FrameLayout) findViewById(C0008R$id.qs_frame);
        NotificationStackScrollLayout notificationStackScrollLayout = (NotificationStackScrollLayout) findViewById(C0008R$id.notification_stack_scroller);
        ...
        this.mKeyguardStatusBar = findViewById(C0008R$id.keyguard_header);
        ViewStub viewStub = (ViewStub) findViewById(C0008R$id.keyguard_user_switcher);
