...
public class RotationButtonController {
    ...
    private final IRotationWatcher.Stub mRotationWatcher = new IRotationWatcher.Stub() { // from class: com.android.systemui.statusbar.phone.RotationButtonController.1
        public void onRotationChanged(int i) throws RemoteException {
            RotationButtonController.this.mMainThreadHandler.postAtFrontOfQueue(new Runnable(i) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$RotationButtonController$1$wNXXdlqLeBk1NR5FrlGSJawDu0I
    ...
    public void setRotateSuggestionButtonState(boolean z, boolean z2) {
        ...
        if ((z || this.mRotationButton.isVisible()) && (currentView = this.mRotationButton.getCurrentView()) != null && (imageDrawable = this.mRotationButton.getImageDrawable()) != null) {
            ...
            if (animator3 == null || !animator3.isRunning()) {
                ...
                ofFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.phone.RotationButtonController.2
    ...
    public void onRotationProposal(int i, int i2, boolean z) {
        ...
        if (this.mRotationButton.acceptRotationProposal()) {
            if (!z) {
                ...
                if (i2 == 0 || i2 == 2) {
                    i3 = isRotationAnimationCCW ? C0016R$style.RotateButtonCCWStart90 : C0016R$style.RotateButtonCWStart90;
                } else {
                    i3 = isRotationAnimationCCW ? C0016R$style.RotateButtonCCWStart0 : C0016R$style.RotateButtonCWStart0;
                }
                this.mStyleRes = i3;
    ...
    public class TaskStackListenerImpl extends TaskStackChangeListener {
        ...
        public void onActivityRequestedOrientationChanged(int i, int i2) {
            Optional.ofNullable(ActivityManagerWrapper.getInstance()).map($$Lambda$Zm3Yj0EQnVWvu_ZksQOsrTwJ3k.INSTANCE).ifPresent(new Consumer(i) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$RotationButtonController$TaskStackListenerImpl$zCjhcFpUTQGdzdQEgIMUjTrjPZU
                public final /* synthetic */ int f$1;
