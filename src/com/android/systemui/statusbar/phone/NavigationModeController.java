...
public class NavigationModeController implements Dumpable {
    ...
    private final DeviceProvisionedController.DeviceProvisionedListener mDeviceProvisionedCallback = new DeviceProvisionedController.DeviceProvisionedListener() { // from class: com.android.systemui.statusbar.phone.NavigationModeController.1
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.android.systemui.statusbar.phone.NavigationModeController.2
    ...
    public void updateCurrentInteractionMode(boolean z) {
        ...
        this.mUiBgExecutor.execute(new Runnable(currentInteractionMode) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NavigationModeController$Az4iHIVUWwUXS_IGosEIyzFux8w
    ...
    private int getCurrentInteractionMode(Context context) {
        int integer = context.getResources().getInteger(17694861);
        String str = TAG;
