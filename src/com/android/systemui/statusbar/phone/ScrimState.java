...
public enum ScrimState {
    ...
    KEYGUARD {
        ...
        public void prepare(ScrimState scrimState) {
            ...
            this.mBehindAlpha = this.mScrimBehindAlphaKeyguard;
    ...
    BOUNCER_SCRIMMED_BOOT {
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
            this.mBehindAlpha = 0.0f;
            this.mBubbleAlpha = 0.0f;
            this.mFrontAlpha = this.mDefaultScrimAlpha;
            this.mAnimationDuration = 3500;
        }
    },
    BRIGHTNESS_MIRROR {
        @Override // com.android.systemui.statusbar.phone.ScrimState
    ...
    UNLOCKED {
        ...
        public void prepare(ScrimState scrimState) {
            ...
            this.mFrontAlpha = 0.0f;
            this.mBubbleAlpha = 0.0f;
            int mode = OpLsState.getInstance().getBiometricUnlockController().getMode();
            if ((mode == 5 || mode == 7) && OpUtils.isHomeApp()) {
                this.mAnimationDuration = 800;
            } else if (OpUtils.isRecentUnlockBiometricFace() || OpUtils.isRecentUnlockBiometricFinger()) {
                if (OpUtils.DEBUG_ONEPLUS) {
                    Log.i("ScrimState.UNLOCKED", "mAnimationDuration = 0, isRecentUnlockBiometricFace():" + OpUtils.isRecentUnlockBiometricFace() + ", isRecentUnlockBiometricFinger():" + OpUtils.isRecentUnlockBiometricFinger());
                }
