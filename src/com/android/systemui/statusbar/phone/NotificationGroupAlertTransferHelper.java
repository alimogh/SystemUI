...
public class NotificationGroupAlertTransferHelper implements OnHeadsUpChangedListener, StatusBarStateController.StateListener {
    ...
    private void alertNotificationWhenPossible(NotificationEntry notificationEntry, AlertingNotificationManager alertingNotificationManager) {
        ...
        if ((stageParams.getContentViews() & contentFlag) == 0) {
            ...
            this.mRowContentBindStage.requestRebind(notificationEntry, new NotifBindPipeline.BindCallback(notificationEntry, contentFlag) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationGroupAlertTransferHelper$eMYMUXNB2yOw4q9wL9gYe0M0Ark
                ...
                public final void onBindFinished(NotificationEntry notificationEntry2) {
                    NotificationGroupAlertTransferHelper.this.lambda$alertNotificationWhenPossible$0$NotificationGroupAlertTransferHelper(this.f$1, this.f$2, notificationEntry2);
                }
            });
