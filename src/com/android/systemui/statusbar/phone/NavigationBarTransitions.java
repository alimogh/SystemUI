...
public final class NavigationBarTransitions extends BarTransitions implements LightBarTransitionsController.DarkIntensityApplier {
    ...
    private final IWallpaperVisibilityListener mWallpaperVisibilityListener = new IWallpaperVisibilityListener.Stub() { // from class: com.android.systemui.statusbar.phone.NavigationBarTransitions.1
    ...
    public NavigationBarTransitions(NavigationBarView navigationBarView, CommandQueue commandQueue) {
        ...
        if (currentView != null) {
            this.mNavButtons = currentView.findViewById(C0008R$id.nav_buttons);
        }
    }
    ...
    public void applyDarkIntensity(float f) {
        if (this.mView != null) {
            ...
            Log.d("NavBarTransitions", "mView == null, " + f + ", " + this.mNavBarMode);
        }
    }
