...
public class RegionSamplingHelper implements View.OnAttachStateChangeListener, View.OnLayoutChangeListener {
    private boolean mByPassThreshold = false;
    ...
    public RegionSamplingHelper(View view, SamplingCallback samplingCallback) {
        this.mSamplingListener = new CompositionSamplingListener(view.getContext().getMainExecutor()) { // from class: com.android.systemui.statusbar.phone.RegionSamplingHelper.3
    ...
    private void updateMediaLuma(float f) {
        ...
        if (Math.abs(f - this.mLastMedianLuma) > this.mLuminanceChangeThreshold || ((this.mSampledView instanceof NavigationBarView) && this.mByPassThreshold && QuickStepContract.isGesturalMode(this.mOverviewProxyService.getNavBarMode()))) {
    ...
    public void setByPassThreshold(boolean z) {
        this.mByPassThreshold = z;
    }
