...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    public PhoneStatusBarTransitions(PhoneStatusBarView phoneStatusBarView, View view) {
        super(view, C0006R$drawable.status_background);
        this.mIconAlphaWhenOpaque = phoneStatusBarView.getContext().getResources().getFraction(C0005R$dimen.status_bar_icon_drawing_alpha, 1, 1);
        this.mLeftSide = phoneStatusBarView.findViewById(C0008R$id.status_bar_left_side);
        this.mStatusIcons = phoneStatusBarView.findViewById(C0008R$id.statusIcons);
        this.mBattery = phoneStatusBarView.findViewById(C0008R$id.battery);
