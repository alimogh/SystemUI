    ...
    public static class Slot {
        ...
        private void setSubSlot(StatusBarIconHolder statusBarIconHolder, int i) {
            if (this.mSubSlots == null) {
                ...
                if (statusBarIconHolder.getType() == 2) {
                    Collections.sort(this.mSubSlots, new Comparator<StatusBarIconHolder>(this) { // from class: com.android.systemui.statusbar.phone.StatusBarIconList.Slot.1
                        public int compare(StatusBarIconHolder statusBarIconHolder2, StatusBarIconHolder statusBarIconHolder3) {
                            StatusBarSignalPolicy.MobileIconState mobileState = statusBarIconHolder2.getMobileState();
                            StatusBarSignalPolicy.MobileIconState mobileState2 = statusBarIconHolder3.getMobileState();
                            if (mobileState == null || mobileState2 == null) {
                                return 0;
                            }
                            int i2 = mobileState.phoneId;
                            int i3 = mobileState2.phoneId;
                            return i2 == i3 ? mobileState2.subId - mobileState.subId : i3 - i2;
                        }
                    });
                }
            }
