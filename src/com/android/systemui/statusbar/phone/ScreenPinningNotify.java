...
public class ScreenPinningNotify {
    ...
    public void showPinningStartToast() {
        makeAllUserToastAndShow(C0015R$string.screen_pinning_start);
    }

    public void showPinningExitToast() {
        makeAllUserToastAndShow(C0015R$string.screen_pinning_exit);
    }
    ...
    public void showEscapeToast(boolean z, boolean z2) {
        ...
        if (z) {
            i = C0015R$string.screen_pinning_toast_gesture_nav;
        } else if (z2) {
            i = C0015R$string.screen_pinning_toast;
        } else {
            i = C0015R$string.screen_pinning_toast_recents_invisible;
        }
