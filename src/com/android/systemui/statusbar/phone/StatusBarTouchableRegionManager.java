...
public final class StatusBarTouchableRegionManager implements Dumpable {
    ...
    public StatusBarTouchableRegionManager(Context context, NotificationShadeWindowController notificationShadeWindowController, ConfigurationController configurationController, HeadsUpManagerPhone headsUpManagerPhone) {
        ...
        this.mHeadsUpManager.addHeadsUpPhoneListener(new HeadsUpManagerPhone.OnHeadsUpPhoneListenerChange() { // from class: com.android.systemui.statusbar.phone.StatusBarTouchableRegionManager.3
        ...
        notificationShadeWindowController.setForcePluginOpenListener(new NotificationShadeWindowController.ForcePluginOpenListener() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$StatusBarTouchableRegionManager$zqDZ6-Pei5QdrwLKWlTK2XAXySs
    ...
    public void setup(StatusBar statusBar, View view) {
        ...
        this.mNotificationPanelView = view.findViewById(C0008R$id.notification_panel);
    }
