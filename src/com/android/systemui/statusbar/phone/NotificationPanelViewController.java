...
import com.oneplus.systemui.statusbar.phone.OpPanelViewController;
...
public class NotificationPanelViewController extends OpPanelViewController {
    ...
    private final AnimatableProperty KEYGUARD_HEADS_UP_SHOWING_AMOUNT = AnimatableProperty.from("KEYGUARD_HEADS_UP_SHOWING_AMOUNT", new BiConsumer() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$OZSOwGan-FM_WhbUvj9snkcbnX8
    ...
    }, new Function() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$zLH5b8RJBtRSCf103Z1grf2LCf0
    ...
    }, C0008R$id.keyguard_hun_animator_tag, C0008R$id.keyguard_hun_animator_end_tag, C0008R$id.keyguard_hun_animator_start_tag);
    ...
    private Runnable mHeadsUpExistenceChangedRunnable = new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$rvgAK3TYgwqivfcZ2YHWM7JuvzA
    ...
    final KeyguardUpdateMonitorCallback mKeyguardUpdateCallback = new KeyguardUpdateMonitorCallback() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.1
        ...
        public void onDeviceProvisioned() {
            if (NotificationPanelViewController.this.mNotificationStackScroller == null) {
                Log.w(PanelViewController.TAG, "mNotificationStackScroller is null");
                return;
            }
            String str = PanelViewController.TAG;
            Log.d(str, "onDeviceProvisioned to setScrolling: " + NotificationPanelViewController.this.mBarState + ", " + NotificationPanelViewController.this.mQsExpanded + "," + NotificationPanelViewController.this.mQsExpansionFromOverscroll);
            ...
            boolean z = true;
            if (NotificationPanelViewController.this.mBarState == 1 || (NotificationPanelViewController.this.mQsExpanded && !NotificationPanelViewController.this.mQsExpansionFromOverscroll)) {
                z = false;
            }
    ...
    private final AnimatableProperty mPanelAlphaAnimator = AnimatableProperty.from("panelAlpha", $$Lambda$aKsp0zdf_wKFZXD1TonJ2cFEsN4.INSTANCE, $$Lambda$SmdYpsZqQm1fpR9OgK3SiEL3pJQ.INSTANCE, C0008R$id.panel_alpha_animator_tag, C0008R$id.panel_alpha_animator_start_tag, C0008R$id.panel_alpha_animator_end_tag);
    ...
    private boolean mShowWLBBreakModeView;
    ...
    protected final Runnable mUpdateCameraStateTimeout;
    ...
    public NotificationPanelViewController(NotificationPanelView notificationPanelView, InjectionInflationController injectionInflationController, NotificationWakeUpCoordinator notificationWakeUpCoordinator, PulseExpansionHandler pulseExpansionHandler, DynamicPrivacyController dynamicPrivacyController, KeyguardBypassController keyguardBypassController, FalsingManager falsingManager, ShadeController shadeController, NotificationLockscreenUserManager notificationLockscreenUserManager, NotificationEntryManager notificationEntryManager, KeyguardStateController keyguardStateController, StatusBarStateController statusBarStateController, DozeLog dozeLog, DozeParameters dozeParameters, CommandQueue commandQueue, VibratorHelper vibratorHelper, LatencyTracker latencyTracker, PowerManager powerManager, AccessibilityManager accessibilityManager, int i, KeyguardUpdateMonitor keyguardUpdateMonitor, MetricsLogger metricsLogger, ActivityManager activityManager, ZenModeController zenModeController, ConfigurationController configurationController, FlingAnimationUtils.Builder builder, StatusBarTouchableRegionManager statusBarTouchableRegionManager, ConversationNotificationManager conversationNotificationManager, MediaHierarchyManager mediaHierarchyManager, BiometricUnlockController biometricUnlockController, StatusBarKeyguardViewManager statusBarKeyguardViewManager) {
        ...
        animationProperties2.setAnimationEndAction(new Consumer() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$HnNg1uN3kkP2Byw0u02uaOtm-nk
        ...
        this.mAnimateKeyguardStatusViewInvisibleEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.7
            @Override // java.lang.Runnable
            public void run() {
        ...
        this.mAnimateKeyguardStatusViewGoneEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.8
            @Override // java.lang.Runnable
            public void run() {
                NotificationPanelViewController.this.mKeyguardStatusViewAnimating = false;
        ...
        this.mAnimateKeyguardStatusViewVisibleEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.9
            @Override // java.lang.Runnable
            public void run() {
                NotificationPanelViewController.this.mKeyguardStatusViewAnimating = false;
            }
        };
        this.mAnimateKeyguardStatusBarInvisibleEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.10
            @Override // java.lang.Runnable
            public void run() {
        ...
        this.mStatusBarAnimateAlphaListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.12
        ...
        this.mAnimateKeyguardBottomAreaInvisibleEndRunnable = new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.13
            @Override // java.lang.Runnable
            public void run() {
                NotificationPanelViewController.this.mKeyguardBottomArea.setVisibility(8);
            }
        };
        this.mFragmentListener = new FragmentHostManager.FragmentListener() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.17
            ...
            public void onFragmentViewCreated(String str, Fragment fragment) {
                ...
                NotificationPanelViewController.this.mQs.getView().addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$17$vXp76OtjFLWoF0EsmRr5jIrfuLM
                    @Override // android.view.View.OnLayoutChangeListener
                    public final void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                        NotificationPanelViewController.AnonymousClass17.this.lambda$onFragmentViewCreated$0$NotificationPanelViewController$17(view, i2, i3, i4, i5, i6, i7, i8, i9);
                    }
                });
            ...
            public /* synthetic */ void lambda$onFragmentViewCreated$0$NotificationPanelViewController$17(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                if (i5 - i3 != i9 - i7) {
        ...
        this.mUpdateCameraStateTimeout = new Runnable(this) { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.19
            @Override // java.lang.Runnable
            public void run() {
                Log.d(PanelViewController.TAG, "update camera state timeout");
                ((KeyguardUpdateMonitor) Dependency.get(KeyguardUpdateMonitor.class)).updateLaunchingCameraState(false);
            }
        };
        ...
        pulseExpansionHandler.setPulseExpandAbortListener(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$iN7P4plRLlpAkFmRApdB8IRWjNM
            @Override // java.lang.Runnable
            public final void run() {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$LinMYB2Oj2N48himJfZkXl5Ac08
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
    ...
    private void onFinishInflate() {
        if (OpUtils.DEBUG_ONEPLUS) {
            String str = PanelViewController.TAG;
            Log.d(str, "onFinishInflate:, getCallers= " + Debug.getCallers(7));
        }
        this.mView.setNotificationPanelViewController(this);
        this.mHandler = new Handler();
        loadDimens();
        this.mKeyguardStatusBar = (KeyguardStatusBarView) this.mView.findViewById(C0008R$id.keyguard_header);
        KeyguardStatusView keyguardStatusView = (KeyguardStatusView) this.mView.findViewById(C0008R$id.keyguard_status_view);
        this.mKeyguardStatusView = keyguardStatusView;
        keyguardStatusView.setTag("keyguardStatusView");
        ViewGroup viewGroup = (ViewGroup) this.mView.findViewById(C0008R$id.big_clock_container);
        this.mBigClockContainer = viewGroup;
        ((KeyguardClockSwitch) this.mView.findViewById(C0008R$id.keyguard_clock_container)).setBigClockContainer(viewGroup);
        this.mNotificationContainerParent = (NotificationsQuickSettingsContainer) this.mView.findViewById(C0008R$id.notification_container_parent);
        NotificationStackScrollLayout notificationStackScrollLayout = (NotificationStackScrollLayout) this.mView.findViewById(C0008R$id.notification_stack_scroller);
        ...
        this.mKeyguardBottomArea = (KeyguardBottomAreaView) this.mView.findViewById(C0008R$id.keyguard_bottom_area);
        ...
        this.mQsFrame = (FrameLayout) this.mView.findViewById(C0008R$id.qs_frame);
        this.mPulseExpansionHandler.setUp(this.mNotificationStackScroller, this.mExpansionCallback, this.mShadeController);
        this.mWakeUpCoordinator.addListener(new NotificationWakeUpCoordinator.WakeUpListener() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.4
        ...
        this.mView.setRtlChangeListener(new NotificationPanelView.RtlChangeListener() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$UjVwGXo83aLB3W0dUJndREhKfQk
    ...
    @Override // com.oneplus.systemui.statusbar.phone.OpPanelViewController, com.android.systemui.statusbar.phone.PanelViewController
    public void loadDimens() {
        ...
        this.mStatusBarMinHeight = this.mResources.getDimensionPixelSize(17105481);
        this.mQsPeekHeight = this.mResources.getDimensionPixelSize(C0005R$dimen.qs_peek_height);
        this.mNotificationsHeaderCollideDistance = this.mResources.getDimensionPixelSize(C0005R$dimen.header_notifications_collide_distance);
        this.mClockPositionAlgorithm.loadDimens(this.mResources);
        this.mQsFalsingThreshold = this.mResources.getDimensionPixelSize(C0005R$dimen.qs_falsing_threshold);
        this.mPositionMinSideMargin = this.mResources.getDimensionPixelSize(C0005R$dimen.op_notification_panel_min_side_margin);
        this.mIndicationBottomPadding = this.mResources.getDimensionPixelSize(C0005R$dimen.keyguard_indication_bottom_padding);
        this.mQsNotificationTopPadding = this.mResources.getDimensionPixelSize(C0005R$dimen.qs_notification_padding);
        this.mShelfHeight = this.mResources.getDimensionPixelSize(C0005R$dimen.notification_shelf_height);
        this.mDarkIconSize = this.mResources.getDimensionPixelSize(C0005R$dimen.status_bar_icon_drawing_size_dark);
        this.mHeadsUpInset = this.mResources.getDimensionPixelSize(17105481) + this.mResources.getDimensionPixelSize(C0005R$dimen.heads_up_status_bar_padding);
    }
    ...
    private void setStatusBar(StatusBar statusBar) {
        ...
        if (notificationPanelView != null) {
            notificationPanelView.setStatuBar(this.mStatusBar);
            this.mView.initOpBottomArea();
            this.mView.updateOpLockIcon();
        }
    }
    ...
    public void updateResources() {
        int dimensionPixelSize = this.mResources.getDimensionPixelSize(C0005R$dimen.qs_panel_width);
        int integer = this.mResources.getInteger(C0009R$integer.notification_panel_layout_gravity);
        ...
        int dimensionPixelSize2 = this.mResources.getDimensionPixelSize(C0005R$dimen.notification_panel_width);
    ...
    private void reInflateViews() {
        ...
        updateShowWLBBreakModeView();
        int indexOfChild = this.mView.indexOfChild(this.mKeyguardStatusView);
        this.mView.removeView(this.mKeyguardStatusView);
        KeyguardStatusView keyguardStatusView = (KeyguardStatusView) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mView.getContext())).inflate(C0011R$layout.keyguard_status_view, (ViewGroup) this.mView, false);
        this.mKeyguardStatusView = keyguardStatusView;
        keyguardStatusView.setTag("keyguardStatusView");
        this.mView.addView(this.mKeyguardStatusView, indexOfChild);
        this.mBigClockContainer.removeAllViews();
        ((KeyguardClockSwitch) this.mView.findViewById(C0008R$id.keyguard_clock_container)).setBigClockContainer(this.mBigClockContainer);
        ...
        KeyguardBottomAreaView keyguardBottomAreaView2 = (KeyguardBottomAreaView) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mView.getContext())).inflate(C0011R$layout.keyguard_bottom_area, (ViewGroup) this.mView, false);
        ...
        initBottomArea();
        this.mKeyguardIndicationController.setKeyguardBottomArea(this.mKeyguardBottomArea);
    ...
    private void initBottomArea() {
        ...
        this.mView.setStatuBar(this.mStatusBar);
        this.mView.initOpBottomArea();
        this.mView.updateOpLockIcon();
    }
    ...
    private void startQsSizeChangeAnimation(int i, int i2) {
        ...
        this.mQsSizeChangeAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.5
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
        ...
        this.mQsSizeChangeAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.6
    ...
    private void positionClockAndNotifications() {
        ...
        if (this.mBarState != 1) {
            ...
            int height2 = (int) (((float) this.mKeyguardStatusView.getHeight()) - (((float) this.mDarkIconSize) / 2.0f));
            ViewGroup viewGroup = (ViewGroup) this.mKeyguardStatusView.findViewById(C0008R$id.status_view_container);
            if (viewGroup != null) {
                height2 = viewGroup.getMeasuredHeight() + getStatusViewContainerWithPanelViewPadding(this.mResources);
            }
            if (OpUtils.DEBUG_ONEPLUS) {
                Log.i(PanelViewController.TAG, "positionClockAndNotifications, keyguardStatusViewInnerHeight:" + height2 + ", getStatusViewContainerWithPanelViewPadding:" + getStatusViewContainerWithPanelViewPadding(this.mResources));
            }
            this.mClockPositionAlgorithm.setup(this.mStatusBarMinHeight, height - max, this.mNotificationStackScroller.getIntrinsicContentHeight(), getExpandedFraction(), height, height2, clockPreferredY, hasCustomClock(), z2, this.mInterpolatedDarkAmount, this.mEmptyDragAmount, bypassEnabled, getUnlockedStackScrollerPadding());
    ...
    public int computeMaxKeyguardNotifications(int i) {
        return opComputeMaxKeyguardNotifications(i);
    }

    public int opComputeMaxKeyguardNotifications(int i) {
        float f;
        String str = PanelViewController.TAG;
        this.mClockPositionAlgorithm.getMinStackScrollerPadding();
        int max = Math.max(1, this.mResources.getDimensionPixelSize(C0005R$dimen.notification_divider_height));
        ...
        ViewGroup viewGroup = (ViewGroup) this.mKeyguardStatusView.findViewById(C0008R$id.status_view_container);
        if (viewGroup == null) {
            Log.i(str, "opComputeMaxKeyguardNotifications, containerView == null");
            viewGroup = this.mKeyguardStatusView;
        }
        int opGetMaxClockY = this.mClockPositionAlgorithm.opGetMaxClockY();
        int[] locationOnScreen = this.mKeyguardBottomArea.getIndicationArea().getLocationOnScreen();
        float height = (float) (locationOnScreen[1] - ((viewGroup.getHeight() + opGetMaxClockY) + getStatusViewContainerWithPanelViewPadding(this.mResources)));
        ExpandableView expandableView = null;
        int wLBCurrentMode = this.mNotificationStackScroller.getWLBCurrentMode();
        int i2 = wLBCurrentMode == 0 ? 0 : 1;
        if (OpUtils.DEBUG_ONEPLUS) {
            Log.i(str, "opComputeMaxKeyguardNotifications, availableSpace:" + height + ", keyguardIndicationArea_loc[1]:" + locationOnScreen[1] + ", keyguardStatusViewInner_loc:" + opGetMaxClockY + ", containerView.getHeight():" + viewGroup.getHeight() + ", getStatusViewContainerWithPanelViewPadding:" + getStatusViewContainerWithPanelViewPadding(this.mResources) + ", shelfSize:" + f + ", maximum:" + i + ", wlbMode:" + wLBCurrentMode + ", count:" + i2);
        }
    ...
    public void resetViews(boolean z) {
        ...
        boolean isKeyguardFadingAway = this.mKeyguardStateController.isKeyguardFadingAway();
    ...
    private boolean handleQsTouch(MotionEvent motionEvent) {
        ...
        if (Build.DEBUG_ONEPLUS && actionMasked == 0) {
            Log.d(PanelViewController.TAG, "return QS touch");
        }
        return false;
    }
    ...
    private void animateKeyguardStatusBarOut() {
        ...
        ofFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.11
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
    ...
    private void setQsExpansion(float f) {
        ...
        if (this.mQs instanceof QSFragment) {
            if (OpUtils.DEBUG_ONEPLUS) {
                String str = PanelViewController.TAG;
                Log.d(str, "setQsExpansion: height= " + f + ", mQsMinExpansionHeight= " + this.mQsMinExpansionHeight + ", mQsMaxExpansionHeight= " + this.mQsMaxExpansionHeight + ", result= " + this.mQsExpansionHeight + ", mBarState= " + this.mBarState + ", mKeyguardShowing= " + this.mKeyguardShowing + ", getCallers= " + Debug.getCallers(10));
            }
            ((QSFragment) this.mQs).setExpansionHight(this.mQsExpansionHeight);
        }
        updateQsExpansion();
    ...
    private String determineAccessibilityPaneTitle() {
        ...
        if (qs != null && qs.isCustomizing()) {
            return this.mResources.getString(C0015R$string.accessibility_desc_quick_settings_edit);
        }
        if (this.mQsExpansionHeight != 0.0f && this.mQsFullyExpanded) {
            return this.mResources.getString(C0015R$string.accessibility_desc_quick_settings);
        }
        if (this.mBarState == 1) {
            return this.mResources.getString(C0015R$string.accessibility_desc_lock_screen);
        }
        return this.mResources.getString(C0015R$string.accessibility_desc_notification_shade);
    }

    private float calculateQsTopPadding() {
        if (OpUtils.DEBUG_ONEPLUS && !this.mKeyguardShowing) {
            String str = PanelViewController.TAG;
            Log.d(str, "calculateQsTopPadding: mIsExpanding = " + this.mIsExpanding + ", mQsExpandedWhenExpandingStarted = " + this.mQsExpandedWhenExpandingStarted + ", mQsMaxExpansionHeight = " + this.mQsMaxExpansionHeight + ", mExpandedHeight = " + this.mExpandedHeight + ", mQsExpansionHeight = " + this.mQsExpansionHeight + ", mQsNotificationTopPadding = " + this.mQsNotificationTopPadding);
        }
    ...
    private void updateNotificationTranslucency() {
        ...
        if (OpUtils.DEBUG_ONEPLUS) {
            String str = PanelViewController.TAG;
            Log.d(str, "updateNotificationTranslucency: mClosingWithAlphaFadeOut: " + this.mClosingWithAlphaFadeOut + ", mExpandingFromHeadsUp = " + this.mExpandingFromHeadsUp + ", mHeadsUpManager.hasPinnedHeadsUp() = " + this.mHeadsUpManager.hasPinnedHeadsUp() + ", barState = " + this.mBarState + ", mHintAnimationRunning = " + this.mHintAnimationRunning + ", alpha = " + fadeoutAlpha);
        }
    ...
    public void onExpandingFinished() {
        ...
        if (isFullyCollapsed()) {
            ...
            DejankUtils.postAfterTraversal(new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.15
                @Override // java.lang.Runnable
                public void run() {
                    NotificationPanelViewController.this.setListening(false);
                }
            });
            this.mView.postOnAnimation(new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.16
                @Override // java.lang.Runnable
                public void run() {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateShowWLBBreakModeView() {
        boolean z = true;
        if (this.mBarState != 1) {
            z = false;
        }
        showWLBBreakModeView(z);
    }

    public void showWLBBreakModeView(boolean z) {
        this.mShowWLBBreakModeView = z;
        updateWLBBreakModeView();
    }

    private void updateWLBBreakModeView() {
        this.mNotificationStackScroller.updateWLBBreakModeView(this.mShowWLBBreakModeView);
    }
    ...
    public void updateVerticalPanelPosition(float f) {
        String str = PanelViewController.TAG;
        Log.d(str, "updateVerticalPanelPosition mLastOrientation =" + this.mLastOrientation);
        ...
        Log.d(str, "updateVerticalPanelPosition: x=" + f + ", leftMost=" + width + ", rightMost=" + width2 + ", getWidth=" + this.mView.getWidth() + ", NSSWidth=" + this.mNotificationStackScroller.getWidth() + ", sideMargin=" + this.mPositionMinSideMargin);
    ...
    public void launchCamera(boolean z, int i) {
        ...
        this.mKeyguardBottomArea.getRightPreview();
        ...
        this.mNotificationStackScroller.hideMediaControlIfNeeded();
    }

    public void onAffordanceLaunchEnded() {
        setLaunchingAffordance(false);
        ((KeyguardUpdateMonitor) Dependency.get(KeyguardUpdateMonitor.class)).updateLaunchingLeftAffordance(false);
    }
    ...
    public boolean canCameraGestureBeLaunched(boolean z) {
        ...
        boolean isDreaming = ((KeyguardUpdateMonitor) Dependency.get(KeyguardUpdateMonitor.class)).isDreaming();
        String str2 = PanelViewController.TAG;
        Log.d(str2, "canCameraGestureBeLaunched: packageToLaunch= " + str + ", keyguardIsShowing= " + z + ", isForegroundApp= " + isForegroundApp(str) + ", isSwipingInProgress= " + this.mAffordanceHelper.isSwipingInProgress() + ", isDream= " + isDreaming);
        if (str == null) {
            return false;
        }
        if ((z || !isForegroundApp(str) || isDreaming) && !this.mAffordanceHelper.isSwipingInProgress()) {
            return true;
        }
        return false;
    }
    ...
    public void setUnlockAlpha(float f) {
        ...
        if (biometricUnlockController.shouldApplySpeedUpPolicy()) {
            if (!z && !this.mKeyguardShowing) {
                getKeyguardStatusView().setVisibility(4);
            }
    ...
    public PanelViewController.TouchHandler createTouchHandler() {
        return new PanelViewController.TouchHandler() { // from class: com.android.systemui.statusbar.phone.NotificationPanelViewController.18
            @Override // com.android.systemui.statusbar.phone.PanelViewController.TouchHandler
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                boolean z = true;
                if (NotificationPanelViewController.this.mBlockTouches || (NotificationPanelViewController.this.mQsFullyExpanded && NotificationPanelViewController.this.mQs.disallowPanelTouches())) {
                    String str = PanelViewController.TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("Skip onInterceptTouchEvent by ");
                    sb.append(NotificationPanelViewController.this.mBlockTouches);
                    sb.append(", ");
                    sb.append(NotificationPanelViewController.this.mQsFullyExpanded);
                    sb.append(", ");
                    if (NotificationPanelViewController.this.mQs == null || !NotificationPanelViewController.this.mQs.disallowPanelTouches()) {
                        z = false;
                    }
                    sb.append(z);
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                StatusBar statusBar;
                boolean z = true;
                if (NotificationPanelViewController.this.mBlockTouches || (NotificationPanelViewController.this.mQsFullyExpanded && NotificationPanelViewController.this.mQs != null && NotificationPanelViewController.this.mQs.disallowPanelTouches())) {
                    String str = PanelViewController.TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("Skip onTouchEvent by ");
                    sb.append(NotificationPanelViewController.this.mBlockTouches);
                    sb.append(", ");
                    sb.append(NotificationPanelViewController.this.mQsFullyExpanded);
                    sb.append(", ");
                    ...
                    Log.d(str, sb.toString());
                    return false;
                } else if (NotificationPanelViewController.this.mOpNotificationController.isPanelDisabledInBrickMode()) {
                    return false;
                } else {
                    if (NotificationPanelViewController.this.mStatusBar.isBouncerShowingScrimmed()) {
                        Log.d(PanelViewController.TAG, "Skip onTouchEvent BouncerShowingScrimmed");
                        return false;
                    }
                    NotificationPanelViewController notificationPanelViewController = NotificationPanelViewController.this;
                    StatusBar statusBar2 = notificationPanelViewController.mStatusBar;
                    if (statusBar2 == null || notificationPanelViewController.mHeadsUpManager == null || !statusBar2.isQsDisabled() || !NotificationPanelViewController.this.mHeadsUpManager.hasPinnedHeadsUp() || !NotificationPanelViewController.this.mStatusBar.isKeyguardShowing() || !NotificationPanelViewController.this.mStatusBar.isOccluded()) {
                        ...
                        if (!NotificationPanelViewController.this.mIsExpanding) {
                            ...
                            if (!notificationPanelViewController2.shouldQuickSettingsIntercept(notificationPanelViewController2.mDownX, NotificationPanelViewController.this.mDownY, 0.0f) && !NotificationPanelViewController.this.mStatusBar.isBouncerShowing() && NotificationPanelViewController.this.mPulseExpansionHandler.onTouchEvent(motionEvent)) {
                                if (Build.DEBUG_ONEPLUS) {
                                    Log.d(PanelViewController.TAG, "expanding");
                                }
                                return true;
                            }
                        }
                        ...
                        boolean onTouchEvent = ((!NotificationPanelViewController.this.mIsExpanding || NotificationPanelViewController.this.mHintAnimationRunning) && !NotificationPanelViewController.this.mQsExpanded && NotificationPanelViewController.this.mBarState != 0 && !NotificationPanelViewController.this.mDozing && (motionEvent.getAction() != 0 || (statusBar = NotificationPanelViewController.this.mStatusBar) == null || !statusBar.isBouncerShowing())) ? NotificationPanelViewController.this.mAffordanceHelper.onTouchEvent(motionEvent) | false : false;
                        ...
                        if (Build.DEBUG_ONEPLUS) {
                            Log.d(PanelViewController.TAG, "handleQsTouch");
                        }
                        return true;
                    }
                    if (Build.DEBUG_ONEPLUS && motionEvent.getActionMasked() == 0) {
                        Log.d(PanelViewController.TAG, "return QS HeadsUp touch");
                    }
                    return false;
                }
            }
    ...
    public class OnOverscrollTopChangedListener implements NotificationStackScrollLayout.OnOverscrollTopChangedListener {
        ...
        public void flingTopOverscroll(float f, boolean z) {
            ...
            notificationPanelViewController2.flingSettings(f, (!z || !NotificationPanelViewController.this.mQsExpansionEnabled) ? 1 : 0, new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$OnOverscrollTopChangedListener$6FaWnl4RjuYk8pBm1fvFXqN0qu8
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public class KeyguardAffordanceHelperCallback implements KeyguardAffordanceHelper.Callback {
        ...
        public void onAnimationToSideStarted(boolean z, float f, float f2) {
            ...
            if (z) {
                ...
                if (NotificationPanelViewController.this.mKeyguardBottomArea.isLeftVoiceAssist()) {
                    keyguardUpdateMonitor.updateLaunchingLeftAffordance(true);
                }
                if (NotificationPanelViewController.this.mFalsingManager.shouldEnforceBouncer()) {
                    NotificationPanelViewController.this.mStatusBar.executeRunnableDismissingKeyguard(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$KeyguardAffordanceHelperCallback$bICF6GSeDLbT7pBsxqsaY2Sd-4Y
                        @Override // java.lang.Runnable
                        public final void run() {
                            NotificationPanelViewController.KeyguardAffordanceHelperCallback.this.lambda$onAnimationToSideStarted$0$NotificationPanelViewController$KeyguardAffordanceHelperCallback();
                        }
                ...
                if ("lockscreen_affordance".equals(NotificationPanelViewController.this.mLastCameraLaunchSource)) {
                    ((OpPanelViewController) NotificationPanelViewController.this).mHandler.removeCallbacks(NotificationPanelViewController.this.mUpdateCameraStateTimeout);
                    keyguardUpdateMonitor.updateLaunchingCameraState(true);
                    ((OpPanelViewController) NotificationPanelViewController.this).mHandler.postDelayed(NotificationPanelViewController.this.mUpdateCameraStateTimeout, 2000);
                ...
                if (NotificationPanelViewController.this.mFalsingManager.shouldEnforceBouncer()) {
                    NotificationPanelViewController.this.mStatusBar.executeRunnableDismissingKeyguard(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$KeyguardAffordanceHelperCallback$R1jytGxMXTpJHS829GYzcUGilW8
                        @Override // java.lang.Runnable
                        public final void run() {
                            NotificationPanelViewController.KeyguardAffordanceHelperCallback.this.lambda$onAnimationToSideStarted$1$NotificationPanelViewController$KeyguardAffordanceHelperCallback();
                        }
                    }, null, true, false, true);
                } else {
                    NotificationPanelViewController notificationPanelViewController = NotificationPanelViewController.this;
            ...
            if (!NotificationPanelViewController.this.mStatusBar.isOccluded()) {
                NotificationPanelViewController.this.mStatusBar.startLaunchTransitionTimeout();
            } else {
                Log.w(PanelViewController.TAG, "do not start launch transition timeout");
            }
        ...
        public /* synthetic */ void lambda$onAnimationToSideStarted$0$NotificationPanelViewController$KeyguardAffordanceHelperCallback() {
            NotificationPanelViewController.this.mKeyguardBottomArea.launchLeftAffordance();
        }

        /* access modifiers changed from: private */
        /* renamed from: lambda$onAnimationToSideStarted$1 */
        public /* synthetic */ void lambda$onAnimationToSideStarted$1$NotificationPanelViewController$KeyguardAffordanceHelperCallback() {
            NotificationPanelViewController notificationPanelViewController = NotificationPanelViewController.this;
            notificationPanelViewController.mKeyguardBottomArea.launchCamera(notificationPanelViewController.mLastCameraLaunchSource);
        }
        ...
        public void onAnimationToSideEnded() {
            ...
            String str = PanelViewController.TAG;
            Log.w(str, "onAnimationToSideEnded isPanelExpanded:" + NotificationPanelViewController.this.mStatusBar.isPanelExpanded() + " isOccluded" + NotificationPanelViewController.this.mStatusBar.isOccluded());
            if (!NotificationPanelViewController.this.mStatusBar.isPanelExpanded() && NotificationPanelViewController.this.mStatusBar.isOccluded()) {
                NotificationPanelViewController.this.mBlockTouches = false;
            }
        }
        ...
        public void onIconClicked(boolean z) {
            ...
            if (!notificationPanelViewController.mHintAnimationRunning) {
                ...
                notificationPanelViewController.mAffordanceHelper.startHintAnimation(z, new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NotificationPanelViewController$KeyguardAffordanceHelperCallback$sp6x_JxGl2c39DMqfoi0x_FWE1U
                    @Override // java.lang.Runnable
                    public final void run() {
                        NotificationPanelViewController.KeyguardAffordanceHelperCallback.this.lambda$onIconClicked$2$NotificationPanelViewController$KeyguardAffordanceHelperCallback();
                    }
                });
                if (NotificationPanelViewController.this.mView.getLayoutDirection() == 1) {
                    z = !z;
        ...
        public /* synthetic */ void lambda$onIconClicked$2$NotificationPanelViewController$KeyguardAffordanceHelperCallback() {
            NotificationPanelViewController notificationPanelViewController = NotificationPanelViewController.this;
    ...
    public class ZenModeControllerCallback implements ZenModeController.Callback {
        ...
        public void onZenChanged(int i) {
            ...
            NotificationPanelViewController.this.updateShowWLBBreakModeView();
        }
    }
    ...
    public class StatusBarStateListener implements StatusBarStateController.StateListener {
        ...
        public void onStateChanged(int i) {
            ...
            if (z) {
                NotificationPanelViewController.this.mQsMinExpansionHeight = 0;
            }
            ...
            if (NotificationPanelViewController.this.mNotificationStackScroller != null) {
                NotificationPanelViewController.this.mNotificationStackScroller.setBarState(i);
            }
            NotificationPanelViewController.this.updateQSPulseExpansion();
    ...
    public class OnLayoutChangeListener extends PanelViewController.OnLayoutChangeListener {
        ...
        public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
            ...
            if (NotificationPanelViewController.this.mQs != null) {
                float f = (float) NotificationPanelViewController.this.mQsMinExpansionHeight;
                NotificationPanelViewController notificationPanelViewController2 = NotificationPanelViewController.this;
                ...
                if (NotificationPanelViewController.this.mQsExpansionHeight == f) {
                    ...
                    notificationPanelViewController3.mQsExpansionHeight = (float) notificationPanelViewController3.mQsMinExpansionHeight;
                }
    ...
    private class OnConfigurationChangedListener extends PanelViewController.OnConfigurationChangedListener {
        ...
        public void onConfigurationChanged(Configuration configuration) {
            ...
            String str = PanelViewController.TAG;
            Log.d(str, " OnConfigurationChangedListener orientation=" + configuration.orientation + " mLastOrientation=" + NotificationPanelViewController.this.mLastOrientation);
    ...
    public void updateLaunchingCameraState(boolean z, int i) {
        ...
        sb.append(", ");
        sb.append(this.mStatusBar.getFacelockController() != null ? Boolean.valueOf(this.mStatusBar.getFacelockController().isFacelockRunning()) : "null");
        sb.append(", ");
        ...
        boolean z2 = true;
        ((KeyguardUpdateMonitor) Dependency.get(KeyguardUpdateMonitor.class)).updateLaunchingCameraState(true);
        ...
        statusBar.notifyCameraLaunching(null, z2);
    }

    @Override // com.oneplus.systemui.statusbar.phone.OpPanelViewController
    public KeyguardClockPositionAlgorithm getKeyguardClockPositionAlgorithm() {
        return this.mClockPositionAlgorithm;
    }
    ...
    public boolean bypassPreventMode(Context context) {
        ActivityInfo activityInfo;
        KeyguardBottomAreaView keyguardBottomAreaView = this.mKeyguardBottomArea;
        ...
        String str = (resolveCameraIntent == null || (activityInfo = resolveCameraIntent.activityInfo) == null) ? null : activityInfo.packageName;
        String topActivityName = OpUtils.getTopActivityName(context);
        if ((str == null || !str.equals(topActivityName)) && !"com.oneplus.gallery".equals(topActivityName) && !"com.oneplus.deskclock".equals(topActivityName)) {
            return false;
        }
        return true;
    }

    private int getStatusViewContainerWithPanelViewPadding(Resources resources) {
        return resources.getDimensionPixelSize(C0005R$dimen.op_control_margin_space3);
    }

    public void setIsImeShow(boolean z) {
        this.mNotificationStackScroller.setIsImeShow(z);
    }
}
