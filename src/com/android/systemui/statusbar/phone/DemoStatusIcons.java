...
public class DemoStatusIcons extends StatusIconContainer implements DemoMode, DarkIconDispatcher.DarkReceiver {
    ...
    public DemoStatusIcons(LinearLayout linearLayout, int i) {
        ...
        setOpTag("demo_status_icon_container");
    }
    ...
    public void dispatchDemoCommand(String str, Bundle bundle) {
        ...
        if (!this.mDemoMode && str.equals("enter")) {
            ...
            if (string != null) {
                updateSlot("volume", null, string.equals("vibrate") ? C0006R$drawable.stat_sys_ringer_vibrate : 0);
            }
            String string2 = bundle.getString("zen");
            if (string2 != null) {
                updateSlot("zen", null, string2.equals("dnd") ? C0006R$drawable.stat_sys_dnd : 0);
            }
            String string3 = bundle.getString("bluetooth");
            if (string3 != null) {
                updateSlot("bluetooth", null, string3.equals("connected") ? C0006R$drawable.stat_sys_data_bluetooth_connected : 0);
            }
            ...
            if (string5 != null) {
                updateSlot("alarm_clock", null, string5.equals("show") ? C0006R$drawable.stat_sys_alarm : 0);
            }
            String string6 = bundle.getString("tty");
            if (string6 != null) {
                updateSlot("tty", null, string6.equals("show") ? C0006R$drawable.stat_sys_tty_mode : 0);
            }
            ...
            if (string9 != null) {
                updateSlot("cast", null, string9.equals("show") ? C0006R$drawable.stat_sys_cast : 0);
            }
            String string10 = bundle.getString("hotspot");
            if (string10 != null) {
                if (string10.equals("show")) {
                    i = C0006R$drawable.stat_sys_hotspot;
                }
    ...
    public void addMobileView(StatusBarSignalPolicy.MobileIconState mobileIconState) {
        ...
        StatusBarMobileView fromContext = StatusBarMobileView.fromContext(((LinearLayout) this).mContext, mobileIconState.slot);
