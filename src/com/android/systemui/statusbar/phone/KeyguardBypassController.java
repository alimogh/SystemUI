...
public class KeyguardBypassController implements Dumpable {
    ...
    public KeyguardBypassController(@NotNull Context context, @NotNull final TunerService tunerService, @NotNull StatusBarStateController statusBarStateController, @NotNull NotificationLockscreenUserManager notificationLockscreenUserManager, @NotNull KeyguardStateController keyguardStateController, @NotNull DumpManager dumpManager) {
        ...
        if (hasSystemFeature) {
            ...
            final int i = context.getResources().getBoolean(17891462) ? 1 : 0;
    ...
    public final void maybePerformPendingUnlock() {
        ...
        if (pendingUnlock != null) {
            ...
            if (pendingUnlock2 == null) {
                Intrinsics.throwNpe();
                throw null;
            } else if (onBiometricAuthenticated(pendingUnlockType, pendingUnlock2.isStrongBiometric())) {
