...
public class NearestTouchFrame extends FrameLayout {
    ...
    private View findNearestChild(MotionEvent motionEvent) {
        ...
        return (View) this.mClickableChildren.stream().filter($$Lambda$dFYK0EjGBZUG5FTAJ9pyZPnsifY.INSTANCE).map(new Function(motionEvent) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$NearestTouchFrame$c68uozdLu3LZY-hrzFrFQ-dtMIM
