...
public class StatusBarRemoteInputCallback implements NotificationRemoteInputManager.Callback, CommandQueue.Callbacks, StatusBarStateController.StateListener {
    ...
    public void onStateChanged(int i) {
        ...
        if ((this.mStatusBarStateController.leaveOpenOnKeyguardHide() || z) && !this.mStatusBarStateController.isKeyguardRequested()) {
            if (z) {
                ...
                handler.post(new Runnable(view) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$au9TYywfgPbmO65RQz_jg3-3Qz0
    ...
    public void onWorkChallengeChanged() {
        ...
        if (this.mPendingWorkRemoteInputView != null && !this.mLockscreenUserManager.isAnyProfilePublicMode()) {
            this.mShadeController.postOnShadeExpanded(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$StatusBarRemoteInputCallback$R1k7Wh1xlx-jAMn9HjU1lr6mXXE
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public /* synthetic */ void lambda$onWorkChallengeChanged$2$StatusBarRemoteInputCallback() {
        ...
        if (view != null) {
            ...
            if (parent2 instanceof NotificationStackScrollLayout) {
                ...
                expandableNotificationRow.post(new Runnable((NotificationStackScrollLayout) parent2, expandableNotificationRow) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$StatusBarRemoteInputCallback$L_R5DgtrNavZQt2DnmfrB_93PMA
    ...
    public /* synthetic */ void lambda$onWorkChallengeChanged$1$StatusBarRemoteInputCallback(NotificationStackScrollLayout notificationStackScrollLayout, ExpandableNotificationRow expandableNotificationRow) {
        $$Lambda$StatusBarRemoteInputCallback$Pf9b4xR3WdydZqpSHpd3WHttUBw r0 = new Runnable(notificationStackScrollLayout) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$StatusBarRemoteInputCallback$Pf9b4xR3WdydZqpSHpd3WHttUBw
            public final /* synthetic */ NotificationStackScrollLayout f$1;
    ...
    public void onMakeExpandedVisibleForRemoteInput(ExpandableNotificationRow expandableNotificationRow, View view) {
        ...
        Objects.requireNonNull(view);
        privateLayout.setOnExpandedVisibleListener(new Runnable(view) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$MVkYf3B-uVxXy7rxrXvHR4SUXEU
            public final /* synthetic */ View f$0;
    ...
    public boolean handleRemoteViewClick(View view, PendingIntent pendingIntent, NotificationRemoteInputManager.ClickHandler clickHandler) {
        ...
        this.mActivityStarter.dismissKeyguardThenExecute(new ActivityStarter.OnDismissAction(pendingIntent, clickHandler) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$StatusBarRemoteInputCallback$n1nyYEfnirLBe7S11WLW5h0H_EI
