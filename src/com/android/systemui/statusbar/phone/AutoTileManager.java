...
public class AutoTileManager implements UserAwareController {
    ...
    @VisibleForTesting
    final CastController.Callback mCastCallback = new CastController.Callback() { // from class: com.android.systemui.statusbar.phone.AutoTileManager.5
        ...
        public void onCastDevicesChanged() {
            if (!AutoTileManager.this.mAutoTracker.isAdded("cast")) {
                ...
                if (z) {
                    ...
                    AutoTileManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$5$1GZPv7QA0z8r97QhKE685hmdwXU
    ...
    private final DataSaverController.Listener mDataSaverListener = new DataSaverController.Listener() { // from class: com.android.systemui.statusbar.phone.AutoTileManager.2
        ...
        public void onDataSaverChanged(boolean z) {
            if (!AutoTileManager.this.mAutoTracker.isAdded("saver") && z) {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$2$aKs9haH_6r0xP_BBV2VFTNLlSTM
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    private final HotspotController.Callback mHotspotCallback = new HotspotController.Callback() { // from class: com.android.systemui.statusbar.phone.AutoTileManager.3
        ...
        public void onHotspotChanged(boolean z, int i) {
            if (!AutoTileManager.this.mAutoTracker.isAdded("hotspot") && z) {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$3$87T2WHtAMmDdyVJTv6iCOd5Jwd4
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    @VisibleForTesting
    final NightDisplayListener.Callback mNightDisplayCallback = new NightDisplayListener.Callback() { // from class: com.android.systemui.statusbar.phone.AutoTileManager.4
        ...
        private void addNightTile() {
            if (!AutoTileManager.this.mAutoTracker.isAdded("night")) {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$4$PdMTvLTZ6PP_LASECKaYJDhadms
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    private void populateSettingsList() {
        try {
            String[] stringArray = this.mContext.getResources().getStringArray(C0001R$array.config_quickSettingsAutoAdd);
    ...
    public void lambda$changeUser$0(UserHandle userHandle) {
        if (!Thread.currentThread().equals(this.mHandler.getLooper().getThread())) {
            this.mHandler.post(new Runnable(userHandle) { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$YUAO-oFSfDM4QNvsf1l5gpCAopQ
    ...
    public class AutoAddSetting extends SecureSetting {
        ...
        public void handleValueChanged(int i, boolean z) {
            if (AutoTileManager.this.mAutoTracker.isAdded(this.mSpec)) {
                AutoTileManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$AutoAddSetting$b5h6ITGFUhhbZfNJqWDC6XxQfJE
                    @Override // java.lang.Runnable
                    public final void run() {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$AutoTileManager$AutoAddSetting$bs0leZa_T3XhOtGqbTRqC7ErikE
                    @Override // java.lang.Runnable
                    public final void run() {
