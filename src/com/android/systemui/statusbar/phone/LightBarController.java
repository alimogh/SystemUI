...
public class LightBarController implements BatteryController.BatteryStateChangeCallback, Dumpable {
    ...
    private boolean mHasDockedStack;
    ...
    public LightBarController(Context context, DarkIconDispatcher darkIconDispatcher, BatteryController batteryController, NavigationModeController navigationModeController) {
        Color.valueOf(context.getColor(C0004R$color.dark_mode_icon_color_single_tone));
        this.mStatusBarIconController = (SysuiDarkIconDispatcher) darkIconDispatcher;
        this.mBatteryController = batteryController;
        batteryController.addCallback(this);
        this.mNavigationMode = navigationModeController.addListener(new NavigationModeController.ModeChangedListener() { // from class: com.android.systemui.statusbar.phone.-$$Lambda$LightBarController$jv_bCwiUMKhQXOE_5D5jhZNF2Tw
    ...
    public void setNavigationBar(LightBarTransitionsController lightBarTransitionsController) {
        Log.d("LightBarController", "setNavigationBar()");
    ...
    public boolean getDockedLight() {
        return this.mDockedLight;
    }

    public boolean getHasDockedStack() {
        return this.mHasDockedStack;
    }
    ...
    public void setScrimState(ScrimState scrimState, float f, ColorExtractor.GradientColors gradientColors) {
        ...
        boolean z2 = (scrimState == ScrimState.BOUNCER || scrimState == ScrimState.BOUNCER_SCRIMMED || scrimState == ScrimState.BOUNCER_SCRIMMED_BOOT || f < 0.1f || gradientColors.supportsDarkText()) ? false : true;
    ...
    private void updateStatus() {
        ...
        Log.d("LightBarController", " updateStatus numStacks=" + length);
        this.mHasDockedStack = length != 1;
        int i = -1;
        int i2 = 0;
        for (int i3 = 0; i3 < length; i3++) {
            boolean isLight = isLight(this.mAppearanceRegions[i3].getAppearance(), this.mStatusBarMode, 8);
            this.mDockedLight = isLight;
            if (isLight) {
                i2++;
                i = i3;
            }
    ...
    private void updateNavigation() {
        Log.d("LightBarController", "updateNavigation() NavigationMode:" + this.mNavigationMode);
