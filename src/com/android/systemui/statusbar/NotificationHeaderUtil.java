...
public class NotificationHeaderUtil {
    private static final ResultApplicator mGreyApplicator = new ResultApplicator() { // from class: com.android.systemui.statusbar.NotificationHeaderUtil.4
        ...
        public void apply(View view, View view2, boolean z, boolean z2) {
            ...
            applyToChild((ImageView) view2.findViewById(16908294), z, notificationHeaderView.getOriginalIconColor());
            applyToChild((ImageView) view2.findViewById(16908949), z, notificationHeaderView.getOriginalNotificationColor());
        }
    ...
    public NotificationHeaderUtil(ExpandableNotificationRow expandableNotificationRow) {
        ...
        this.mComparators.add(new HeaderProcessor(this.mRow, 16909225, sIconExtractor, sGreyComparator, mGreyApplicator));
        this.mComparators.add(new HeaderProcessor(this.mRow, 16909319, null, new ViewComparator(this) { // from class: com.android.systemui.statusbar.NotificationHeaderUtil.5
            @Override // com.android.systemui.statusbar.NotificationHeaderUtil.ViewComparator
            public boolean compare(View view, View view2, Object obj, Object obj2) {
        ...
        this.mComparators.add(new HeaderProcessor(this.mRow, 16908761, null, sTextViewComparator, sAppNameApplicator));
        this.mComparators.add(HeaderProcessor.forTextView(this.mRow, 16909033));
        this.mDividers.add(16909034);
        this.mDividers.add(16909036);
        this.mDividers.add(16909539);
    }
    ...
    private void sanitizeChild(View view) {
        if (view != null) {
            sanitizeHeader((ViewGroup) view.findViewById(16909225));
        }
    }
    ...
    private void sanitizeHeader(ViewGroup viewGroup) {
        ...
        if (viewGroup != null) {
            ...
            View findViewById = viewGroup.findViewById(16909535);
            int i = 0;
            while (true) {
                if (i >= childCount) {
                    z = false;
