...
public interface ISystemUiProxy extends IInterface {
    int getFullScreenNavBarInset(String str) throws RemoteException;
    ...
    void notifyLeaveOneHandMode() throws RemoteException;
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case R$styleable.Constraint_layout_goneMarginTop /* 103 */:
                                        parcel.enforceInterface("com.android.systemui.shared.recents.ISystemUiProxy");
                                        notifyGestureEnded(parcel.readInt());
                                        parcel2.writeNoException();
                                        return true;
                                    case R$styleable.Constraint_motionStagger /* 104 */:
                                        parcel.enforceInterface("com.android.systemui.shared.recents.ISystemUiProxy");
                                        notifyLeaveOneHandMode();
                                        parcel2.writeNoException();
                                        return true;
                                    case R$styleable.Constraint_pathMotionArc /* 105 */:
                                        parcel.enforceInterface("com.android.systemui.shared.recents.ISystemUiProxy");
                                        int fullScreenNavBarInset = getFullScreenNavBarInset(parcel.readString());
                                        parcel2.writeNoException();
                                        parcel2.writeInt(fullScreenNavBarInset);
                                        return true;
                                    default:
