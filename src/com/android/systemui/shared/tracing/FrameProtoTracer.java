...
public class FrameProtoTracer<P, S extends P, T extends P, R> implements Choreographer.FrameCallback {
    ...
    private final TraceBuffer.ProtoProvider<P, S, T> mProvider = new TraceBuffer.ProtoProvider<P, S, T>() { // from class: com.android.systemui.shared.tracing.FrameProtoTracer.1
    ...
    public FrameProtoTracer(ProtoTraceParams<P, S, T, R> protoTraceParams) {
        ...
        this.mBuffer = new TraceBuffer<>(1048576, this.mProvider, new Consumer<T>() { // from class: com.android.systemui.shared.tracing.FrameProtoTracer.2
