...
public class AssistDisclosure {
    ...
    public class AssistDisclosureView extends View implements ValueAnimator.AnimatorUpdateListener {
        ...
        public AssistDisclosureView(Context context) {
            ...
            this.mAnimator.addListener(new AnimatorListenerAdapter(AssistDisclosure.this) { // from class: com.android.systemui.assist.AssistDisclosure.AssistDisclosureView.1
                boolean mCancelled;
            ...
            this.mThickness = getResources().getDimension(C0005R$dimen.assist_disclosure_thickness);
            this.mShadowThickness = getResources().getDimension(C0005R$dimen.assist_disclosure_shadow_thickness);
        }
