...
public final class PhoneStateMonitor {
    ...
    PhoneStateMonitor(Context context, BroadcastDispatcher broadcastDispatcher, Optional<Lazy<StatusBar>> optional, BootCompleteCache bootCompleteCache) {
        ...
        bootCompleteCache.addListener(new BootCompleteCache.BootCompleteListener() { // from class: com.android.systemui.assist.-$$Lambda$PhoneStateMonitor$kU1yau2iyc4oGSlu9ejSJU0AW3w
        ...
        instance.registerTaskStackListener(new TaskStackChangeListener() { // from class: com.android.systemui.assist.PhoneStateMonitor.2
