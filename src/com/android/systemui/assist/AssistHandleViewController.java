...
public class AssistHandleViewController implements NavigationBarTransitions.DarkIntensityListener {
    ...
    public AssistHandleViewController(Handler handler, View view) {
        ...
        this.mAssistHintLeft = (CornerHandleView) view.findViewById(C0008R$id.assist_hint_left);
        this.mAssistHintRight = (CornerHandleView) view.findViewById(C0008R$id.assist_hint_right);
    }
    ...
    public void lambda$setAssistHintVisible$0(boolean z) {
        if (!this.mHandler.getLooper().isCurrentThread()) {
            this.mHandler.post(new Runnable(z) { // from class: com.android.systemui.assist.-$$Lambda$AssistHandleViewController$UwVsLlCfHOnxZGhueV8hx6rT9Z4
    ...
    public void lambda$setAssistHintBlocked$1(boolean z) {
        if (!this.mHandler.getLooper().isCurrentThread()) {
            this.mHandler.post(new Runnable(z) { // from class: com.android.systemui.assist.-$$Lambda$AssistHandleViewController$ai-ftoeNqQkXVTgh21US20St6-A
                public final /* synthetic */ boolean f$1;
