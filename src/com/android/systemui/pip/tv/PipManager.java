...
public class PipManager implements BasePipManager, PipTaskOrganizer.PipTransitionCallback {
    ...
    public class PipManagerPinnedStackListener extends PinnedStackListenerForwarder.PinnedStackListener {
        ...
        public void onMovementBoundsChanged(boolean z) {
            PipManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipManager$PipManagerPinnedStackListener$xzENomr6fPtav6biMAAyvIPEf_c
                @Override // java.lang.Runnable
        ...
        private /* synthetic */ void lambda$onMovementBoundsChanged$0$PipManager$PipManagerPinnedStackListener() {
            Rect rect = new Rect();
        ...
        public void onActionsChanged(ParceledListSlice parceledListSlice) {
            ...
            PipManager.this.mHandler.post(new Runnable() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipManager$PipManagerPinnedStackListener$pvNxqxzg0ewPBlnvdhxIPv7OOlM
                @Override // java.lang.Runnable
                public final void run() {
        ...
        private /* synthetic */ void lambda$onActionsChanged$1$PipManager$PipManagerPinnedStackListener() {
            for (int size = PipManager.this.mListeners.size() - 1; size >= 0; size--) {
    ...
    public PipManager(Context context, BroadcastDispatcher broadcastDispatcher, PipBoundsHandler pipBoundsHandler, PipTaskOrganizer pipTaskOrganizer, PipSurfaceTransactionHelper pipSurfaceTransactionHelper, Divider divider) {
        ...
        if (!this.mInitialized) {
            ...
            this.mResizeAnimationDuration = context.getResources().getInteger(C0009R$integer.config_pipResizeAnimationDuration);
            ...
            if (sSettingsPackageAndClassNamePairList == null) {
                String[] stringArray = this.mContext.getResources().getStringArray(C0001R$array.tv_pip_settings_class_name);
    ...
    private void loadConfigurationsAndApply(Configuration configuration) {
        ...
        this.mSettingsPipBounds = Rect.unflattenFromString(resources.getString(C0015R$string.pip_settings_bounds));
        this.mMenuModePipBounds = Rect.unflattenFromString(resources.getString(C0015R$string.pip_menu_bounds));
    ...
    private void updatePipVisibility(boolean z) {
        ((UiOffloadThread) Dependency.get(UiOffloadThread.class)).execute(new Runnable(z) { // from class: com.android.systemui.pip.tv.-$$Lambda$PipManager$B3cwmVrFFG3e6pUajgQn8FpuCeM
