...
public class PipMenuActivity extends Activity implements PipManager.Listener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0011R$layout.tv_pip_menu);
        TvPipComponent build = this.mPipComponentBuilder.pipControlsView((PipControlsView) findViewById(C0008R$id.pip_controls)).build();
        ...
        Animator loadAnimator = AnimatorInflater.loadAnimator(this, C0000R$anim.tv_pip_menu_fade_in_animation);
        this.mFadeInAnimation = loadAnimator;
        loadAnimator.setTarget(this.mPipControlsViewController.getView());
        Animator loadAnimator2 = AnimatorInflater.loadAnimator(this, C0000R$anim.tv_pip_menu_fade_out_animation);
