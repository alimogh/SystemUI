...
public class PipControlsViewController {
    ...
    private final View.OnFocusChangeListener mFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.android.systemui.pip.tv.PipControlsViewController.3
    ...
    private final PipManager.MediaListener mPipMediaListener = new PipManager.MediaListener() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipControlsViewController$kZf8PkTX4QNE7Vc5zsES51WG3gA
    ...
    public PipControlsViewController(PipControlsView pipControlsView, PipManager pipManager, LayoutInflater layoutInflater, Handler handler) {
        ...
        fullButtonView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipControlsViewController$rQPZrjnmUU8eHBhj9PVaj2cMJVs
        ...
        closeButtonView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipControlsViewController$rqMCDyXd4qEJoGxUNtb2wXHRu3A
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        this.mPlayPauseButtonView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipControlsViewController$q5wDnhpgYTIhYtkeUXKZ3KQDbyI
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    private /* synthetic */ void lambda$new$0$PipControlsViewController(View view) {
        this.mPipManager.movePipToFullscreen();
    }

    /* access modifiers changed from: public */
    /* renamed from: lambda$new$1 */
    private /* synthetic */ void lambda$new$1$PipControlsViewController(View view) {
    ...
    private /* synthetic */ void lambda$new$2$PipControlsViewController(View view) {
    ...
    private void updateUserActions() {
        ...
        if (!this.mCustomActions.isEmpty()) {
            while (this.mCustomButtonViews.size() < this.mCustomActions.size()) {
                PipControlButtonView pipControlButtonView = (PipControlButtonView) this.mLayoutInflater.inflate(C0011R$layout.tv_pip_custom_control, (ViewGroup) this.mView, false);
            ...
            while (i < this.mCustomActions.size()) {
                ...
                remoteAction.getIcon().loadDrawableAsync(this.mView.getContext(), new Icon.OnDrawableLoadedListener() { // from class: com.android.systemui.pip.tv.-$$Lambda$PipControlsViewController$kC7tvkXWtpNyYLWHDbM2CyhHzr4
                ...
                if (remoteAction.isEnabled()) {
                    pipControlButtonView2.setOnClickListener(new View.OnClickListener(remoteAction) { // from class: com.android.systemui.pip.tv.-$$Lambda$PipControlsViewController$1reZdb40mM6nxQSPhdAKH0IMN6M
        ...
        if (playbackState == 2) {
            ...
            if (playbackState == 0) {
                ...
                this.mPlayPauseButtonView.setText(C0015R$string.pip_pause);
            } else {
                this.mPlayPauseButtonView.setImageResource(C0006R$drawable.ic_play_arrow_white);
                this.mPlayPauseButtonView.setText(C0015R$string.pip_play);
            }
        }
