...
public class PipMenuActivity extends Activity {
    ...
    private final Runnable mFinishRunnable = new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivity$on3_yLRCya18yWlE7CavD_fHImk
        @Override // java.lang.Runnable
        public final void run() {
            PipMenuActivity.lambda$on3_yLRCya18yWlE7CavD_fHImk(PipMenuActivity.this);
        }
    };
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0011R$layout.pip_menu_activity);
        ...
        View findViewById = findViewById(C0008R$id.background);
        this.mViewRoot = findViewById;
        findViewById.setBackground(this.mBackgroundDrawable);
        View findViewById2 = findViewById(C0008R$id.menu_container);
        this.mMenuContainer = findViewById2;
        findViewById2.setAlpha(0.0f);
        View findViewById3 = findViewById(C0008R$id.settings);
        ...
        View findViewById4 = findViewById(C0008R$id.dismiss);
        ...
        findViewById(C0008R$id.expand_button).setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivity$70yHDyzrwE1GNEVEQrmSEL7H6fY
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                PipMenuActivity.this.lambda$onCreate$2$PipMenuActivity(view);
            }
        });
        View findViewById5 = findViewById(C0008R$id.resize_handle);
        this.mResizeHandle = findViewById5;
        findViewById5.setAlpha(0.0f);
        this.mActionsGroup = (LinearLayout) findViewById(C0008R$id.actions_group);
        this.mBetweenActionPaddingLand = getResources().getDimensionPixelSize(C0005R$dimen.pip_between_action_padding_land);
        updateFromIntent(getIntent());
        setTitle(C0015R$string.pip_menu_title);
    ...
    private void initAccessibility() {
        getWindow().getDecorView().setAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: com.android.systemui.pip.phone.PipMenuActivity.3
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, PipMenuActivity.this.getResources().getString(C0015R$string.pip_menu_title)));
            }
    ...
    private void updateActionViews(Rect rect) {
        ViewGroup viewGroup = (ViewGroup) findViewById(C0008R$id.expand_container);
        ViewGroup viewGroup2 = (ViewGroup) findViewById(C0008R$id.actions_container);
            ...
            if (this.mMenuState != 1) {
                ...
                if (this.mActionsGroup != null) {
                    ...
                    while (this.mActionsGroup.getChildCount() < this.mActions.size()) {
                        this.mActionsGroup.addView((ImageButton) from.inflate(C0011R$layout.pip_menu_action, (ViewGroup) this.mActionsGroup, false));
                    }
                    int i = 0;
                    ...
                    while (i2 < this.mActions.size()) {
                        ...
                        remoteAction.getIcon().loadDrawableAsync(this, new Icon.OnDrawableLoadedListener(imageButton) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivity$FgVNA6rqcnXmAeLQlbztL7Zw7mU
                        ...
                        if (remoteAction.isEnabled()) {
                            imageButton.setOnClickListener(new View.OnClickListener(remoteAction) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivity$Ts5um0YR6IQ0YRdLS2dyHj4GSpg
    ...
    public /* synthetic */ void lambda$updateActionViews$6$PipMenuActivity(RemoteAction remoteAction, View view) {
        this.mHandler.post(new Runnable(remoteAction) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivity$KxDwr2Rt3pvR-EKt-FVSgFixejo
