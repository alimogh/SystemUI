...
public class PipTouchHandler {
    ...
    private Runnable mShowTargetAction = new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$bnz9PC9JAAj_rxnZq96LLBoKnqw
    ...
    public PipTouchHandler(Context context, IActivityManager iActivityManager, PipMenuActivityController pipMenuActivityController, InputConsumerController inputConsumerController, PipBoundsHandler pipBoundsHandler, PipTaskOrganizer pipTaskOrganizer, FloatingContentCoordinator floatingContentCoordinator, DeviceConfigProxy deviceConfigProxy, PipSnapAlgorithm pipSnapAlgorithm, SysUiState sysUiState) {
        ...
        this.mPipResizeGestureHandler = new PipResizeGestureHandler(context, pipBoundsHandler, pipMotionHelper, deviceConfigProxy, pipTaskOrganizer, new Function() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$Pinp5dDEZz4g_gFarHF_EBKOZzg
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                return PipTouchHandler.lambda$Pinp5dDEZz4g_gFarHF_EBKOZzg(PipTouchHandler.this, (Rect) obj);
            }
        }, new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$uINUOEMRLade2qxAeU4HH4-1XrU
            @Override // java.lang.Runnable
            public final void run() {
        ...
        $$Lambda$PipTouchHandler$Uq5M9Md512Sfgd22VAeFpot25E0 r4 = new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$Uq5M9Md512Sfgd22VAeFpot25E0
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.mTouchState = new PipTouchState(viewConfiguration, handler, r4, new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$QWy-27z4N9eSKLQk7iOWRu3Ei38
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.mEnableDismissDragToEdge = resources.getBoolean(C0003R$bool.config_pipEnableDismissDragToEdge);
        this.mEnableResize = resources.getBoolean(C0003R$bool.config_pipEnableResizeForMenu);
        reloadResources();
        ...
        this.mConnection = new PipAccessibilityInteractionConnection(this.mContext, this.mMotionHelper, pipTaskOrganizer, pipSnapAlgorithm, new PipAccessibilityInteractionConnection.AccessibilityCallbacks() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$1nY3kLe318Fm3UtIAbDmSK80h7w
        ...
        frameLayout.setBackgroundDrawable(context.getDrawable(C0006R$drawable.floating_dismiss_gradient_transition));
        ...
        this.mMagnetizedPip.setAnimateStuckToTarget(new Function5() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$Nekx4ZO_bAe0QnJLdZ92hnlTRtE
        ...
        this.mMagnetizedPip.setMagnetListener(new MagnetizedObject.MagnetListener() { // from class: com.android.systemui.pip.phone.PipTouchHandler.1
            ...
            public void onReleasedInTarget(MagnetizedObject.MagneticTarget magneticTarget) {
                ...
                PipTouchHandler.this.mHandler.post(new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$1$zJ5cwW9_qQ4umng-tgHurxl3qHI
                    @Override // java.lang.Runnable
                    public final void run() {
            ...
            private /* synthetic */ void lambda$onReleasedInTarget$0$PipTouchHandler$1() {
    ...
    private /* synthetic */ void lambda$new$0$PipTouchHandler() {
        this.mMenuController.showMenuWithDelay(2, this.mMotionHelper.getBounds(), true, willResizeMenu(), shouldShowResizeHandle());
    }

    /* access modifiers changed from: public */
    /* renamed from: lambda$new$1 */
    private /* synthetic */ Unit lambda$new$1$PipTouchHandler(MagnetizedObject.MagneticTarget magneticTarget, Float f, Float f2, Boolean bool, Function0 function0) {
    ...
    private void reloadResources() {
        ...
        this.mBottomOffsetBufferPx = resources.getDimensionPixelSize(C0005R$dimen.pip_bottom_offset_buffer);
        this.mExpandedShortestEdgeSize = resources.getDimensionPixelSize(C0005R$dimen.pip_expanded_shortest_edge_size);
        this.mImeOffset = resources.getDimensionPixelSize(C0005R$dimen.pip_ime_offset);
        this.mDismissAreaHeight = resources.getDimensionPixelSize(C0005R$dimen.floating_dismiss_gradient_height);
        updateMagneticTargetSize();
    }

    private void updateMagneticTargetSize() {
        if (this.mTargetView != null) {
            int dimensionPixelSize = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.dismiss_circle_size);
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(dimensionPixelSize, dimensionPixelSize);
            layoutParams.gravity = 81;
            layoutParams.bottomMargin = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.floating_dismiss_bottom_margin);
    ...
    private void hideDismissTarget() {
        ...
        physicsAnimator.withEndActions(new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$JjtgIlfsvLfISVWRI9f7tSgS_AA
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private /* synthetic */ void lambda$hideDismissTarget$2$PipTouchHandler() {
    ...
    public class DefaultPipTouchGesture extends PipTouchGesture {
        ...
        public boolean onUp(PipTouchState pipTouchState) {
            ...
            if (pipTouchState.isDragging()) {
                ...
                PipTouchHandler.this.mMotionHelper.flingToSnapTarget(velocity.x, velocity.y, new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$DefaultPipTouchGesture$K8tFYcJKtB3Bkuu5piDq-0-1YhA
                    @Override // java.lang.Runnable
                    public final void run() {
                        PipTouchHandler.DefaultPipTouchGesture.lambda$onUp$0(PipTouchHandler.this);
                    }
                }, new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipTouchHandler$DefaultPipTouchGesture$c8YgJLEypMoVYe3YjylatK650zk
                    @Override // java.lang.Runnable
                    public final void run() {
