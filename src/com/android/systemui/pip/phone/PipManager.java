...
public class PipManager implements BasePipManager, PipTaskOrganizer.PipTransitionCallback {
    ...
    private final TaskStackChangeListener mTaskStackListener = new TaskStackChangeListener() { // from class: com.android.systemui.pip.phone.PipManager.2
        ...
        public void onActivityUnpinned() {
            ...
            ((UiOffloadThread) Dependency.get(UiOffloadThread.class)).execute(new Runnable(componentName) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$2$7wUFTc4hTjTQbo3BPlrl8V6q3tU
    ...
    public class PipManagerPinnedStackListener extends PinnedStackListenerForwarder.PinnedStackListener {
        ...
        public void onListenerRegistered(IPinnedStackController iPinnedStackController) {
            PipManager.this.mHandler.post(new Runnable(iPinnedStackController) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$MK-nIqOfkRku5-KYToXZ0-DmcZA
        ...
        public void onImeVisibilityChanged(boolean z, int i) {
            PipManager.this.mHandler.post(new Runnable(z, i) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$u1KCCoxakH7gZKPv7iZK4aLn7MU
        ...
        public void onMovementBoundsChanged(boolean z) {
            PipManager.this.mHandler.post(new Runnable(z) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$f-SQ0yydZH1ZP4stoL54CdBZ7QU
                public final /* synthetic */ boolean f$1;
        ...
        public void onActionsChanged(ParceledListSlice parceledListSlice) {
            PipManager.this.mHandler.post(new Runnable(parceledListSlice) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$w3TtXQNx6JYy0rkssM6SOCMIiCQ
        ...
        public void onActivityHidden(ComponentName componentName) {
            PipManager.this.mHandler.post(new Runnable(componentName) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$jzbSRhWFoxplnSPY2RgqZCPd1ts
        ...
        public void onDisplayInfoChanged(DisplayInfo displayInfo) {
            PipManager.this.mHandler.post(new Runnable(displayInfo) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$P0_Ji3WptNFaEdrasIn3ZLSvnUM
        ...
        public void onAspectRatioChanged(float f) {
            PipManager.this.mHandler.post(new Runnable(f) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$PipManagerPinnedStackListener$as1Gj0OwAKB_hvEWCKYdRYRFM9g
    ...
    public void setShelfHeight(boolean z, int i) {
        this.mHandler.post(new Runnable(z, i) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$f_jRwYFIWoME7ctX-wrfhuNp1q0
            public final /* synthetic */ boolean f$1;
            public final /* synthetic */ int f$2;
    ...
    public void setPinnedStackAnimationType(int i) {
        this.mHandler.post(new Runnable(i) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$_erwmkZE5c2eLc8r_OSTlUw7erk
    ...
    public void setPinnedStackAnimationListener(IPinnedStackAnimationListener iPinnedStackAnimationListener) {
        this.mHandler.post(new Runnable(iPinnedStackAnimationListener) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipManager$t2XWznriuk4XHpM7EiG9uJamHUY
