...
public class PipResizeGestureHandler {
    ...
    public PipResizeGestureHandler(Context context, PipBoundsHandler pipBoundsHandler, PipMotionHelper pipMotionHelper, DeviceConfigProxy deviceConfigProxy, PipTaskOrganizer pipTaskOrganizer, Function<Rect, Rect> function, Runnable runnable, SysUiState sysUiState) {
        ...
        deviceConfigProxy.addOnPropertiesChangedListener("systemui", this.mMainExecutor, new DeviceConfig.OnPropertiesChangedListener() { // from class: com.android.systemui.pip.phone.PipResizeGestureHandler.1
    ...
    private void reloadResources() {
        this.mDelta = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.pip_resize_edge_size);
    ...
    private void onMotionEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (!this.mLastResizeBounds.isEmpty()) {
                this.mPipTaskOrganizer.scheduleFinishResizePip(this.mLastResizeBounds, new Consumer() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipResizeGestureHandler$RnFltK7-aDIBKCAT3ErPSvbZbyg
    ...
    public /* synthetic */ void lambda$onMotionEvent$1$PipResizeGestureHandler(Rect rect) {
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.android.systemui.pip.phone.-$$Lambda$PipResizeGestureHandler$Z3nEFx0Z3KpDDBgJ9VHLzJ4HnEg
