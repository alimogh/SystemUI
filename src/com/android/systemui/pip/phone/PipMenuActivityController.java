...
public class PipMenuActivityController {
    ...
    private Runnable getMenuStateChangeFinishedCallback(Messenger messenger, Bundle bundle) {
        ...
        return new Runnable(bundle, messenger) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivityController$_kNQCJDSdqogZpt_djM4gC8wQ7M
    ...
    private void onMenuStateChanged(int i, boolean z, Runnable runnable) {
        if (i != this.mMenuState) {
            this.mListeners.forEach(new Consumer(i, z, runnable) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMenuActivityController$_vkUUS2B_ghvg2Kknl2htGLPiZU
