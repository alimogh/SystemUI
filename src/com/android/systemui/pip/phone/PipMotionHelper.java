...
public class PipMotionHelper implements PipAppOpsListener.Callback, FloatingContentCoordinator.FloatingContent {
    ...
    public PipMotionHelper(Context context, PipTaskOrganizer pipTaskOrganizer, PipMenuActivityController pipMenuActivityController, PipSnapAlgorithm pipSnapAlgorithm, FloatingContentCoordinator floatingContentCoordinator) {
        ...
        this.mUpdateBoundsCallback = new Consumer(rect) { // from class: com.android.systemui.pip.phone.-$$Lambda$9ryw0tgRGCMDitW4U_PfPc0I9v4
        ...
        AnonymousClass1 r0 = new PipTaskOrganizer.PipTransitionCallback() { // from class: com.android.systemui.pip.phone.PipMotionHelper.1
    ...
    public void expandPipToFullscreen(boolean z) {
        ...
        this.mPipTaskOrganizer.getUpdateHandler().post(new Runnable(z) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMotionHelper$Wmfum8DiHO44sGCBrLFpc_A8U44
    ...
    public void flingToSnapTarget(float f, float f2, Runnable runnable, Runnable runnable2) {
        ...
        if (runnable != null) {
            this.mTemporaryBoundsPhysicsAnimator.addUpdateListener(new PhysicsAnimator.UpdateListener(runnable) { // from class: com.android.systemui.pip.phone.-$$Lambda$PipMotionHelper$AiW2VQGjSOah3v_re0mTkvmkPLc
