...
public class PipBoundsHandler {
    ...
    private final DisplayController.OnDisplaysChangedListener mDisplaysChangedListener = new DisplayController.OnDisplaysChangedListener() { // from class: com.android.systemui.pip.PipBoundsHandler.1
    ...
    private void reloadResources() {
        ...
        this.mDefaultAspectRatio = resources.getFloat(17105070);
        this.mDefaultStackGravity = resources.getInteger(17694785);
        int dimensionPixelSize = resources.getDimensionPixelSize(17105155);
        ...
        this.mMinAspectRatio = resources.getFloat(17105073);
        this.mMaxAspectRatio = resources.getFloat(17105072);
    }
