...
public class PipTaskOrganizer extends TaskOrganizer implements DisplayController.OnDisplaysChangedListener {
    ...
    public PipTaskOrganizer(Context context, PipBoundsHandler pipBoundsHandler, PipSurfaceTransactionHelper pipSurfaceTransactionHelper, Divider divider, DisplayController displayController, PipAnimationController pipAnimationController) {
        ...
        this.mEnterExitAnimationDuration = context.getResources().getInteger(C0009R$integer.config_pipResizeAnimationDuration);
        this.mOverridableMinSize = context.getResources().getDimensionPixelSize(17105391);
    ...
    public void exitPip(final int i) {
        ...
        if (z) {
            ...
            applySyncTransaction(windowContainerTransaction, new WindowContainerTransactionCallback() { // from class: com.android.systemui.pip.PipTaskOrganizer.2
                public void onTransactionReady(int i4, SurfaceControl.Transaction transaction2) {
                    transaction2.apply();
    ...
    private void enterPipWithAlphaAnimation(final Rect rect, final long j) {
        ...
        applySyncTransaction(windowContainerTransaction, new WindowContainerTransactionCallback() { // from class: com.android.systemui.pip.PipTaskOrganizer.3
            public void onTransactionReady(int i, SurfaceControl.Transaction transaction2) {
                transaction2.apply();
                PipTaskOrganizer.this.mUpdateHandler.post(new Runnable(rect, j) { // from class: com.android.systemui.pip.-$$Lambda$PipTaskOrganizer$3$8PwkJ_EmtPzPmZpwIQc9Ay-0188
            ...
            public /* synthetic */ void lambda$onTransactionReady$0$PipTaskOrganizer$3(Rect rect2, long j2) {
                PipAnimationController.PipTransitionAnimator animator = PipTaskOrganizer.this.mPipAnimationController.getAnimator(PipTaskOrganizer.this.mLeash, rect2, 0.0f, 1.0f);
                animator.setTransitionDirection(2);
                animator.setPipAnimationCallback(PipTaskOrganizer.this.mPipAnimationCallback);
                animator.setDuration(j2).start();
            }
        });
    }
    ...
    private void sendOnPipTransitionStarted(int i) {
        runOnMainHandler(new Runnable(i) { // from class: com.android.systemui.pip.-$$Lambda$PipTaskOrganizer$JUO3Grq_R7eMASAsK_v_c6_mMuI
    ...
    private void sendOnPipTransitionFinished(int i) {
        runOnMainHandler(new Runnable(i) { // from class: com.android.systemui.pip.-$$Lambda$PipTaskOrganizer$cVPyDgP7uB9XVG-Z8xzNA-yEDd4
            public final /* synthetic */ int f$1;
    ...
    private void sendOnPipTransitionCancelled(int i) {
        runOnMainHandler(new Runnable(i) { // from class: com.android.systemui.pip.-$$Lambda$PipTaskOrganizer$TTTo1eGF0SlCllWVDuAJlbhmvjo
            public final /* synthetic */ int f$1;
