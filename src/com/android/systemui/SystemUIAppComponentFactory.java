...
public class SystemUIAppComponentFactory extends AppComponentFactory {
    ...
    public Application instantiateApplicationCompat(ClassLoader classLoader, String str) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        ...
        if (instantiateApplicationCompat instanceof ContextInitializer) {
            ((ContextInitializer) instantiateApplicationCompat).setContextAvailableCallback(new ContextAvailableCallback() { // from class: com.android.systemui.-$$Lambda$SystemUIAppComponentFactory$K7lft0lbYxYv1XYt4OjLQAAUcDg
    ...
    private /* synthetic */ void lambda$instantiateApplicationCompat$0$SystemUIAppComponentFactory(Context context) {
    ...
    public ContentProvider instantiateProviderCompat(ClassLoader classLoader, String str) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        ...
        if (instantiateProviderCompat instanceof ContextInitializer) {
            ((ContextInitializer) instantiateProviderCompat).setContextAvailableCallback(new ContextAvailableCallback(instantiateProviderCompat) { // from class: com.android.systemui.-$$Lambda$SystemUIAppComponentFactory$pPiiW5zNbVk8McZrLK2oqhHWM0g
