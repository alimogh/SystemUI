...
public class OverviewProxyRecentsImpl implements RecentsImplementation {
    ...
    public void toggleRecentApps() {
        if (this.mOverviewProxyService.getProxy() != null) {
            $$Lambda$OverviewProxyRecentsImpl$ZzsBj6p_GVl3rLvpPgWKT0NW9E r0 = new Runnable() { // from class: com.android.systemui.recents.-$$Lambda$OverviewProxyRecentsImpl$ZzsBj6p_GVl3rLvpPg-WKT0NW9E
            ...
            if (lazy == null || !lazy.get().isKeyguardShowing()) {
                ...
                this.mStatusBarLazy.get().executeRunnableDismissingKeyguard(new Runnable(r0) { // from class: com.android.systemui.recents.-$$Lambda$OverviewProxyRecentsImpl$PUSBynP3ZsSZrPqXO1jJqSKnayU
    ...
    public boolean splitPrimaryTask(int i, Rect rect, int i2) {
        ...
        if (runningTask != null && !z && !isScreenPinningActive) {
            if (!runningTask.supportsSplitScreenMultiWindow) {
                Toast.makeText(this.mContext, C0015R$string.dock_non_resizeble_failed_to_dock_text, 0).show();
