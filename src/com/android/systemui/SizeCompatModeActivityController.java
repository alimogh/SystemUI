...
public class SizeCompatModeActivityController extends SystemUI implements CommandQueue.Callbacks {
    ...
    public static class RestartActivityButton extends ImageButton implements View.OnClickListener, View.OnLongClickListener {
        ...
        RestartActivityButton(Context context, boolean z) {
            ...
            Drawable drawable = context.getDrawable(C0006R$drawable.btn_restart);
            setImageDrawable(drawable);
            setContentDescription(context.getString(C0015R$string.restart_button_description));
        ...
        public void showHint() {
            if (this.mShowingHint == null) {
                View inflate = LayoutInflater.from(getContext()).inflate(C0011R$layout.size_compat_mode_hint, (ViewGroup) null);
                PopupWindow popupWindow = new PopupWindow(inflate, -2, -2);
                popupWindow.setWindowLayoutType(this.mWinParams.type);
                popupWindow.setElevation(getResources().getDimension(C0005R$dimen.bubble_elevation));
                ...
                Button button = (Button) inflate.findViewById(C0008R$id.got_it);
                button.setBackground(new RippleDrawable(ColorStateList.valueOf(-3355444), null, null));
                button.setOnClickListener(new View.OnClickListener(popupWindow) { // from class: com.android.systemui.-$$Lambda$SizeCompatModeActivityController$RestartActivityButton$tZJkvUnAETgfbkQvNUGL2mQWd9s
        ...
        private /* synthetic */ void lambda$showHint$0$SizeCompatModeActivityController$RestartActivityButton() {
