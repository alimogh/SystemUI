...
public class DividerImeController implements DisplayImeController.ImePositionProcessor {
    ...
    private void startAsyncAnimation() {
        ...
        this.mAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerImeController$w9tTEADRpkU2gnFFBrPgOh19s0k
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DividerImeController.this.lambda$startAsyncAnimation$0$DividerImeController(valueAnimator2);
            }
        });
    ...
    public void pause(int i) {
        this.mHandler.post(new Runnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerImeController$WahrdFPYjNuoSU9XvYFcvsrVnqE
    ...
    public void resume(int i) {
        this.mHandler.post(new Runnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerImeController$BXScwQHRnelwDiQfpGXRr_rI2HQ
            @Override // java.lang.Runnable
            public final void run() {
