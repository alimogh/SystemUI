...
public class WindowManagerProxy {
    ...
    public void dismissOrMaximizeDocked(SplitScreenTaskOrganizer splitScreenTaskOrganizer, SplitDisplayLayout splitDisplayLayout, boolean z) {
        this.mExecutor.execute(new Runnable(splitScreenTaskOrganizer, splitDisplayLayout, z) { // from class: com.android.systemui.stackdivider.-$$Lambda$WindowManagerProxy$rVfdVu_tfFj6B198IbDRYIqAmkk
    ...
    public void setResizing(final boolean z) {
        this.mExecutor.execute(new Runnable(this) { // from class: com.android.systemui.stackdivider.WindowManagerProxy.2
            @Override // java.lang.Runnable
            public void run() {
                try {
    ...
    public boolean applyEnterSplit(SplitScreenTaskOrganizer splitScreenTaskOrganizer, SplitDisplayLayout splitDisplayLayout) {
        ...
        for (int size = rootTasks.size() - 1; size >= 0; size--) {
            ...
            if ((runningTaskInfo.isResizeable || runningTaskInfo.topActivityType == 2) && runningTaskInfo.configuration.windowConfiguration.getWindowingMode() == 1) {
    ...
    public void lambda$dismissOrMaximizeDocked$0(SplitScreenTaskOrganizer splitScreenTaskOrganizer, SplitDisplayLayout splitDisplayLayout, boolean z) {
        ...
        rootTasks.removeIf(new Predicate() { // from class: com.android.systemui.stackdivider.-$$Lambda$WindowManagerProxy$a7UL3QZ0yLpefq_HcLMSf4F6Xoo
