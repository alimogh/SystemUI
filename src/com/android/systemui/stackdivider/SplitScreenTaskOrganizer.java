...
public class SplitScreenTaskOrganizer extends TaskOrganizer {
    ...
    public void onTaskInfoChanged(ActivityManager.RunningTaskInfo runningTaskInfo) {
        Log.i("SplitScreenTaskOrg", "onTaskInfoChanged: , taskInfo.displayId:" + runningTaskInfo.displayId);
        if (runningTaskInfo.displayId == 0) {
            this.mDivider.getHandler().post(new Runnable(runningTaskInfo) { // from class: com.android.systemui.stackdivider.-$$Lambda$SplitScreenTaskOrganizer$VFKjLFziXUrC1SQQoEI4rRScXR8
