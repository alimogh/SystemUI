...
public class DividerView extends FrameLayout implements View.OnTouchListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public DividerView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mHandleDelegate = new View.AccessibilityDelegate() { // from class: com.android.systemui.stackdivider.DividerView.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (DividerView.this.isHorizontalDivision()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_full, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_top_full)));
                    if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_70, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_top_70)));
                    }
                    if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_50, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_top_50)));
                    }
                    if (snapAlgorithm.isLastSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_30, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_top_30)));
                    }
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_rb_full, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_bottom_full)));
                    return;
                }
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_full, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_left_full)));
                if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_70, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_left_70)));
                }
                if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_50, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_left_50)));
                }
                if (snapAlgorithm.isLastSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_tl_30, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_left_30)));
                }
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0008R$id.action_move_rb_full, ((FrameLayout) DividerView.this).mContext.getString(C0015R$string.accessibility_action_divider_right_full)));
            }
            ...
            public boolean performAccessibilityAction(View view, int i3, Bundle bundle) {
                ...
                if (i3 == C0008R$id.action_move_tl_full) {
                    dismissStartTarget = snapAlgorithm.getDismissEndTarget();
                } else if (i3 == C0008R$id.action_move_tl_70) {
                    dismissStartTarget = snapAlgorithm.getLastSplitTarget();
                } else if (i3 == C0008R$id.action_move_tl_50) {
                    dismissStartTarget = snapAlgorithm.getMiddleTarget();
                } else if (i3 == C0008R$id.action_move_tl_30) {
                    dismissStartTarget = snapAlgorithm.getFirstSplitTarget();
                } else {
                    dismissStartTarget = i3 == C0008R$id.action_move_rb_full ? snapAlgorithm.getDismissStartTarget() : null;
                }
        ...
        this.mUpdateEmbeddedMatrix = new Runnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$gYHlgbXuNmQPZwegMVIGXJIPqrw
            @Override // java.lang.Runnable
    ...
    public void onFinishInflate() {
        ...
        this.mHandle = (DividerHandleView) findViewById(C0008R$id.docked_divider_handle);
        this.mBackground = findViewById(C0008R$id.docked_divider_background);
        this.mMinimizedShadow = (MinimizedDockShadow) findViewById(C0008R$id.minimized_dock_shadow);
        this.mHandle.setOnTouchListener(this);
        int dimensionPixelSize = getResources().getDimensionPixelSize(17105175);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(17105174);
        this.mDividerInsets = dimensionPixelSize2;
        this.mDividerSize = dimensionPixelSize - (dimensionPixelSize2 * 2);
        this.mTouchElevation = getResources().getDimensionPixelSize(C0005R$dimen.docked_stack_divider_lift_elevation);
        this.mLongPressEntraceAnimDuration = getResources().getInteger(C0009R$integer.long_press_dock_anim_duration);
        getResources().getBoolean(C0003R$bool.recents_grow_in_multiwindow);
    ...
    public void setHidden(boolean z) {
        if (this.mSurfaceHidden != z) {
            ...
            post(new Runnable(z) { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$TP32kTCyKLx_1f9AtbEqSDBRQpc
    ...
    private ValueAnimator getFlingAnimator(int i, DividerSnapAlgorithm.SnapTarget snapTarget, final long j) {
        ...
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(z, snapTarget) { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$u5GQHsrRvt8_5w1XNqzKKcI9oT8
            public final /* synthetic */ boolean f$1;
        ...
        final $$Lambda$DividerView$tccy1KLrWHo7BodDaNEbFmJ9inc r0 = new Consumer(snapTarget) { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$tccy1KLrWHo7BodDaNEbFmJ9inc
        ...
        ofInt.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.stackdivider.DividerView.3
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                DividerView.this.mHandler.postDelayed(new Runnable(r0, Boolean.valueOf(this.mCancelled)) { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$3$46R0aXdd2QIwTYyQi54oXkaDuIU
    ...
    public void enterSplitMode(boolean z) {
        post(new Runnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$j0_a3lVKLSVmfH3PyfTxFs9nesg
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void setResizeDimLayer(SurfaceControl.Transaction transaction, boolean z, float f) {
        ...
        if (surfaceControl == null) {
            Slog.d("DividerView", "setResizeDimLayer SurfaceControl is null.");
        } else if (f <= 0.001f) {
    ...
    public void onRecentsDrawn() {
        ...
        if (dividerState.animateAfterRecentsDrawn) {
            ...
            this.mHandler.post(new Runnable(calculatePositionForInsetBounds) { // from class: com.android.systemui.stackdivider.-$$Lambda$DividerView$sxEYNP7KxoTbmEvg7gYGZZnnOWQ
