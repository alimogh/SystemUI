...
public class SyncTransactionQueue {
    ...
    private final Runnable mOnReplyTimeout = new Runnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$SyncTransactionQueue$3R1SopzfkzcMF9bQ5SW13TqpBDA
    ...
    public class SyncCallback extends WindowContainerTransactionCallback {
        ...
        public void onTransactionReady(int i, SurfaceControl.Transaction transaction) {
            SyncTransactionQueue.this.mHandler.post(new Runnable(i, transaction) { // from class: com.android.systemui.stackdivider.-$$Lambda$SyncTransactionQueue$SyncCallback$6QadB1gd3-1ucfrIts4w_5mHJHE
