...
public class Divider extends SystemUI implements DividerView.DividerCallbacks, DisplayController.OnDisplaysChangedListener {
    private TaskStackChangeListener mActivityRestartListener = new TaskStackChangeListener() { // from class: com.android.systemui.stackdivider.Divider.1
    ...
    private DisplayChangeController.OnDisplayChangingListener mRotationController = new DisplayChangeController.OnDisplayChangingListener() { // from class: com.android.systemui.stackdivider.-$$Lambda$Divider$0WHTGcDpweqOnqzkpJAQb7brKYs
    ...
    public void onDisplayConfigurationChanged(int i, Configuration configuration) {
        if (i != 0 || !this.mSplits.isSplitScreenSupported()) {
            Slog.i("Divider", "onDisplayConfigurationChanged return, displayId:" + i + ", mSplits.isSplitScreenSupported():" + this.mSplits.isSplitScreenSupported());
            return;
        }
    ...
    private void addDivider(Configuration configuration) {
        ...
        this.mView = (DividerView) LayoutInflater.from(displayContext).inflate(C0011R$layout.docked_stack_divider, (ViewGroup) null);
        ...
        int dimensionPixelSize = displayContext.getResources().getDimensionPixelSize(17105175);
    ...
    private void update(Configuration configuration) {
        ...
        Slog.i("Divider", "update, isDividerHidden:" + z + ", stack: " + Debug.getCallers(7));
        removeDivider();
    ...
    public void onTaskVanished() {
        this.mHandler.post(new Runnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$Divider$JQC7s2DcACmP1thtllRZ30N2PIw
    ...
    private void updateVisibility(boolean z) {
        if (this.mVisible != z) {
            ...
            if (z) {
                ...
                this.mWindowManagerProxy.runInSync(new SyncTransactionQueue.TransactionRunnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$Divider$PFK1wU0r4FZbucBwkJAZvajxzCU
                ...
                this.mWindowManagerProxy.runInSync(new SyncTransactionQueue.TransactionRunnable() { // from class: com.android.systemui.stackdivider.-$$Lambda$Divider$VIerqJCgwVozy2YX14uply8NzWc
                    @Override // com.android.systemui.stackdivider.SyncTransactionQueue.TransactionRunnable
                    public final void runWithTransaction(SurfaceControl.Transaction transaction) {
            ...
            synchronized (this.mDockedStackExistsListeners) {
                this.mDockedStackExistsListeners.removeIf(new Predicate(z) { // from class: com.android.systemui.stackdivider.-$$Lambda$Divider$fg71CWqbbHGuQEcI_sx-8tNWcJg
    ...
    public void setMinimized(boolean z) {
        this.mHandler.post(new Runnable(z) { // from class: com.android.systemui.stackdivider.-$$Lambda$Divider$qaeq-4YZm8Jheg2TUOpTbHIkGx8
    ...
    public long getAnimDuration() {
        return (long) (Settings.Global.getFloat(this.mContext.getContentResolver(), "transition_animation_scale", this.mContext.getResources().getFloat(17105050)) * 336.0f);
    }
