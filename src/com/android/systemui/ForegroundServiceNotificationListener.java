...
public class ForegroundServiceNotificationListener {
    ...
    private void updateNotification(NotificationEntry notificationEntry, int i) {
        ...
        this.mForegroundServiceController.updateUserState(sbn.getUserId(), new ForegroundServiceController.UserStateUpdateCallback(sbn, i, notificationEntry) { // from class: com.android.systemui.-$$Lambda$ForegroundServiceNotificationListener$bKAGLLFV59EYZBLeV36rpndtUhU
