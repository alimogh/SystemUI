...
public class GlobalActionsComponent extends SystemUI implements CommandQueue.Callbacks, GlobalActions.GlobalActionsManager {
    ...
    public void start() {
        ...
        newExtension.withDefault(new Supplier() { // from class: com.android.systemui.globalactions.-$$Lambda$_JK3806lHhx7U5FWWTWu23JrO_A
            @Override // java.util.function.Supplier
            public final Object get() {
                return (GlobalActions) Provider.this.get();
            }
        });
        newExtension.withCallback(new Consumer() { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsComponent$bGplH0pcKhfpL1pOMBpgWKJntvw
    ...
    @Override // com.android.systemui.plugins.GlobalActions.GlobalActionsManager
    public void op_reboot(boolean z, String str, boolean z2) {
        try {
            this.mBarService.op_reboot(z, str, z2);
        } catch (RemoteException unused) {
        }
    }
}
