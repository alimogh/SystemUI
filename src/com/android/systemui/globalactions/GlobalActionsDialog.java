...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, ConfigurationController.ConfigurationListener, GlobalActionsPanelPlugin.Callbacks, LifecycleOwner {
    ...
    private ContentObserver mAirplaneModeObserver = new ContentObserver(this.mMainHandler) { // from class: com.android.systemui.globalactions.GlobalActionsDialog.9
    ...
    public GlobalActionsDialog(Context context, GlobalActions.GlobalActionsManager globalActionsManager, AudioManager audioManager, IDreamManager iDreamManager, DevicePolicyManager devicePolicyManager, LockPatternUtils lockPatternUtils, BroadcastDispatcher broadcastDispatcher, ConnectivityManager connectivityManager, TelephonyManager telephonyManager, ContentResolver contentResolver, Vibrator vibrator, Resources resources, ConfigurationController configurationController, ActivityStarter activityStarter, KeyguardStateController keyguardStateController, UserManager userManager, TrustManager trustManager, IActivityManager iActivityManager, TelecomManager telecomManager, MetricsLogger metricsLogger, NotificationShadeDepthController notificationShadeDepthController, SysuiColorExtractor sysuiColorExtractor, IStatusBarService iStatusBarService, NotificationShadeWindowController notificationShadeWindowController, IWindowManager iWindowManager, Executor executor, UiEventLogger uiEventLogger, RingerModeTracker ringerModeTracker, SysUiState sysUiState, Handler handler, ControlsComponent controlsComponent, CurrentUserContextTracker currentUserContextTracker) {
        ...
        boolean z = !resources.getBoolean(17891577);
    ...
    private /* synthetic */ void lambda$new$0$GlobalActionsDialog(Integer num) {
        this.mHandler.sendEmptyMessage(1);
    }

    /* access modifiers changed from: public */
    /* renamed from: lambda$new$1 */
    private /* synthetic */ void lambda$new$1$GlobalActionsDialog(List list) {
    ...
    private void seedFavorites() {
        if (this.mControlsControllerOptional.isPresent() && !this.mControlsServiceInfos.isEmpty()) {
            String[] stringArray = this.mContext.getResources().getStringArray(C0001R$array.config_controlsPreferredPackages);
            ...
            if (!arrayList.isEmpty()) {
                this.mControlsControllerOptional.get().seedFavoritesForComponents(arrayList, new Consumer(sharedPreferences) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$EJt8cxa32l15bNtCDpbH4THSAbg
    ...
    private /* synthetic */ void lambda$seedFavorites$2$GlobalActionsDialog(SharedPreferences sharedPreferences, SeedResponse seedResponse) {
    ...
    public int getMaxShownPowerItems() {
        return this.mResources.getInteger(C0009R$integer.power_menu_max_columns);
    }
    ...
    public String[] getDefaultActions() {
        return this.mResources.getStringArray(17236043);
    }
    ...
    private ActionsDialog createDialog() {
        ...
        ActionsDialog actionsDialog = new ActionsDialog(this.mContext, this.mAdapter, this.mOverflowAdapter, getWalletViewController(), this.mDepthController, this.mSysuiColorExtractor, this.mStatusBarService, this.mNotificationShadeWindowController, controlsAvailable(), (!this.mControlsUiControllerOptional.isPresent() || !shouldShowControls()) ? null : this.mControlsUiControllerOptional.get(), this.mSysUiState, new Runnable() { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$jlxsGoRx8E3djFav9gCad5fjKg0
    ...
    public final class PowerOptionsAction extends SinglePressAction {
        ...
        @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
        public void onPress() {
            ActionsDialog actionsDialog = this.this$0.mDialog;
            if (actionsDialog != null) {
    ...
    public final class ShutDownAction extends SinglePressAction implements LongPressAction {
        ...
        private ShutDownAction() {
            super(r3, C0006R$drawable.op_ic_lock_power_off, 17040259);
    ...
    public abstract class EmergencyAction extends SinglePressAction {
        ...
        public View create(Context context, View view, ViewGroup viewGroup, LayoutInflater layoutInflater) {
            ...
            create.setBackgroundTintList(ColorStateList.valueOf(create.getResources().getColor(C0004R$color.op_control_state_color_error_dark)));
            int color = create.getResources().getColor(C0004R$color.op_control_text_color_primary_dark);
            TextView textView = (TextView) create.findViewById(16908299);
            textView.setTextColor(color);
            textView.setSelected(true);
            ((ImageView) create.findViewById(16908294)).getDrawable().setTint(create.getResources().getColor(C0004R$color.op_control_icon_color_active_dark));
            return create;
        }
    }
    ...
    public class EmergencyAffordanceAction extends EmergencyAction {
        ...
        EmergencyAffordanceAction() {
            super(r3, C0006R$drawable.ic_emergency_star, 17040255);
            GlobalActionsDialog.this = r3;
        }
    ...
    public class EmergencyDialerAction extends EmergencyAction {
        ...
        private EmergencyDialerAction() {
            super(r3, C0006R$drawable.ic_emergency_star, C0015R$string.global_action_emergency);
            GlobalActionsDialog.this = r3;
        }
    ...
    public final class RestartAction extends SinglePressAction implements LongPressAction {
        ...
        private RestartAction() {
            super(r3, C0006R$drawable.op_ic_restart, 17040261);
            GlobalActionsDialog.this = r3;
        }
    ...
    public class ScreenshotAction extends SinglePressAction implements LongPressAction {
        ...
        public ScreenshotAction() {
            super(r3, C0006R$drawable.ic_global_action_screenshot, 17040262);
            GlobalActionsDialog.this = r3;
        }
    ...
    public final class LogoutAction extends SinglePressAction {
        ...
        private /* synthetic */ void lambda$onPress$0$GlobalActionsDialog$LogoutAction() {
            try {
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302818, 17040263) { // from class: com.android.systemui.globalactions.GlobalActionsDialog.3
            @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302299, 17040253) { // from class: com.android.systemui.globalactions.GlobalActionsDialog.4
            @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302860, 17040267) { // from class: com.android.systemui.globalactions.GlobalActionsDialog.5
            @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
            public boolean showBeforeProvisioning() {
                return true;
            }
    ...
    public class LockDownAction extends SinglePressAction {
        ...
        public void onPress() {
            ...
            GlobalActionsDialog.this.mHandler.postDelayed(new Runnable() { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$LockDownAction$XAwczE30yz6IBOlgb2Bdgs7PPO4
                @Override // java.lang.Runnable
                public final void run() {
                    GlobalActionsDialog.LockDownAction.this.lambda$onPress$1$GlobalActionsDialog$LockDownAction();
                }
            }, 300);
        }

        /* access modifiers changed from: public */
        /* renamed from: lambda$onPress$1 */
        private /* synthetic */ void lambda$onPress$1$GlobalActionsDialog$LockDownAction() {
            try {
        ...
        /* access modifiers changed from: public */
        /* renamed from: lambda$onPress$0 */
        private /* synthetic */ void lambda$onPress$0$GlobalActionsDialog$LockDownAction() {
        ...
        if (this.mUserManager.isUserSwitcherEnabled()) {
            for (final UserInfo userInfo2 : this.mUserManager.getUsers()) {
                if (userInfo2.supportsSwitchToByUser()) {
                    ...
                    sb.append(str2);
                    sb.append(z ? " ✔" : "");
                    addIfShouldShowAction(list, new SinglePressAction(17302690, createFromPath, sb.toString()) { // from class: com.android.systemui.globalactions.GlobalActionsDialog.6
                        @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
                        public boolean showBeforeProvisioning() {
                            return false;
                        }
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        ...
        this.mUpdateMonitor.setShutdownDialogVisible(false);
    }
    ...
    public void onShow(DialogInterface dialogInterface) {
        ...
        this.mUpdateMonitor.setShutdownDialogVisible(true);
    }
    ...
    public class MyAdapter extends MultiListLayout.MultiListAdapter {
        ...
        private int countItems(boolean z) {
            ...
            for (int i2 = 0; i2 < GlobalActionsDialog.this.mItems.size(); i2++) {
                Action action = GlobalActionsDialog.this.mItems.get(i2);
                if (GlobalActionsDialog.this.shouldShowAction(action) && action.shouldBeSeparated() == z) {
                    i++;
                }
            }
            return i;
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            create.setOnClickListener(new View.OnClickListener(i) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$MyAdapter$mHwNDdvU6gX4bdQUg9ucB10QA0w
                ...
                public final void onClick(View view2) {
                    GlobalActionsDialog.MyAdapter.this.lambda$getView$0$GlobalActionsDialog$MyAdapter(this.f$1, view2);
                }
            });
            if (item instanceof LongPressAction) {
                create.setOnLongClickListener(new View.OnLongClickListener(i) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$MyAdapter$VSUDyewgk86XHamZik1hS11jzxk
                    public final /* synthetic */ int f$1;
                    ...
                    public final boolean onLongClick(View view2) {
                        return GlobalActionsDialog.MyAdapter.this.lambda$getView$1$GlobalActionsDialog$MyAdapter(this.f$1, view2);
                    }
                });
            }
            return create;
        ...
        private /* synthetic */ void lambda$getView$0$GlobalActionsDialog$MyAdapter(int i, View view) {
            onClickItem(i);
        }

        /* access modifiers changed from: public */
        /* renamed from: lambda$getView$1 */
        private /* synthetic */ boolean lambda$getView$1$GlobalActionsDialog$MyAdapter(int i, View view) {
    ...
    public class MyPowerOptionsAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            int i2 = C0011R$layout.global_actions_power_item;
            if (view == null) {
                view = LayoutInflater.from(GlobalActionsDialog.this.mContext).inflate(i2, viewGroup, false);
            }
            view.setOnClickListener(new View.OnClickListener(i) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$MyPowerOptionsAdapter$1Eh2DubmssVYkSJim0aUqOlbRwo
                public final /* synthetic */ int f$1;
                ...
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    GlobalActionsDialog.MyPowerOptionsAdapter.this.lambda$getView$0$GlobalActionsDialog$MyPowerOptionsAdapter(this.f$1, view2);
                }
            });
            if (item instanceof LongPressAction) {
                view.setOnLongClickListener(new View.OnLongClickListener(i) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$MyPowerOptionsAdapter$6pRTHtt8NeZPwBRYp6m27hpqOuU
                    public final /* synthetic */ int f$1;
                    ...
                    @Override // android.view.View.OnLongClickListener
                    public final boolean onLongClick(View view2) {
                        return GlobalActionsDialog.MyPowerOptionsAdapter.this.lambda$getView$1$GlobalActionsDialog$MyPowerOptionsAdapter(this.f$1, view2);
                    }
                });
            }
        ...
        /* access modifiers changed from: public */
        /* renamed from: lambda$getView$0 */
        private /* synthetic */ void lambda$getView$0$GlobalActionsDialog$MyPowerOptionsAdapter(int i, View view) {
            onClickItem(i);
        }

        /* access modifiers changed from: public */
        /* renamed from: lambda$getView$1 */
        private /* synthetic */ boolean lambda$getView$1$GlobalActionsDialog$MyPowerOptionsAdapter(int i, View view) {
            return onLongClickItem(i);
        }
    ...
    public class MyOverflowAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            int i2 = C0011R$layout.controls_more_item;
            if (view == null) {
                view = LayoutInflater.from(GlobalActionsDialog.this.mContext).inflate(i2, viewGroup, false);
            }
    ...
    public abstract class SinglePressAction implements Action {
        ...
        @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
        public View create(Context context, View view, ViewGroup viewGroup, LayoutInflater layoutInflater) {
            View inflate = layoutInflater.inflate(C0011R$layout.global_actions_grid_item_v2, viewGroup, false);
    ...
    public class AirplaneModeAction extends ToggleAction {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        AirplaneModeAction() {
            super(r8, 17302467, 17302469, 17040271, 17040270, 17040269);
    ...
    public class SilentModeToggleAction extends ToggleAction {
        ...
        public SilentModeToggleAction() {
            super(r8, 17302317, 17302316, 17040266, 17040265, 17040264);
            GlobalActionsDialog.this = r8;
        }
    ...
    public static class SilentModeTriStateAction implements Action, View.OnClickListener {
        private final int[] ITEM_IDS = {16909258, 16909259, 16909260};
        private final AudioManager mAudioManager;
    ...
    public static final class ActionsDialog extends Dialog implements DialogInterface, ColorExtractor.OnColorsChangedListener {
        ...
        ActionsDialog(Context context, MyAdapter myAdapter, MyOverflowAdapter myOverflowAdapter, GlobalActionsPanelPlugin.PanelViewController panelViewController, NotificationShadeDepthController notificationShadeDepthController, SysuiColorExtractor sysuiColorExtractor, IStatusBarService iStatusBarService, NotificationShadeWindowController notificationShadeWindowController, boolean z, ControlsUiController controlsUiController, SysUiState sysUiState, Runnable runnable, boolean z2, MyPowerOptionsAdapter myPowerOptionsAdapter) {
            super(context, C0016R$style.Theme_SystemUI_Dialog_GlobalActions);
            this.mContext = context;
        ...
        private void showControls(ControlsUiController controlsUiController) {
            this.mControlsUiController = controlsUiController;
            controlsUiController.show(this.mControlsView, new Runnable() { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$ActionsDialog$pdjB9IUZqjM8heY8C5-6yJKk6nA
                @Override // java.lang.Runnable
                public final void run() {
        ...
        private void initializeWalletView() {
            ...
            if (panelViewController != null && panelViewController.getPanelContent() != null) {
                ...
                if (rotation == 0) {
                    ...
                    FrameLayout frameLayout = (FrameLayout) findViewById(C0008R$id.global_actions_wallet);
                    FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -1);
                    if (!this.mControlsAvailable) {
                        layoutParams.topMargin = this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.global_actions_wallet_top_margin);
                    }
                    View panelContent = this.mWalletViewController.getPanelContent();
                    frameLayout.addView(panelContent, layoutParams);
                    ViewGroup viewGroup = (ViewGroup) findViewById(C0008R$id.global_actions_grid_root);
                    if (viewGroup != null) {
                        panelContent.addOnLayoutChangeListener(new View.OnLayoutChangeListener(viewGroup) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$ActionsDialog$1RYmYsH7EaEqXQvxS03WLknm2g4
        ...
        private /* synthetic */ void lambda$initializeWalletView$0$GlobalActionsDialog$ActionsDialog() {
            RotationPolicy.setRotationLockAtAngle(this.mContext, false, 0);
        }

        /* access modifiers changed from: public */
        /* renamed from: lambda$initializeWalletView$1 */
        private /* synthetic */ void lambda$initializeWalletView$1$GlobalActionsDialog$ActionsDialog() {
        ...
        private ListPopupWindow createPowerOverflowPopup() {
            GlobalActionsPopupMenu globalActionsPopupMenu = new GlobalActionsPopupMenu(this.mContext, false);
            ...
            globalActionsPopupMenu.setAnchorView(findViewById(C0008R$id.global_actions_overflow_button));
        ...
        private /* synthetic */ void lambda$createPowerOverflowPopup$3$GlobalActionsDialog$ActionsDialog(AdapterView adapterView, View view, int i, long j) {
            this.mOverflowAdapter.onClickItem(i);
        }

        /* access modifiers changed from: public */
        /* renamed from: lambda$createPowerOverflowPopup$4 */
        private /* synthetic */ boolean lambda$createPowerOverflowPopup$4$GlobalActionsDialog$ActionsDialog(AdapterView adapterView, View view, int i, long j) {
        ...
        private void initializeLayout() {
            setContentView(C0011R$layout.global_actions_grid_v2);
            fixNavBarClipping();
            this.mControlsView = (ViewGroup) findViewById(C0008R$id.global_actions_controls);
            MultiListLayout multiListLayout = (MultiListLayout) findViewById(C0008R$id.global_actions_view);
            ...
            multiListLayout.setListViewAccessibilityDelegate(new View.AccessibilityDelegate() { // from class: com.android.systemui.globalactions.GlobalActionsDialog.ActionsDialog.1
                ...
                public boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
                    accessibilityEvent.getText().add(ActionsDialog.this.mContext.getString(17040268));
                    return true;
                }
            });
            ...
            this.mContainer = (ViewGroup) findViewById(C0008R$id.global_actions_container);
            this.mLockMessageContainer = (ViewGroup) requireViewById(C0008R$id.global_actions_lock_message_container);
            this.mLockMessage = (TextView) requireViewById(C0008R$id.global_actions_lock_message);
            View findViewById = findViewById(C0008R$id.global_actions_overflow_button);
        ...
        private /* synthetic */ void lambda$initializeLayout$5$GlobalActionsDialog$ActionsDialog(View view) {
        ...
        public void show() {
            ...
            viewGroup.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener(viewGroup) { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$ActionsDialog$CP6yrx-HlmH5eBtWjRBI0YZx3uM
                public final /* synthetic */ ViewGroup f$0;
        ...
        private /* synthetic */ void lambda$show$7$GlobalActionsDialog$ActionsDialog(ValueAnimator valueAnimator) {
        ...
        private /* synthetic */ void lambda$dismiss$9$GlobalActionsDialog$ActionsDialog() {
        ...
        private /* synthetic */ void lambda$dismiss$8$GlobalActionsDialog$ActionsDialog(ValueAnimator valueAnimator) {
        ...
        private /* synthetic */ void lambda$dismissForControlsActivity$10$GlobalActionsDialog$ActionsDialog() {
        ...
        public void refreshDialog() {
            ...
            if (controlsUiController2 != null) {
                controlsUiController2.show(this.mControlsView, new Runnable() { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$ActionsDialog$pdjB9IUZqjM8heY8C5-6yJKk6nA
                    @Override // java.lang.Runnable
                    public final void run() {
                        GlobalActionsDialog.ActionsDialog.m15lambda$pdjB9IUZqjM8heY8C56yJKk6nA(GlobalActionsDialog.ActionsDialog.this);
                    }
        ...
        public void hideLockMessage() {
            if (this.mLockMessageContainer.getVisibility() == 0) {
                this.mLockMessageContainer.animate().alpha(0.0f).setDuration(150).setListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.globalactions.GlobalActionsDialog.ActionsDialog.3
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
        ...
        public void showLockMessage() {
            Drawable drawable = this.mContext.getDrawable(17302466);
            drawable.setTint(this.mContext.getColor(C0004R$color.control_primary_text));
    ...
    private boolean isAdvancedRebootEnabled() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "advanced_reboot", 0) != 0;
    }

    public final class RecoveryAction extends SinglePressAction {
        @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
        public boolean showBeforeProvisioning() {
            return false;
        }
        ...
        private RecoveryAction() {
            super(r3, C0006R$drawable.ic_recovery, C0015R$string.zzz_op_global_action_recovery);
            GlobalActionsDialog.this = r3;
        }

        @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
        public void onPress() {
            GlobalActionsDialog.this.mHandler.postDelayed(new Runnable() { // from class: com.android.systemui.globalactions.-$$Lambda$GlobalActionsDialog$RecoveryAction$odIMTe-NSZ26X-XtvuLjBVfOymY
                @Override // java.lang.Runnable
                public final void run() {
                    GlobalActionsDialog.RecoveryAction.this.lambda$onPress$0$GlobalActionsDialog$RecoveryAction();
                }
            }, 500);
        }
        ...
        /* access modifiers changed from: public */
        /* renamed from: lambda$onPress$0 */
        private /* synthetic */ void lambda$onPress$0$GlobalActionsDialog$RecoveryAction() {
            GlobalActionsDialog.this.mWindowManagerFuncs.op_reboot(false, "recovery", false);
        }
    }

    public final class BootloaderAction extends SinglePressAction {
        @Override // com.android.systemui.globalactions.GlobalActionsDialog.Action
        public boolean showBeforeProvisioning() {
            return false;
        }
        ...
        private BootloaderAction() {
            super(r3, C0006R$drawable.ic_bootloader, C0015R$string.zzz_op_global_action_bootloader);
            GlobalActionsDialog.this = r3;
        }
