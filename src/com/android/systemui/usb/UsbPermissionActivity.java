    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (this.mDevice == null) {
                alertParams.mMessage = getString(C0015R$string.usb_accessory_permission_prompt, new Object[]{charSequence, this.mAccessory.getDescription()});
                ...
                if (z) {
                    i = C0015R$string.usb_device_permission_prompt_warn;
                } else {
                    i = C0015R$string.usb_device_permission_prompt;
                }
            ...
            if (!z && booleanExtra && !(this.mDevice == null && this.mAccessory == null)) {
                ...
                if (usbDevice == null) {
                    checkBox.setText(getString(C0015R$string.always_use_accessory, new Object[]{charSequence, this.mAccessory.getDescription()}));
                } else {
                    checkBox.setText(getString(C0015R$string.always_use_device, new Object[]{charSequence, usbDevice.getProductName()}));
                }
                this.mAlwaysUse.setOnCheckedChangeListener(this);
                TextView textView = (TextView) alertParams.mView.findViewById(16908844);
