    ...
    public void onCreate(Bundle bundle) {
        ...
        if ("http".equals(scheme) || "https".equals(scheme)) {
            ...
            if (description == null || description.length() == 0) {
                alertParams.mTitle = getString(C0015R$string.title_usb_accessory);
            }
            alertParams.mMessage = getString(C0015R$string.usb_accessory_uri_prompt, new Object[]{this.mUri});
            alertParams.mPositiveButtonText = getString(C0015R$string.label_view);
