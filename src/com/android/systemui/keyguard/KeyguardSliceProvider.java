...
public class KeyguardSliceProvider extends SliceProvider implements NextAlarmController.NextAlarmChangeCallback, ZenModeController.Callback, NotificationMediaManager.MediaListener, StatusBarStateController.StateListener, SystemUIAppComponentFactory.ContextInitializer {
    ...
    public void addZenModeLocked(ListBuilder listBuilder) {
        if (isDndOn()) {
            ...
            rowBuilder.setContentDescription(getContext().getResources().getString(C0015R$string.accessibility_quick_settings_dnd));
    ...
    public boolean onCreateSliceProvider() {
        ...
        synchronized (sInstanceLock) {
            ...
            this.mDatePattern = getContext().getString(C0015R$string.system_ui_aod_date_pattern);
        ...
        synchronized (this) {
            ...
            if (triggerTime > 0) {
                try {
                    ...
                    Log.e("KeyguardSliceProvider", "can't setExact alarm : " + e);
                }
            }
        }
        updateNextAlarm();
    ...
    public void onPrimaryMetadataOrStateChanged(MediaMetadata mediaMetadata, int i) {
        synchronized (this) {
            ...
            if (!this.mMediaIsVisible || isPlayingState || this.mStatusBarState == 0) {
                ...
                this.mMediaHandler.postDelayed(new Runnable(mediaMetadata, i) { // from class: com.android.systemui.keyguard.-$$Lambda$KeyguardSliceProvider$ZXZ19al6fy8sNCp7cWhRFX26Q9o
    ...
    private void updateMediaStateLocked(MediaMetadata mediaMetadata, int i) {
        ...
        if (mediaMetadata != null) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = getContext().getResources().getString(C0015R$string.music_controls_no_title);
            }
        } else {
            charSequence = null;
        }
