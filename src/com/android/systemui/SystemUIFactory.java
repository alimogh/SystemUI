...
public class SystemUIFactory {
    ...
    public static void createFromConfig(Context context) {
        if (mFactory == null) {
            String string = context.getString(C0015R$string.config_systemUIFactoryComponent);
    ...
    public String[] getSystemUIServiceComponents(Resources resources) {
        return resources.getStringArray(C0001R$array.config_systemUIServiceComponents);
    }

    public String[] getSystemUIServiceComponentsPerUser(Resources resources) {
        return resources.getStringArray(C0001R$array.config_systemUIServiceComponentsPerUser);
    }
