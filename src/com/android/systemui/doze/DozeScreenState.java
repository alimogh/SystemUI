...
public class DozeScreenState implements DozeMachine.Part {
    ...
    private static final int ENTER_DOZE_DELAY = SystemProperties.getInt("debug.doze_delay_time", 1000);
    ...
    public void transitionTo(DozeMachine.State state, DozeMachine.State state2) {
        ...
        if (state2 == DozeMachine.State.FINISH) {
            ...
            if (hasCallbacks || z5 || z2 || z3) {
                ...
                if (state2 == DozeMachine.State.DOZE_AOD && ((this.mParameters.shouldControlScreenOff() || updateMonitor.isAlwaysOnEnabled()) && !z3)) {
                    z = true;
                }
                if (z) {
                ...
                if (!hasCallbacks) {
                    ...
                    if (z) {
                        this.mHandler.postDelayed(this.mApplyPendingScreenState, (long) ENTER_DOZE_DELAY);
                    } else {
                ...
                this.mDozeHost.prepareForGentleSleep(new Runnable(screenState) { // from class: com.android.systemui.doze.-$$Lambda$DozeScreenState$Q7dH1ne3iIuPaAubBMflNieFfwI
