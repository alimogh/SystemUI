...
public final class PhysicsAnimator<T> {
    ...
    private PhysicsAnimator(T t) {
        ...
        this.startAction = new Function0<Unit>(this) { // from class: com.android.systemui.util.animation.PhysicsAnimator$startAction$1
            ...
            public final String getSignature() {
                return "startInternal$packages__apps__OPSystemUI__android_common__OPSystemUI_core()V";
            }

            @Override // kotlin.jvm.functions.Function0
            public final void invoke() {
                ((PhysicsAnimator) this.receiver).startInternal$packages__apps__OPSystemUI__android_common__OPSystemUI_core();
            }
        };
        this.cancelAction = new Function1<Set<? extends FloatPropertyCompat<? super T>>, Unit>(this) { // from class: com.android.systemui.util.animation.PhysicsAnimator$cancelAction$1
            @Override // kotlin.jvm.internal.CallableReference
            public final String getName() {
            ...
            @Override // kotlin.jvm.internal.CallableReference
            public final String getSignature() {
                return "cancelInternal$packages__apps__OPSystemUI__android_common__OPSystemUI_core(Ljava/util/Set;)V";
            }
            ...
            public final void invoke(@NotNull Set<? extends FloatPropertyCompat<? super T>> set) {
                ...
                ((PhysicsAnimator) this.receiver).cancelInternal$packages__apps__OPSystemUI__android_common__OPSystemUI_core(set);
            }
        };
    }
    ...
    @NotNull
    public final ArrayList<PhysicsAnimator<T>.InternalListener> getInternalListeners$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
    ...
    public final PhysicsAnimator<T> spring(@NotNull FloatPropertyCompat<? super T> floatPropertyCompat, float f, float f2, @NotNull SpringConfig springConfig) {
        ...
        spring(floatPropertyCompat, f, f2, springConfig.getStiffness$packages__apps__OPSystemUI__android_common__OPSystemUI_core(), springConfig.getDampingRatio$packages__apps__OPSystemUI__android_common__OPSystemUI_core());
        return this;
    }
    ...
    public final PhysicsAnimator<T> flingThenSpring(@NotNull FloatPropertyCompat<? super T> floatPropertyCompat, float f, @NotNull FlingConfig flingConfig, @NotNull SpringConfig springConfig, boolean z) {
        ...
        float min$packages__apps__OPSystemUI__android_common__OPSystemUI_core = i < 0 ? flingConfig.getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core() : flingConfig.getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core();
        if (!z || !isValidValue(min$packages__apps__OPSystemUI__android_common__OPSystemUI_core)) {
            copy$default.setStartVelocity$packages__apps__OPSystemUI__android_common__OPSystemUI_core(f);
        } else {
            float value = floatPropertyCompat.getValue(t) + (f / (flingConfig.getFriction$packages__apps__OPSystemUI__android_common__OPSystemUI_core() * 4.2f));
            float min$packages__apps__OPSystemUI__android_common__OPSystemUI_core2 = (flingConfig.getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core() + flingConfig.getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core()) / ((float) 2);
            if ((i < 0 && value > min$packages__apps__OPSystemUI__android_common__OPSystemUI_core2) || (f > f2 && value < min$packages__apps__OPSystemUI__android_common__OPSystemUI_core2)) {
                float min$packages__apps__OPSystemUI__android_common__OPSystemUI_core3 = value < min$packages__apps__OPSystemUI__android_common__OPSystemUI_core2 ? flingConfig.getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core() : flingConfig.getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core();
                if (isValidValue(min$packages__apps__OPSystemUI__android_common__OPSystemUI_core3)) {
                    spring(floatPropertyCompat, min$packages__apps__OPSystemUI__android_common__OPSystemUI_core3, f, springConfig);
                    return this;
                }
            }
            float value2 = min$packages__apps__OPSystemUI__android_common__OPSystemUI_core - floatPropertyCompat.getValue(t);
            float friction$packages__apps__OPSystemUI__android_common__OPSystemUI_core = flingConfig.getFriction$packages__apps__OPSystemUI__android_common__OPSystemUI_core() * 4.2f * value2;
            if (value2 > 0.0f && f >= 0.0f) {
                f = Math.max(friction$packages__apps__OPSystemUI__android_common__OPSystemUI_core, f);
            } else if (value2 < 0.0f && f <= 0.0f) {
                f = Math.min(friction$packages__apps__OPSystemUI__android_common__OPSystemUI_core, f);
            }
            copy$default.setStartVelocity$packages__apps__OPSystemUI__android_common__OPSystemUI_core(f);
            copy$default2.setFinalPosition$packages__apps__OPSystemUI__android_common__OPSystemUI_core(min$packages__apps__OPSystemUI__android_common__OPSystemUI_core);
        }
    ...
    public final PhysicsAnimator<T> withEndActions(@NotNull Runnable... runnableArr) {
        ...
        List<T> filterNotNull = ArraysKt.filterNotNull(runnableArr);
        ...
        for (T t : filterNotNull) {
            arrayList2.add(new Function0<Unit>(t) { // from class: com.android.systemui.util.animation.PhysicsAnimator$withEndActions$1$1
                @Override // kotlin.jvm.internal.CallableReference
                public final String getName() {
                    return "run";
                }
    ...
    public final void startInternal$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
        ...
        for (FloatPropertyCompat<? super T> floatPropertyCompat : getAnimatedProperties$packages__apps__OPSystemUI__android_common__OPSystemUI_core()) {
            ...
            if (flingConfig != null) {
                arrayList.add(new Function0<Unit>(this, flingConfig, value, floatPropertyCompat, t) { // from class: com.android.systemui.util.animation.PhysicsAnimator$startInternal$1
                    ...
                    public final void invoke() {
                        ...
                        flingConfig2.setMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core(Math.min(this.$currentValue, flingConfig2.getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core()));
                        flingConfig2.setMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core(Math.max(this.$currentValue, flingConfig2.getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core()));
                        ...
                        this.$flingConfig.applyToAnimation$packages__apps__OPSystemUI__android_common__OPSystemUI_core(flingAnimation);
            ...
            if (springConfig != null) {
                if (flingConfig == null) {
                    ...
                    springConfig.applyToAnimation$packages__apps__OPSystemUI__android_common__OPSystemUI_core(springAnimation);
                    arrayList.add(new Function0<Unit>(springAnimation) { // from class: com.android.systemui.util.animation.PhysicsAnimator$startInternal$2
                        @Override // kotlin.jvm.internal.CallableReference
                        public final String getName() {
                            return "start";
                        }
                    ...
                    this.endListeners.add(0, new EndListener<T>(this, floatPropertyCompat, flingConfig.getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core(), flingConfig.getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core(), springConfig) { // from class: com.android.systemui.util.animation.PhysicsAnimator$startInternal$3
                        final /* synthetic */ FloatPropertyCompat $animatedProperty;
                        ...
                        {
                            this.this$0 = r1;
                            this.$animatedProperty = r2;
                            this.$flingMin = r3;
                            this.$flingMax = r4;
                            this.$springConfig = r5;
                        }

                        @Override // com.android.systemui.util.animation.PhysicsAnimator.EndListener
                        public void onAnimationEnd(T t2, @NotNull FloatPropertyCompat<? super T> floatPropertyCompat2, boolean z, boolean z2, float f, float f2, boolean z3) {
                            Intrinsics.checkParameterIsNotNull(floatPropertyCompat2, "property");
                            boolean z4 = true;
                            if (!(!Intrinsics.areEqual(floatPropertyCompat2, this.$animatedProperty)) && z && !z2) {
                                ...
                                if (z5 || z4) {
                                    this.$springConfig.setStartVelocity$packages__apps__OPSystemUI__android_common__OPSystemUI_core(f2);
                                    if (this.$springConfig.getFinalPosition$packages__apps__OPSystemUI__android_common__OPSystemUI_core() == PhysicsAnimatorKt.UNSET) {
                                        if (z5) {
                                            this.$springConfig.setFinalPosition$packages__apps__OPSystemUI__android_common__OPSystemUI_core(f2 < f3 ? this.$flingMin : this.$flingMax);
                                        } else if (z4) {
                                            ...
                                            springConfig2.setFinalPosition$packages__apps__OPSystemUI__android_common__OPSystemUI_core(f4);
                                        }
                                    }
                                    SpringAnimation springAnimation2 = this.this$0.getSpringAnimation(this.$animatedProperty, t2);
                                    this.$springConfig.applyToAnimation$packages__apps__OPSystemUI__android_common__OPSystemUI_core(springAnimation2);
        ...
        this.internalListeners.add(new InternalListener(this, t, getAnimatedProperties$packages__apps__OPSystemUI__android_common__OPSystemUI_core(), new ArrayList(this.updateListeners), new ArrayList(this.endListeners), new ArrayList(this.endActions)));
        for (T t2 : arrayList) {
            t2.invoke();
        }
        clearAnimator();
    ...
    private final DynamicAnimation<?> configureDynamicAnimation(DynamicAnimation<?> dynamicAnimation, FloatPropertyCompat<? super T> floatPropertyCompat) {
        dynamicAnimation.addUpdateListener(new DynamicAnimation.OnAnimationUpdateListener(this, floatPropertyCompat) { // from class: com.android.systemui.util.animation.PhysicsAnimator$configureDynamicAnimation$1
            ...
            public final void onAnimationUpdate(DynamicAnimation<DynamicAnimation<?>> dynamicAnimation2, float f, float f2) {
                int size = this.this$0.getInternalListeners$packages__apps__OPSystemUI__android_common__OPSystemUI_core().size();
                for (int i = 0; i < size; i++) {
                    ((PhysicsAnimator.InternalListener) this.this$0.getInternalListeners$packages__apps__OPSystemUI__android_common__OPSystemUI_core().get(i)).onInternalAnimationUpdate$packages__apps__OPSystemUI__android_common__OPSystemUI_core(this.$property, f, f2);
                }
            }
        });
    ...
    public final class InternalListener {
        ...
        public final void onInternalAnimationUpdate$packages__apps__OPSystemUI__android_common__OPSystemUI_core(@NotNull FloatPropertyCompat<? super T> floatPropertyCompat, float f, float f2) {
            Intrinsics.checkParameterIsNotNull(floatPropertyCompat, "property");
        ...
        public final boolean onInternalAnimationEnd$packages__apps__OPSystemUI__android_common__OPSystemUI_core(@NotNull FloatPropertyCompat<? super T> floatPropertyCompat, boolean z, float f, float f2, boolean z2) {
            Intrinsics.checkParameterIsNotNull(floatPropertyCompat, "property");
            if (!this.properties.contains(floatPropertyCompat)) {
                return false;
            }
    ...
    @NotNull
    public final Set<FloatPropertyCompat<? super T>> getAnimatedProperties$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
    ...
    public final void cancelInternal$packages__apps__OPSystemUI__android_common__OPSystemUI_core(@NotNull Set<? extends FloatPropertyCompat<? super T>> set) {
        Intrinsics.checkParameterIsNotNull(set, "properties");
    ...
    public static final class SpringConfig {
        ...
        public final float getStiffness$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            return this.stiffness;
        }

        public final float getDampingRatio$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            return this.dampingRatio;
        }

        public final void setStartVelocity$packages__apps__OPSystemUI__android_common__OPSystemUI_core(float f) {
        ...
        public final float getFinalPosition$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            return this.finalPosition;
        }

        public final void setFinalPosition$packages__apps__OPSystemUI__android_common__OPSystemUI_core(float f) {
        ...
        public final void applyToAnimation$packages__apps__OPSystemUI__android_common__OPSystemUI_core(@NotNull SpringAnimation springAnimation) {
    ...
    public static final class FlingConfig {
        ...
        public final float getFriction$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            return this.friction;
        }

        public final float getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            return this.min;
        }

        public final void setMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core(float f) {
            this.min = f;
        }

        public final float getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
            return this.max;
        }

        public final void setMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core(float f) {
            this.max = f;
        }
        ...
        public final void applyToAnimation$packages__apps__OPSystemUI__android_common__OPSystemUI_core(@NotNull FlingAnimation flingAnimation) {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final Function1<Object, PhysicsAnimator<?>> getInstanceConstructor$packages__apps__OPSystemUI__android_common__OPSystemUI_core() {
        ...
        public final <T> PhysicsAnimator<T> getInstance(@NotNull T t) {
            ...
            if (!PhysicsAnimatorKt.getAnimators().containsKey(t)) {
                PhysicsAnimatorKt.getAnimators().put(t, getInstanceConstructor$packages__apps__OPSystemUI__android_common__OPSystemUI_core().invoke(t));
            }
        ...
        public final float estimateFlingEndValue(float f, float f2, @NotNull FlingConfig flingConfig) {
            Intrinsics.checkParameterIsNotNull(flingConfig, "flingConfig");
            return Math.min(flingConfig.getMax$packages__apps__OPSystemUI__android_common__OPSystemUI_core(), Math.max(flingConfig.getMin$packages__apps__OPSystemUI__android_common__OPSystemUI_core(), f + (f2 / (flingConfig.getFriction$packages__apps__OPSystemUI__android_common__OPSystemUI_core() * 4.2f))));
        }
