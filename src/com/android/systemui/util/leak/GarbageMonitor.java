...
public class GarbageMonitor implements Dumpable {
    ...
    public GarbageMonitor(Context context, Looper looper, LeakDetector leakDetector, LeakReporter leakReporter) {
        ...
        if (ENABLE_AM_HEAP_LIMIT) {
            this.mHeapLimit = (long) Settings.Global.getInt(context.getContentResolver(), "systemui_am_heap_limit", this.mContext.getResources().getInteger(C0009R$integer.watch_heap_limit));
        }
    }
    ...
    public static class MemoryTile extends QSTileImpl<QSTile.State> {
            ...
            if (!this.dumpInProgress) {
                ...
                new Thread("HeapDumpThread") { // from class: com.android.systemui.util.leak.GarbageMonitor.MemoryTile.1
                    ...
                    public void run() {
                        ...
                        ((QSTileImpl) MemoryTile.this).mHandler.post(new Runnable(MemoryTile.this.gm.dumpHprofAndGetShareIntent()) { // from class: com.android.systemui.util.leak.-$$Lambda$GarbageMonitor$MemoryTile$1$cmBeuqKr1b9hrY1trlao7X6pfIc
        ...
        public void handleUpdateState(QSTile.State state, Object obj) {
            ...
            if (this.dumpInProgress) {
                ...
                str = this.mContext.getString(C0015R$string.heap_dump_tile_name);
            }
            state.label = str;
