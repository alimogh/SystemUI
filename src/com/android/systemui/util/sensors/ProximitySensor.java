...
public class ProximitySensor {
    ...
    public ProximitySensor(Resources resources, AsyncSensorManager asyncSensorManager) {
        ...
        this.mSensorEventListener = new SensorEventListener() { // from class: com.android.systemui.util.sensors.ProximitySensor.1
        ...
        if (findCustomProxSensor != null) {
            try {
                getCustomProxThreshold(resources);
            } catch (IllegalStateException e) {
                Log.e("ProxSensor", "Can not load custom proximity sensor.", e);
            }
        }
        sensor = findCustomProxSensor;
        if (sensor == null && (sensor = asyncSensorManager.getDefaultSensor(33171025)) != null) {
    ...
    private Sensor findCustomProxSensor(Resources resources) {
        String string = resources.getString(C0015R$string.proximity_sensor_type);
        if (string.isEmpty()) {
            return null;
        }
    ...
    private float getCustomProxThreshold(Resources resources) {
        try {
            return resources.getFloat(C0005R$dimen.proximity_sensor_threshold);
    ...
    public void registerInternal() {
        if (!this.mRegistered && !this.mPaused && !this.mListeners.isEmpty()) {
            ...
            if (DEBUG) {
                Log.d("ProxSensor", "registerInternal: " + Debug.getCallers(5));
            }
    ...
    public void alertListeners() {
        if (!this.mAlerting.getAndSet(true)) {
            new ArrayList(this.mListeners).forEach(new Consumer() { // from class: com.android.systemui.util.sensors.-$$Lambda$ProximitySensor$ghFL-7mqmC5TPLUcAxsPY-h6a_M
    ...
    public static class ProximityCheck implements Runnable {
        ...
        public ProximityCheck(ProximitySensor proximitySensor, DelayableExecutor delayableExecutor) {
            ...
            this.mListener = new ProximitySensorListener() { // from class: com.android.systemui.util.sensors.-$$Lambda$ProximitySensor$ProximityCheck$VWMwluPHAE8LZl7uid6iAJaZ0zg
        ...
        public void onProximityEvent(ProximityEvent proximityEvent) {
            this.mCallbacks.forEach(new Consumer() { // from class: com.android.systemui.util.sensors.-$$Lambda$ProximitySensor$ProximityCheck$ruTS1Tk02_hYvk7mh0KkebUZDkE
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
