        ...
        if (action != 0) {
            if (action == 1) {
                if (this.movedEnough) {
                    ...
                    onUp(view, motionEvent, f, f2, rawX, rawY, xVelocity, velocityTracker2.getYVelocity());
            ...
            this.handler.postDelayed(new Runnable(this, view) { // from class: com.android.systemui.util.RelativeTouchListener$onTouch$1
