...
public class PagedTileLayout extends ViewPager implements QSPanel.QSTileLayout {
    ...
    private final PagerAdapter mAdapter = new PagerAdapter() { // from class: com.android.systemui.qs.PagedTileLayout.3
    ...
    private boolean mIsUseMediaLayout;
    ...
    private final ViewPager.OnPageChangeListener mOnPageChangeListener = new ViewPager.SimpleOnPageChangeListener() { // from class: com.android.systemui.qs.PagedTileLayout.2
    ...
    public void fakeDragBy(float f) {
        try {
            ...
            post(new Runnable(this.mPages.size() - 1) { // from class: com.android.systemui.qs.-$$Lambda$PagedTileLayout$EgpYNrlBIoNqA0Bh-2xqmY_dv38
    ...
    private /* synthetic */ void lambda$fakeDragBy$1$PagedTileLayout(int i) {
    ...
    public void computeScroll() {
        try {
            ...
            Log.d("PagedTileLayout", "computeScroll: caught exception. exit quitely.", e);
        }
    }
    ...
    private TilePage createTilePage() {
        TilePage tilePage = (TilePage) LayoutInflater.from(getContext()).inflate(C0011R$layout.qs_paged_page, (ViewGroup) this, false);
    ...
    public boolean updateResources() {
        ...
        this.mHorizontalClipBound = resources.getDimensionPixelSize(C0005R$dimen.op_notification_side_paddings);
        if (resources.getDisplayMetrics().densityDpi < 510 || resources.getConfiguration().orientation != 2 || !this.mIsUseMediaLayout) {
    ...
    public void setIsUseMediaLayout(boolean z) {
        this.mIsUseMediaLayout = z;
    }
    ...
    public int getNumPages() {
        ...
        if (size % this.mPages.get(0).maxTiles() != 0) {
            i = 1;
        }
        return max + i;
    }
