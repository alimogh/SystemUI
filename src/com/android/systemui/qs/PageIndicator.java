...
public class PageIndicator extends ViewGroup {
    ...
    private final Runnable mAnimationDone = new Runnable() { // from class: com.android.systemui.qs.PageIndicator.1
    ...
    private int mColor = ThemeColorUtils.getColor(100);
    private final int mPageDotWidth = ((int) (((float) this.mPageIndicatorWidth) * 0.4f));
    private final int mPageIndicatorHeight = ((int) ((ViewGroup) this).mContext.getResources().getDimension(C0005R$dimen.qs_page_indicator_height));
    private final int mPageIndicatorWidth = ((int) ((ViewGroup) this).mContext.getResources().getDimension(C0005R$dimen.qs_page_indicator_width));
    ...
    public void setNumPages(int i, int i2) {
        ...
        if (i != getChildCount()) {
            ...
            while (i > getChildCount()) {
                ...
                imageView.setImageResource(C0006R$drawable.op_minor_a_b);
    ...
    public void setLocation(float f) {
        int i = (int) f;
        int i2 = 0;
        setContentDescription(getContext().getString(C0015R$string.accessibility_quick_settings_page, Integer.valueOf(i + 1), Integer.valueOf(getChildCount())));
        int i3 = i << 1;
        if (f != ((float) i)) {
            i2 = 1;
        }
    ...
    private int getTransition(boolean z, boolean z2, boolean z3) {
        if (z3) {
            if (z) {
                if (z2) {
                    return C0006R$drawable.op_major_b_a_animation;
                }
                return C0006R$drawable.op_major_b_c_animation;
            } else if (z2) {
                return C0006R$drawable.op_major_a_b_animation;
            } else {
                return C0006R$drawable.op_major_c_b_animation;
            }
        } else if (z) {
            if (z2) {
                return C0006R$drawable.op_minor_b_c_animation;
            }
            return C0006R$drawable.op_minor_b_a_animation;
        } else if (z2) {
            return C0006R$drawable.op_minor_c_b_animation;
        } else {
            return C0006R$drawable.op_minor_a_b_animation;
        }
    }
