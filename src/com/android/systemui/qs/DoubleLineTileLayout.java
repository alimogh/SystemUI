...
public final class DoubleLineTileLayout extends ViewGroup implements QSPanel.QSTileLayout {
    ...
    public boolean updateResources() {
        ...
        this.smallTileSize = resources.getDimensionPixelSize(C0005R$dimen.qs_quick_tile_size);
        this.cellMarginHorizontal = resources.getDimensionPixelSize(C0005R$dimen.qs_tile_margin_horizontal_two_line);
        this.cellMarginVertical = resources.getDimensionPixelSize(C0005R$dimen.new_qs_vertical_margin);
        requestLayout();
        return false;
    }
        ...
        if (this._listening != z) {
            ...
            if (z) {
                ...
                for (int i = 0; i < numVisibleTiles; i++) {
                    ...
                    uiEventLogger.logWithInstanceId(qSEvent, 0, qSTile.getMetricsSpec(), qSTile.getInstanceId());
                }
            }
        }
    }
