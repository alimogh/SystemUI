...
public class SignalTileView extends QSIconViewImpl {
    ...
    private ImageView mIn = addTrafficView(C0006R$drawable.ic_qs_signal_in);
    private ImageView mOut = addTrafficView(C0006R$drawable.ic_qs_signal_out);
    ...
    public SignalTileView(Context context) {
        ...
        this.mWideOverlayIconStartPadding = context.getResources().getDimensionPixelSize(C0005R$dimen.wide_type_icon_start_padding_qs);
        this.mSignalIndicatorToIconFrameSpacing = context.getResources().getDimensionPixelSize(C0005R$dimen.signal_indicator_to_icon_frame_spacing);
        this.mSignalIndicatorShiftDownAmount = context.getResources().getDimensionPixelSize(C0005R$dimen.qs_signal_indicator_shift_down_amount);
    }
