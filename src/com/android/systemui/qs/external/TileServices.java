...
public class TileServices extends IQSService.Stub {
    ...
    public void freeService(CustomTile customTile, TileServiceManager tileServiceManager) {
        synchronized (this.mServices) {
            ...
            this.mMainHandler.post(new Runnable(customTile.getComponent().getClassName()) { // from class: com.android.systemui.qs.external.-$$Lambda$TileServices$m2qCzd8BVbBUzSnClFn7o_chF7k
