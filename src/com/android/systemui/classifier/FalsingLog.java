...
public class FalsingLog {
    ...
    public static synchronized void wtf(java.lang.String r7, java.lang.String r8, java.lang.Throwable r9) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = com.android.systemui.classifier.FalsingLog.ENABLED     // Catch:{ all -> 0x00b4 }
            if (r1 != 0) goto L_0x0009
            monitor-exit(r0)
            return
        L_0x0009:
            e(r7, r8)
            android.app.Application r1 = android.app.ActivityThread.currentApplication()
            java.lang.String r2 = ""
            boolean r3 = android.os.Build.IS_DEBUGGABLE
