...
public class FalsingManagerProxy implements FalsingManager, Dumpable {
    ...
    FalsingManagerProxy(final Context context, PluginManager pluginManager, Executor executor, DisplayMetrics displayMetrics, ProximitySensor proximitySensor, DeviceConfigProxy deviceConfigProxy, DockManager dockManager, KeyguardUpdateMonitor keyguardUpdateMonitor, DumpManager dumpManager, Executor executor2, StatusBarStateController statusBarStateController) {
        ...
        this.mDeviceConfigListener = new DeviceConfig.OnPropertiesChangedListener(context) { // from class: com.android.systemui.classifier.-$$Lambda$FalsingManagerProxy$15gIs-9mVwyDjJbglxP0IV0T3ag
        ...
        pluginManager.addPluginListener(new PluginListener<FalsingPlugin>() { // from class: com.android.systemui.classifier.FalsingManagerProxy.1
            public void onPluginConnected(FalsingPlugin falsingPlugin, Context context2) {
                FalsingManager falsingManager = falsingPlugin.getFalsingManager(context2);
    ...
    private void setupFalsingManager(Context context) {
        this.mDeviceConfig.getBoolean("systemui", "brightline_falsing_manager_enabled", true);
        if (this.mBrightlineEnabled || this.mInternalFalsingManager == null) {
            this.mBrightlineEnabled = false;
