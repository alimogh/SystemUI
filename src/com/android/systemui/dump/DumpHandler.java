...
public final class DumpHandler {
    ...
    private final void dumpConfig(PrintWriter printWriter) {
        ...
        printWriter.println(this.context.getResources().getString(C0015R$string.config_systemUIVendorServiceComponent));
        dumpServiceList(printWriter, "global", C0001R$array.config_systemUIServiceComponents);
        dumpServiceList(printWriter, "per-user", C0001R$array.config_systemUIServiceComponentsPerUser);
    }
    ...
    private final ParsedArgs parseArgs(String[] strArr) {
        ...
        if (parsedArgs.getCommand() == null && (!mutableList.isEmpty()) && ArraysKt.contains(DumpHandlerKt.access$getCOMMANDS$p(), mutableList.get(0))) {
