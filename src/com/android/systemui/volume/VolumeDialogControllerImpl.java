...
public class VolumeDialogControllerImpl implements VolumeDialogController, Dumpable {
    ...
    static {
        ...
        STREAMS = arrayMap;
        arrayMap.put(4, Integer.valueOf(C0015R$string.stream_alarm));
        STREAMS.put(6, Integer.valueOf(C0015R$string.stream_bluetooth_sco));
        STREAMS.put(8, Integer.valueOf(C0015R$string.stream_dtmf));
        STREAMS.put(3, Integer.valueOf(C0015R$string.stream_music));
        STREAMS.put(10, Integer.valueOf(C0015R$string.stream_accessibility));
        STREAMS.put(5, Integer.valueOf(C0015R$string.stream_notification));
        STREAMS.put(2, Integer.valueOf(C0015R$string.stream_ring));
        STREAMS.put(1, Integer.valueOf(C0015R$string.stream_system));
        STREAMS.put(7, Integer.valueOf(C0015R$string.stream_system_enforced));
        STREAMS.put(9, Integer.valueOf(C0015R$string.stream_tts));
        STREAMS.put(0, Integer.valueOf(C0015R$string.stream_voice_call));
    }
    ...
    public void vibrate(VibrationEffect vibrationEffect) {
        if (this.mHasVibrator && !OpFeatures.isSupport(new int[]{97}) && !OpFeatures.isSupport(new int[]{192})) {
    ...
    private void onShowSafetyWarningW(int i) {
        String str = TAG;
        Log.d(str, "onShowSafetyWarningW flags:" + i + " mShowSafetyWarning:" + this.mShowSafetyWarning);
    ...
    private void onGetCaptionsComponentStateW(boolean z) {
        ...
        try {
            String string = this.mContext.getString(17039884);
    ...
    private boolean checkRoutedToBluetoothW(int i) {
        ...
        if (i == 3) {
            ...
            if (z) {
                String str = TAG;
                Log.i(str, "getDevicesForStream:" + Integer.toHexString(this.mAudio.getDevicesForStream(3)));
            }
        }
        return z;
    }
    ...
    private boolean shouldShowUI(int i) {
        try {
            Optional<U> map = this.mStatusBarOptionalLazy.map(new Function(i) { // from class: com.android.systemui.volume.-$$Lambda$VolumeDialogControllerImpl$ZC0tNHMtDXeM-l4n7hjZubonHuc
            ...
            Log.d(TAG, "shouldShowUI exception:" + e.toString());
            return false;
        }
    }
    ...
    private boolean updateStreamLevelW(int i, int i2) {
        if (D.BUG) {
            String str = TAG;
            Log.d(str, "updateStreamLevelW stream=" + i + " level=" + i2 + " " + Debug.getCallers(5));
        }
        VolumeDialogController.StreamState streamStateW = streamStateW(i);
    ...
    public final class VC extends IVolumeController.Stub {
        ...
        public void displaySafeVolumeWarning(int i) throws RemoteException {
            String str = this.TAG;
            Log.d(str, "displaySafeVolumeWarning flags:" + i + " mDestroyed:" + VolumeDialogControllerImpl.this.mDestroyed);
            if (D.BUG) {
                String str2 = this.TAG;
                Log.d(str2, "displaySafeVolumeWarning " + Util.audioManagerFlagsToString(i));
            }
    ...
    public class C implements VolumeDialogController.Callbacks {
        ...
        public void onShowRequested(final int i) {
            for (final Map.Entry entry : new ConcurrentHashMap(this.mCallbackMap).entrySet()) {
        ...
        public void onDismissRequested(final int i) {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.2
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onStateChanged(VolumeDialogController.State state) {
            ...
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.3
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onLayoutDirectionChanged(final int i) {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.4
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onConfigurationChanged() {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.5
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onShowVibrateHint() {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.6
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onShowSilentHint() {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.7
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onScreenOff() {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.8
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onShowSafetyWarning(final int i) {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                ...
                Log.d(str, "onShowSafetyWarning flags:" + i);
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.9
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onAccessibilityModeChanged(Boolean bool) {
            ...
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(this) { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.C.10
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        public void onCaptionComponentStateChanged(Boolean bool, Boolean bool2) {
            boolean z = false;
            if (SystemProperties.getInt("sys.debug.systemui.caption", 0) == 1) {
                bool = Boolean.TRUE;
            }
            if (bool != null) {
                z = bool.booleanValue();
            ...
            for (Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable(entry, z, bool2) { // from class: com.android.systemui.volume.-$$Lambda$VolumeDialogControllerImpl$C$Q4oXmUMuqtOXvcXaIdydaXsm_80
    ...
    public final class RingerModeObservers {
        ...
        private final Observer<Integer> mRingerModeInternalObserver = new Observer<Integer>() { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.RingerModeObservers.2
            public void onChanged(Integer num) {
                VolumeDialogControllerImpl.this.mWorker.post(new Runnable(num) { // from class: com.android.systemui.volume.-$$Lambda$VolumeDialogControllerImpl$RingerModeObservers$2$2YUQzphxT5pK7JvSmIyMJf-BaPo
        ...
        private final Observer<Integer> mRingerModeObserver = new Observer<Integer>() { // from class: com.android.systemui.volume.VolumeDialogControllerImpl.RingerModeObservers.1
            public void onChanged(Integer num) {
                VolumeDialogControllerImpl.this.mWorker.post(new Runnable(num) { // from class: com.android.systemui.volume.-$$Lambda$VolumeDialogControllerImpl$RingerModeObservers$1$CmgEGLTOVVQV5yIb7ebHF_uhtJc
                    public final /* synthetic */ Integer f$1;
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.media.VOLUME_CHANGED_ACTION")) {
                ...
                Log.d(VolumeDialogControllerImpl.TAG, "onReceive ACTION_SCREEN_OFF");
                if (!(OpLsState.getInstance() == null || OpLsState.getInstance().getPhoneStatusBar() == null)) {
                    OpLsState.getInstance().getPhoneStatusBar().getMsgDump();
                }
