...
public class CaptionsToggleImageButton extends AlphaOptimizedImageButton {
    private static final int[] OPTED_OUT_STATE = {C0002R$attr.optedOut};
    ...
    public CaptionsToggleImageButton(Context context, AttributeSet attributeSet) {
        ...
        setContentDescription(getContext().getString(C0015R$string.volume_odi_captions_content_description));
    }
    ...
    public Runnable setCaptionsEnabled(boolean z) {
        ...
        if (z) {
            str = getContext().getString(C0015R$string.volume_odi_captions_hint_disable);
        } else {
            str = getContext().getString(C0015R$string.volume_odi_captions_hint_enable);
        }
        ViewCompat.replaceAccessibilityAction(this, accessibilityActionCompat, str, new AccessibilityViewCommand() { // from class: com.android.systemui.volume.-$$Lambda$CaptionsToggleImageButton$G1CrD-3iT19JR_3d-rnIgC4b3Mg
        ...
        if (this.mCaptionsEnabled) {
            i = C0006R$drawable.ic_volume_odi_captions;
        } else {
            i = C0006R$drawable.ic_volume_odi_captions_disabled;
        }
