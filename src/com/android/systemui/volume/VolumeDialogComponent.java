...
import com.oneplus.opthreekey.OpThreekeyDialogImpl;
...
public class VolumeDialogComponent implements VolumeComponent, TunerService.Tunable, VolumeDialogControllerImpl.UserActivityListener, OpThreekeyDialog$UserActivityListener, OpThreekeyVolumeGuideController.IOpThreekeyVolumeGuideControllerCallBack, OpThreekeyVolumeGuideController.UserActivityListener {
    ...
    private OpThreekeyDialogImpl mThreekeyDialog;
    ...
    public VolumeDialogComponent(Context context, KeyguardViewMediator keyguardViewMediator, VolumeDialogControllerImpl volumeDialogControllerImpl) {
        ...
        newExtension.withDefault(new Supplier() { // from class: com.android.systemui.volume.-$$Lambda$5eQ6FmuY0CORdNfZebXQAtrsfI4
            @Override // java.util.function.Supplier
            public final Object get() {
                return VolumeDialogComponent.this.createDefault();
            }
        });
        newExtension.withCallback(new Consumer() { // from class: com.android.systemui.volume.-$$Lambda$VolumeDialogComponent$vZvGMkdhFGTZ9hLE1BnozIW6Wb0
        ...
        ((OpThreekeyVolumeGuideController) Dependency.get(OpThreekeyVolumeGuideController.class)).init(2020, this);
    }
    ...
    public /* synthetic */ void lambda$new$0$VolumeDialogComponent(VolumeDialog volumeDialog) {
        ...
        if (OpUtils.isSupportSOCThreekey()) {
            OpThreekeyDialogImpl opThreekeyDialogImpl = this.mThreekeyDialog;
            if (opThreekeyDialogImpl != null) {
                opThreekeyDialogImpl.destroy();
            }
            OpThreekeyDialogImpl opThreekeyDialogImpl2 = new OpThreekeyDialogImpl(this.mContext);
            this.mThreekeyDialog = opThreekeyDialogImpl2;
            opThreekeyDialogImpl2.init(2020, this);
        }
    }
    ...
    @Override // com.oneplus.opthreekey.OpThreekeyDialog$UserActivityListener
    public void onThreekeyStateUserActivity() {
        onUserActivity();
    }
}
