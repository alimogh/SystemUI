...
public class ZenModePanel extends FrameLayout {
    ...
    public ZenModePanel(Context context, AttributeSet attributeSet) {
        ...
        this.mZenModeConditionLayoutId = C0011R$layout.zen_mode_condition;
        this.mZenModeButtonLayoutId = C0011R$layout.zen_mode_button;
        if (DEBUG) {
    ...
    public void createZenButtons() {
        SegmentedButtons segmentedButtons = (SegmentedButtons) findViewById(C0008R$id.zen_buttons);
        this.mZenButtons = segmentedButtons;
        segmentedButtons.addButton(C0015R$string.interruption_level_none_twoline, C0015R$string.interruption_level_none_with_warning, 2);
        this.mZenButtons.addButton(C0015R$string.interruption_level_alarms_twoline, C0015R$string.interruption_level_alarms, 3);
        this.mZenButtons.addButton(C0015R$string.interruption_level_priority_twoline, C0015R$string.interruption_level_priority, 1);
    ...
    public void onFinishInflate() {
        ...
        createZenButtons();
        this.mZenIntroduction = findViewById(C0008R$id.zen_introduction);
        this.mZenIntroductionMessage = (TextView) findViewById(C0008R$id.zen_introduction_message);
        View findViewById = findViewById(C0008R$id.zen_introduction_confirm);
        this.mZenIntroductionConfirm = findViewById;
        findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.volume.-$$Lambda$ZenModePanel$lbJ8lHqFYfMZus-ckwTZAx6gp_I
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ZenModePanel.this.lambda$onFinishInflate$0$ZenModePanel(view);
            }
        });
        TextView textView = (TextView) findViewById(C0008R$id.zen_introduction_customize);
        this.mZenIntroductionCustomize = textView;
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.volume.-$$Lambda$ZenModePanel$1BYa_z9Fn3nPDHjhUKHednhVOqQ
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ZenModePanel.this.lambda$onFinishInflate$1$ZenModePanel(view);
            }
        });
        this.mConfigurableTexts.add(this.mZenIntroductionCustomize, C0015R$string.zen_priority_customize_button);
        this.mZenConditions = (LinearLayout) findViewById(C0008R$id.zen_conditions);
        this.mZenAlarmWarning = (TextView) findViewById(C0008R$id.zen_alarm_warning);
        this.mZenRadioGroup = (RadioGroup) findViewById(C0008R$id.zen_radio_buttons);
        this.mZenRadioGroupContent = (LinearLayout) findViewById(C0008R$id.zen_radio_buttons_content);
        this.mEdit = (ViewGroup) findViewById(C0008R$id.edit_container);
        ...
        View findViewById3 = findViewById(C0008R$id.auto_rule);
    ...
    public void setEmptyState(int i, int i2) {
        this.mEmptyIcon.post(new Runnable(i, i2) { // from class: com.android.systemui.volume.-$$Lambda$ZenModePanel$HiD6qQcUVG9hPBXBbXjbkowbyWE
    ...
    public void setAutoText(CharSequence charSequence) {
        this.mAutoTitle.post(new Runnable(charSequence) { // from class: com.android.systemui.volume.-$$Lambda$ZenModePanel$B3Y2r55PL6J4kgbiM4zXPpDTjiA
    ...
    private void transitionFrom(View view, View view2) {
        view.post(new Runnable(view2, view) { // from class: com.android.systemui.volume.-$$Lambda$ZenModePanel$BhXvHb7L6APT_cYYehmMxR3OZv4
    ...
    static /* synthetic */ void lambda$transitionFrom$5(View view, View view2) {
        ...
        view.bringToFront();
        view.animate().cancel();
        view.animate().alpha(1.0f).setDuration(300).withEndAction(new Runnable(view2) { // from class: com.android.systemui.volume.-$$Lambda$ZenModePanel$YCGXBCe2GBC47ckivA_D9jTXkLc
            public final /* synthetic */ View f$0;
    ...
    private void updateWidgets() {
        ...
        if (z) {
            if (z2) {
                i = C0015R$string.zen_priority_introduction;
            } else if (z4) {
                i = C0015R$string.zen_alarms_introduction;
            } else if (this.mVoiceCapable) {
                i = C0015R$string.zen_silence_introduction_voice;
            } else {
                i = C0015R$string.zen_silence_introduction;
            }
    ...
    private String computeAlarmWarningText(boolean z) {
        ...
        if (condition == null || isForever(condition)) {
            i = C0015R$string.zen_alarm_warning_indef;
        } else {
            long tryParseCountdownConditionId = ZenModeConfig.tryParseCountdownConditionId(this.mSessionExitCondition.id);
            i = (tryParseCountdownConditionId <= currentTimeMillis || nextAlarm >= tryParseCountdownConditionId) ? 0 : C0015R$string.zen_alarm_warning;
        }
        if (i == 0) {
            return null;
        }
        ...
        return getResources().getString(i, getResources().getString(z2 ? C0015R$string.alarm_template : C0015R$string.alarm_template_far, DateFormat.format(DateFormat.getBestDateTimePattern(Locale.getDefault(), z2 ? is24HourFormat ? "Hm" : "hma" : is24HourFormat ? "EEEHm" : "EEEhma"), nextAlarm)));
    }
    ...
    private static String foreverSummary(Context context) {
        return context.getString(17041532);
    }
    ...
    private void bind(Condition condition, final View view, final int i) {
        ...
        if (condition != null) {
            ...
            conditionTag.lines.setOnClickListener(new View.OnClickListener(this) { // from class: com.android.systemui.volume.ZenModePanel.4
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    conditionTag.rb.setChecked(true);
                }
    ...
    private void announceConditionSelection(ConditionTag conditionTag) {
        ...
        int selectedZen = getSelectedZen(0);
        if (selectedZen == 1) {
            str = this.mContext.getString(C0015R$string.interruption_level_priority);
        } else if (selectedZen == 2) {
            str = this.mContext.getString(C0015R$string.interruption_level_none);
        } else if (selectedZen == 3) {
            str = this.mContext.getString(C0015R$string.interruption_level_alarms);
        } else {
            return;
        }
        announceForAccessibility(this.mContext.getString(C0015R$string.zen_mode_and_condition, str, conditionTag.line1.getText()));
    }
    ...
    private void onClickTimeButton(android.view.View r20, com.android.systemui.volume.ZenModePanel.ConditionTag r21, boolean r22, int r23) {
        /*
            ...
            com.android.systemui.qs.QSDndEvent r4 = com.android.systemui.qs.QSDndEvent.QS_DND_TIME_UP
            goto L_0x0016
        L_0x0014:
            com.android.systemui.qs.QSDndEvent r4 = com.android.systemui.qs.QSDndEvent.QS_DND_TIME_DOWN
        L_0x0016:
            r3.log(r4)
            r3 = 0
            int[] r4 = com.android.systemui.volume.ZenModePanel.MINUTE_BUCKETS
            int r4 = r4.length
            ...
            android.service.notification.Condition r5 = r1.condition
            android.net.Uri r5 = getConditionId(r5)
            long r9 = android.service.notification.ZenModeConfig.tryParseCountdownConditionId(r5)
        ...
        L_0x0038:
            ...
            int r5 = r5 - r6
        L_0x003b:
            int[] r7 = com.android.systemui.volume.ZenModePanel.MINUTE_BUCKETS
            r16 = r7[r5]
        ...
        L_0x0053:
            ...
            int r17 = android.app.ActivityManager.getCurrentUser()
            r18 = 0
            android.service.notification.Condition r3 = android.service.notification.ZenModeConfig.toTimeCondition(r13, r14, r16, r17, r18)
            goto L_0x0065
        L_0x0062:
            int r6 = r6 + 1
            goto L_0x0032
        L_0x0065:
            ...
            int r2 = com.android.systemui.volume.ZenModePanel.DEFAULT_BUCKET_INDEX
            r0.mBucketIndex = r2
            android.content.Context r3 = r0.mContext
            int[] r4 = com.android.systemui.volume.ZenModePanel.MINUTE_BUCKETS
            r2 = r4[r2]
        ...
        L_0x0097:
            ...
            r4 = r23
            r0.bind(r3, r2, r4)
            android.widget.RadioButton r2 = r1.rb
            r2.setChecked(r8)
            r0.select(r3)
    ...
    public final class ZenPrefs implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        private ZenPrefs() {
            this.mNoneDangerousThreshold = ZenModePanel.this.mContext.getResources().getInteger(C0009R$integer.zen_mode_alarm_warning_threshold);
