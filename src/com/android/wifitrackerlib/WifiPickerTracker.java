...
public class WifiPickerTracker extends BaseWifiTracker {
    ...
    private void updateStandardWifiEntryScans(List<ScanResult> list) {
        ...
        this.mStandardWifiEntryCache.entrySet().removeIf(new Predicate(mapScanResultsToKey) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$BCwaIQQiP0fvxsNUSnDq9UqTFVQ
    ...
    private void updateSuggestedWifiEntryScans(List<ScanResult> list) {
        ...
        this.mSuggestedWifiEntryCache.entrySet().removeIf(new Predicate(treeSet) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$b19vs3Vj3eXbrjFN5lP9dtI7hsE
    ...
    private void updatePasspointWifiEntryScans(List<ScanResult> list) {
        ...
        this.mPasspointWifiEntryCache.entrySet().removeIf(new Predicate(treeSet) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$b5PKKEVNG30K9l5cXQHsuoupJmU
    ...
    private void updateOsuWifiEntryScans(List<ScanResult> list) {
        ...
        this.mOsuWifiEntryCache.values().forEach(new Consumer(matchingPasspointConfigsForOsuProviders) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$v1LdO2tPR3JJiIf1xFFNAIzpUTI
    ...
    private void updateNetworkRequestEntryScans(List<ScanResult> list) {
        ...
        if (networkRequestEntry != null) {
            ...
            this.mNetworkRequestEntry.updateScanResultInfo((List) list.stream().filter(new Predicate(ssid, security) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$pqxDzYwc6dZqh70kHuMaEBXjaV4
    ...
    private void updateWifiConfigurations(List<WifiConfiguration> list) {
        ...
        this.mWifiConfigCache.values().stream().filter($$Lambda$WifiPickerTracker$GePaFPqD_aenaiEba32ZGYPo9E.INSTANCE).count();
    ...
    private void conditionallyCreateConnectedStandardWifiEntry(WifiInfo wifiInfo, NetworkInfo networkInfo) {
        if (!wifiInfo.isPasspointAp() && !wifiInfo.isOsuAp()) {
            this.mWifiConfigCache.values().stream().filter(new Predicate(wifiInfo.getNetworkId()) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$DitgtO9_1wALYexVACURnNqwLlI
                public final /* synthetic */ int f$1;
            ...
            }).findAny().ifPresent(new Consumer(wifiInfo, networkInfo) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$PEwbf5ZKF_Aj2ns46UMv4q1HGVo
    ...
    private void conditionallyCreateConnectedSuggestedWifiEntry(WifiInfo wifiInfo, NetworkInfo networkInfo) {
        if (!wifiInfo.isPasspointAp() && !wifiInfo.isOsuAp()) {
            this.mSuggestedConfigCache.values().stream().filter(new Predicate(wifiInfo.getNetworkId()) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$tJL8mW_AZGayOGupUDCgP3_UlzQ
                public final /* synthetic */ int f$1;
            ...
            }).findAny().ifPresent(new Consumer(wifiInfo, networkInfo) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$BFLWShdPM2NcgUJrV0IHcg4MXWc
                public final /* synthetic */ WifiInfo f$1;
                public final /* synthetic */ NetworkInfo f$2;
    ...
    private void conditionallyCreateConnectedPasspointWifiEntry(WifiInfo wifiInfo, NetworkInfo networkInfo) {
        if (wifiInfo.isPasspointAp()) {
            Stream.concat(this.mWifiConfigCache.values().stream(), this.mSuggestedConfigCache.values().stream()).filter(new Predicate(wifiInfo.getNetworkId()) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$bjLRrQ4OQ8BTAnYZyvpe1EHxYpE
                public final /* synthetic */ int f$1;
            ...
            }).findAny().ifPresent(new Consumer(wifiInfo, networkInfo) { // from class: com.android.wifitrackerlib.-$$Lambda$WifiPickerTracker$g9rZ4NCkczW2OW23M8uCJ7orWlk
                public final /* synthetic */ WifiInfo f$1;
                public final /* synthetic */ NetworkInfo f$2;
