        ...
        this.mReceiver = new BroadcastReceiver() { // from class: com.android.keyguard.KeyguardEsimArea.1
            ...
            public void onReceive(Context context2, Intent intent) {
                ...
                if ("com.android.keyguard.disable_esim".equals(intent.getAction()) && (resultCode = getResultCode()) != 0) {
                    ...
                    AlertDialog create = new AlertDialog.Builder(((Button) KeyguardEsimArea.this).mContext).setMessage(C0015R$string.error_disable_esim_msg).setTitle(C0015R$string.error_disable_esim_title).setCancelable(false).setPositiveButton(C0015R$string.ok, (DialogInterface.OnClickListener) null).create();
