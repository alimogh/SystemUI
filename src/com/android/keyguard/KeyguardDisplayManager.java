...
public class KeyguardDisplayManager {
    ...
    private boolean showPresentation(Display display) {
        ...
        if (this.mPresentations.get(displayId) == null) {
            ...
            keyguardPresentation.setOnDismissListener(new DialogInterface.OnDismissListener(keyguardPresentation, displayId) { // from class: com.android.keyguard.-$$Lambda$KeyguardDisplayManager$WcC7zwdycYHh9dpCnEiRCOObKEQ
    ...
    public static final class KeyguardPresentation extends Presentation {
        ...
        KeyguardPresentation(Context context, Display display, LayoutInflater layoutInflater) {
            super(context, display, C0016R$style.Theme_SystemUI_KeyguardPresentation);
        ...
        public void onCreate(Bundle bundle) {
            ...
            setContentView(this.mInjectableLayoutInflater.inflate(C0011R$layout.keyguard_presentation, (ViewGroup) null));
            getWindow().getDecorView().setSystemUiVisibility(1792);
            getWindow().getAttributes().setFitInsetsTypes(0);
            getWindow().setNavigationBarContrastEnforced(false);
            getWindow().setNavigationBarColor(0);
            View findViewById = findViewById(C0008R$id.clock);
