...
public class KeyguardSecurityModel {
    ...
    private final boolean mIsPukScreenAvailable = this.mContext.getResources().getBoolean(17891460);
    ...
    public SecurityMode getSecurityMode(int i) {
        ...
        int unlockedSubIdForState = keyguardUpdateMonitor.getUnlockedSubIdForState(3);
        ...
        int intValue = ((Integer) DejankUtils.whitelistIpcs(new Supplier(i) { // from class: com.android.keyguard.-$$Lambda$KeyguardSecurityModel$wVA2_YbUv0Q_IYsNKsPxtYAIjp0
