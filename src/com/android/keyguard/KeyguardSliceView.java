...
public class KeyguardSliceView extends LinearLayout implements View.OnClickListener, Observer<Slice>, TunerService.Tunable, ConfigurationController.ConfigurationListener {
    ...
    public KeyguardSliceView(Context context, AttributeSet attributeSet, ActivityStarter activityStarter, ConfigurationController configurationController, TunerService tunerService, Resources resources) {
        ...
        this.mRowPadding = resources.getDimensionPixelSize(C0005R$dimen.subtitle_clock_padding);
        this.mRowWithHeaderPadding = resources.getDimensionPixelSize(C0005R$dimen.header_subtitle_padding);
    ...
    public void onFinishInflate() {
        ...
        this.mRow = (Row) findViewById(C0008R$id.row);
        this.mTextColor = Utils.getColorAttrDefaultColor(((LinearLayout) this).mContext, C0002R$attr.wallpaperTextColor);
        this.mIconSize = (int) ((LinearLayout) this).mContext.getResources().getDimension(C0005R$dimen.widget_icon_size);
        this.mIconSizeWithHeader = (int) ((LinearLayout) this).mContext.getResources().getDimension(C0005R$dimen.header_icon_size);
        this.mRowTextSize = (float) ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.op_owner_info_font_size);
        this.mRowWithHeaderTextSize = (float) ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.header_row_font_size);
    ...
    private void showSlice() {
        ...
        while (i4 < size) {
            ...
            if (OpUtils.isMCLVersionFont() && (mclTypeface = OpUtils.getMclTypeface(3)) != null) {
                keyguardSliceTextView.setTypeface(mclTypeface);
            }
            i4++;
        }
    ...
    public void setupUri(String str) {
        ...
        if (liveData != null && liveData.hasActiveObservers()) {
            ...
            try {
                ...
                Log.w("KeyguardSliceView", "setupUri fail, ", e);
            }
        }
    ...
    public void onDensityOrFontScaleChanged() {
        this.mIconSize = ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.widget_icon_size);
        this.mIconSizeWithHeader = (int) ((LinearLayout) this).mContext.getResources().getDimension(C0005R$dimen.header_icon_size);
        this.mRowTextSize = (float) ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.op_owner_info_font_size);
        this.mRowWithHeaderTextSize = (float) ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.header_row_font_size);
    }
    ...
    public static class KeyguardSliceTextView extends TextView implements ConfigurationController.ConfigurationListener {
        private static int sStyleId = C0016R$style.TextAppearance_Keyguard_Secondary;
        ...
        public void onDensityOrFontScaleChanged() {
            updatePadding();
            setTextSize(0, (float) getResources().getDimensionPixelSize(C0005R$dimen.op_owner_info_font_size));
        }
        ...
        private void updatePadding() {
            ...
            int dimension = ((int) getContext().getResources().getDimension(C0005R$dimen.widget_horizontal_padding)) / 2;
            if (!z) {
                i = -1;
            }
            setPadding(dimension, 0, i * dimension, 0);
            setCompoundDrawablePadding((int) ((TextView) this).mContext.getResources().getDimension(C0005R$dimen.widget_icon_padding));
        }
