...
public class KeyguardClockSwitch extends RelativeLayout {
    ...
    private ClockManager.ClockChangedListener mClockChangedListener = new ClockManager.ClockChangedListener() { // from class: com.android.keyguard.-$$Lambda$KeyguardClockSwitch$H31kNGqlEfE-tZQZgrBtirdKZKc
    ...
    private final ColorExtractor.OnColorsChangedListener mColorsListener = new ColorExtractor.OnColorsChangedListener() { // from class: com.android.keyguard.-$$Lambda$KeyguardClockSwitch$1K4q2TFTethGttjK4WWfYw-lPoo
    ...
    private final StatusBarStateController.StateListener mStateListener = new StatusBarStateController.StateListener() { // from class: com.android.keyguard.KeyguardClockSwitch.1
    ...
    public KeyguardClockSwitch(Context context, AttributeSet attributeSet, StatusBarStateController statusBarStateController, SysuiColorExtractor sysuiColorExtractor, ClockManager clockManager) {
        ...
        clockVisibilityTransition.addTarget(C0008R$id.default_clock_view);
        ...
        clockVisibilityTransition2.addTarget(C0008R$id.default_clock_view_bold);
    ...
    public void onFinishInflate() {
        ...
        this.mClockView = (TextClock) findViewById(C0008R$id.default_clock_view);
        this.mClockViewBold = (TextClock) findViewById(C0008R$id.default_clock_view_bold);
        this.mSmallClockFrame = (FrameLayout) findViewById(C0008R$id.clock_view);
        this.mKeyguardStatusArea = findViewById(C0008R$id.ambient_assistant_container);
        setClockViewTypeface();
    }
    ...
    public void setKeyguardShowingHeader(boolean z) {
        if (this.mShowingHeader != z) {
            ...
            if (!hasCustomClock()) {
                float dimensionPixelSize = (float) ((RelativeLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.widget_small_font_size);
                float dimensionPixelSize2 = (float) ((RelativeLayout) this).mContext.getResources().getDimensionPixelSize(OpUtils.isMCLVersion() ? C0005R$dimen.oneplus_widget_big_font_size_mcl : C0005R$dimen.oneplus_widget_big_font_size);
                ...
                int dimensionPixelSize3 = ((RelativeLayout) this).mContext.getResources().getDimensionPixelSize(z ? C0005R$dimen.widget_vertical_padding_clock : C0005R$dimen.title_clock_padding);
    ...
    public class ClockVisibilityTransition extends Visibility {
        ...
        private Animator createAnimator(final View view, float f, final int i, final int i2, float f2, float f3) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(f, view, i2, f2, f3) { // from class: com.android.keyguard.-$$Lambda$KeyguardClockSwitch$ClockVisibilityTransition$0YYk1dKss121y1dzD6OuOcSJduA
            ...
            ofFloat.addListener(new KeepAwakeAnimationListener(this, KeyguardClockSwitch.this.getContext()) { // from class: com.android.keyguard.KeyguardClockSwitch.ClockVisibilityTransition.1
            ...
            addListener(new TransitionListenerAdapter(this) { // from class: com.android.keyguard.KeyguardClockSwitch.ClockVisibilityTransition.2
                @Override // android.transition.TransitionListenerAdapter, android.transition.Transition.TransitionListener
                public void onTransitionEnd(Transition transition) {
    ...
    public void setClockViewTypeface() {
        Typeface mclTypeface;
        TextClock textClock;
        if (OpUtils.isMCLVersionFont() && (mclTypeface = OpUtils.getMclTypeface(3)) != null && (textClock = this.mClockView) != null) {
            textClock.setTypeface(mclTypeface);
        }
    }
}
