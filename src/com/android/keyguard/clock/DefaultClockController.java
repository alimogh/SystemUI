...
public class DefaultClockController implements ClockPlugin {
    ...
    private void createViews() {
        View inflate = this.mLayoutInflater.inflate(C0011R$layout.default_clock_preview, (ViewGroup) null);
        this.mView = inflate;
        this.mTextTime = (TextView) inflate.findViewById(C0008R$id.time);
        this.mTextDate = (TextView) this.mView.findViewById(C0008R$id.date);
    }
    ...
    public String getTitle() {
        return this.mResources.getString(C0015R$string.clock_title_default);
    }

    @Override // com.android.systemui.plugins.ClockPlugin
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(this.mResources, C0006R$drawable.default_thumbnail);
    }
