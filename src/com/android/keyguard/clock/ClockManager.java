...
public final class ClockManager {
    ...
    ClockManager(Context context, InjectionInflationController injectionInflationController, PluginManager pluginManager, SysuiColorExtractor sysuiColorExtractor, ContentResolver contentResolver, CurrentUserObservable currentUserObservable, SettingsWrapper settingsWrapper, DockManager dockManager) {
        ...
        this.mDockEventListener = new DockManager.DockEventListener(this) { // from class: com.android.keyguard.clock.ClockManager.2
        };
        ...
        addBuiltinClock(new Supplier(resources, injectionInflationController.injectable(LayoutInflater.from(context)), sysuiColorExtractor) { // from class: com.android.keyguard.clock.-$$Lambda$ClockManager$qcpjSm9nfcenHjNSU7lKV-TGsX4
    ...
    private void reload() {
        ...
        this.mListeners.forEach(new BiConsumer() { // from class: com.android.keyguard.clock.-$$Lambda$ClockManager$qgNV-V-ndKBDwD0H6bkgmOPGFf8
    ...
    public /* synthetic */ void lambda$reload$3$ClockManager(ClockChangedListener clockChangedListener, AvailableClocks availableClocks) {
        ...
        this.mMainHandler.post(new Runnable(currentClock) { // from class: com.android.keyguard.clock.-$$Lambda$ClockManager$mUjYY_SkgClnk-NIhp881jS2o8E
    ...
    public final class AvailableClocks implements PluginListener<ClockPlugin> {
        ...
        public void addClockPlugin(ClockPlugin clockPlugin) {
            ...
            builder.setTitle(new Supplier() { // from class: com.android.keyguard.clock.-$$Lambda$NtEGOukxaFxn97YVYx86DAEBmms
                @Override // java.util.function.Supplier
                public final Object get() {
            ...
            builder.setId(name);
            Objects.requireNonNull(clockPlugin);
            builder.setThumbnail(new Supplier() { // from class: com.android.keyguard.clock.-$$Lambda$d3U4w-CuqsezzeLGogc1fLHnUj0
                @Override // java.util.function.Supplier
                public final Object get() {
                    return ClockPlugin.this.getThumbnail();
                }
            });
            builder.setPreview(new Supplier(clockPlugin) { // from class: com.android.keyguard.clock.-$$Lambda$ClockManager$AvailableClocks$3xFQeynnnUMh38fqZ7v9xTaqzmA
                public final /* synthetic */ ClockPlugin f$1;
