...
public class BatteryMeterDrawableBase extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (i != -1) {
            ...
            int i5 = i2 / 17;
            float f6 = (float) i3;
            this.mFrame.set(f6, (float) (i4 + i5), (float) (i3 + aspectRatio), (float) ((i2 + i4) - i5));
            ...
            if (this.mCharging || this.mPowerSaveEnabled || i <= this.mCriticalLevel || !this.mShowPercent) {
                ...
                f2 = (((float) this.mWidth) * 0.5f) + f6;
                f3 = ((((float) this.mHeight) + this.mTextHeight) * 0.47f) + ((float) i4);
                if (f <= f3) {
                    z = false;
                }
                if (!z) {
            ...
            if (!this.mCharging && !this.mPowerSaveEnabled) {
                if (i <= this.mCriticalLevel) {
                    canvas.drawText(this.mWarningString, (((float) this.mWidth) * 0.5f) + f6, ((((float) this.mHeight) + this.mWarningTextHeight) * 0.48f) + ((float) i4), this.mWarningTextPaint);
                } else if (z2) {
