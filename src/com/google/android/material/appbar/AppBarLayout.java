...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(android.content.Context r12, android.util.AttributeSet r13, int r14) {
        /*
            r11 = this;
            int r0 = com.google.android.material.appbar.AppBarLayout.DEF_STYLE_RES
            ...
            r2 = 0
            r11.pendingAction = r2
            android.content.Context r9 = r11.getContext()
            r3 = 1
            r11.setOrientation(r3)
            r10 = 21
            if (r1 < r10) goto L_0x0027
            com.google.android.material.appbar.ViewUtilsLollipop.setBoundsViewOutlineProvider(r11)
            com.google.android.material.appbar.ViewUtilsLollipop.setStateListAnimatorFromAttrs(r11, r13, r14, r0)
        L_0x0027:
            int[] r5 = com.google.android.material.R$styleable.AppBarLayout
            int r7 = com.google.android.material.appbar.AppBarLayout.DEF_STYLE_RES
            int[] r8 = new int[r2]
            r3 = r9
            r4 = r13
            r6 = r14
            android.content.res.TypedArray r13 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r3, r4, r5, r6, r7, r8)
            ...
            r0.setFillColor(r14)
            r0.initializeElevationOverlay(r9)
        ...
        L_0x0072:
            ...
            float r14 = (float) r14
            com.google.android.material.appbar.ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(r11, r14)
        L_0x0086:
            r14 = 26
        ...
        L_0x00ac:
            ...
            r13.recycle()
            com.google.android.material.appbar.AppBarLayout$1 r12 = new com.google.android.material.appbar.AppBarLayout$1
            r12.<init>()
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public void onHide(final View view) {
            view.animate().scaleX(0.6f).scaleY(0.6f).alpha(0.0f).setDuration(150).setListener(new Animator.AnimatorListener(this) { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.1
        ...
        public void onShow(final View view) {
            view.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(150).setListener(new Animator.AnimatorListener(this) { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.2
                @Override // android.animation.Animator.AnimatorListener
                public void onAnimationCancel(Animator animator) {
                }
        ...
        public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, T t, View view, int i) {
            if (this.lastStartedType == 0 || i == 1) {
                snapToChildIfNeeded(coordinatorLayout, t, view);
                if (t.isLiftOnScroll()) {
                    t.setLiftedState(t.shouldLift(view));
                }
            }
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, T t, int i, float f, View view) {
            animateOffsetWithDuration(coordinatorLayout, t, i, (int) (((((float) Math.abs(getTopBottomOffsetForScrollingSibling() - i)) / ((float) t.getHeight())) + 1.0f) * 180.0f), view);
        }

        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final T t, int i, int i2, View view) {
            ...
            if (this.offsetAnimator == null) {
                ...
                valueAnimator2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.3
                    @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            ...
            if (view instanceof SpringNestScrollView) {
                Path path = new Path();
                path.lineTo(0.8f, 0.8f);
                path.moveTo(0.8f, 0.8f);
                path.cubicTo(0.8f, 0.8f, 0.95f, 0.99f, 1.0f, 1.0f);
                path.lineTo(1.0f, 1.0f);
                Interpolator create = PathInterpolatorCompat.create(path);
                if (i - topBottomOffsetForScrollingSibling < 0) {
                    this.offsetAnimator.setInterpolator(create);
                }
            } else {
                PathInterpolator pathInterpolator = new PathInterpolator(0.67f, 0.37f, 0.97f, 1.0f);
                if (i - topBottomOffsetForScrollingSibling < 0) {
                    this.offsetAnimator.setInterpolator(pathInterpolator);
                } else {
                    this.offsetAnimator.setInterpolator(new PathInterpolator(0.67f, 0.0f, 1.0f, 1.0f));
                }
            }
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, T t, View view) {
            int topBottomOffsetForScrollingSibling = getTopBottomOffsetForScrollingSibling();
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, t, MathUtils.clamp(i, -t.getTotalScrollRange(), 0), 0.0f, view);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t, int i) {
            ...
            if (i3 >= 0 && (pendingAction & 8) == 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (z) {
                        animateOffsetTo(coordinatorLayout, t, i5, 0.0f, null);
                    } else {
                        setHeaderTopBottomOffset(coordinatorLayout, t, i5);
                    }
                } else if ((pendingAction & 1) != 0) {
                    if (z) {
                        animateOffsetTo(coordinatorLayout, t, 0, 0.0f, null);
                    } else {
        ...
        private void addAccessibilityScrollActions(final CoordinatorLayout coordinatorLayout, final T t, final View view) {
            ...
            if (view.canScrollVertically(-1)) {
                ...
                if (i != 0) {
                    ViewCompat.replaceAccessibilityAction(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.4
        ...
        private void addActionToExpand(CoordinatorLayout coordinatorLayout, final T t, AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat, final boolean z) {
            ViewCompat.replaceAccessibilityAction(coordinatorLayout, accessibilityActionCompat, null, new AccessibilityViewCommand(this) { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.5
                @Override // androidx.core.view.accessibility.AccessibilityViewCommand
        ...
        public void onFlingFinished(CoordinatorLayout coordinatorLayout, T t) {
            snapToChildIfNeeded(coordinatorLayout, t, null);
            if (t.isLiftOnScroll()) {
