...
public class Appbar extends ViewGroup {
    ...
    public Appbar(Context context, AttributeSet attributeSet, int i) {
        ...
        obtainStyledAttributes.getDrawable(R$styleable.Appbar_collapseIcon);
        obtainStyledAttributes.getText(R$styleable.Appbar_collapseContentDescription);
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (((CollapsingAppbarLayout) getParent()).isExistSynsText()) {
            return false;
        }
        return super.dispatchTouchEvent(motionEvent);
    }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.appbar.Appbar.SavedState.1
