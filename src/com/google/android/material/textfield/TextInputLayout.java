...
public class TextInputLayout extends LinearLayout {
    ...
    private void setEditText(EditText editText) {
        if (this.mEditText == null) {
            ...
            this.mEditText.addTextChangedListener(new TextWatcher() { // from class: com.google.android.material.textfield.TextInputLayout.1
    ...
    public void setErrorEnabled(boolean r6) {
        ...
        L_0x000f:
            ...
            r1.<init>(r2)
            r5.mErrorView = r1
            int r2 = com.google.android.material.R$id.op_text_input_error
            r1.setId(r2)
        ...
        L_0x002b:
            r1 = 1
            android.widget.TextView r2 = r5.mErrorView     // Catch:{ Exception -> 0x004b }
            int r3 = r5.mErrorTextAppearance     // Catch:{ Exception -> 0x004b }
            androidx.core.widget.TextViewCompat.setTextAppearance(r2, r3)     // Catch:{ Exception -> 0x004b }
            int r2 = android.os.Build.VERSION.SDK_INT     // Catch:{ Exception -> 0x004b }
            r3 = 23
            if (r2 < r3) goto L_0x0049
            android.widget.TextView r2 = r5.mErrorView     // Catch:{ Exception -> 0x004b }
            android.content.res.ColorStateList r2 = r2.getTextColors()     // Catch:{ Exception -> 0x004b }
            int r2 = r2.getDefaultColor()     // Catch:{ Exception -> 0x004b }
        ...
        L_0x004c:
            ...
            int r4 = com.google.android.material.R$color.op_error_color_material_xxx_light
    ...
    private void setError(final CharSequence charSequence, boolean z, boolean z2) {
        ...
        if (this.mErrorShown) {
            ...
            if (z) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimatorUtils.LinearOutSlowInInterpolator).setListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.textfield.TextInputLayout.2
            ...
            if (z) {
                this.mErrorView.animate().alpha(0.0f).setDuration(200).setInterpolator(AnimatorUtils.FastOutLinearInInterpolator).setListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.textfield.TextInputLayout.3
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        ...
        if (this.mCounterEnabled != z) {
            if (z) {
                ...
                try {
                    ...
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), R$color.op_error_color_material_xxx_light));
                }
        ...
        if (this.mEditText != null) {
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    ...
                    this.mPasswordToggleView.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.textfield.TextInputLayout.4
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mHintEnabled && (editText = this.mEditText) != null) {
            ...
            if (this.mEditText instanceof TextInputEditText) {
                this.mCollapsingTextHelper.setExpandedBounds(compoundPaddingLeft, rect.top + getResources().getDimensionPixelOffset(R$dimen.op_control_margin_space2) + 3, compoundPaddingRight, (rect.bottom - this.mEditText.getCompoundPaddingBottom()) + getResources().getDimensionPixelOffset(R$dimen.op_control_margin_space1) + 3);
            } else {
            ...
            if (this.mEditText instanceof TextInputEditText) {
                this.mCollapsingTextHelper.setCollapsedBounds(compoundPaddingLeft, getPaddingTop() + getResources().getDimensionPixelOffset(R$dimen.op_control_margin_space1), compoundPaddingRight, ((i4 - i2) - getPaddingBottom()) + getResources().getDimensionPixelOffset(R$dimen.op_control_margin_space1));
            } else {
    ...
    public void animateToExpansionFraction(float f) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != f) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.TextInputLayout.5
