...
public class SnackbarContentLayout extends LinearLayout {
    ...
    private boolean updateViewsWithinLayout(int i, int i2, int i3) {
        ...
        textView.setPadding(textView.getPaddingLeft(), this.messageView.getPaddingTop(), getResources().getDimensionPixelSize(R$dimen.op_control_margin_space3), this.messageView.getPaddingBottom());
        return true;
    }
