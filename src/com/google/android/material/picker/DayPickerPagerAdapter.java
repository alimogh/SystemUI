...
public class DayPickerPagerAdapter extends PagerAdapter {
    ...
    private int mCount;
    private ArrayList<SimpleMonthView> mCurrentViewList = new ArrayList<>();
    ...
    private final SimpleMonthView.OnDayClickListener mOnDayClickListener = new SimpleMonthView.OnDayClickListener() { // from class: com.google.android.material.picker.DayPickerPagerAdapter.1
    ...
    public ArrayList<SimpleMonthView> getCurrentView() {
