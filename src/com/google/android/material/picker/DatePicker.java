...
public class DatePicker extends FrameLayout {
    ...
    public DatePicker(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mDelegate.setAutoFillChangeListener(new OnDateChangedListener() { // from class: com.google.android.material.picker.DatePicker.1
    ...
    public static abstract class AbstractDatePickerDelegate implements DatePickerDelegate {
        ...
        public static class SavedState extends View.BaseSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.google.android.material.picker.DatePicker.AbstractDatePickerDelegate.SavedState.1
