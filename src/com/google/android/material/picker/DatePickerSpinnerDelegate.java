...
public class DatePickerSpinnerDelegate extends DatePicker.AbstractDatePickerDelegate {
    ...
    DatePickerSpinnerDelegate(DatePicker datePicker, Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        AnonymousClass1 r10 = new NumberPicker.OnValueChangeListener() { // from class: com.google.android.material.picker.DatePickerSpinnerDelegate.1
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() { // from class: com.google.android.material.picker.DatePickerSpinnerDelegate.2
