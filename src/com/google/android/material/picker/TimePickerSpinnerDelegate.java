...
public class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker timePicker, Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        numberPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: com.google.android.material.picker.TimePickerSpinnerDelegate.1
        ...
        this.mMinuteSpinner.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: com.google.android.material.picker.TimePickerSpinnerDelegate.2
            @Override // com.google.android.material.picker.NumberPicker.OnValueChangeListener
        ...
        if (findViewById instanceof Button) {
            ...
            button.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.picker.TimePickerSpinnerDelegate.3
            ...
            this.mAmPmSpinner.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: com.google.android.material.picker.TimePickerSpinnerDelegate.4
                @Override // com.google.android.material.picker.NumberPicker.OnValueChangeListener
