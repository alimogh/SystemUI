...
public class YearPickerView extends FrameLayout {
    ...
    public YearPickerView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mPicker.setWithoutSelectBoldText(false);
        this.mPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() { // from class: com.google.android.material.picker.YearPickerView.1
            @Override // com.google.android.material.picker.NumberPicker.OnValueChangeListener
            public void onValueChange(NumberPicker numberPicker2, int i3, int i4) {
                YearPickerView.this.setCurrentYear();
            }
        });
    }
