...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), false, i) { // from class: com.google.android.material.datepicker.MaterialCalendar.2
