...
public class TabBarView extends HorizontalScrollView {
    ...
    private void doSelectItemAnim(MenuBuilder menuBuilder, MenuItem menuItem) {
        int i = 0;
    ...
    private void setupwithVPAnimate(int i) {
        ...
        if (pagerAdapter instanceof FragmentPagerAdapter) {
            ...
            if ((view instanceof ViewGroup) && (findCollapsingAppbarLayout = findCollapsingAppbarLayout((ViewGroup) view)) != null) {
                ...
                this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: com.google.android.material.tabbar.TabBarView.4
    ...
    public class TabBarOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onShow(final View view) {
            view.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(150).setListener(new Animator.AnimatorListener(this) { // from class: com.google.android.material.tabbar.TabBarView.TabBarOnPageChangeListener.1
        ...
        private void updateOrRecreateIndicatorAnimation(boolean z, final int i, int i2) {
            ...
            if (tabBarView.menuView != null && tabBarView.menu.size() > 0) {
                ...
                if (i3 != left || i4 != right) {
                    ...
                    AnonymousClass1 r2 = new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.tabbar.TabBarView.SlidingTabIndicator.1
                        @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                        public void onAnimationUpdate(ValueAnimator valueAnimator) {
                            int i5;
                            ...
                            if (d < 0.25d) {
                                i5 = (int) (((float) right) + (800.0f * animatedFraction));
                            } else {
                                i5 = (int) ((((double) right) + ((1.0d - ((Math.abs(0.25d - d) * 4.0d) / 15.0d)) * 200.0d)) - 160.0d);
                            }
                            SlidingTabIndicator slidingTabIndicator = SlidingTabIndicator.this;
                            slidingTabIndicator.setIndicatorPosition(AnimationUtils.lerp(slidingTabIndicator.animationStartLeft, left, animatedFraction), AnimationUtils.lerp(SlidingTabIndicator.this.animationStartRight, i5, animatedFraction));
                        }
                    };
                    if (z) {
                        ValueAnimator valueAnimator = new ValueAnimator();
