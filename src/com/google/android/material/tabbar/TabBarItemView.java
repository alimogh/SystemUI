...
public class TabBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    private void setIconToLine() {
        if (this.mDisplay) {
            postDelayed(new Runnable() { // from class: com.google.android.material.tabbar.TabBarItemView.2
                @Override // java.lang.Runnable
                public void run() {
                    TabBarItemView.this.icon.animate().scaleX(0.1f).scaleY(0.1f).setDuration(225).setInterpolator(AnimatorUtils.op__control_interpolator_fast_out_linear_in).withEndAction(new Runnable() { // from class: com.google.android.material.tabbar.TabBarItemView.2.1
                        @Override // java.lang.Runnable
                        public void run() {
                            TabBarItemView.this.icon.animate().scaleY(1.0f).setDuration(10).withEndAction(new Runnable() { // from class: com.google.android.material.tabbar.TabBarItemView.2.1.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    TabBarItemView tabBarItemView = TabBarItemView.this;
