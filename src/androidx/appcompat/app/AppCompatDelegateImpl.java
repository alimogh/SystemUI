...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r17) {
        /*
    ...
    public class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (appCompatDelegateImpl2.mActionModeView != null) {
                ...
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(AppCompatDelegateImpl.this.mActionModeView.getCloseView(), "scaleX", 1.0f, 0.6f);
                ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(AppCompatDelegateImpl.this.mActionModeView.getCloseView(), "scaleY", 1.0f, 0.6f);
                AnimatorSet.Builder play = animatorSet.play(ofFloat);
                play.with(ofFloat2);
                play.with(ofFloat2);
                int childCount = AppCompatDelegateImpl.this.mActionModeView.getMenuView().getChildCount();
                for (int i = 0; i < childCount; i++) {
                    View childAt = AppCompatDelegateImpl.this.mActionModeView.getMenuView().getChildAt(i);
                    ObjectAnimator ofFloat3 = ObjectAnimator.ofFloat(childAt, "scaleY", 1.0f, 0.6f);
                    ObjectAnimator ofFloat4 = ObjectAnimator.ofFloat(childAt, "scaleX", 1.0f, 0.6f);
                ...
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.ActionModeCallbackWrapperV9.1
                    ...
                    public void onAnimationEnd(View view) {
                        ...
                        appCompatDelegateImpl5.doShowToolbarAnim();
                    }
                });
            }
            AppCompatDelegateImpl appCompatDelegateImpl4 = AppCompatDelegateImpl.this;
    ...
    private void doShowToolbarAnim() {
        Toolbar toolBar;
        ToolbarActionBar toolbarActionBar = (ToolbarActionBar) this.mActionBar;
        if (!(toolbarActionBar == null || (toolBar = toolbarActionBar.getToolBar()) == null)) {
            AnimatorSet animatorSet = new AnimatorSet();
            ...
            while (true) {
                if (i >= childCount) {
                    ...
                    for (int i2 = 0; i2 < childCount2; i2++) {
                        ...
                        animatorSet.play(ObjectAnimator.ofFloat(childAt, "scaleY", 0.6f, 1.0f)).with(ObjectAnimator.ofFloat(childAt, "scaleX", 0.6f, 1.0f));
                    }
                } else {
                    i++;
                }
            }
            animatorSet.playTogether(ObjectAnimator.ofFloat(toolBar, "alpha", 1.0f));
            animatorSet.setDuration(150L);
            animatorSet.start();
        }
    }
