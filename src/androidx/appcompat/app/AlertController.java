...
public class AlertController {
    ...
    private void showInBottom(boolean z) {
        ...
        if (z) {
            ...
            if (this.mContext.getResources().getConfiguration().orientation == 2) {
                attributes.width = this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_landscape_width);
            } else {
                attributes.width = -1;
            }
            if (this.mWindow.findViewById(R$id.parentPanel) != null) {
                ...
                View findViewById3 = findViewById.findViewById(R$id.customPanel);
                boolean z2 = (findViewById3 == null || findViewById3.getVisibility() == 8) ? false : true;
                AppCompatDialog appCompatDialog = this.mDialog;
                if (z2) {
                    this.mWindow.setWindowAnimations(R$style.Oneplus_popup_bottom_edittext_animation);
                } else {
    ...
    private void setupDecor() {
        ...
        if (findViewById != null && decorView != null && Build.VERSION.SDK_INT >= 20) {
            decorView.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.appcompat.app.AlertController.2
    ...
    private void setupTitle(ViewGroup viewGroup) {
        ...
        if (!(!TextUtils.isEmpty(this.mTitle)) || !this.mShowTitle) {
            ...
            if (!TextUtils.isEmpty(this.mMessage)) {
                ...
                layoutParams.topMargin = this.mContext.getResources().getDimensionPixelOffset(R$dimen.op_control_margin_space4);
                ...
                this.mMessageView.setTextAppearance(this.mContext, R$style.op_control_text_style_h6);
                this.mMessageView.setTextColor(this.mContext.getResources().getColor(R$color.op_control_text_color_primary_default));
        ...
        if (!TextUtils.isEmpty(this.mMessage) && this.mContext.getResources().getConfiguration().orientation == 1) {
            ...
            layoutParams3.bottomMargin = this.mContext.getResources().getDimensionPixelOffset(R$dimen.op_control_margin_space4);
    ...
    private void updateImage() {
        ...
        if (imageView != null) {
            ...
            if (drawable != null) {
                ...
                if (this.mWindow.findViewById(R$id.parentPanel).getParent() != null && (this.mWindow.findViewById(R$id.parentPanel).getParent() instanceof SmoothRoundLayout)) {
                    ((SmoothRoundLayout) this.mWindow.findViewById(R$id.parentPanel).getParent()).setCornerRadius(0.0f);
                }
            } else {
                imageView.setVisibility(8);
            }
            if (this.mContext.getResources().getConfiguration().orientation == 2) {
                ...
                attributes.width = this.mContext.getResources().getDimensionPixelOffset(R$dimen.oneplus_dialog_landscape_width);
                this.mWindow.setAttributes(attributes);
                this.mWindow.setBackgroundDrawableResource(R$drawable.op_dialog_material_background_landcape_with_image);
            }
        }
    }

    private int getLineMaxNumber(CharSequence charSequence) {
        if (charSequence == null || "".equals(charSequence)) {
            return 0;
        }
        TextPaint textPaint = new TextPaint(1);
        textPaint.setTextSize((float) this.mContext.getResources().getDimensionPixelSize(R$dimen.op_text_size_body1));
        DisplayMetrics displayMetrics = new DisplayMetrics();
        ((WindowManager) this.mContext.getSystemService("window")).getDefaultDisplay().getMetrics(displayMetrics);
        int dimensionPixelOffset = (displayMetrics.widthPixels - (this.mContext.getResources().getDimensionPixelOffset(R$dimen.op_dialog_background_inset) * 2)) - (this.mContext.getResources().getDimensionPixelOffset(R$dimen.op_control_margin_screen_left2) * 2);
        return (int) (((float) dimensionPixelOffset) / (textPaint.measureText(charSequence, 0, charSequence.length()) / ((float) charSequence.length())));
    }
    ...
    private void setupContent(ViewGroup viewGroup) {
        ...
        if (textView != null) {
            ...
            if (charSequence != null) {
                textView.setText(charSequence);
                if (this.mMessage.length() < getLineMaxNumber(this.mMessage)) {
                    this.mMessageView.setGravity(17);
                    return;
                }
                return;
    ...
    private void setupButtons(ViewGroup viewGroup) {
        ...
        if (TextUtils.isEmpty(this.mButtonPositiveText)) {
            ...
            if (this.mButtonPositiveText.equals("Ok") || this.mButtonPositiveText.equals("ok")) {
                this.mButtonPositiveText = "OK";
            }
        ...
        if (TextUtils.isEmpty(this.mButtonNegativeText)) {
            ...
            if (this.mButtonNegativeText.equals("Ok") || this.mButtonNegativeText.equals("ok")) {
                this.mButtonNegativeText = "OK";
            }
        ...
        if (TextUtils.isEmpty(this.mButtonNeutralText)) {
            ...
            if (this.mButtonNeutralText.equals("Ok") || this.mButtonNeutralText.equals("ok")) {
                this.mButtonNeutralText = "OK";
            }
            this.mButtonNeutral.setText(this.mButtonNeutralText);
            this.mButtonNeutral.setVisibility(0);
            z |= true;
        }
        if (this.mButtonPositive.getVisibility() == 0 && this.mButtonNeutral.getVisibility() == 0 && this.mButtonNegative.getVisibility() == 0 && this.mContext.getResources().getConfiguration().orientation == 2) {
            makeButtonReLayout();
        } else if (this.mButtonNeutral.getVisibility() == 0 && this.mContext.getResources().getConfiguration().orientation == 2) {
            this.mButtonNeutral.setGravity(17);
        } else if (z) {
    ...
    private void makeButtonReLayout() {
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.mButtonNeutral.getLayoutParams();
        layoutParams.weight = 8.0f;
        this.mButtonNeutral.setPadding(this.mContext.getResources().getDimensionPixelOffset(R$dimen.op_control_margin_screen_left2), 0, 0, 0);
        this.mButtonNeutral.setLayoutParams(layoutParams);
        LinearLayout.LayoutParams layoutParams2 = (LinearLayout.LayoutParams) this.mButtonPositive.getLayoutParams();
        layoutParams2.gravity = 17;
        layoutParams2.weight = 1.0f;
        this.mButtonPositive.setLayoutParams(layoutParams2);
        LinearLayout.LayoutParams layoutParams3 = (LinearLayout.LayoutParams) this.mButtonNegative.getLayoutParams();
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (this.mCursor != null) {
                    ...
                    if (listAdapter == null) {
                        listAdapter = new CheckedItemAdapter(this.mContext, i, 16908308, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                            @Override // android.widget.ArrayAdapter, android.widget.Adapter
                            public View getView(int i2, View view, ViewGroup viewGroup) {
                                View view2 = super.getView(i2, view, viewGroup);
                                if (view2 != null) {
                                    if (view2.findViewById(16908308) instanceof CheckedTextView) {
                                        CheckedTextView checkedTextView = (CheckedTextView) view2.findViewById(16908308);
                                        TextView textView = (TextView) view2.findViewById(R$id.singlechoice_subtitle);
                                        if (textView != null) {
                                            CharSequence[] charSequenceArr3 = AlertParams.this.mSubItems;
                                            if (charSequenceArr3 != null && charSequenceArr3.length > i2) {
                                        ...
                                        if (i2 == AlertParams.this.mCheckedItem) {
                                        ...
                                        TextView textView3 = (TextView) view2.findViewById(R$id.singlechoice_subtitle);
                                        if (textView3 != null) {
                                            CharSequence[] charSequenceArr4 = AlertParams.this.mSubItems;
                                            if (charSequenceArr4 != null && charSequenceArr4.length > i2) {
                                                textView3.setText(charSequenceArr4[i2]);
                                            }
                ...
                listAdapter = new ArrayAdapter<CharSequence>(this.mContext, i2, 16908308, this.mItems) { // from class: androidx.appcompat.app.AlertController.AlertParams.1
                    @Override // android.widget.ArrayAdapter, android.widget.Adapter
                    public View getView(int i3, View view, ViewGroup viewGroup) {
                        ...
                        if (view2 != null) {
                            ...
                            if (textView != null) {
                                CharSequence[] charSequenceArr4 = AlertParams.this.mSubItems;
                                if (charSequenceArr4 != null && charSequenceArr4.length > i3) {
                                    textView.setText(charSequenceArr4[i3]);
                                }
                                int lineCount = textView.getLineCount();
                                if (AlertParams.this.mCheckedItems != null) {
                                    ...
                                    notifyDataSetChanged();
                                    if (AlertParams.this.mCheckedItems[i3]) {
                                        checkedTextView.setChecked(true);
                                    } else {
                                        checkedTextView.setChecked(false);
                                    }
                ...
                listAdapter = new CursorAdapter(this.mContext, this.mCursor, false) { // from class: androidx.appcompat.app.AlertController.AlertParams.2
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                        ...
                        int i3 = cursor.getInt(this.mIsCheckedIndex);
                        boolean z = true;
                        if (i3 != 1) {
                            z = false;
                        }
            ...
            if (this.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j) {
                        ...
                        if (AlertParams.this.mIsSingleChoice && (checkedTextView = (CheckedTextView) view.findViewById(16908308)) != null) {
                            AlertParams.this.mCheckedItem = i3;
                            for (int i4 = 0; i4 < recycleListView.getCount(); i4++) {
                                if (!(i4 == i3 || (childAt = recycleListView.getChildAt(i4)) == null)) {
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.5
                    @Override // android.widget.AdapterView.OnItemClickListener
                    public void onItemClick(AdapterView<?> adapterView, View view, int i3, long j) {
                        ...
                        if (checkedTextView != null) {
                            ...
                            AlertParams.this.mOnCheckboxClickListener.onClick(alertController.mDialog, i3, checkedTextView.isChecked());
                        }
                    }
                });
            }
