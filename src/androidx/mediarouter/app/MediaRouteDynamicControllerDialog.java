...
public class MediaRouteDynamicControllerDialog extends AppCompatDialog {
    ...
    public final class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void animateLayoutHeight(final View view, final int i) {
            ...
            AnonymousClass1 r1 = new Animation(this) { // from class: androidx.mediarouter.app.MediaRouteDynamicControllerDialog.RecyclerAdapter.1
                /* access modifiers changed from: protected */
                @Override // android.view.animation.Animation
                public void applyTransformation(float f, Transformation transformation) {
                    int i3 = i;
                    int i4 = i2;
                    MediaRouteDynamicControllerDialog.setLayoutHeight(view, i4 + ((int) (((float) (i3 - i4)) * f)));
                }
            };
            r1.setAnimationListener(new Animation.AnimationListener() { // from class: androidx.mediarouter.app.MediaRouteDynamicControllerDialog.RecyclerAdapter.2
