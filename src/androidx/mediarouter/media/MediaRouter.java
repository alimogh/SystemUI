            ...
            if (providerInfo.updateDescriptor(mediaRouteProviderDescriptor)) {
                ...
                if (mediaRouteProviderDescriptor == null || (!mediaRouteProviderDescriptor.isValid() && mediaRouteProviderDescriptor != this.mSystemProvider.getDescriptor())) {
                    ...
                    for (Pair pair : arrayList) {
                        RouteInfo routeInfo3 = pair.first;
                        routeInfo3.maybeUpdateDescriptor(pair.second);
                        if (MediaRouter.DEBUG) {
                    ...
                    for (Pair pair2 : arrayList2) {
                        RouteInfo routeInfo4 = pair2.first;
                        if (updateRouteDescriptorAndNotify(routeInfo4, pair2.second) != 0 && routeInfo4 == this.mSelectedRoute) {
                            z = true;
                        }
                    }
                }
