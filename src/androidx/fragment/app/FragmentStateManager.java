                    ...
                    if (computeExpectedState == this.mFragment.mState) {
                        if (FragmentManager.USE_STATE_MANAGER && this.mFragment.mHiddenChanged) {
                            if (!(this.mFragment.mView == null || this.mFragment.mContainer == null)) {
                                ...
                                this.mHiddenAnimationCancellationSignal = cancellationSignal;
                                if (this.mFragment.mHidden) {
                                    orCreateController.enqueueHide(this, cancellationSignal);
                                } else {
                                    orCreateController.enqueueShow(this, cancellationSignal);
                                }
                            }
                        ...
                        switch (i2) {
                            ...
                            case 3:
                                ...
                                if (!(this.mFragment.mView == null || this.mFragment.mContainer == null || this.mFragmentManagerState <= -1)) {
                                    ...
                                    this.mExitAnimationCancellationSignal = cancellationSignal3;
                                    orCreateController3.enqueueRemove(this, cancellationSignal3);
                                }
