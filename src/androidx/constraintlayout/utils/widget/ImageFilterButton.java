...
public class ImageFilterButton extends AppCompatImageButton {
        ...
        if (f != 0.0f) {
            ...
            if (i >= 21) {
                if (this.mViewOutlineProvider == null) {
                    AnonymousClass1 r8 = new ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.ImageFilterButton.1
    ...
    public void setRound(float f) {
        ...
        if (f != 0.0f) {
            ...
            if (i >= 21) {
                if (this.mViewOutlineProvider == null) {
                    AnonymousClass2 r7 = new ViewOutlineProvider() { // from class: androidx.constraintlayout.utils.widget.ImageFilterButton.2
                        @Override // android.view.ViewOutlineProvider
                        public void getOutline(View view, Outline outline) {
