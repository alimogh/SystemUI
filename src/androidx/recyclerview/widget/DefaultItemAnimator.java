    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                AnonymousClass1 r6 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.1
            ...
            if (z3) {
                ...
                AnonymousClass2 r62 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.2
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            if (z4) {
                ...
                AnonymousClass3 r5 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.3
                    @Override // java.lang.Runnable
                    public void run() {
