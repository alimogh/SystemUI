...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, final ResourcesCompat.FontCallback fontCallback, final Handler handler, boolean z, int i, final int i2) {
        ...
        if (typeface != null) {
            ...
            AnonymousClass1 r1 = new Callable<TypefaceResult>() { // from class: androidx.core.provider.FontsContractCompat.1
            ...
            if (z) {
                ...
                if (fontCallback == null) {
                    ...
                    r3 = new SelfDestructiveThread.ReplyCallback<TypefaceResult>() { // from class: androidx.core.provider.FontsContractCompat.2
                        public void onReply(TypefaceResult typefaceResult) {
                            ...
                            if (i3 == 0) {
                                ...
                                ResourcesCompat.FontCallback.this.callbackFailAsync(i3, handler);
                            }
                        }
                    };
                }
                synchronized (sLock) {
                    ...
                    sBackgroundThread.postAndReply(r1, new SelfDestructiveThread.ReplyCallback<TypefaceResult>() { // from class: androidx.core.provider.FontsContractCompat.3
                        public void onReply(TypefaceResult typefaceResult) {
                            ArrayList<SelfDestructiveThread.ReplyCallback<TypefaceResult>> arrayList3;
                            synchronized (FontsContractCompat.sLock) {
                                arrayList3 = FontsContractCompat.sPendingReplies.get(str);
                                if (arrayList3 != null) {
